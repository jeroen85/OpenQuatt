...
(()=>{const ud=`
  ...
  `,Fi={main:"https://github.com/jeroen85/OpenQuatt/releases/latest",dev:"https://github.com/jeroen85/OpenQuatt/releases/tag/dev-latest"},Is="https://oi.esphome.io/v3/www.js",At=2,_o=4,Ws=6e4,Bs="Power House",Vs="Water Temperature Control (heating curve)",Dn=[{id:"generation",kicker:"Stap 1",title:"Kies je Quatt Hybrid",copy:"Geef hier aan welke Quatt Hybrid je hebt. Dan zet OpenQuatt de juiste regeling klaar.",fields:[{title:"Quatt Hybrid-versie",copy:"Kies de versie die bij jouw Quatt hoort."}]},{id:"flow-source",kicker:"Stap 2",title:"Flowmeting configureren",copy:"Controleer en activeer de flowbron die bij jouw Quatt-versie en controller hoort.",fields:[{title:"Flowbron",copy:"De Quatt-versie en het hardwareprofiel bepalen automatisch welke flowbron OpenQuatt moet gebruiken."}]},{id:"thermostat-source",kicker:"Stap 3",title:"Thermostaatgegevens configureren",copy:"Leg vast waar OpenQuatt de kamertemperatuur en het kamer-setpoint samen vandaan haalt.",fields:[{title:"Thermostaatbron",copy:"Q-edition gebruikt OpenTherm. Listener en Waveshare gebruiken CiC of Home Assistant."}]},{id:"boiler",kicker:"Stap 4",title:"CV-ketel of boiler",copy:"Geef aan of OpenQuatt ondersteuning via een CV-ketel of boiler mag gebruiken.",optionalEntity:"boilerCvAssistEnabled",fields:[{title:"CV-ketel / boiler aanwezig",copy:"Kies of er ondersteuning beschikbaar is en vul eventueel het vermogen in."}]},{id:"strategy",kicker:"Stap 5",title:"Kies de verwarmingsstrategie",copy:"Kies hier hoe OpenQuatt je verwarming regelt. Daarna lopen we samen de belangrijkste instellingen langs.",fields:[{title:"Verwarmingsstrategie",copy:"Kies of OpenQuatt automatisch op je woning reageert, of werkt met een vaste stooklijn."}]},{id:"heating",kicker:"Stap 6",title:"Werk de regeling uit",copy:"Stel nu de gekozen regeling verder in. De inhoud hieronder past zich aan aan je keuze.",fields:[{title:"Instellingen voor jouw regeling",copy:"Je ziet hier alleen de instellingen die echt nodig zijn voor de gekozen regeling."}]},{id:"flow",kicker:"Stap 7",title:"Flowregeling en afstelling",copy:"Leg daarna vast hoe de pomp geregeld moet worden en welke waarden daarbij horen. De autotune staat later onder Instellingen \u2192 Installatie \u2192 Service & commissioning.",fields:[{title:"Flowregeling en tuning",copy:"Kies of OpenQuatt de pomp automatisch regelt, of dat je zelf een vaste pompstand instelt. Stel hier ook de flow-instellingen in."}]},{id:"water",kicker:"Stap 8",title:"Watertemperatuur beveiligen",copy:"Controleer de normale bovengrens en de tripgrens voor het watercircuit.",fields:[{title:"Watertemperatuur",copy:"Met deze grenzen voorkom je dat de watertemperatuur te hoog oploopt."}]},{id:"silent",kicker:"Stap 9",title:"Stille uren en niveaus",copy:"Stel daarna het stille venster en de compressorlimieten voor dag en nacht in.",fields:[{title:"Stille uren",copy:"Hier bepaal je wanneer het systeem rustiger moet werken."}]},{id:"confirm",kicker:"Stap 10",title:"Bevestigen en afronden",copy:"Controleer nog \xE9\xE9n keer je keuzes. Met afronden markeer je Quick Start als voltooid.",fields:[{title:"Afronden",copy:"Je instellingen zijn al opgeslagen. Deze stap markeert alleen dat Quick Start klaar is."}]}],In=[1,2],Ao=Array.from({length:11},(e,t)=>t),ta=["cooling","heating"];function dd(e){return e==="cooling"?"cooling":"heating"}function pd(e){return e==="cooling"?"Cooling":"Heating"}function Jt(e,t,n){return`hp${e}OduRuntime${pd(t)}F${n}`}function le(e,t){return`hp${e}OduRuntimeFrequency${t}`}function _s(e){return[le(e,"Enable"),le(e,"Load"),le(e,"Apply"),le(e,"Status"),...ta.flatMap(t=>Ao.map(n=>Jt(e,t,n)))]}function gd(e){const t=String(e||"").match(/^hp([12])OduRuntimeFrequency(?:Load|Apply)$/);return t?Number(t[1]):0}const oa=In.flatMap(_s),js=new Set(In.flatMap(e=>[le(e,"Load"),le(e,"Apply")])),L={setupComplete:{domain:"binary_sensor",name:"Setup Complete",optional:!0},status:{domain:"binary_sensor",name:"Status",optional:!0},firmwareUpdate:{domain:"update",name:"Firmware Update",optional:!0},firmwareUpdateChannel:{domain:"select",name:"Firmware Update Channel",optional:!0},firmwareUpdateTarget:{domain:"select",name:"Firmware Update Target",optional:!0},firmwareUpdateProgress:{domain:"sensor",name:"Firmware Update Progress",optional:!0},firmwareUpdateStatus:{domain:"text_sensor",name:"Firmware Update Status",optional:!0},firmwareTestOtaUrl:{domain:"text",name:"Firmware Test OTA URL",optional:!0},firmwareTestOtaMd5Url:{domain:"text",name:"Firmware Test OTA MD5 URL",optional:!0},checkFirmwareUpdates:{domain:"button",name:"Check Firmware Updates",optional:!0},installFirmwareTestOta:{domain:"button",name:"Install Firmware Test OTA",optional:!0},installFirmwareUpdateTarget:{domain:"button",name:"Install Firmware Update Target",optional:!0},restartAction:{domain:"button",name:"Restart",optional:!0},uptime:{domain:"sensor",name:"Uptime",optional:!0},uptimeReadable:{domain:"text_sensor",name:"Uptime readable",optional:!0},timeNowHhmm:{domain:"text_sensor",name:"Time now (HH:MM)",optional:!0},timeValid:{domain:"binary_sensor",name:"Time valid",optional:!0},ipAddress:{domain:"text_sensor",name:"IP Address",optional:!0},wifiSsid:{domain:"text_sensor",name:"WiFi SSID",optional:!0},projectVersionText:{domain:"text_sensor",name:"OpenQuatt Version",optional:!0},releaseChannelText:{domain:"text_sensor",name:"OpenQuatt Release Channel",optional:!0},installationTopology:{domain:"text_sensor",name:"OpenQuatt Installation Topology",optional:!0},hardwareProfileText:{domain:"text_sensor",name:"OpenQuatt Hardware Profile",optional:!0},connectionText:{domain:"text_sensor",name:"OpenQuatt Connection",optional:!0},wifiSignal:{domain:"sensor",name:"WiFi Signal",optional:!0},espInternalTemp:{domain:"sensor",name:"ESP Internal Temperature",optional:!0},hpGeneration:{domain:"select",name:"Quatt Hybrid version"},strategy:{domain:"select",name:"Heating Control Mode"},openquattEnabled:{domain:"switch",name:"OpenQuatt Enabled",optional:!0},boilerCvAssistEnabled:{domain:"switch",name:"Boiler assist enabled",optional:!0},manualCoolingEnable:{domain:"switch",name:"Manual Cooling Enable",optional:!0},cicCompatibilityMode:{domain:"switch",name:"CiC Compatibility Mode",optional:!0},silentModeOverride:{domain:"select",name:"Silent Mode Override",optional:!0},heatingEnableSelected:{domain:"binary_sensor",name:"Heating Enable (Selected)",optional:!0},heatingEnableValid:{domain:"binary_sensor",name:"Heating Enable Valid",optional:!0},heatingBlockedByThermostat:{domain:"binary_sensor",name:"Heating blocked by thermostat",optional:!0},coolingEnableSelected:{domain:"binary_sensor",name:"Cooling Enable (Selected)",optional:!0},coolingRequestActive:{domain:"binary_sensor",name:"Cooling Request Active",optional:!0},coolingPermitted:{domain:"binary_sensor",name:"Cooling Permitted",optional:!0},coolingBlockReason:{domain:"text_sensor",name:"Cooling Block Reason",optional:!0},coolingGuardMode:{domain:"text_sensor",name:"Cooling Guard Mode",optional:!0},coolingDewPointSelected:{domain:"sensor",name:"Cooling Dew Point (Selected)",optional:!0},coolingMinimumSafeSupplyTemp:{domain:"sensor",name:"Cooling Minimum Safe Supply Temp",optional:!0},coolingEffectiveMinSupplyTemp:{domain:"sensor",name:"Cooling Effective Minimum Supply Temp",optional:!0},coolingFallbackNightMinOutdoorTemp:{domain:"sensor",name:"Cooling Fallback Night Minimum Outdoor Temp",optional:!0},coolingFallbackMinSupplyTemp:{domain:"sensor",name:"Cooling Fallback Minimum Supply Temp",optional:!0},coolingSupplyTarget:{domain:"sensor",name:"Cooling Supply Target",optional:!0},coolingSupplyError:{domain:"sensor",name:"Cooling Supply Error",optional:!0},coolingDemandRaw:{domain:"sensor",name:"Cooling Demand (raw)",optional:!0},coolingBaseDemandRaw:{domain:"sensor",name:"Cooling base demand raw",optional:!0},coolingLimitedDemand:{domain:"sensor",name:"Cooling limited demand",optional:!0},coolingLimiterAllowedMax:{domain:"sensor",name:"Cooling limiter allowed max",optional:!0},coolingBufferGapFiltered:{domain:"sensor",name:"Cooling buffer gap filtered",optional:!0},coolingBufferGapRate:{domain:"sensor",name:"Cooling buffer gap rate",optional:!0},coolingProjectedGap:{domain:"sensor",name:"Cooling projected gap",optional:!0},coolingProjectionBrakeActive:{domain:"sensor",name:"Cooling projection brake active",optional:!0},coolingDewGap:{domain:"sensor",name:"Cooling dew gap",optional:!0},coolingStopBufferGap:{domain:"sensor",name:"Cooling stop buffer gap",optional:!0},coolingLimiterReasonCode:{domain:"sensor",name:"Cooling limiter reason code",optional:!0},coolingStopReasonCode:{domain:"sensor",name:"Cooling stop reason code",optional:!0},coolingRequestReasonCode:{domain:"sensor",name:"Cooling request reason code",optional:!0},coolingRequestHp1Level:{domain:"sensor",name:"Cooling request HP1 level",optional:!0},coolingRequestHp2Level:{domain:"sensor",name:"Cooling request HP2 level",optional:!0},coolingRequestOwnerHp:{domain:"sensor",name:"Cooling request owner HP",optional:!0},coolingOwnerHp:{domain:"sensor",name:"Cooling owner HP",optional:!0},coolingWaterCycleActive:{domain:"sensor",name:"Cooling water cycle active",optional:!0},waterSupplySource:{domain:"select",name:"Water Supply Source",optional:!0},flowSource:{domain:"select",name:"Flow Source",optional:!0},qFlowSource:{domain:"select",name:"Q Flow Source",optional:!0},outdoorUnitFlowMode:{domain:"select",name:"Outdoor Unit Flow Mode",optional:!0},outsideTempSource:{domain:"select",name:"Outside Temperature Source",optional:!0},roomTempSource:{domain:"select",name:"Room Temperature Source",optional:!0},roomSetpointSource:{domain:"select",name:"Room Setpoint Source",optional:!0},heatingEnableSource:{domain:"select",name:"Heating Enable Source",optional:!0},coolingEnableSource:{domain:"select",name:"Cooling Enable Source",optional:!0},localWaterSupplyTempSource:{domain:"select",name:"Local Water Supply Temp Source",optional:!0},coolingMinimumSupplyTemp:{domain:"number",name:"Cooling Minimum Supply Temp",optional:!0},coolingDemandMax:{domain:"number",name:"Cooling Demand Max",optional:!0},coolingRestartDelta:{domain:"number",name:"Cooling Restart Delta",optional:!0},coolingPidKp:{domain:"number",name:"Cooling PID Kp",optional:!0},coolingPidKi:{domain:"number",name:"Cooling PID Ki",optional:!0},coolingPidKd:{domain:"number",name:"Cooling PID Kd",optional:!0},coolingSafetyMargin:{domain:"number",name:"Cooling Safety Margin",optional:!0},coolingRequestOnDelta:{domain:"number",name:"Cooling Request On Delta",optional:!0},coolingRequestOffDelta:{domain:"number",name:"Cooling Request Off Delta",optional:!0},coolingWithoutDewPointMode:{domain:"select",name:"Cooling Without Dew Point",optional:!0},flowControlMode:{domain:"select",name:"Flow Control Mode"},flowSetpoint:{domain:"number",name:"Flow Setpoint"},coolingFlowSetpoint:{domain:"number",name:"Cooling Flow Setpoint",optional:!0},manualIpwm:{domain:"number",name:"Manual iPWM"},compressorStarts2hWarningLimit:{domain:"number",name:"Compressor starts 2h warning limit",optional:!0},compressorStarts72hWarningLimit:{domain:"number",name:"Compressor starts 72h warning limit",optional:!0},compressorCyclingWarning2h:{domain:"binary_sensor",name:"Compressor cycling warning 2h",optional:!0},compressorCyclingWarning72h:{domain:"binary_sensor",name:"Compressor cycling warning 72h",optional:!0},alternatingCompressorStartsWarning:{domain:"binary_sensor",name:"Alternating compressor starts warning",optional:!0},compressorCyclingAlertLatched:{domain:"binary_sensor",name:"Compressor cycling alert latched",optional:!0},compressorCyclingAlertAlternating:{domain:"binary_sensor",name:"Compressor cycling alert alternating",optional:!0},compressorCyclingAlertFirstSeen:{domain:"sensor",name:"Compressor cycling alert first seen",optional:!0},compressorCyclingAlertLastSeen:{domain:"sensor",name:"Compressor cycling alert last seen",optional:!0},compressorCyclingAlertHp1Peak2h:{domain:"sensor",name:"Compressor cycling alert HP1 peak 2h",optional:!0},compressorCyclingAlertHp1Peak72h:{domain:"sensor",name:"Compressor cycling alert HP1 peak 72h",optional:!0},compressorCyclingAlertHp2Peak2h:{domain:"sensor",name:"Compressor cycling alert HP2 peak 2h",optional:!0},compressorCyclingAlertHp2Peak72h:{domain:"sensor",name:"Compressor cycling alert HP2 peak 72h",optional:!0},acknowledgeCompressorCyclingAlert:{domain:"button",name:"Acknowledge compressor cycling alert",optional:!0},hp1CompressorStarts2h:{domain:"sensor",name:"HP1 - Compressor starts 2h",optional:!0},hp1CompressorStarts6h:{domain:"sensor",name:"HP1 - Compressor starts 6h",optional:!0},hp1CompressorStarts24h:{domain:"sensor",name:"HP1 - Compressor starts 24h",optional:!0},hp1CompressorStarts72h:{domain:"sensor",name:"HP1 - Compressor starts 72h",optional:!0},hp1CompressorLastStartAge:{domain:"sensor",name:"HP1 - Compressor last start age",optional:!0},hp2CompressorStarts2h:{domain:"sensor",name:"HP2 - Compressor starts 2h",optional:!0},hp2CompressorStarts6h:{domain:"sensor",name:"HP2 - Compressor starts 6h",optional:!0},hp2CompressorStarts24h:{domain:"sensor",name:"HP2 - Compressor starts 24h",optional:!0},hp2CompressorStarts72h:{domain:"sensor",name:"HP2 - Compressor starts 72h",optional:!0},hp2CompressorLastStartAge:{domain:"sensor",name:"HP2 - Compressor last start age",optional:!0},lowflowFaultActive:{domain:"binary_sensor",name:"Lowflow fault active",optional:!0},flowMismatch:{domain:"binary_sensor",name:"Flow mismatch (HP1 vs HP2)",optional:!0},cicPollingEnabled:{domain:"switch",name:"CIC - Enable polling",optional:!0},cicFeedUrl:{domain:"text",name:"CIC - Feed URL",optional:!0},cicWaterSupplyTemp:{domain:"sensor",name:"CIC - Water Supply Temp",optional:!0},cicControlSetpoint:{domain:"sensor",name:"CIC - Control setpoint",optional:!0},cicRoomSetpoint:{domain:"sensor",name:"CIC - Room setpoint",optional:!0},cicRoomTemp:{domain:"sensor",name:"CIC - Room temperature",optional:!0},cicFlowrate:{domain:"sensor",name:"CIC - Flowrate (filtered)",optional:!0},cicLastSuccessAge:{domain:"sensor",name:"CIC - Last success age",optional:!0},cicChEnabled:{domain:"binary_sensor",name:"CIC - CH enabled",optional:!0},cicChEnableValid:{domain:"binary_sensor",name:"CIC - CH enable valid",optional:!0},cicCoolingEnabled:{domain:"binary_sensor",name:"CIC - Cooling enabled",optional:!0},cicJsonFeedOk:{domain:"binary_sensor",name:"CIC - JSON Feed OK",optional:!0},cicDataStale:{domain:"binary_sensor",name:"CIC - Data stale",optional:!0},otEnabled:{domain:"switch",name:"OpenTherm Enabled",optional:!0},otThermostatChEnable:{domain:"binary_sensor",name:"OT - Thermostat CH Enable",optional:!0},otThermostatStatusValid:{domain:"binary_sensor",name:"OT - Thermostat Status Valid",optional:!0},otThermostatCoolingEnable:{domain:"binary_sensor",name:"OT - Thermostat Cooling Enable",optional:!0},otLinkProblem:{domain:"binary_sensor",name:"OT - Link Problem",optional:!0},otControlSetpoint:{domain:"sensor",name:"OT - Control Setpoint",optional:!0},otRoomSetpoint:{domain:"sensor",name:"OT - Room Setpoint",optional:!0},otRoomTemp:{domain:"sensor",name:"OT - Room Temperature",optional:!0},flowKp:{domain:"number",name:"Flow PI Kp",optional:!0},flowKi:{domain:"number",name:"Flow PI Ki",optional:!0},boilerRatedHeatPower:{domain:"number",name:"Boiler rated heat power",optional:!0},commissioningCm100Start:{domain:"button",name:"CM100 Start",optional:!0},commissioningCm100Stop:{domain:"button",name:"CM100 Stop",optional:!0},commissioningStatus:{domain:"text_sensor",name:"Commissioning status",optional:!0},cm100Active:{domain:"binary_sensor",name:"CM100 active",optional:!0},boilerPowerTestStart:{domain:"button",name:"Boiler Power Test Start",optional:!0},boilerPowerTestAbort:{domain:"button",name:"Boiler Power Test Abort",optional:!0},boilerPowerTestApply:{domain:"button",name:"Boiler Power Test Apply",optional:!0},boilerPowerTestResult:{domain:"sensor",name:"Boiler power test result",optional:!0},boilerPowerTestActive:{domain:"binary_sensor",name:"Boiler power test active",optional:!0},boilerPowerTestStatus:{domain:"text_sensor",name:"Boiler power test status",optional:!0},flowAutotuneStart:{domain:"button",name:"Flow Autotune Start",optional:!0},flowAutotuneAbort:{domain:"button",name:"Flow Autotune Abort",optional:!0},flowAutotuneApply:{domain:"button",name:"Apply Flow Autotune Kp-Ki",optional:!0},flowAutotuneStatus:{domain:"text_sensor",name:"Flow Autotune status",optional:!0},flowKpSuggested:{domain:"number",name:"Flow Autotune Kp suggested",optional:!0},flowKiSuggested:{domain:"number",name:"Flow Autotune Ki suggested",optional:!0},airPurgeStart:{domain:"button",name:"Air Purge Start",optional:!0},airPurgeAbort:{domain:"button",name:"Air Purge Abort",optional:!0},airPurgeReturnToAuto:{domain:"switch",name:"Air purge return to Auto",optional:!0},airPurgeActive:{domain:"binary_sensor",name:"Air purge active",optional:!0},airPurgeStatus:{domain:"text_sensor",name:"Air purge status",optional:!0},airPurgeRemaining:{domain:"sensor",name:"Air purge remaining",optional:!0},airPurgePhase:{domain:"sensor",name:"Air purge phase",optional:!0},airPurgeTargetIpwm:{domain:"sensor",name:"Air purge target iPWM",optional:!0},manualFlowStart:{domain:"button",name:"Manual Flow Start",optional:!0},manualFlowAbort:{domain:"button",name:"Manual Flow Abort",optional:!0},manualFlowApplyHeating:{domain:"button",name:"Apply Manual Flow To Heating",optional:!0},manualFlowApplyCooling:{domain:"button",name:"Apply Manual Flow To Cooling",optional:!0},manualFlowActive:{domain:"binary_sensor",name:"Manual flow active",optional:!0},manualFlowStatus:{domain:"text_sensor",name:"Manual flow status",optional:!0},manualFlowSetpoint:{domain:"number",name:"Manual flow service setpoint",optional:!0},manualFlowTargetIpwm:{domain:"sensor",name:"Manual flow target iPWM",optional:!0},quickFlowTest:{domain:"switch",name:"Quick flow test",optional:!0},manualHpStart:{domain:"button",name:"Manual HP Start",optional:!0},manualHpAbort:{domain:"button",name:"Manual HP Abort",optional:!0},manualHpActive:{domain:"binary_sensor",name:"Manual HP active",optional:!0},manualHpStatus:{domain:"text_sensor",name:"Manual HP status",optional:!0},manualHpGuardStatus:{domain:"text_sensor",name:"Manual HP guard status",optional:!0},manualHp1Mode:{domain:"select",name:"Manual HP1 service mode",optional:!0},manualHp2Mode:{domain:"select",name:"Manual HP2 service mode",optional:!0},manualHp1Level:{domain:"number",name:"Manual HP1 compressor level",optional:!0},manualHp2Level:{domain:"number",name:"Manual HP2 compressor level",optional:!0},hpWaterCalibrationStart:{domain:"button",name:"HP Water Calibration Start",optional:!0},hpWaterCalibrationAbort:{domain:"button",name:"HP Water Calibration Abort",optional:!0},hpWaterCalibrationApply:{domain:"button",name:"Apply HP Water Calibration Offsets",optional:!0},hpWaterCalibrationActive:{domain:"binary_sensor",name:"HP water calibration active",optional:!0},hpWaterCalibrationStatus:{domain:"text_sensor",name:"HP water calibration status",optional:!0},hpWaterCalibrationRemaining:{domain:"sensor",name:"HP water calibration remaining",optional:!0},hpWaterCalibrationPhase:{domain:"sensor",name:"HP water calibration phase",optional:!0},hpWaterCalibrationSpread:{domain:"sensor",name:"HP water calibration spread",optional:!0},hpWaterCalibrationSupplyDelta:{domain:"sensor",name:"HP water calibration supply delta",optional:!0},hpWaterCalibrationStableProgress:{domain:"sensor",name:"HP water calibration stable window progress",optional:!0},hpWaterCalibrationStableRequired:{domain:"sensor",name:"HP water calibration stable window required",optional:!0},hpWaterCalibrationResultReference:{domain:"sensor",name:"HP water calibration result reference",optional:!0},hpWaterCalibrationResultSpreadBefore:{domain:"sensor",name:"HP water calibration result spread before",optional:!0},hpWaterCalibrationResultExpectedSpread:{domain:"sensor",name:"HP water calibration result expected spread",optional:!0},hpWaterCalibrationResultHp1InRawAvg:{domain:"sensor",name:"HP water calibration result HP1 water in raw average",optional:!0},hpWaterCalibrationResultHp1OutRawAvg:{domain:"sensor",name:"HP water calibration result HP1 water out raw average",optional:!0},hpWaterCalibrationResultHp2InRawAvg:{domain:"sensor",name:"HP water calibration result HP2 water in raw average",optional:!0},hpWaterCalibrationResultHp2OutRawAvg:{domain:"sensor",name:"HP water calibration result HP2 water out raw average",optional:!0},hp1WaterInOffset:{domain:"number",name:"HP1 water in temperature offset",optional:!0},hp1WaterOutOffset:{domain:"number",name:"HP1 water out temperature offset",optional:!0},hp2WaterInOffset:{domain:"number",name:"HP2 water in temperature offset",optional:!0},hp2WaterOutOffset:{domain:"number",name:"HP2 water out temperature offset",optional:!0},hp1WaterInOffsetSuggested:{domain:"number",name:"HP calibration HP1 water in offset suggested",optional:!0},hp1WaterOutOffsetSuggested:{domain:"number",name:"HP calibration HP1 water out offset suggested",optional:!0},hp2WaterInOffsetSuggested:{domain:"number",name:"HP calibration HP2 water in offset suggested",optional:!0},hp2WaterOutOffsetSuggested:{domain:"number",name:"HP calibration HP2 water out offset suggested",optional:!0},controlModeLabel:{domain:"text_sensor",name:"Control Mode (Label)"},flowMode:{domain:"text_sensor",name:"Flow Mode"},dayMax:{domain:"number",name:"Day max level"},silentMax:{domain:"number",name:"Silent max level"},silentStartTime:{domain:"time",name:"Silent start time"},silentEndTime:{domain:"time",name:"Silent end time"},openquattResumeAt:{domain:"datetime",name:"OpenQuatt resume at",optional:!0},maxWater:{domain:"number",name:"Maximum water temperature"},minRuntime:{domain:"number",name:"Minimum runtime"},totalPower:{domain:"sensor",name:"Total Power Input"},heatingPowerInput:{domain:"sensor",name:"Heating Power Input",optional:!0},coolingPowerInput:{domain:"sensor",name:"Cooling Power Input",optional:!0},totalCop:{domain:"sensor",name:"Total COP"},totalEer:{domain:"sensor",name:"Total EER",optional:!0},totalHeat:{domain:"sensor",name:"Total Heat Power"},totalCoolingPower:{domain:"sensor",name:"Total Cooling Power",optional:!0},boilerActive:{domain:"binary_sensor",name:"Boiler active",optional:!0},boilerHeatPower:{domain:"sensor",name:"Boiler Heat Power",optional:!0},systemHeatPower:{domain:"sensor",name:"System Heat Power",optional:!0},flowSelected:{domain:"sensor",name:"Flow average (Selected)"},flowLocal:{domain:"sensor",name:"Flow average (local)",optional:!0},controllerFlow:{domain:"sensor",name:"Controller Flow",optional:!0},trendHistoryEnabled:{domain:"switch",name:"Trendopslag",optional:!0},trendHistoryFlashEnabled:{domain:"switch",name:"Trendhistorie opslaan in flash",optional:!0},webServerLogHistoryEnabled:{domain:"switch",name:"RAM log history",optional:!0},debugLevel:{domain:"select",name:"Debug Level",optional:!0},trendHistoryFlush:{domain:"button",name:"Trendhistorie nu opslaan",optional:!0},trendHistoryFlashAvailable:{domain:"text_sensor",name:"Trendhistorie beschikbaar",optional:!0},trendHistoryFlashOldest:{domain:"text_sensor",name:"Trendhistorie oudste punt",optional:!0},trendHistoryFlashNewest:{domain:"text_sensor",name:"Trendhistorie nieuwste punt",optional:!0},trendHistoryFlashLastFlush:{domain:"text_sensor",name:"Trendhistorie laatste opslag",optional:!0},trendHistoryFlashSize:{domain:"sensor",name:"Trendhistorie grootte",optional:!0},trendHistoryFlashWrites:{domain:"sensor",name:"Trendhistorie schrijfacties",optional:!0},lifetimeEnergyHistoryEnabled:{domain:"switch",name:"Lifetime energiehistorie opslaan",optional:!0},lifetimeEnergyHourRetention:{domain:"select",name:"Uurdetail bewaren",optional:!0},lifetimeEnergyHistoryCapture:{domain:"button",name:"Lifetime energiehistorie nu opslaan",optional:!0},lifetimeEnergyHistoryClear:{domain:"button",name:"Lifetime energiehistorie wissen",optional:!0},lifetimeEnergyHistoryAvailable:{domain:"text_sensor",name:"Lifetime energiehistorie beschikbaar",optional:!0},lifetimeEnergyHistoryOldest:{domain:"text_sensor",name:"Lifetime energiehistorie oudste dag",optional:!0},lifetimeEnergyHistoryNewest:{domain:"text_sensor",name:"Lifetime energiehistorie nieuwste dag",optional:!0},lifetimeEnergyHistoryLastWrite:{domain:"text_sensor",name:"Lifetime energiehistorie laatste opslag",optional:!0},lifetimeEnergyHistorySize:{domain:"sensor",name:"Lifetime energiehistorie grootte",optional:!0},lifetimeEnergyHistoryWrites:{domain:"sensor",name:"Lifetime energiehistorie schrijfacties",optional:!0},electricalEnergyDaily:{domain:"sensor",name:"Electrical Energy Daily",optional:!0},electricalEnergyCumulative:{domain:"sensor",name:"Electrical Energy Cumulative",optional:!0},heatingElectricalEnergyDaily:{domain:"sensor",name:"Heating Electrical Energy Daily",optional:!0},heatingElectricalEnergyCumulative:{domain:"sensor",name:"Heating Electrical Energy Cumulative",optional:!0},coolingElectricalEnergyDaily:{domain:"sensor",name:"Cooling Electrical Energy Daily",optional:!0},coolingElectricalEnergyCumulative:{domain:"sensor",name:"Cooling Electrical Energy Cumulative",optional:!0},heatpumpThermalEnergyDaily:{domain:"sensor",name:"HeatPump Thermal Energy Daily",optional:!0},heatpumpThermalEnergyCumulative:{domain:"sensor",name:"HeatPump Thermal Energy Cumulative",optional:!0},heatpumpCoolingEnergyDaily:{domain:"sensor",name:"HeatPump Cooling Energy Daily",optional:!0},heatpumpCoolingEnergyCumulative:{domain:"sensor",name:"HeatPump Cooling Energy Cumulative",optional:!0},heatpumpCopDaily:{domain:"sensor",name:"HeatPump COP Daily",optional:!0},heatpumpCopCumulative:{domain:"sensor",name:"HeatPump COP Cumulative",optional:!0},heatpumpEerDaily:{domain:"sensor",name:"HeatPump EER Daily",optional:!0},heatpumpEerCumulative:{domain:"sensor",name:"HeatPump EER Cumulative",optional:!0},boilerThermalEnergyDaily:{domain:"sensor",name:"Boiler Thermal Energy Daily",optional:!0},boilerThermalEnergyCumulative:{domain:"sensor",name:"Boiler Thermal Energy Cumulative",optional:!0},systemThermalEnergyDaily:{domain:"sensor",name:"System Thermal Energy Daily",optional:!0},systemThermalEnergyCumulative:{domain:"sensor",name:"System Thermal Energy Cumulative",optional:!0},roomTemp:{domain:"sensor",name:"Room Temperature (Selected)"},roomSetpoint:{domain:"sensor",name:"Room Setpoint (Selected)"},supplyTemp:{domain:"sensor",name:"Water Supply Temp (Selected)"},outsideTempSelected:{domain:"sensor",name:"Outside Temperature (Selected)",optional:!0},waterSupplyTempEsp:{domain:"sensor",name:"Water Supply Temp",optional:!0},waterSupplyTempPt1000:{domain:"sensor",name:"Water Supply Temp (PT1000)",optional:!0},waterSupplyTempDs18b20:{domain:"sensor",name:"Water Supply Temp (DS18B20)",optional:!0},outsideTempLocalAggregated:{domain:"sensor",name:"Outside Temperature (Local aggregated)",optional:!0},outsideTempHa:{domain:"sensor",name:"HA - Outside Temperature",optional:!0},waterSupplyTempHa:{domain:"sensor",name:"HA - Water Supply Temperature",optional:!0},roomSetpointHa:{domain:"sensor",name:"HA - Thermostat Setpoint",optional:!0},roomTempHa:{domain:"sensor",name:"HA - Thermostat Room Temperature",optional:!0},heatingEnableHa:{domain:"binary_sensor",name:"HA - Heating Enable",optional:!0},coolingEnableHa:{domain:"binary_sensor",name:"HA - Cooling Enable",optional:!0},outsideTempHaValid:{domain:"binary_sensor",name:"HA - Outside Temperature Valid",optional:!0},waterSupplyTempHaValid:{domain:"binary_sensor",name:"HA - Water Supply Temperature Valid",optional:!0},roomSetpointHaValid:{domain:"binary_sensor",name:"HA - Room Setpoint Valid",optional:!0},roomTempHaValid:{domain:"binary_sensor",name:"HA - Room Temperature Valid",optional:!0},heatingEnableHaValid:{domain:"binary_sensor",name:"HA - Heating Enable Valid",optional:!0},coolingEnableHaValid:{domain:"binary_sensor",name:"HA - Cooling Enable Valid",optional:!0},roomTempEffectiveSource:{domain:"text_sensor",name:"Room Temperature Effective Source",optional:!0},roomSetpointEffectiveSource:{domain:"text_sensor",name:"Room Setpoint Effective Source",optional:!0},heatingEnableEffectiveSource:{domain:"text_sensor",name:"Heating Enable Effective Source",optional:!0},coolingEnableEffectiveSource:{domain:"text_sensor",name:"Cooling Enable Effective Source",optional:!0},curveSupplyTarget:{domain:"sensor",name:"Heating Curve Supply Target"},requestReason:{domain:"text_sensor",name:"Request Reason",optional:!0},strategyActiveCode:{domain:"sensor",name:"Strategy active code",optional:!0},strategyPhaseCode:{domain:"sensor",name:"Strategy phase code",optional:!0},strategyRequestedPower:{domain:"sensor",name:"Strategy requested power",optional:!0},strategySupplyTarget:{domain:"sensor",name:"Strategy supply target",optional:!0},strategyWaterLimitFactor:{domain:"sensor",name:"Strategy water limit factor",optional:!0},strategyRequestActive:{domain:"binary_sensor",name:"Strategy request active",optional:!0},strategyWaterTripActive:{domain:"binary_sensor",name:"Strategy water trip active",optional:!0},strategyWaterHardTripActive:{domain:"binary_sensor",name:"Strategy water hard trip active",optional:!0},curveDemandEffective:{domain:"sensor",name:"Curve demand (effective)",optional:!0},curveDemandDiscrete:{domain:"sensor",name:"Curve demand (discrete)",optional:!0},curveDispatchTotalLevel:{domain:"sensor",name:"Curve dispatch total level",optional:!0},curveTargetHp1Level:{domain:"sensor",name:"Curve target HP1 level",optional:!0},curveTargetHp2Level:{domain:"sensor",name:"Curve target HP2 level",optional:!0},curveRestartInhibit:{domain:"sensor",name:"Curve restart inhibit",optional:!0},curvePhase:{domain:"text_sensor",name:"Curve Phase",optional:!0},curveOperatingRegime:{domain:"text_sensor",name:"Curve operating regime",optional:!0},curveCapacityMode:{domain:"text_sensor",name:"Curve capacity mode",optional:!0},hpCapacity:{domain:"sensor",name:"HP capacity (W)",optional:!0},hpDeficit:{domain:"sensor",name:"HP deficit (W)",optional:!0},phouseHouse:{domain:"sensor",name:"Power House \u2013 P_house",optional:!0},phouseReq:{domain:"sensor",name:"Power House \u2013 P_req",optional:!0},duoOptimizerReason:{domain:"text_sensor",name:"Duo optimizer reason",optional:!0},selectedInputHoldActive:{domain:"text_sensor",name:"Selected Input Hold Active",optional:!0},silentActive:{domain:"binary_sensor",name:"Silent active"},silentStatus:{domain:"text_sensor",name:"Silent status",optional:!0},silentWindow:{domain:"text_sensor",name:"Silent window (start-end)",optional:!0},stickyActive:{domain:"binary_sensor",name:"Sticky pump active"},housePower:{domain:"number",name:"Rated maximum house power"},houseColdTemp:{domain:"number",name:"House cold temp"},houseOutdoorMax:{domain:"number",name:"Maximum heating outdoor temperature"},phResponseProfile:{domain:"select",name:"Power House response profile"},phKp:{domain:"number",name:"Power House temperature reaction"},phComfortBelow:{domain:"number",name:"Power House comfort below setpoint"},phComfortAbove:{domain:"number",name:"Power House comfort above setpoint"},phDemandRiseTime:{domain:"number",name:"Power House demand rise time"},phDemandFallTime:{domain:"number",name:"Power House demand fall time"},lowLoadDynamicThresholds:{domain:"text_sensor",name:"Low-load dynamic thresholds",optional:!0},lowLoadDynamicOffFactor:{domain:"number",name:"Low-load dynamic OFF factor",optional:!0},lowLoadDynamicOnFactor:{domain:"number",name:"Low-load dynamic ON factor",optional:!0},lowLoadMinimumHysteresis:{domain:"number",name:"Low-load minimum hysteresis",optional:!0},lowLoadCm2ReentryBlock:{domain:"number",name:"Low-load CM2 re-entry block",optional:!0},curveControlProfile:{domain:"select",name:"Heating Curve Control Profile"},heatingCurvePidKp:{domain:"number",name:"Heating Curve PID Kp",optional:!0},heatingCurvePidKi:{domain:"number",name:"Heating Curve PID Ki",optional:!0},heatingCurvePidKd:{domain:"number",name:"Heating Curve PID Kd",optional:!0},curveFallbackSupply:{domain:"number",name:"Curve Fallback Tsupply (No Outside Temp)"},curveM20:{domain:"number",name:"Curve Tsupply @ -20\xB0C"},curveM10:{domain:"number",name:"Curve Tsupply @ -10\xB0C"},curve0:{domain:"number",name:"Curve Tsupply @ 0\xB0C"},curve5:{domain:"number",name:"Curve Tsupply @ 5\xB0C"},curve10:{domain:"number",name:"Curve Tsupply @ 10\xB0C"},curve15:{domain:"number",name:"Curve Tsupply @ 15\xB0C"},hp1ExcludedA:{domain:"select",name:"HP1 - Excluded compressor level A"},hp1ExcludedB:{domain:"select",name:"HP1 - Excluded compressor level B"},hp1Power:{domain:"sensor",name:"HP1 - Power Input"},hp1Heat:{domain:"sensor",name:"HP1 - Heat Power"},hp1Cooling:{domain:"sensor",name:"HP1 - Cooling Power"},hp1Cop:{domain:"sensor",name:"HP1 - COP"},hp1Compressor:{domain:"sensor",name:"HP1 compressor level",optional:!0},hp1Freq:{domain:"sensor",name:"HP1 - Compressor frequency"},hp1FanSpeed:{domain:"sensor",name:"HP1 - Fan speed"},hp1Flow:{domain:"sensor",name:"HP1 - Flow"},hp1EvaporatorCoilTemp:{domain:"sensor",name:"HP1 - Evaporator coil temperature"},hp1InnerCoilTemp:{domain:"sensor",name:"HP1 - Inner coil temperature"},hp1OutsideTemp:{domain:"sensor",name:"HP1 - Outside temperature"},hp1CondenserPressure:{domain:"sensor",name:"HP1 - Condenser pressure"},hp1DischargeTemp:{domain:"sensor",name:"HP1 - Gas discharge temperature"},hp1EvaporatorPressure:{domain:"sensor",name:"HP1 - Evaporator pressure"},hp1ReturnTemp:{domain:"sensor",name:"HP1 - Gas return temperature"},hp1WaterIn:{domain:"sensor",name:"HP1 - Water in temperature"},hp1WaterOut:{domain:"sensor",name:"HP1 - Water out temperature"},hp1WaterInRaw:{domain:"sensor",name:"HP1 - Water in temperature raw",optional:!0},hp1WaterOutRaw:{domain:"sensor",name:"HP1 - Water out temperature raw",optional:!0},hp1Mode:{domain:"text_sensor",name:"HP1 - Working Mode Label"},hp1Failures:{domain:"text_sensor",name:"HP1 - Active Failures List"},hp1Defrost:{domain:"binary_sensor",name:"HP1 - Defrost"},hp1BottomPlate:{domain:"binary_sensor",name:"HP1 - Bottom plate heater"},hp1Crankcase:{domain:"binary_sensor",name:"HP1 - Crankcase heater"},hp1Eev:{domain:"sensor",name:"HP1 - EEV steps"},hp1FourWay:{domain:"binary_sensor",name:"HP1 - 4-Way valve"},hp2ExcludedA:{domain:"select",name:"HP2 - Excluded compressor level A",optional:!0},hp2ExcludedB:{domain:"select",name:"HP2 - Excluded compressor level B",optional:!0},hp2Power:{domain:"sensor",name:"HP2 - Power Input",optional:!0},hp2Heat:{domain:"sensor",name:"HP2 - Heat Power",optional:!0},hp2Cooling:{domain:"sensor",name:"HP2 - Cooling Power",optional:!0},hp2Cop:{domain:"sensor",name:"HP2 - COP",optional:!0},hp2Compressor:{domain:"sensor",name:"HP2 compressor level",optional:!0},hp2Freq:{domain:"sensor",name:"HP2 - Compressor frequency",optional:!0},hp2FanSpeed:{domain:"sensor",name:"HP2 - Fan speed",optional:!0},hp2Flow:{domain:"sensor",name:"HP2 - Flow",optional:!0},hp2EvaporatorCoilTemp:{domain:"sensor",name:"HP2 - Evaporator coil temperature",optional:!0},hp2InnerCoilTemp:{domain:"sensor",name:"HP2 - Inner coil temperature",optional:!0},hp2OutsideTemp:{domain:"sensor",name:"HP2 - Outside temperature",optional:!0},hp2CondenserPressure:{domain:"sensor",name:"HP2 - Condenser pressure",optional:!0},hp2DischargeTemp:{domain:"sensor",name:"HP2 - Gas discharge temperature",optional:!0},hp2EvaporatorPressure:{domain:"sensor",name:"HP2 - Evaporator pressure",optional:!0},hp2ReturnTemp:{domain:"sensor",name:"HP2 - Gas return temperature",optional:!0},hp2WaterIn:{domain:"sensor",name:"HP2 - Water in temperature",optional:!0},hp2WaterOut:{domain:"sensor",name:"HP2 - Water out temperature",optional:!0},hp2WaterInRaw:{domain:"sensor",name:"HP2 - Water in temperature raw",optional:!0},hp2WaterOutRaw:{domain:"sensor",name:"HP2 - Water out temperature raw",optional:!0},hp2Mode:{domain:"text_sensor",name:"HP2 - Working Mode Label",optional:!0},hp2Failures:{domain:"text_sensor",name:"HP2 - Active Failures List",optional:!0},hp2Defrost:{domain:"binary_sensor",name:"HP2 - Defrost",optional:!0},hp2BottomPlate:{domain:"binary_sensor",name:"HP2 - Bottom plate heater",optional:!0},hp2Crankcase:{domain:"binary_sensor",name:"HP2 - Crankcase heater",optional:!0},hp2Eev:{domain:"sensor",name:"HP2 - EEV steps",optional:!0},hp2FourWay:{domain:"binary_sensor",name:"HP2 - 4-Way valve",optional:!0},apply:{domain:"button",name:"Complete setup"},reset:{domain:"button",name:"Reset setup state"}};In.forEach(e=>{const t=`HP${e} - EXPERIMENTAL`;L[le(e,"Enable")]={domain:"switch",name:`${t} ODU runtime frequency write enable`,optional:!0},L[le(e,"Load")]={domain:"button",name:`${t} load ODU runtime frequency table`,optional:!0},L[le(e,"Apply")]={domain:"button",name:`${t} apply ODU runtime frequency table`,optional:!0},L[le(e,"Status")]={domain:"text_sensor",name:`${t} ODU runtime frequency status`,optional:!0},ta.forEach(n=>{Ao.forEach(r=>{L[Jt(e,n,r)]={domain:"number",name:`${t} ${dd(n)} F${r} runtime Hz`,optional:!0}})})});const na=[{id:"overview",label:"Overzicht",icon:"monitor-dashboard"},{id:"energy",label:"Energie",icon:"zap"},{id:"diagnosis",label:"Diagnose",icon:"activity"},{id:"results",label:"Resultaten",icon:"bar-chart"},{id:"settings",label:"Instellingen",icon:"settings"}],md=new Set(na.map(e=>e.id)),hd={activity:'<path d="M3 12h4l2-7 4 14 2-7h6"/>',"bar-chart":'<path d="M4 19V5"/><path d="M20 19H4"/><rect x="7" y="11" width="3" height="5" rx="1"/><rect x="12" y="7" width="3" height="9" rx="1"/><rect x="17" y="3" width="3" height="13" rx="1"/>',"clipboard-check":'<rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4.5h6"/><path d="m9 13 2 2 4-5"/>',flame:'<path d="M12 12c2 -2.96 0 -7 -1 -8c0 3.04 -1.77 4.74 -3 6c-1.23 1.26 -2 3.24 -2 5a6 6 0 1 0 12 0c0 -1.53 -1.06 -3.94 -2 -5c-1.79 3 -2.79 3 -4 2z"/>',"home-cog":'<path d="M5 12h-2l9 -9l9 9h-2"/><path d="M5 12v7a2 2 0 0 0 2 2h4"/><path d="M9 21v-6a2 2 0 0 1 2 -2h1"/><circle cx="17" cy="18" r="2"/><path d="M17 14.5v1.5"/><path d="M17 20v1.5"/><path d="M13.97 16.25l1.3 .75"/><path d="M18.73 19l1.3 .75"/><path d="M20.03 16.25l-1.3 .75"/><path d="M15.27 19l-1.3 .75"/>',link:'<path d="M9 15l6 -6"/><path d="M11 6l.46 -.54a5 5 0 0 1 7.08 7.08l-.54 .46"/><path d="M13 18l-.46 .54a5 5 0 0 1 -7.08 -7.08l.54 -.46"/>',"monitor-dashboard":'<rect x="3" y="4" width="18" height="12" rx="2"/><path d="M8 20h8"/><path d="M12 16v4"/><path d="M6.5 7h7v4h-7z"/><path d="M16 7h2"/><path d="M16 10h2"/><path d="M6.5 13h3"/><path d="M11 13h2.5"/>',"more-horizontal":'<path d="M5 12h.01"/><path d="M12 12h.01"/><path d="M19 12h.01"/>',settings:'<path d="M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/><path d="M19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06A1.7 1.7 0 0 0 15 19.4a1.7 1.7 0 0 0-1 1.55V21a2 2 0 1 1-4 0v-.09a1.7 1.7 0 0 0-1-1.55 1.7 1.7 0 0 0-1.88.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.7 1.7 0 0 0 4.6 15a1.7 1.7 0 0 0-1.55-1H3a2 2 0 1 1 0-4h.09A1.7 1.7 0 0 0 4.6 9a1.7 1.7 0 0 0-.34-1.88l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.7 1.7 0 0 0 9 4.6a1.7 1.7 0 0 0 1-1.55V3a2 2 0 1 1 4 0v.09A1.7 1.7 0 0 0 15 4.6a1.7 1.7 0 0 0 1.88-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.7 1.7 0 0 0 19.4 9a1.7 1.7 0 0 0 1.55 1H21a2 2 0 1 1 0 4h-.09A1.7 1.7 0 0 0 19.4 15z"/>',server:'<rect x="3" y="4" width="18" height="8" rx="3"/><rect x="3" y="12" width="18" height="8" rx="3"/><path d="M7 8h.01"/><path d="M7 16h.01"/>',snowflake:'<path d="M12 4v16"/><path d="M4 12h16"/><path d="m6.4 6.4 11.2 11.2"/><path d="m17.6 6.4 -11.2 11.2"/>',tool:'<path d="M7 10h3v-3l-3.5 -3.5a6 6 0 0 1 8 8l6 6a2 2 0 0 1 -3 3l-6 -6a6 6 0 0 1 -8 -8z"/>',zap:'<path d="M13 2 4 14h7l-1 8 9-12h-7l1-8z"/>'};function ra(e,t=""){const n=hd[e];return n?`<svg${t?` class="${s(t)}"`:""} viewBox="0 0 24 24" aria-hidden="true" focusable="false">${n}</svg>`:""}const Se=[{id:"installation",label:"Installatie",icon:"home-cog"},{id:"heating",label:"Verwarmen",icon:"flame"},{id:"cooling",label:"Koelen",icon:"snowflake"},{id:"integrations",label:"Bronnen / integraties",icon:"link"},{id:"service",label:"Service",icon:"tool"},{id:"system",label:"Systeem",icon:"server"}],Be=new Set(Se.map(e=>e.id)),fd=[{title:"HP1",accent:"blue",keys:{power:"hp1Power",heat:"hp1Heat",cooling:"hp1Cooling",cop:"hp1Cop",freq:"hp1Freq",fanSpeed:"hp1FanSpeed",flow:"hp1Flow",evaporatorCoilTemp:"hp1EvaporatorCoilTemp",innerCoilTemp:"hp1InnerCoilTemp",outsideTemp:"hp1OutsideTemp",condenserPressure:"hp1CondenserPressure",dischargeTemp:"hp1DischargeTemp",evaporatorPressure:"hp1EvaporatorPressure",returnTemp:"hp1ReturnTemp",waterIn:"hp1WaterIn",waterOut:"hp1WaterOut",mode:"hp1Mode",failures:"hp1Failures",defrost:"hp1Defrost",bottomPlate:"hp1BottomPlate",crankcase:"hp1Crankcase",eev:"hp1Eev",fourWay:"hp1FourWay"}},{title:"HP2",accent:"orange",keys:{power:"hp2Power",heat:"hp2Heat",cooling:"hp2Cooling",cop:"hp2Cop",freq:"hp2Freq",fanSpeed:"hp2FanSpeed",flow:"hp2Flow",evaporatorCoilTemp:"hp2EvaporatorCoilTemp",innerCoilTemp:"hp2InnerCoilTemp",outsideTemp:"hp2OutsideTemp",condenserPressure:"hp2CondenserPressure",dischargeTemp:"hp2DischargeTemp",evaporatorPressure:"hp2EvaporatorPressure",returnTemp:"hp2ReturnTemp",waterIn:"hp2WaterIn",waterOut:"hp2WaterOut",mode:"hp2Mode",failures:"hp2Failures",defrost:"hp2Defrost",bottomPlate:"hp2BottomPlate",crankcase:"hp2Crankcase",eev:"hp2Eev",fourWay:"hp2FourWay"}}],pe=[{key:"curveM20",outdoor:-20,label:"-20\xB0C"},{key:"curveM10",outdoor:-10,label:"-10\xB0C"},{key:"curve0",outdoor:0,label:"0\xB0C"},{key:"curve5",outdoor:5,label:"5\xB0C"},{key:"curve10",outdoor:10,label:"10\xB0C"},{key:"curve15",outdoor:15,label:"15\xB0C"}],Ht=["housePower","houseColdTemp","houseOutdoorMax","phResponseProfile","phKp","phComfortBelow","phComfortAbove","phDemandRiseTime","phDemandFallTime"],jo=["dayMax","silentMax","maxWater"],Ye=["flowControlMode","flowSetpoint","coolingFlowSetpoint","manualIpwm"],qn=["flowKp","flowKi"],kn=["hp1WaterInOffset","hp1WaterOutOffset","hp2WaterInOffset","hp2WaterOutOffset"],Cn=["hp1WaterInRaw","hp1WaterIn","hp1WaterOutRaw","hp1WaterOut","hp2WaterInRaw","hp2WaterIn","hp2WaterOutRaw","hp2WaterOut"],aa=["compressorStarts2hWarningLimit","compressorStarts72hWarningLimit","compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","compressorCyclingAlertLatched","compressorCyclingAlertAlternating","compressorCyclingAlertFirstSeen","compressorCyclingAlertLastSeen","compressorCyclingAlertHp1Peak2h","compressorCyclingAlertHp1Peak72h","compressorCyclingAlertHp2Peak2h","compressorCyclingAlertHp2Peak72h","acknowledgeCompressorCyclingAlert","hp1CompressorStarts2h","hp1CompressorStarts6h","hp1CompressorStarts24h","hp1CompressorStarts72h","hp1CompressorLastStartAge","hp2CompressorStarts2h","hp2CompressorStarts6h","hp2CompressorStarts24h","hp2CompressorStarts72h","hp2CompressorLastStartAge","lowflowFaultActive","flowMismatch","cicPollingEnabled","cicDataStale","otEnabled","otLinkProblem","hp1Failures","hp2Failures"],bd=["compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","compressorCyclingAlertLatched","lowflowFaultActive","flowMismatch","cicPollingEnabled","cicDataStale","otEnabled","otLinkProblem","hp1Failures","hp2Failures"],ia=["commissioningStatus","cm100Active","commissioningCm100Start","commissioningCm100Stop","boilerPowerTestStart","boilerPowerTestAbort","boilerPowerTestApply","boilerPowerTestResult","boilerPowerTestActive","boilerPowerTestStatus","boilerHeatPower","flowAutotuneStart","flowAutotuneAbort","flowAutotuneApply","flowAutotuneStatus","flowKpSuggested","flowKiSuggested","airPurgeStart","airPurgeAbort","airPurgeReturnToAuto","airPurgeActive","airPurgeStatus","airPurgeRemaining","airPurgePhase","airPurgeTargetIpwm","manualFlowStart","manualFlowAbort","manualFlowApplyHeating","manualFlowApplyCooling","manualFlowActive","manualFlowStatus","manualFlowSetpoint","manualFlowTargetIpwm","manualHpStart","manualHpAbort","manualHpActive","manualHpStatus","manualHpGuardStatus","manualHp1Mode","manualHp2Mode","manualHp1Level","manualHp2Level","hpWaterCalibrationStart","hpWaterCalibrationAbort","hpWaterCalibrationApply","hpWaterCalibrationActive","hpWaterCalibrationStatus","hpWaterCalibrationRemaining","hpWaterCalibrationPhase","hpWaterCalibrationSpread","hpWaterCalibrationSupplyDelta","hpWaterCalibrationStableProgress","hpWaterCalibrationStableRequired","hpWaterCalibrationResultReference","hpWaterCalibrationResultSpreadBefore","hpWaterCalibrationResultExpectedSpread","hpWaterCalibrationResultHp1InRawAvg","hpWaterCalibrationResultHp1OutRawAvg","hpWaterCalibrationResultHp2InRawAvg","hpWaterCalibrationResultHp2OutRawAvg",...Cn,"hp1WaterInOffsetSuggested","hp1WaterOutOffsetSuggested","hp2WaterInOffsetSuggested","hp2WaterOutOffsetSuggested","flowSelected","hp1Compressor","hp1Freq","hp1Failures","hp2Compressor","hp2Freq","hp2Failures","hp1Mode","hp2Mode"],Ks=["cicCompatibilityMode"],Us=["otEnabled","otLinkProblem"],zs=["cicPollingEnabled","cicFeedUrl","cicDataStale"],Gs=["otThermostatChEnable","otThermostatCoolingEnable","otControlSetpoint","otRoomSetpoint","otRoomTemp"],Qs=["cicJsonFeedOk","cicWaterSupplyTemp","cicControlSetpoint","cicRoomSetpoint","cicRoomTemp","cicFlowrate","cicLastSuccessAge","cicChEnabled","cicCoolingEnabled"],sa=["waterSupplySource","localWaterSupplyTempSource","flowSource","qFlowSource","outdoorUnitFlowMode","outsideTempSource","roomTempSource","roomSetpointSource","heatingEnableSource","coolingEnableSource"],Ys=["supplyTemp","waterSupplyTempEsp","waterSupplyTempPt1000","waterSupplyTempDs18b20","waterSupplyTempHa","waterSupplyTempHaValid","flowSelected","flowLocal","controllerFlow","hp1Flow","hp2Flow","outsideTempSelected","outsideTempLocalAggregated","outsideTempHa","outsideTempHaValid","roomTemp","roomTempEffectiveSource","roomTempHa","roomTempHaValid","roomSetpoint","roomSetpointEffectiveSource","roomSetpointHa","roomSetpointHaValid","heatingEnableSelected","heatingEnableValid","heatingBlockedByThermostat","heatingEnableEffectiveSource","otThermostatChEnable","otThermostatStatusValid","cicChEnabled","cicChEnableValid","heatingEnableHa","heatingEnableHaValid","coolingEnableSelected","coolingEnableEffectiveSource","coolingEnableHa","coolingEnableHaValid"],Je=["hardwareProfileText","hpGeneration","flowSource","qFlowSource","cicPollingEnabled","cicFeedUrl","cicJsonFeedOk","cicDataStale","cicFlowrate","controllerFlow","flowSelected","flowLocal","hp1Flow","hp2Flow","commissioningCm100Start","commissioningCm100Stop","commissioningStatus","cm100Active","quickFlowTest"],Ho=["hardwareProfileText","roomTempSource","roomSetpointSource","roomTemp","roomSetpoint","roomTempEffectiveSource","roomSetpointEffectiveSource","otEnabled","otLinkProblem","otRoomTemp","otRoomSetpoint","cicPollingEnabled","cicFeedUrl","cicJsonFeedOk","cicDataStale","cicRoomTemp","cicRoomSetpoint","roomTempHa","roomTempHaValid","roomSetpointHa","roomSetpointHaValid"],Js=["coolingMinimumSupplyTemp","coolingDemandMax","coolingRestartDelta","coolingRequestOnDelta","coolingRequestOffDelta","coolingSafetyMargin","coolingWithoutDewPointMode","coolingGuardMode","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingEffectiveMinSupplyTemp"],Mo=[...pe.map(e=>e.key),"curveFallbackSupply","curveControlProfile"],Zs=["minRuntime","hp1ExcludedA","hp1ExcludedB","hp2ExcludedA","hp2ExcludedB"],Po=["silentStartTime","silentEndTime","silentMax","dayMax"],vd=1e4;const Rr=[{minutes:15,label:"15 min"},{minutes:30,label:"30 min"},{minutes:60,label:"1 uur"}],Gt=["projectVersionText","releaseChannelText","installationTopology","hardwareProfileText","connectionText","timeValid","controlModeLabel","strategy","openquattEnabled","manualCoolingEnable","silentModeOverride","outsideTempSelected","roomTemp","roomSetpoint","supplyTemp","flowSelected","flowControlMode","flowMode","flowSetpoint","coolingFlowSetpoint","manualIpwm","flowKp","flowKi","totalPower","heatingPowerInput","coolingPowerInput","hp1Mode","hp1Compressor","hp1Freq","hp1Flow","hp1Power","hp1Heat","hp1Cooling","hp1EvaporatorCoilTemp","hp1InnerCoilTemp","hp1CondenserPressure","hp1EvaporatorPressure","hp1WaterIn","hp1WaterOut","hp1Defrost","hp1Failures","hp2Mode","hp2Compressor","hp2Freq","hp2Flow","hp2Power","hp2Heat","hp2Cooling","hp2EvaporatorCoilTemp","hp2InnerCoilTemp","hp2CondenserPressure","hp2EvaporatorPressure","hp2WaterIn","hp2WaterOut","hp2Defrost","hp2Failures","coolingEnableSelected","coolingRequestActive","coolingPermitted","coolingBlockReason","coolingGuardMode","coolingMinimumSupplyTemp","coolingSafetyMargin","coolingDemandMax","coolingRestartDelta","coolingPidKp","coolingPidKi","coolingPidKd","coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingEffectiveMinSupplyTemp","coolingSupplyTarget","coolingSupplyError","coolingDemandRaw","coolingBaseDemandRaw","coolingLimitedDemand","coolingLimiterAllowedMax","coolingBufferGapFiltered","coolingBufferGapRate","coolingProjectedGap","coolingProjectionBrakeActive","coolingDewGap","coolingStopBufferGap","coolingLimiterReasonCode","coolingStopReasonCode","coolingRequestReasonCode","coolingRequestHp1Level","coolingRequestHp2Level","coolingRequestOwnerHp","coolingOwnerHp","coolingWaterCycleActive","requestReason","strategyActiveCode","strategyPhaseCode","strategyRequestedPower","strategySupplyTarget","strategyWaterLimitFactor","strategyRequestActive","strategyWaterTripActive","strategyWaterHardTripActive","curveControlProfile","heatingCurvePidKp","heatingCurvePidKi","heatingCurvePidKd","curveSupplyTarget","curveDemandEffective","curveDemandDiscrete","curveDispatchTotalLevel","curveTargetHp1Level","curveTargetHp2Level","curveRestartInhibit","curvePhase","curveOperatingRegime","curveCapacityMode","phouseHouse","phouseReq","hpCapacity","hpDeficit","duoOptimizerReason","selectedInputHoldActive","silentActive","lowLoadDynamicThresholds","lowLoadDynamicOffFactor","lowLoadDynamicOnFactor","lowLoadMinimumHysteresis","lowLoadCm2ReentryBlock","lowflowFaultActive","flowMismatch","compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","cicDataStale","otLinkProblem"],Mt=["firmwareUpdate","firmwareUpdateChannel","firmwareUpdateTarget","firmwareUpdateProgress","firmwareUpdateStatus"],yd=["firmwareTestOtaUrl","firmwareTestOtaMd5Url","installFirmwareTestOta"],la=[...Mt,...yd,"installFirmwareUpdateTarget","projectVersionText","releaseChannelText","installationTopology","hardwareProfileText","connectionText"],bn=["hp2ExcludedA","hp2ExcludedB","hp2Power","hp2WaterOut"],ze=["status","uptime","uptimeReadable","timeNowHhmm","timeValid","ipAddress","wifiSsid","wifiSignal","installationTopology","hardwareProfileText","connectionText","hpGeneration","projectVersionText","releaseChannelText","espInternalTemp"],ca=["strategy","openquattEnabled","boilerCvAssistEnabled","openquattResumeAt","manualCoolingEnable","silentModeOverride","coolingEnableSelected","coolingRequestActive","coolingPermitted","coolingBlockReason","coolingGuardMode","coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingEffectiveMinSupplyTemp","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingSupplyTarget","coolingSupplyError","coolingDemandRaw","controlModeLabel","flowMode","totalPower","heatingPowerInput","coolingPowerInput","totalCop","totalEer","totalHeat","totalCoolingPower","strategyRequestedPower","phouseHouse","phouseReq","hpCapacity","boilerActive","boilerHeatPower","systemHeatPower","electricalEnergyDaily","electricalEnergyCumulative","heatingElectricalEnergyDaily","heatingElectricalEnergyCumulative","coolingElectricalEnergyDaily","coolingElectricalEnergyCumulative","heatpumpThermalEnergyDaily","heatpumpThermalEnergyCumulative","heatpumpCoolingEnergyDaily","heatpumpCoolingEnergyCumulative","heatpumpCopDaily","heatpumpCopCumulative","heatpumpEerDaily","heatpumpEerCumulative","boilerThermalEnergyDaily","boilerThermalEnergyCumulative","systemThermalEnergyDaily","systemThermalEnergyCumulative","lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites","flowSelected","outsideTempSelected","roomTemp","roomSetpoint","supplyTemp","curveSupplyTarget","silentActive","stickyActive","hp1Power","hp1Heat","hp1Cooling","hp1Cop","hp1Compressor","hp1Freq","hp1FanSpeed","hp1Flow","hp1EvaporatorCoilTemp","hp1InnerCoilTemp","hp1OutsideTemp","hp1CondenserPressure","hp1DischargeTemp","hp1EvaporatorPressure","hp1ReturnTemp","hp1WaterIn","hp1WaterOut","hp1Mode","hp1Failures","hp1Defrost","hp1BottomPlate","hp1Crankcase","hp1Eev","hp1FourWay","hp2Power","hp2Heat","hp2Cooling","hp2Cop","hp2Compressor","hp2Freq","hp2FanSpeed","hp2Flow","hp2EvaporatorCoilTemp","hp2InnerCoilTemp","hp2OutsideTemp","hp2CondenserPressure","hp2DischargeTemp","hp2EvaporatorPressure","hp2ReturnTemp","hp2WaterIn","hp2WaterOut","hp2Mode","hp2Failures","hp2Defrost","hp2BottomPlate","hp2Crankcase","hp2Eev","hp2FourWay"],Xs=["strategy","openquattEnabled","boilerCvAssistEnabled","openquattResumeAt","manualCoolingEnable","trendHistoryEnabled","trendHistoryFlashEnabled","coolingPermitted","coolingRequestActive","coolingBlockReason","controlModeLabel","flowMode","flowSelected","outsideTempSelected","roomTemp","roomSetpoint","supplyTemp","curveSupplyTarget","silentActive","stickyActive","totalPower","heatingPowerInput","coolingPowerInput","totalHeat","totalCoolingPower","totalCop","totalEer","strategyRequestedPower","phouseReq","hpCapacity","boilerActive","boilerHeatPower","systemHeatPower","silentModeOverride","hp1Power","hp1Heat","hp1Cooling","hp1Cop","hp1Compressor","hp1Freq","hp1FanSpeed","hp1Mode","hp1Flow","hp1EvaporatorCoilTemp","hp1InnerCoilTemp","hp1OutsideTemp","hp1CondenserPressure","hp1DischargeTemp","hp1EvaporatorPressure","hp1ReturnTemp","hp1WaterIn","hp1WaterOut","hp1Defrost","hp1BottomPlate","hp1Crankcase","hp1Eev","hp1FourWay","hp2Power","hp2Heat","hp2Cooling","hp2Cop","hp2Compressor","hp2Freq","hp2FanSpeed","hp2Mode","hp2Flow","hp2EvaporatorCoilTemp","hp2InnerCoilTemp","hp2OutsideTemp","hp2CondenserPressure","hp2DischargeTemp","hp2EvaporatorPressure","hp2ReturnTemp","hp2WaterIn","hp2WaterOut","hp2Defrost","hp2BottomPlate","hp2Crankcase","hp2Eev","hp2FourWay",...bd],wd=["hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower","strategy",...Ht,...Mo,...Ye,"maxWater",...Po,...Je,...Ho,"coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingEffectiveMinSupplyTemp","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingSupplyTarget","coolingSupplyError","coolingDemandRaw","totalPower","heatingPowerInput","coolingPowerInput","totalHeat","totalCoolingPower","strategyRequestedPower","phouseHouse","phouseReq","hpCapacity","boilerActive","boilerHeatPower","systemHeatPower","flowSelected","roomTemp","roomSetpoint","supplyTemp","curveSupplyTarget","hp1Power","hp1Heat","hp1Cooling","hp1Freq","hp1FanSpeed","hp1Flow","hp1EvaporatorCoilTemp","hp1InnerCoilTemp","hp1OutsideTemp","hp1CondenserPressure","hp1DischargeTemp","hp1EvaporatorPressure","hp1ReturnTemp","hp1WaterIn","hp1WaterOut","hp2Power","hp2Heat","hp2Cooling","hp2Freq","hp2FanSpeed","hp2Flow","hp2EvaporatorCoilTemp","hp2InnerCoilTemp","hp2OutsideTemp","hp2CondenserPressure","hp2DischargeTemp","hp2EvaporatorPressure","hp2ReturnTemp","hp2WaterIn","hp2WaterOut"],el=[{label:"Nu",tone:"blue",categories:[{title:"Verwarmen",tone:"orange",groups:[{title:"Warmtepomp",rows:[["Elektrisch vermogen","heatingPowerInput"],["Warmteafgifte","totalHeat"],["COP","totalCop"]]},{title:"CV-ketel",rows:[["Warmteafgifte","boilerHeatPower"]]},{title:"Systeem",rows:[["Warmteafgifte","systemHeatPower"]]}]},{title:"Koelen",tone:"blue",groups:[{title:"Warmtepomp",rows:[["Elektrisch vermogen","coolingPowerInput"],["Koelafgifte","totalCoolingPower"],["COP (EER)","totalEer"]]}]}]},{label:"Vandaag",tone:"orange",categories:[{title:"Verwarmen",tone:"orange",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","heatingElectricalEnergyDaily"],["Warmte","heatpumpThermalEnergyDaily"],["COP","heatpumpCopDaily"]]},{title:"CV-ketel",rows:[["Warmte","boilerThermalEnergyDaily"]]},{title:"Systeem",rows:[["Warmte","systemThermalEnergyDaily"]]}]},{title:"Koelen",tone:"blue",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","coolingElectricalEnergyDaily"],["Koeling","heatpumpCoolingEnergyDaily"],["COP (EER)","heatpumpEerDaily"]]}]}]},{label:"Cumulatief",tone:"green",categories:[{title:"Verwarmen",tone:"orange",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","heatingElectricalEnergyCumulative"],["Warmte","heatpumpThermalEnergyCumulative"],["COP","heatpumpCopCumulative"]]},{title:"CV-ketel",rows:[["Warmte","boilerThermalEnergyCumulative"]]},{title:"Systeem",rows:[["Warmte","systemThermalEnergyCumulative"]]}]},{title:"Koelen",tone:"blue",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","coolingElectricalEnergyCumulative"],["Koeling","heatpumpCoolingEnergyCumulative"],["COP (EER)","heatpumpEerCumulative"]]}]}]}],tl=["strategy","installationTopology","hpGeneration","openquattEnabled","boilerCvAssistEnabled","boilerRatedHeatPower",...ia,"manualCoolingEnable","silentModeOverride","trendHistoryEnabled","trendHistoryFlashEnabled","trendHistoryFlush","webServerLogHistoryEnabled","trendHistoryFlashAvailable","trendHistoryFlashOldest","trendHistoryFlashNewest","trendHistoryFlashLastFlush","trendHistoryFlashSize","trendHistoryFlashWrites","lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites",...Ks,...Us,...Gs,...zs,...Qs,...sa,...Ys,...Ye,...qn,...kn,...Cn,...aa,...Js,...jo,...Ht,...Mo,...Zs,...Po,...oa];const Jy=new Set(["installationTopology",...ia,...oa,"trendHistoryFlashAvailable","trendHistoryFlashOldest","trendHistoryFlashNewest","trendHistoryFlashLastFlush","trendHistoryFlashSize","trendHistoryFlashWrites","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites","cicDataStale","otLinkProblem","coolingGuardMode","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingEffectiveMinSupplyTemp"]),Zt=[{id:"installation",label:"Installatie",keys:["setupComplete","hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower"]},{id:"operation",label:"Bediening",keys:["strategy","openquattEnabled","manualCoolingEnable","silentModeOverride","openquattResumeAt"]},{id:"integrations",label:"Integraties",keys:["otEnabled","cicPollingEnabled","cicFeedUrl","cicCompatibilityMode"]},{id:"sensor_sources",label:"Sensorbronnen",keys:["waterSupplySource","localWaterSupplyTempSource","flowSource","qFlowSource","outdoorUnitFlowMode","outsideTempSource","roomTempSource","roomSetpointSource","heatingEnableSource","coolingEnableSource",...kn]},{id:"comfort",label:"Comfort",keys:["silentStartTime","silentEndTime","dayMax","silentMax","maxWater"]},{id:"heatingCurve",label:"Stooklijn",keys:["curveControlProfile","curveFallbackSupply",...pe.map(e=>e.key)]},{id:"powerHouse",label:"Power House",keys:["housePower","houseColdTemp","houseOutdoorMax","phResponseProfile","phKp","phComfortBelow","phComfortAbove","phDemandRiseTime","phDemandFallTime"]},{id:"flow",label:"Flow",keys:["flowControlMode","flowSetpoint","coolingFlowSetpoint","manualIpwm","flowKp","flowKi"]},{id:"cooling",label:"Koeling",keys:["coolingMinimumSupplyTemp","coolingDemandMax","coolingRestartDelta","coolingRequestOnDelta","coolingRequestOffDelta","coolingSafetyMargin","coolingWithoutDewPointMode"]},{id:"compressor",label:"Compressor",keys:["minRuntime","compressorStarts2hWarningLimit","compressorStarts72hWarningLimit","hp1ExcludedA","hp1ExcludedB","hp2ExcludedA","hp2ExcludedB"]},{id:"system",label:"Systeem",keys:["trendHistoryEnabled","trendHistoryFlashEnabled","lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","webServerLogHistoryEnabled","firmwareUpdateChannel"]}],ol=1,ao=[...new Set(Zt.flatMap(e=>e.keys))],Sd=new Set(ao),qd=5e3,kd=3e4,Cd=6e4,Ko=12e3,Wn=4e3,Td=1500,Ed=3e4,$d=3e4,Ad=1e3,ua=3e4,xi=250,Hd=750,Md=22,Pd=Md/1.7,Nd=360/3.2,No="2000-01-01 00:00:00",Xt=24,Tn=[3,12,24,72,168,336,720],o={mounted:!1,root:null,nativeApp:null,nativeFrontendLoaded:!1,nativeFrontendLoading:!1,pollTimer:null,supplementaryPrimeTimer:null,entitySyncInFlight:!1,pendingEntitySyncOptions:null,lastEntitySyncAttemptAt:0,lastFastEntitySyncAt:0,lastBulkEntitySyncAt:0,lastStaticEntitySyncAt:0,lastAuthStatusRefreshAt:0,loginAuthStatusPollTimer:null,lastApiSecurityStatusRefreshAt:0,summary:"",stage:"Laden...",interfacePanelOpen:Od(),devPanelOpen:xd(),nativeOpen:Fd()==="native",currentStep:"generation",quickStartModalMode:"wizard",settingsGroup:Dd(),appView:"",overviewTheme:Rd(),hpVisualMode:Wd(),hpLayoutMode:Vd(),trendWindowHours:jd(),trendHistoryRaw:"",trendHistoryError:"",trendHistorySignature:"",trendHistoryNowMs:Number.NaN,trendHistoryLastFetchAt:0,trendHistoryFetchPromise:null,energyHistoryRaw:"",energyHistoryError:"",energyHistorySignature:"",energyHistoryNowMs:Number.NaN,energyHistoryLastFetchAt:0,energyHistoryRequestQuery:"",energyHistoryFetchQuery:"",energyHistoryFetchPromise:null,energyHistoryCsrfToken:"",energyHistoryView:"day",energyHistoryImportFileName:"",energyHistoryImportSource:"",energyHistoryImportRange:"",energyHistoryImportRecords:[],energyHistoryImportHourRecords:[],energyHistoryImportDuplicateCount:0,energyHistoryImportSkippedCount:0,energyHistoryImportInvalidCount:0,energyHistoryImportUnsupportedCount:0,energyHistoryImportBusy:!1,energyHistoryImportProgressPercent:0,energyHistoryImportError:"",energyHistoryImportNotice:"",energyHistoryExportMode:"days_and_hours",energyHistoryExportBusy:!1,energyHistoryExportError:"",energyHistoryExportNotice:"",settingsStorageDetailsOpen:!1,energyHistoryPeriodSelection:{day:"",week:"",month:"",year:""},deviceReconnectMode:"",deviceReconnectStartedAt:0,deviceReconnectRecoveryStartedAt:0,deviceReconnectRecoveryTimer:null,deviceReconnectLastError:"",firmwareOtaQuietUntil:0,firmwareOtaQuietTimer:null,entitySyncFailureCount:0,lastEntitySyncAt:0,lastEntitySyncSuccessAt:0,lastEntityResponseAt:0,overviewMetadataHydrated:!1,overviewMetadataHydrating:!1,busyAction:"",controlError:"",controlNotice:"",webServerLogSource:null,webServerLogConnected:!1,webServerLogEnabled:null,webServerLogError:"",webServerLogHistoryLoading:!1,webServerLogHistoryError:"",webServerLogHistoryRequestToken:0,webServerLogHistoryLoaded:!1,webServerLogScrollRestoreToken:0,cm100CommissioningScrollRestoreToken:0,serviceTaskModalScrollRestoreToken:0,quickStartScrollRestoreToken:0,quickStartCicFeedUrlDraft:null,quickStartThermostatSourceDraft:null,webServerLogCopyMessage:"",webServerLogCopyError:"",webServerLogRecentTail:[],webServerLogRecentAnchorAt:0,webServerLogEntries:[],debugRecordingActive:!1,debugRecordingStartedAt:0,debugRecordingEndsAt:0,debugRecordingTimer:null,debugRecordingSamples:[],debugRecordingError:"",debugRecordingNotice:"",debugRecordingBusy:!1,debugRecordingLastSampleAt:0,debugRecordingSequence:0,debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingEvents:[],debugRecordingSelectedMinutes:15,debugRecordingDeviceStatus:null,debugRecordingAcknowledgedId:lf(),debugRecordingDeviceBundle:null,debugRecordingDevicePollTimer:null,complete:!1,lastKnownInstallationTopology:"",quickStartModalOpen:!0,loadingEntities:!0,entities:{},optionalMissingEntities:{},settingsInfoOpen:"",installationMonitoringDetailsOpen:!1,integrationDiagnosticsOpen:!1,oduRuntimeFrequencyDetailsOpen:!1,installationMonitoringProblemSignature:"",settingsInteractionLock:!1,settingsRenderSignature:"",settingsBackupDraft:null,settingsBackupError:"",settingsBackupBusy:!1,pendingCommissioningCm100Start:!1,pendingBoilerPowerTestStart:!1,pendingFlowAutotuneStart:!1,pendingAirPurgeStart:!1,pendingManualFlowStart:!1,pendingManualHpStart:!1,pendingHpWaterCalibrationStart:!1,commissioningTaskLock:"",commissioningBoilerHeatPowerDisplay:"",headerRenderSignature:"",drafts:{},inputDrafts:{},focusedField:"",updateModalOpen:!1,systemModal:"",authStatus:null,authDraftUsername:"",authDraftCurrentPassword:"",authDraftNewPassword:"",authDraftConfirmPassword:"",authBusy:!1,authNotice:"",authError:"",apiSecurityStatus:null,apiSecurityBusy:!1,apiSecurityNotice:"",apiSecurityError:"",updateCheckBusy:!1,updateInstallBusy:!1,updateInstallTargetVersion:"",updateInstallPhaseHint:"",updateInstallProgressHint:Number.NaN,updateInstallMode:"",updateInstallTargetConnection:"",updateInstallTargetTopology:"",firmwareAdvancedOpen:!1,firmwareConnectionSwitchOpen:!1,firmwareConnectionSwitchConfirmed:!1,firmwareTopologySwitchOpen:!1,firmwareTopologySwitchConfirmed:!1,updateInstallCompleted:!1,updateInstallCompletedVersion:"",updateManualUploadOpen:!1,updateManualUploadFile:null,updateManualUploadFileName:"",updateManualUploadError:"",updateTestFirmwareOpen:!1,updateTestFirmwarePr:"",updateTestFirmwareConfirmed:!1,updateTestFirmwareError:"",updateTestFirmwareBuild:null,pauseResumeDraft:"",draggingCurveKey:"",motionFrame:0,motionStartedAt:0,reducedMotion:Ud(),motionPreferenceMedia:null,motionPreferenceListener:null,motionTargets:{pipeFlows:[],fanBlades:[]}};function Rd(){try{return window.localStorage.getItem("oq-overview-theme")==="dark"?"dark":"light"}catch{return"light"}}function Ld(e){o.overviewTheme=e==="dark"?"dark":"light";try{window.localStorage.setItem("oq-overview-theme",o.overviewTheme)}catch{}}function Od(){return!1}function wr(e){o.interfacePanelOpen=e===!0}function Fd(){try{return window.localStorage.getItem("oq-active-surface")==="native"?"native":"app"}catch{return"app"}}function nl(e){try{window.localStorage.setItem("oq-active-surface",e==="native"?"native":"app")}catch{}}function xd(){try{return window.localStorage.getItem("oq-dev-panel-open")==="true"}catch{return!1}}function Dd(){try{const e=window.localStorage.getItem("oq-settings-group");return Be.has(e)?e:Se[0].id}catch{return Se[0].id}}function vn(e,t={}){o.settingsGroup=Be.has(e)?e:Se[0].id;try{window.localStorage.setItem("oq-settings-group",o.settingsGroup)}catch{}t.syncUrl!==!1&&o.appView==="settings"&&ll(t.syncMode||"replace")}function Id(e){o.devPanelOpen=e===!0;try{window.localStorage.setItem("oq-dev-panel-open",o.devPanelOpen?"true":"false")}catch{}}function Wd(){try{return window.localStorage.getItem("oq-hp-visual-mode")==="compact"?"compact":"schematic"}catch{return"schematic"}}function Bd(e){o.hpVisualMode=e==="compact"?"compact":"schematic";try{window.localStorage.setItem("oq-hp-visual-mode",o.hpVisualMode)}catch{}}function Vd(){try{const e=window.localStorage.getItem("oq-hp-layout-mode");return e==="focus-hp1"||e==="focus-hp2"?e:"equal"}catch{return"equal"}}function _d(e){o.hpLayoutMode=e==="focus-hp1"||e==="focus-hp2"?e:"equal";try{window.localStorage.setItem("oq-hp-layout-mode",o.hpLayoutMode)}catch{}}function jd(){try{const e=Number(window.localStorage.getItem("oq-trend-window-hours"));return Tn.includes(e)?e:Xt}catch{return Xt}}function rl(){const e=o.entities?.trendHistoryFlashEnabled;if(!e)return!1;if(typeof e.value=="boolean")return e.value;const t=String(e.state??e.value??"").toLowerCase();return t==="on"||t==="true"||t==="1"}function Kd(){return rl()?Tn:Tn.filter(e=>e<=168)}function da(e){const t=Kd(),n=Number(e);return t.includes(n)?n:Number.isFinite(n)&&n>t[t.length-1]?t[t.length-1]:t.includes(Xt)?Xt:t[0]}function pa(e){o.trendWindowHours=da(e);try{window.localStorage.setItem("oq-trend-window-hours",String(o.trendWindowHours))}catch{}}function eo(){return"overview"}function al(){if(typeof window>"u"||typeof window.matchMedia!="function")return null;try{return window.matchMedia("(prefers-reduced-motion: reduce)")}catch{return null}}function Ud(){return!!al()?.matches}function zd(e){if(o.reducedMotion=!!e?.matches,o.reducedMotion){ga();return}ya()}function Gd(){const e=al();!e||o.motionPreferenceMedia===e||(o.motionPreferenceMedia=e,o.motionPreferenceListener=zd,typeof e.addEventListener=="function"?e.addEventListener("change",o.motionPreferenceListener):typeof e.addListener=="function"&&e.addListener(o.motionPreferenceListener),o.reducedMotion=!!e.matches)}function Qd(){return Object.keys(o.entities).length>0}function ga(){o.motionFrame&&(window.cancelAnimationFrame(o.motionFrame),o.motionFrame=0),o.motionStartedAt=0,ba()}function Yd(){return xi+Math.floor(Math.random()*(Hd-xi+1))}function Jd(){return(document.hidden?ua:qd)+Yd()}function il(e=Jd()){o.pollTimer||o.nativeOpen||o.updateInstallBusy||yl()||(o.pollTimer=window.setTimeout(async()=>{o.pollTimer=null,await ae(),il()},e))}function Bn(){il()}function ma(){o.pollTimer&&(window.clearTimeout(o.pollTimer),o.pollTimer=null)}function Zd(){o.nativeOpen||(ma(),Bn(),document.hidden||ae({forceProbe:!0}))}function ha(e={}){if($n(),o.nativeOpen){ma(),ga(),o.nativeFrontendLoaded||Lr();return}if(ya(),Bn(),e.refresh!==!1){if(!Qd()){Hm();return}ae({forceFast:!0})}}function Ro(e){return e==="trends"&&(e="diagnosis"),!md.has(e)||e==="diagnosis"&&!po()?"":e}function En(e){return String(e||"").trim().toLowerCase()}function fa(){try{const e=new URL(window.location.href),t=En(e.searchParams.get("view")||""),n=Ro(t);if(n)return n;const r=En(e.hash.replace(/^#/,""));return Ro(r)||""}catch{return""}}function sl(){try{const e=new URL(window.location.href),t=En(e.searchParams.get("section")||"");if(Be.has(t))return t;const n=En(e.searchParams.get("group")||"");return Be.has(n)?n:""}catch{return""}}function ll(e="replace"){try{const t=new URL(window.location.href),n=Ro(o.appView)||eo();if(t.searchParams.set("view",n),n==="settings"){const a=Be.has(o.settingsGroup)?o.settingsGroup:Se[0].id;t.searchParams.set("section",a),t.searchParams.delete("group")}else t.searchParams.delete("section"),t.searchParams.delete("group");t.hash&&Ro(t.hash.replace(/^#/,""))&&(t.hash="");const r=e==="push"?"pushState":"replaceState";window.history[r]({oqView:n,oqSettingsSection:n==="settings"?o.settingsGroup:""},"",t.toString())}catch{}}function Et(e,t={}){const n=Ro(e)||eo(),r=t.syncMode||"replace",a=o.appView!==n;o.appView=n,(a||t.forceSync)&&ll(r)}function Xd(){const e=fa()||eo(),t=e==="settings"?sl()||o.settingsGroup:"";if(!(e===o.appView&&(e!=="settings"||t===o.settingsGroup))){if(o.appView=e,e==="settings"&&t){o.settingsGroup=t;try{window.localStorage.setItem("oq-settings-group",o.settingsGroup)}catch{}}m(),ae({forceFast:!0})}}function $n(){o.nativeApp&&(o.nativeApp.classList.add("oq-native-app"),o.nativeApp.classList.toggle("oq-native-app--collapsed",!o.nativeOpen),o.nativeApp.setAttribute("aria-hidden",o.nativeOpen?"false":"true"))}function ep(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Di,{once:!0}):Di(),window.addEventListener("pointermove",Im),window.addEventListener("pointerup",Wm),window.addEventListener("popstate",Xd),window.addEventListener("oq-mock-updated",tp),window.addEventListener("oq-dev-controls-changed",op),document.addEventListener("visibilitychange",Zd)}function tp(){o.mounted&&ae()}function op(){o.mounted&&m()}function Di(){np();let e=document.querySelector("esp-app");e||(e=document.createElement("esp-app"),document.body.appendChild(e)),o.nativeApp=e,o.nativeFrontendLoaded=Array.from(document.scripts).some(t=>t.src===Is),o.mounted||(rp(e),o.mounted=!0,ha()),$n(),o.nativeOpen||(ae(),ei({silent:!0}))}function np(){if(!document.head)return;let e=document.head.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",document.head.appendChild(e)),e.setAttribute("content","width=device-width, initial-scale=1")}function rp(e){const t=document.createElement("section");t.id="oq-helper-root",t.lang="nl-NL",document.documentElement&&!document.documentElement.lang&&(document.documentElement.lang="nl-NL"),e.parentNode.insertBefore(t,e),t.addEventListener("click",xm),t.addEventListener("change",Fm),t.addEventListener("input",Nm),t.addEventListener("keydown",Rm),t.addEventListener("wheel",Om,{passive:!1}),t.addEventListener("focusin",os),t.addEventListener("focusout",os),t.addEventListener("mouseover",Mm),t.addEventListener("mouseout",Pm),t.addEventListener("pointerdown",Dm),o.root=t,Gd();const n=fa()||eo(),r=n==="settings"?sl():"";r&&vn(r,{syncUrl:!1}),Et(n,{syncMode:"replace",forceSync:!0}),ba(),m()}function ap(e){return new Promise((t,n)=>{if(!e){t();return}const r=Array.from(document.scripts).find(i=>i.src===e);if(r){if(r.dataset.loaded==="true"){t();return}r.addEventListener("load",()=>t(),{once:!0}),r.addEventListener("error",i=>n(i),{once:!0});return}const a=document.createElement("script");a.src=e,a.async=!1,a.addEventListener("load",()=>{a.dataset.loaded="true",t()},{once:!0}),a.addEventListener("error",i=>n(i),{once:!0}),document.head.appendChild(a)})}async function Lr(){if(!(o.nativeFrontendLoaded||o.nativeFrontendLoading)){o.nativeFrontendLoading=!0,o.nativeOpen&&m();try{await ap(Is),o.nativeFrontendLoaded=!0}catch(e){o.controlError=`ESPHome fallback kon niet worden geladen. ${e.message||e}`,o.nativeOpen=!1,nl("app"),m(),ha()}finally{o.nativeFrontendLoading=!1,o.nativeOpen&&m()}}}function Ii(){if(!o.root)return;const e=typeof window<"u"?window.__OQ_DEV_CONTROLS__:null;!e||typeof e.bind!="function"||e.bind(o.root)}function ba(){o.root&&(o.root.style.removeProperty("--oq-flow-offset"),o.root.style.removeProperty("--oq-flow-offset-reverse"),o.root.style.removeProperty("--oq-fan-rotation"),o.root.getAttribute("style")||o.root.removeAttribute("style"))}function va(){return o.motionTargets={pipeFlows:[],fanBlades:[]},o.root?(o.root.querySelectorAll(".oq-hp-schematic-board.is-running").forEach(r=>{r.querySelectorAll(".oq-hp-tech-pipe-flow").forEach(a=>{o.motionTargets.pipeFlows.push(a)})}),o.root.querySelectorAll(".oq-hp-schematic-board.is-water-flowing:not(.is-running)").forEach(r=>{r.querySelectorAll('.oq-hp-tech-pipe-flow[data-oq-flow-variant="water"]').forEach(a=>{o.motionTargets.pipeFlows.push(a)})}),o.root.querySelectorAll(".oq-hp-schematic-board.is-fan-running").forEach(r=>{r.querySelectorAll(".oq-hp-tech-fan-blades").forEach(a=>{o.motionTargets.fanBlades.push(a)})}),o.motionTargets.pipeFlows.length+o.motionTargets.fanBlades.length):0}function ip(){return o.motionTargets.pipeFlows.length>0||o.motionTargets.fanBlades.length>0}function cl(e=performance.now()){if(!o.root||o.reducedMotion||!ip()&&va()===0)return!1;o.motionStartedAt||(o.motionStartedAt=e);const t=(e-o.motionStartedAt)/1e3,n=t*Nd%360;return o.motionTargets.pipeFlows.forEach(r=>{const a=r.dataset.oqFlowVariant==="water"?.42:1,i=-(t*Pd*a);r.style.strokeDashoffset=`${i.toFixed(3)}px`}),o.motionTargets.fanBlades.forEach(r=>{r.style.transform=`rotate(${n.toFixed(3)}deg)`}),!0}function ul(e){if(!cl(e)){o.motionFrame=0,o.motionStartedAt=0;return}o.motionFrame=window.requestAnimationFrame(ul)}function ya(){if(o.motionFrame||o.reducedMotion||va()===0)return;const e=performance.now();if(o.motionStartedAt=e,!cl(e)){o.motionStartedAt=0;return}o.motionFrame=window.requestAnimationFrame(ul)}function Xe(){const e=window.location.pathname.replace(/\/$/,"");return e===""?"":e}function G(e,t,n=""){const r=n?`/${n}`:"";return`${Xe()}/${e}/${encodeURIComponent(t)}${r}`}function ce(e=E("strategy")){return String(e||"").includes("Water Temperature Control")}function sp(e=E("flowControlMode")){return String(e||"").toLowerCase().includes("manual")}function bt(){return typeof window<"u"&&window.__OQ_DEV_META&&typeof window.__OQ_DEV_META=="object"?window.__OQ_DEV_META:{}}function lp(){const e=String(E("hpGeneration")||"").trim();return e||""}function An(e){const t=String(e||"").trim().toLowerCase();return t==="single"||t.includes("quatt single")||t.includes("openquatt single")?"single":t==="duo"||t.includes("quatt duo")||t.includes("openquatt duo")?"duo":""}function cp(){if(!Array.isArray(bn))return"";if(bn.some(t=>v(t)))return"duo";const e=o.optionalMissingEntities||{};return bn.every(t=>e[t])?"single":""}function Sr(e){const t=An(e);return(t==="single"||t==="duo")&&typeof o<"u"&&o&&typeof o=="object"&&(o.lastKnownInstallationTopology=t),t}function up(){if(typeof o<"u"&&o&&typeof o=="object"){const e=String(o.lastKnownInstallationTopology||"").trim().toLowerCase();if(e==="single"||e==="duo")return e}return""}function Z(){const e=An(E("installationTopology"));if(e==="single"||e==="duo")return Sr(e);const t=An(bt().installation);if(t==="single"||t==="duo")return Sr(t);const n=cp();return n?Sr(n):up()}function Uo(){const e=Z(),t=lp();return e==="single"?t?`Quatt Single ${t}`:"Quatt Single":e==="duo"?t?`Quatt Duo ${t}`:"Quatt Duo":t?`Quatt Hybrid ${t}`:"Quatt Hybrid"}function Me(){return"OpenQuatt"}function dl(e){const t=String(e||"").trim().toLowerCase();return t==="wifi"||t==="wi-fi"||t.includes("wifi")||t.includes("wi-fi")?"wifi":t==="eth"||t==="ethernet"||t.includes("ethernet")?"eth":""}function De(e=Rt()){return e==="wifi"?"Wi-Fi":e==="eth"?"Ethernet":"Onbekend"}function Lo(e=Z()){return e==="single"?"Single":e==="duo"?"Duo":"Onbekende opstelling"}function Vn(){const e=String(E("hardwareProfileText")||"").trim().toLowerCase();return e&&e!=="unknown"&&e!=="onbekend"?e:String(bt().hardwareProfile||e).trim().toLowerCase()}function Rt(){return dl(E("connectionText")||bt().connection)}function dp(){const e=Rt();return e==="wifi"?"eth":e==="eth"?"wifi":""}function pp(){const e=Z();return e==="single"?"duo":e==="duo"?"single":""}function gp(){const e=o.entities.firmwareUpdateTarget||{};return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function pl(e){return gp().includes(e)}function Oo(e=Z(),t=Rt()){const n=Lo(e),r=Vn();return r==="heatpump_controller_q"?`Heatpump Controller Q ${n} ${De(t)}`:r==="heatpump_listener"?`Heatpump Listener ${n} ${De(t)}`:r==="waveshare"?`Waveshare ${n} ${De(t)}`:`${Me()} ${n} ${De(t)}`}function wa(){const e=Vn(),t=Z(),n=Rt(),r=dp();return e!=="heatpump_controller_q"||t!=="single"&&t!=="duo"||n!=="wifi"&&n!=="eth"||!r?null:{canSwitch:v("firmwareUpdateTarget")&&pl("alternate connection")&&v("installFirmwareUpdateTarget"),currentConnection:n,targetConnection:r,currentLabel:De(n),targetLabel:De(r),currentBuildLabel:Oo(t,n),targetBuildLabel:Oo(t,r)}}function Sa(){const e=Vn(),t=Z(),n=pp(),r=Rt(),a=e==="heatpump_controller_q"?["wifi","eth"]:["wifi"];return!["heatpump_controller_q","heatpump_listener","waveshare"].includes(e)||t!=="single"&&t!=="duo"||!n||!a.includes(r)?null:{canSwitch:v("firmwareUpdateTarget")&&pl("alternate topology")&&v("installFirmwareUpdateTarget"),currentTopology:t,targetTopology:n,currentConnection:r,targetConnection:r,currentLabel:Lo(t),targetLabel:Lo(n),currentBuildLabel:Oo(t,r),targetBuildLabel:Oo(n,r)}}function Fo(e=o.updateTestFirmwarePr){const t=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(t)?t:""}function _n(){const e=Vn(),t=Z(),n=Rt(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||t!=="single"&&t!=="duo"||!a.connections.includes(n))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};const i=`openquatt-${a.slug}-${t}-${n}`,l=t==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,md5FileName:`${i}.firmware.ota.bin.md5`,label:`${a.label} ${l} ${De(n)}`}}function qa(e=Fo(),t=_n()){if(!e||!t.available)return null;const r=`${`https://github.com/jeroen85/OpenQuatt/releases/download/pr-${e}`}/${t.otaFileName}`;return{otaUrl:r,md5Url:`${r}.md5`,releaseApiUrl:`https://api.github.com/repos/jeroen85/OpenQuatt/releases/tags/pr-${e}`}}function gl(){const e=A("timeValid"),t=String(E("timeNowHhmm")||"").trim();if(t&&t!=="invalid")return t;if(v("timeValid")&&!e)return"Geen tijdsync";try{return new Intl.DateTimeFormat("nl-NL",{hour:"2-digit",minute:"2-digit"}).format(new Date)}catch{return new Date().toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"})}}function ml(){return v("timeValid")&&!A("timeValid")?"Geen tijdsync":`${new Intl.DateTimeFormat("nl-NL",{day:"numeric",month:"short",year:"numeric"}).format(new Date)} \xB7 ${gl()}`}function un(e){if(!Number.isFinite(e)||e<0)return"\u2014";const t=Math.floor(e),n=Math.floor(t/1440),r=Math.floor(t%1440/60),a=t%60;return n>0?`${n}d ${r}u`:r>0?`${r}u ${a}m`:`${a}m`}function mp(e){return String(e?.uom??e?.unit_of_measurement??"").trim().toLowerCase()}function hp(e){const t=e?.state;if(t!==""&&t!==null&&t!==void 0){const a=Number(t);if(Number.isFinite(a))return a}const n=e?.value,r=Number(n);return Number.isFinite(r)?r:NaN}function ka(){const e=hp(o.entities.uptime);if(Number.isFinite(e)&&e>=0){const r=mp(o.entities.uptime);if(r==="d")return un(e*1440);if(r==="h")return un(e*60);if(r==="s")return un(e/60)}const t=String(o.entities.uptimeReadable?.state??o.entities.uptimeReadable?.value??"").trim();if(t&&t.toLowerCase()!=="unknown")return t;const n=Number(bt().bootedAt);return!Number.isFinite(n)||n<=0?"\u2014":un((Date.now()-n)/6e4)}function Ca(){const e=String(o.entities.ipAddress?.state??o.entities.ipAddress?.value??"").trim();if(e)return e;const t=String(bt().ipAddress||"").trim();return t||(typeof window<"u"?String(window.location.hostname||"").trim():"")||"\u2014"}function zo(){if($e())return"Controleren";const e=et();if(e)return e.phaseLabel;if($a())return"Bijgewerkt";if(Qt())return"Bezig";if(io())return"Beschikbaar";const t=fl();if(t!==null&&t<=0)return"Actueel";const n=bt();return typeof n.updateLabel=="string"&&n.updateLabel.trim()?n.updateLabel.trim():n.updateAvailable===!0?"Beschikbaar":n.updateAvailable===!1||Ha()?"Actueel":ie()?"Nog niet gecontroleerd":"\u2014"}function ie(){return o.entities.firmwareUpdate||null}function jn(){const e=ie();return e?String(e.state??e.value??"").trim().toLowerCase():""}function fp(){const e=o.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function Kn(){return fp().toLowerCase()}function hl(){const e=o.entities.firmwareUpdateProgress;if(!e)return Number.NaN;const t=Number(e.value??e.state);return Number.isNaN(t)?Number.NaN:Math.max(0,Math.min(100,t))}function Ta(){const e=String(o.updateInstallTargetVersion||"").trim(),t=oe();return!e||!t?!1:Qo(t,e)>=0}function bp(e=ie()||{}){const t=Pt(e),n=oe(e);return!t||!n?!1:Qo(n,t)>=0}function Ea(){return(Ta()||bp())&&!$e()&&!To()&&!io()}function $a(){return(o.updateInstallCompleted||Ea())&&!$e()&&!et()&&!io()}function Go(){o.updateInstallBusy=!1,o.updateInstallTargetVersion="",o.updateInstallPhaseHint="",o.updateInstallProgressHint=Number.NaN,o.updateInstallMode="",o.updateInstallTargetConnection="",o.updateInstallTargetTopology="",Cp()}function fe(){o.updateManualUploadFile=null,o.updateManualUploadFileName="",o.updateManualUploadError=""}function xe(e={}){e.clearPr&&(o.updateTestFirmwarePr=""),o.updateTestFirmwareConfirmed=!1,o.updateTestFirmwareError="",o.updateTestFirmwareBuild=null}function vp(){const e=Kn(),t=hl();if(e==="starting"||e==="uploading"||e==="rebooting"){o.updateInstallPhaseHint=e,Number.isNaN(t)||(o.updateInstallProgressHint=e==="rebooting"?Math.max(t,100):t);return}if(o.updateInstallBusy){if(Ta()){o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100;return}o.controlNotice.includes("opnieuw is opgestart")&&(o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100)}}function To(){const e=Kn();return e==="starting"||e==="uploading"||e==="rebooting"}function et(){vp();const e=Kn(),t=e==="starting"||e==="uploading"||e==="rebooting",n=t?e:o.updateInstallPhaseHint,r=hl(),a=Number.isNaN(o.updateInstallProgressHint)?0:Math.round(o.updateInstallProgressHint),i=t&&!Number.isNaN(r)?Math.round(r):a;return!To()&&!o.updateInstallBusy?null:n==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:o.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":o.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":o.updateInstallMode==="topology-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna met de gekozen opstelling terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:n==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${Me()} gedownload en ge\xEFnstalleerd.`:o.updateInstallMode==="connection-switch"?`De ${De(o.updateInstallTargetConnection)}-build wordt nu naar ${Me()} verzonden.`:o.updateInstallMode==="topology-switch"?`De ${Oo(o.updateInstallTargetTopology,o.updateInstallTargetConnection)}-build wordt nu naar ${Me()} verzonden.`:`Firmware wordt nu naar ${Me()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${Me()}.`:o.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${De(o.updateInstallTargetConnection)} is gestart.`:o.updateInstallMode==="topology-switch"?`Opstellingswissel naar ${Lo(o.updateInstallTargetTopology)} is gestart.`:`OTA-update is gestart voor ${Me()}.`}}function Pt(e=ie()||{}){const t=String(e.latest_version||"").trim();if(t)return t;const n=String(e.value||"").trim(),r=String(e.current_version||"").trim();return n&&n!==r&&/^v/i.test(n)?n:""}function oe(e=ie()||{}){const t=String(o.entities.projectVersionText?.state||o.entities.projectVersionText?.value||"").trim();return t||String(e.current_version||"").trim()}function yp(e=ie()||{}){const t=oe(e),n=String(e.current_version||"").trim();return!t||!n||t===n?!1:Qo(t,n)>0}function Aa(e=ie()||{},t=mt()){const n=String(t||"").trim().toLowerCase(),r=String(e.release_url||"").trim().toLowerCase(),a=Pt(e).toLowerCase();if(!n||n==="\u2014")return!0;if(n==="dev"){if(r){if(r.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(n==="main"){if(r){if(r.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function Wi(e){const n=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return n?{major:Number(n[1]),minor:Number(n[2]),patch:Number(n[3]),prereleaseTag:n[4]||"",prereleaseNumber:n[5]?Number(n[5]):null}:null}function Qo(e,t){const n=Wi(e),r=Wi(t);if(!n||!r)return 0;if(n.major!==r.major)return n.major>r.major?1:-1;if(n.minor!==r.minor)return n.minor>r.minor?1:-1;if(n.patch!==r.patch)return n.patch>r.patch?1:-1;const a=!n.prereleaseTag,i=!r.prereleaseTag;return a!==i?a?1:-1:n.prereleaseTag!==r.prereleaseTag?n.prereleaseTag>r.prereleaseTag?1:-1:n.prereleaseNumber!==r.prereleaseNumber?(n.prereleaseNumber||0)>(r.prereleaseNumber||0)?1:-1:0}function Qt(){if(Ea())return!1;const e=jn();return o.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function $e(){const e=jn();return o.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function io(){const e=jn();if(!Aa())return!1;const t=fl();return t!==null?t>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:bt().updateAvailable===!0}function Ha(){const e=jn();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||yp()}function Ma(){const e=ie()||{},t=oe(e)||"\u2014";let n=Aa(e)?Pt(e):"";const r=n?Qo(n,t):null;return!$e()&&r!==null&&r<=0&&(n=""),{current:t,latest:n||"\u2014"}}function fl(){const{current:e,latest:t}=Ma();return e==="\u2014"||t==="\u2014"?null:Qo(t,e)}function bl(e=mt()){const t=String(e||"").trim().toLowerCase();return Fi[t]||Fi.main}function wp(){const e=String((ie()||{}).release_url||"").trim(),t=bl();return!e||t.includes("/dev-latest")&&!e.includes("/dev-latest")||!t.includes("/dev-latest")&&e.includes("/dev-latest")?t:e}function Sp(){return Me()}function mt(){return String(E("firmwareUpdateChannel")||o.entities.releaseChannelText?.state||o.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function qp(){return Ma().latest!=="\u2014"}function Bi(e){return String(e||"").toLowerCase().replace(/wi[\s-]?fi/g,"wifi").replace(/[^a-z0-9]+/g,"")}function kp(e,t=ie()||{}){const n=Bi(e);return n?Bi(`${t.title||""} ${t.summary||""}`).includes(n):!0}function vl(e){return new Promise(t=>window.setTimeout(t,e))}function yl(e=Date.now()){return Number(o.firmwareOtaQuietUntil||0)>e}function Un(e=Ko){const n=Date.now()+e;o.firmwareOtaQuietUntil=Math.max(Number(o.firmwareOtaQuietUntil||0),n),o.pendingEntitySyncOptions=null,ma(),typeof Ge=="function"&&Ge(),o.firmwareOtaQuietTimer&&window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=window.setTimeout(()=>{o.firmwareOtaQuietTimer=null,o.firmwareOtaQuietUntil=0,!o.updateInstallBusy&&!o.nativeOpen&&Bn()},e)}function Cp(){o.firmwareOtaQuietTimer&&(window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=null),o.firmwareOtaQuietUntil=0,o.nativeOpen||Bn()}const Tp=1500;function Pa(){o.deviceReconnectRecoveryTimer&&(window.clearTimeout(o.deviceReconnectRecoveryTimer),o.deviceReconnectRecoveryTimer=null)}function Lt(){return Number(o.deviceReconnectRecoveryStartedAt||0)>0}function Ep(){return Lt()?Number(o.deviceReconnectRecoveryStartedAt||0):Number(o.deviceReconnectStartedAt||0)}function $p(){return Lt()?"Gegevens verversen":"Wachten op gegevens"}function Ap(){const e=Ep(),t=e>0?Math.max(0,Math.round((Date.now()-e)/1e3)):0;return Lt()?t>0?`${t}s aan het verversen`:"Net weer online":t>0?`${t}s bezig`:"Net gestart"}function Vi(){if(!o.deviceReconnectMode||Lt())return!1;Pa(),o.deviceReconnectRecoveryStartedAt=Date.now(),o.deviceReconnectLastError="",o.entitySyncFailureCount=0;const e=o.deviceReconnectRecoveryStartedAt;return o.deviceReconnectRecoveryTimer=window.setTimeout(()=>{o.deviceReconnectMode&&Number(o.deviceReconnectRecoveryStartedAt||0)===e&&(wl(),m())},Tp),m(),!0}function Na(e="reconnect",t=""){o.deviceReconnectMode||(o.deviceReconnectStartedAt=Date.now()),Pa(),o.deviceReconnectMode=e,o.deviceReconnectRecoveryStartedAt=0,o.deviceReconnectLastError=t?String(t):o.deviceReconnectLastError,o.systemModal="",o.updateModalOpen=!1,o.controlError=""}function wl(){Pa(),!(!o.deviceReconnectMode&&!o.entitySyncFailureCount)&&(o.deviceReconnectMode="",o.deviceReconnectStartedAt=0,o.deviceReconnectRecoveryStartedAt=0,o.deviceReconnectLastError="",o.entitySyncFailureCount=0)}function Hp(){return Lt()?"OpenQuatt is weer online":o.deviceReconnectMode==="ota"?"OpenQuatt wordt bijgewerkt":o.deviceReconnectMode==="restart"?"OpenQuatt herstart":"Verbinding herstellen"}function Mp(){return Lt()?o.deviceReconnectMode==="ota"?"De update is bijna klaar. We verversen nu de gegevens en het logboek.":"De controller reageert weer. We verversen nu de gegevens en het logboek.":o.deviceReconnectMode==="ota"?"De controller installeert de update en start daarna opnieuw op. Deze melding verdwijnt zodra de web-app weer gegevens ontvangt.":o.deviceReconnectMode==="restart"?"De controller start opnieuw op. De web-app probeert automatisch opnieuw verbinding te maken.":"De web-app krijgt tijdelijk geen gegevens van de controller. We proberen automatisch opnieuw te verbinden."}function Pp(){return o.deviceReconnectMode?`
        ...
        <section class="oq-helper-modal oq-helper-modal--reconnect" role="status" aria-live="polite" aria-labelledby="oq-reconnect-modal-title">
          <div class="oq-helper-modal-head">
            <div>
              ...
              <h2 class="oq-helper-modal-title" id="oq-reconnect-modal-title">${s(Hp())}</h2>
            </div>
          </div>
    ...
    `:""}function Ra(e=mt()){const t=ie()||{},n=oe(t);o.entities.firmwareUpdate={...t,state:"CHECKING",value:"",latest_version:"",latestVersion:"",summary:"",release_url:bl(e),current_version:n}}async function La(e={}){const t=String(e.expectedBuildLabel||"").trim();for(let n=0;n<6;n+=1){await vl(n===0?900:1200),await D(la,"all",{forceMissing:!0});const r=Aa(),a=!t||kp(t),i=qp(),l=$e(),c=zo();if(r&&a&&(i||!l&&c!=="Nog niet gecontroleerd"))return!0}return!1}async function Yo(e={}){let t=!1;const n=Number.isFinite(Number(e.initialDelayMs))?Math.max(0,Number(e.initialDelayMs)):700,r=Number.isFinite(Number(e.pollDelayMs))?Math.max(250,Number(e.pollDelayMs)):1e3;for(let a=0;a<45;a+=1){await vl(a===0?n:r);try{if(await D(la,"all",{forceMissing:!0}),Kn()==="rebooting"&&Na("ota"),m(),o.updateInstallMode==="connection-switch"){const i=dl(o.updateInstallTargetConnection);if(i&&Rt()===i&&!To()&&!Qt())return!0}else if(o.updateInstallMode==="topology-switch"){const i=An(o.updateInstallTargetTopology);if(i&&Z()===i&&!To()&&!Qt())return!0}else if(Ta()||Ea()||Ha()&&!To()&&!Qt())return!0}catch{t||(o.controlNotice="Wachten tot het device opnieuw is opgestart...",m(),t=!0)}}return!1}function Np(){const e=mt(),t=et();if(t)return t.copy;if($a()){const n=o.updateInstallCompletedVersion||oe()||mt();return`${Me()} draait nu op ${n}.`}return Qt()?`OTA-update wordt voorbereid voor ${Me()}. Het device kan kort herstarten.`:$e()?`We controleren of er op kanaal ${e} een nieuwe firmware beschikbaar is.`:io()?"Er staat een nieuwere firmware klaar.":Ha()?`Je draait al de nieuwste firmware op kanaal ${e}.`:"Kies een kanaal en controleer of er een nieuwere firmware klaarstaat."}function Sl(){return!!(o.firmwareAdvancedOpen||o.firmwareConnectionSwitchOpen||o.firmwareTopologySwitchOpen||o.updateManualUploadOpen||o.updateTestFirmwareOpen)}function dn(e,t,n,r,a=!1){return`
      <button
    ...
    `}function Rp(e,t,n,r){if(!Sl())return"";const i=!!(et()||o.updateInstallBusy||$e());return`
      <div class="oq-helper-modal-callout oq-helper-modal-callout--subtle oq-firmware-advanced-panel">
        ...
        <div class="oq-firmware-advanced-options">
          ${e?dn("toggle-firmware-connection-switch","Verbinding wisselen",`Naar ${t.targetLabel}`,o.firmwareConnectionSwitchOpen,i):""}
          ${n?dn("toggle-firmware-topology-switch","Opstelling wisselen",`Naar ${r.targetLabel}`,o.firmwareTopologySwitchOpen,i):""}
          ${dn("toggle-firmware-upload","Handmatige upload","Lokaal OTA-bestand",o.updateManualUploadOpen,i)}
          ${dn("toggle-firmware-test","Testfirmware","PR-release installeren",o.updateTestFirmwareOpen,i)}
        </div>
        ${Lp()}
        ${Op()}
        ${xp()}
    ...
    `}function Lp(){const e=wa();if(!e||!o.firmwareConnectionSwitchOpen)return"";const n=!!(et()||o.updateInstallBusy||$e()),r=!!o.firmwareConnectionSwitchConfirmed,a=e.targetConnection==="eth",i=!e.canSwitch,l=a?"Sluit eerst de netwerkkabel aan. Na de herstart verdwijnt Wi-Fi uit deze firmware.":"Na de herstart verdwijnt Ethernet uit deze firmware. Als er geen Wi-Fi-gegevens bekend zijn, start het OpenQuatt fallback access point.",c=i?'<p class="oq-helper-modal-note oq-helper-modal-note--muted">Verbindingswissel wordt geladen. Open deze modal opnieuw of wacht een moment als de knop disabled blijft.</p>':"";return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
          <strong>Verbinding wisselen</strong>
          <span>Installeer dezelfde ${s(mt())}-build voor de andere netwerkverbinding.</span>
        </div>
    ...
    `}function Fp(){if(!o.updateTestFirmwareOpen)return"";const t=!!(et()||o.updateInstallBusy||$e()),n=Fo(),r=_n(),a=qa(n,r),i=!!(r.available&&v("firmwareTestOtaUrl")&&v("firmwareTestOtaMd5Url")&&v("installFirmwareTestOta")),l=!!(n&&i),c=o.updateTestFirmwareBuild||null,d=r.available?r.label:r.error,u=a?r.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen.";return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
    ...
    `}function xp(){if(!o.updateManualUploadOpen)return"";const t=!!(et()||o.updateInstallBusy||$e()),n=String(o.updateManualUploadFileName||o.updateManualUploadFile?.name||"").trim();return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
    ...
    `}function Or(){return[o.interfacePanelOpen?"open":"closed",o.nativeOpen?"native":"app",o.appView,o.complete?"complete":"incomplete",o.overviewTheme,o.hpVisualMode,re("installationTopology"),re("hardwareProfileText"),re("connectionText"),o.firmwareAdvancedOpen?"firmware-advanced-open":"firmware-advanced-closed",o.firmwareConnectionSwitchOpen?"connection-open":"connection-closed",o.firmwareTopologySwitchOpen?"topology-open":"topology-closed",o.updateManualUploadOpen?"upload-open":"upload-closed",o.updateTestFirmwareOpen?"test-open":"test-closed",o.updateTestFirmwareError,re("hpGeneration"),re("projectVersionText"),re("releaseChannelText"),Oa()].join("|")}function Oa(){const e=Math.max(Number(o.lastEntityResponseAt||0),Number(o.lastEntitySyncAt||0)),t=Number(o.deviceReconnectStartedAt||0);return o.entitySyncFailureCount>0&&!o.deviceReconnectMode?"Bezig":e>0&&(!o.deviceReconnectMode||e>=t)?"Verbonden":o.deviceReconnectMode?Lt()?"Verbonden":o.deviceReconnectMode==="reconnect"?"Offline":"Bezig":v("status")&&!A("status")?"Offline":"Bezig"}function ql(){return String(E("projectVersionText")||"").trim()||"\u2014"}function Dp(){const e=ql();return e&&e!=="\u2014"?e:zo()}function kl(){const e=o.entities.espInternalTemp;if(!e)return"\u2014";const t=H("espInternalTemp");return Number.isNaN(t)?B("espInternalTemp"):I(t,1,e.uom||" \xB0C")}function Fa(){const e=o.authStatus;return e?e.enabled?e.setup_window_active?"Instelvenster":"Beveiligd":"Onbeveiligd":"Laden..."}function Ip(){return"Login"}function Wp(){const e=o.authStatus;return e?e.enabled?"De web-app vraagt nu een login voordat beheer beschikbaar is. Je kunt die hier aanpassen of uitzetten.":"De web-app staat open op je netwerk. Houd de herstelknop 5 seconden vast om een login toe te voegen.":"We halen de huidige loginstatus op."}function xa(){const e=o.authStatus;return e?e.enabled?e.setup_window_active?"Login actief. Tijdelijk instelvenster is open.":`Login actief${e.source?` via ${e.source}`:""}.`:e.setup_window_active?"Login uit. Tijdelijk instelvenster is open.":"Login uit. Webtoegang is open / onbeveiligd op het netwerk.":"Logingegevens laden..."}function Bp(){return"ESPHome API encryption"}function Vp(){const e=o.apiSecurityStatus;return e?e.pending_restart?"Deze wijziging wordt actief na herstart. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":e.transport_active===!0?"De native API is beveiligd. Je kunt de sleutel hier bekijken, kopi\xEBren of vernieuwen.":e.key?"De sleutel blijft opgeslagen, ook wanneer encryptie uit staat. Je kunt hem hier meteen kopi\xEBren of opnieuw inschakelen.":"Er is nog geen API-sleutel opgeslagen. Deze wijziging wordt actief na herstart.":"We halen de huidige API-beveiliging op."}function _p(){const e=o.apiSecurityStatus;return e?e.enabled?"Uitschakelen":"Inschakelen":"Laden..."}function jp(){const e=o.apiSecurityStatus;return e?e.key?"Vernieuw sleutel":"Genereer sleutel":"Laden..."}function _i(e,t,n="",r=!1){return`
    ...
    `}function Kp(){const e=o.apiSecurityStatus||{},t=e.enabled===!0,n=!!e.key,r=!!e.pending_restart,a=o.apiSecurityNotice,i=o.apiSecurityError?`<div class="oq-helper-modal-note oq-helper-modal-note--error" aria-live="assertive">${s(o.apiSecurityError)}</div>`:"";return`
        ...
        <section class="oq-helper-modal oq-helper-modal--wide" role="dialog" aria-modal="true" aria-labelledby="oq-api-security-modal-title">
          <div class="oq-helper-modal-head">
            <div>
              ...
              <h2 class="oq-helper-modal-title" id="oq-api-security-modal-title">${s(Bp())}</h2>
            </div>
          ...
          <p class="oq-helper-modal-copy">${s(Vp())}</p>
          ...
          <div class="oq-settings-api-security-shell oq-settings-api-security-shell--modal">
            <div class="oq-settings-quickstart-status-row oq-settings-api-security-status-row">
              <div>
                ...
                <strong class="oq-settings-quickstart-status-value">${s(ni())}</strong>
                <p class="oq-settings-quickstart-status-copy">${s(ri())}</p>
              </div>
              <button
    ...
    `}function Up(){const e=[["Netwerkstatus",Oa()],["IP-adres",Ca()]],t=String(E("wifiSsid")||"").trim();t&&e.push(["WiFi SSID",t]);const n=o.entities.wifiSignal;if(n){const r=H("wifiSignal");Number.isNaN(r)||e.push(["WiFi signaal",I(r,0,n.uom||" dBm")])}return e}function Cl(e){return e==="version"?"open-update-modal":e==="connectivity"?"open-connectivity-modal":e==="debugRecording"?"open-debug-recording-modal":e==="webserverLog"?"open-webserver-log-modal":e==="login"?"open-login-modal":""}function Tl(){return[["installation","Installatie",Uo()],["uptime","Uptime",ka()],["connectivity","Connectiviteit",Oa()],["time","Tijd",gl()],["version","Versie",Dp(),!!ie()],["debugRecording","Debugopname",nf(),!0],["webserverLog","Logboek",gc(),!0]]}function El(){return io()}function $l(e){return e==="version"&&El()}function ko(){return`
      <div class="oq-helper-status-grid">
        ${Tl().map(([t,n,r,a])=>{const i=Cl(t),l=!!(a||i),c=$l(t);return`
          <${l?"button":"div"}
    ...
    `}function Fr(){if(!o.root)return!1;const e=o.root.querySelector(".oq-helper-status-grid");if(!e)return!!o.root.querySelector(".oq-helper-hub");const t=Tl();if(e.querySelectorAll("[data-oq-header-status]").length!==t.length)return e.outerHTML=ko(),!0;for(const[r,a,i,l]of t){const c=e.querySelector(`[data-oq-header-status="${r}"]`);if(!c)return e.outerHTML=ko(),!0;const d=Cl(r),u=!!(l||d);if(c.tagName.toLowerCase()!==(u?"button":"div"))return e.outerHTML=ko(),!0;const g=c.querySelector(".oq-helper-status-label"),b=c.querySelector(".oq-helper-status-value");if(!g||!b)return e.outerHTML=ko(),!0;g.textContent!==a&&(g.textContent=a);const h=$l(r),y=h?`<span class="oq-helper-status-value-text">${s(i)}</span><span class="oq-helper-status-badge" aria-label="Update beschikbaar" title="Update beschikbaar"></span>`:s(i);b.innerHTML!==y&&(b.innerHTML=y),u?c.setAttribute("data-oq-action",d):c.removeAttribute("data-oq-action"),c.classList.toggle("oq-helper-status-item--button",u),c.classList.toggle("oq-helper-status-item--attention",h)}return!0}function zp(){const e=typeof window<"u"?window.__OQ_DEV_CONTROLS__:null;return!e||typeof e.render!="function"?"":e.render()}function ji(){const e=zp();return e?o.devPanelOpen?`
    ...
    `:`
      ...
      `:""}function Gp(){const e=o.nativeOpen?"native":"app",t=El();return o.interfacePanelOpen?`
    ...
    `:`
        <aside class="oq-helper-hub oq-helper-hub--collapsed" aria-label="Weergave en systeem">
          <div class="oq-helper-hub-head-actions">
            ...
            >${ra("more-horizontal","oq-helper-hub-toggle-icon")}${t?'<span class="oq-helper-hub-toggle-dot" aria-hidden="true"></span>':""}</button>
          </div>
        </aside>
      `}function Qp(){if(!o.root)return;if(o.interfacePanelOpen){o.root.querySelector(".oq-debug-recording-header-status")?.remove(),Fr();return}const e=o.root.querySelector(".oq-helper-hub--collapsed .oq-helper-hub-head-actions");if(!e)return;const t=e.querySelector(".oq-debug-recording-header-status"),n=$c();if(!n){t?.remove();return}if(t){t.outerHTML=n;return}e.insertAdjacentHTML("afterbegin",n)}function Yp(){const e=o.nativeOpen?"native":"app",t=o.nativeFrontendLoading?"ESPHome fallback wordt geladen. Daarna blijft alleen de native webinterface actief.":"De OpenQuatt-app is tijdelijk uitgeschakeld, zodat de ESPHome fallback zelfstandig en zonder extra interfacebelasting kan draaien.",n=o.controlError?`<p class="oq-native-surface-note oq-native-surface-note--error">${s(o.controlError)}</p>`:"";return`
    ...
    `}function Jp(){const e=o.authStatus||{},t=e.enabled===!0,n=e.setup_window_active===!0,r=t||n,a=t?String(e.username||"").trim():"",i=o.authNotice?`<div class="oq-helper-modal-success oq-helper-modal-success--compact" aria-live="polite"><strong>Opgeslagen</strong><span>${s(o.authNotice)}</span></div>`:"",l=o.authError?`<div class="oq-helper-modal-note oq-helper-modal-note--error" aria-live="assertive">${s(o.authError)}</div>`:"",d=r?`
      ...
      <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
        <section class="oq-helper-modal" role="dialog" aria-modal="true" aria-labelledby="oq-login-modal-title">
          <div class="oq-helper-modal-head">
            <div>
              <p class="oq-helper-modal-kicker">Systeem</p>
              <h2 class="oq-helper-modal-title" id="oq-login-modal-title">${s(Ip())}</h2>
            </div>
            <button class="oq-helper-modal-close" type="button" data-oq-action="close-system-modal" aria-label="Sluit login-popup">\xD7</button>
          </div>
          <p class="oq-helper-modal-copy">${s(Wp())}</p>
          ${i}
          ${l}
          <div class="oq-helper-modal-grid">
            ${_i("Beveiligingsstatus",Fa(),xa())}
            ${_i("Gebruiker",t?a||"Geen naam":"Geen login",t?"Deze naam gebruik je om in te loggen.":"Er staat nog geen login op het device.")}
          </div>
          ${d}
          <div class="oq-helper-modal-actions">
    ...
    `}function Zp(){if(!o.updateModalOpen)return"";const e=ie(),t=o.entities.firmwareUpdateChannel||null,{current:n,latest:r}=Ma(),a=$e(),i=Qt(),l=io(),c=Np(),d=et(),u=$a(),g=wp(),b=u?"Firmware-update afgerond":d||i?"Firmware-update bezig":a?"Controleren op firmware-update":Sp(),h=t?Array.isArray(t.option)?t.option:Array.isArray(t.options)?t.options:[]:[],y=wa(),p=Sa(),f=!!(y&&!u),S=!!(p&&!u);return`
        ...
        <section class="oq-helper-modal oq-helper-modal--firmware oq-helper-modal--scrollable" role="dialog" aria-modal="true" aria-labelledby="oq-update-modal-title">
          ...
          <div class="oq-helper-modal-grid">
            <div class="oq-helper-modal-row">
              ...
              <strong class="oq-helper-modal-value">${s(zo())}</strong>
            </div>
            <div class="oq-helper-modal-row">
            ...
            <div class="oq-helper-modal-row">
              ...
              <strong class="oq-helper-modal-value">${s(mt())}</strong>
            </div>
          </div>
          ${h.length?`
    ...
    `}function Xp(){if(o.systemModal==="login")return Jp();if(o.systemModal==="api-security")return Kp();if(o.systemModal==="connectivity"){const e=Up();return`
        <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `}if(o.systemModal==="settings-backup-restore")return Ab();if(o.systemModal==="settings-backup-import")return $b();if(o.systemModal==="history-storage")return wb();if(String(o.systemModal||"").startsWith("service-task-"))return gb();if(o.systemModal==="settings-backup-success"){const e=o.controlNotice||"Backup hersteld.";return`
        <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `;if(o.systemModal==="webserver-logs")return of();if(o.systemModal==="debug-recording")return Ef();if(o.systemModal==="openquatt-pause"){const e=A("openquattEnabled"),t=o.busyAction==="openquatt-regulation",n=v("openquattResumeAt"),r=o.loadingEntities||o.entitySyncInFlight,a=n||!r,i=Da(),l=Ia(E("openquattResumeAt")),c=Ml();return`
        <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `}return""}function E(e){if(Object.prototype.hasOwnProperty.call(o.drafts,e))return o.drafts[e];const t=o.entities[e];return t?t.value??t.state??"":""}function tt(e){const t=o.entities[e]||{};return{min:Number(t.min_value??0),max:Number(t.max_value??100),step:Number(t.step??1),uom:t.uom||""}}function Re(e){return Object.prototype.hasOwnProperty.call(o.inputDrafts,e)?o.inputDrafts[e]:E(e)}function Ze(e){if(typeof e=="number")return e;const t=String(e??"").trim().replace(",",".");return!t||t==="-"||t==="."||t==="-."?Number.NaN:Number(t)}function so(e){const t=String(e||"").trim();if(!t)return"";const n=t.match(/^(\d{1,2}):?(\d{2})(?::?(\d{2}))?$/);if(!n)return"";const r=Number(n[1]),a=Number(n[2]),i=Number(n[3]||"0");return[r,a,i].some(l=>Number.isNaN(l))||r<0||r>23||a<0||a>59||i<0||i>59?"":`${String(r).padStart(2,"0")}:${String(a).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function xr(e){const t=so(e);return t?t.slice(0,5):""}function ot(e){const t=String(e||"").trim();if(!t)return"";const n=t.match(/^(\d{4})-(\d{2})-(\d{2})(?:[T\s](\d{2}):(\d{2})(?::(\d{2}))?)$/);if(!n)return"";const r=Number(n[1]),a=Number(n[2]),i=Number(n[3]),l=Number(n[4]),c=Number(n[5]),d=Number(n[6]||"0");return[r,a,i,l,c,d].some(u=>Number.isNaN(u))||r<2e3||a<1||a>12||i<1||i>31||l<0||l>23||c<0||c>59||d<0||d>59?"":`${String(r).padStart(4,"0")}-${String(a).padStart(2,"0")}-${String(i).padStart(2,"0")} ${String(l).padStart(2,"0")}:${String(c).padStart(2,"0")}:${String(d).padStart(2,"0")}`}function Dr(e){const t=ot(e);return!t||t===No?"":t.slice(0,16).replace(" ","T")}function Al(e){const t=ot(e);if(!t||t===No)return null;const n=t.match(/^(\d{4})-(\d{2})-(\d{2}) (\d{2}):(\d{2}):(\d{2})$/);if(!n)return null;const r=Number(n[1]),a=Number(n[2]),i=Number(n[3]),l=Number(n[4]),c=Number(n[5]),d=Number(n[6]),u=new Date(r,a-1,i,l,c,d,0);return Number.isNaN(u.getTime())?null:u}function Da(e=E("openquattResumeAt")){return!!Al(e)}function Ia(e,t=!1){const n=Al(e);return n?new Intl.DateTimeFormat("nl-NL",t?{weekday:"short",day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"}:{weekday:"long",day:"numeric",month:"long",hour:"2-digit",minute:"2-digit"}).format(n):""}function Ki(e){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),a=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0");return`${t}-${n}-${r}T${a}:${i}`}function eg(e){const t=new Date(e.getTime());t.setSeconds(0,0);const n=t.getMinutes(),r=n%15;return r!==0&&t.setMinutes(n+(15-r)),t}function Hl(e){const t=new Date;if(e==="2h"||e==="8h"){const n=e==="2h"?2:8,r=eg(new Date(t.getTime()+n*3600*1e3));return Ki(r)}if(e==="tomorrow-morning"){const n=new Date(t);return n.setDate(n.getDate()+1),n.setHours(7,0,0,0),Ki(n)}return""}function Ml(){const e=Dr(o.pauseResumeDraft);if(e)return e;const t=Dr(E("openquattResumeAt"));return t||Hl("2h")}function lo(){return[...new Set(["setupComplete",...tl])]}const Wa=["trendHistoryEnabled","trendHistoryFlashEnabled","trendHistoryFlush","trendHistoryFlashAvailable","trendHistoryFlashOldest","trendHistoryFlashNewest","trendHistoryFlashLastFlush","trendHistoryFlashSize","trendHistoryFlashWrites","lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites"],tg=["trendHistoryEnabled","trendHistoryFlashEnabled","trendHistoryFlashAvailable","trendHistoryFlashOldest","trendHistoryFlashNewest","trendHistoryFlashLastFlush","trendHistoryFlashSize","trendHistoryFlashWrites"],og=["lifetimeEnergyHistoryEnabled","lifetimeEnergyHourRetention","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites"];function Eo(){return[...new Set(Wa)]}async function Ba(e={}){await D(Eo(),"all",{concurrency:_o,forceMissing:e.forceMissing===!0}),await Nt({force:e.forceEnergyHistory===!0,metaOnly:!0})}function Co(e=[250,1e3,2500]){e.forEach(t=>{window.setTimeout(()=>{o.nativeOpen||o.appView!=="settings"||Ba({forceMissing:t===0}).finally(()=>{o.appView==="settings"&&o.mounted&&!o.nativeOpen&&m()})},t)})}const ng="@schema|openquatt.energy_history_import.v1",rg=850,Hn=[{id:"days",label:"Alleen dagtotalen",fileLabel:"daily"},{id:"days_and_hours",label:"Dagtotalen + uurdetail",fileLabel:"daily-hourly"},{id:"hours",label:"Alleen uurdetail",fileLabel:"hourly"}],ag={forbidden:"Beveiligingstoken ontbreekt of is verlopen. Vernieuw de pagina en probeer opnieuw.",partition_unavailable:"Niet beschikbaar op deze Flash-indeling. Flash de controller eenmalig via USB met de nieuwe indeling.",time_unavailable:"De controller heeft nog geen geldige tijd. Probeer opnieuw zodra de tijdsync klaar is.",empty_records:"Er zijn geen records verstuurd.",payload_too_large:"Deze importbatch is te groot. Probeer het bestand opnieuw te importeren."},Ae={electricalInput:["electrical_input_wh","electricalInputWh","energy_hp_electric","hpElectric","hp_electric_wh","total_hp_electric_wh","totalHpElectric"],heatingInput:["heating_input_wh","heatingInputWh"],coolingInput:["cooling_input_wh","coolingInputWh"],heatpumpHeatOutput:["heatpump_heat_output_wh","heatpumpHeatOutputWh","energy_hp_heat","hpHeat","hp_heat_wh","total_hp_heat_wh","totalHpHeat"],heatpumpCoolingOutput:["heatpump_cooling_output_wh","heatpumpCoolingOutputWh","energy_hp_cooling","hpCooling","hp_cooling_wh","total_hp_cooling_wh","totalHpCooling"],boilerHeatOutput:["boiler_heat_output_wh","boilerHeatOutputWh","energy_boiler_heat","boilerHeat","boiler_heat_wh","total_boiler_heat_wh","totalBoilerHeat"],systemHeatOutput:["system_heat_output_wh","systemHeatOutputWh"]};function zn(e){const t=String(e||"").trim();return Hn.some(n=>n.id===t)?t:"days_and_hours"}function Pl(e){const t=zn(e);return Hn.find(n=>n.id===t)||Hn[1]}function ig(e){const t=Pl(e),n=new Date().toISOString().slice(0,10);return`openquatt-energy-history-${t.fileLabel}-${n}.json`}function sg(e,t){const n=URL.createObjectURL(e),r=document.createElement("a");r.href=n,r.download=t,r.style.display="none",document.body.appendChild(r),r.click(),window.setTimeout(()=>{URL.revokeObjectURL(n),r.remove()},0)}async function lg(){if(o.energyHistoryExportBusy)return;const e=zn(o.energyHistoryExportMode),t=Pl(e);if(o.energyHistoryExportMode=e,o.energyHistoryExportBusy=!0,o.energyHistoryExportError="",o.energyHistoryExportNotice="",m(),Jo()){o.energyHistoryExportBusy=!1,o.energyHistoryExportNotice=`Preview: ${t.label.toLowerCase()} zou als JSON worden gedownload.`,m();return}try{const n=await fetch(`${Xe()}/energy/history/export?mode=${encodeURIComponent(e)}`,{cache:"no-store"});if(!n.ok)throw new Error(`HTTP ${n.status}`);const r=await n.blob();sg(r,ig(e)),o.energyHistoryExportNotice=`${t.label} ge\xEBxporteerd.`}catch(n){o.energyHistoryExportError=`Exporteren mislukt. ${n.message}`}finally{o.energyHistoryExportBusy=!1,m()}}function Nl(e=!1){const t=e?o.energyHistoryImportNotice:"";o.energyHistoryImportFileName="",o.energyHistoryImportSource="",o.energyHistoryImportRange="",o.energyHistoryImportRecords=[],o.energyHistoryImportHourRecords=[],o.energyHistoryImportDuplicateCount=0,o.energyHistoryImportSkippedCount=0,o.energyHistoryImportInvalidCount=0,o.energyHistoryImportUnsupportedCount=0,o.energyHistoryImportBusy=!1,o.energyHistoryImportProgressPercent=0,o.energyHistoryImportError="",o.energyHistoryImportNotice=t}function Rl(e){if(e==null||e==="")return 0;const t=String(e).trim();let n=0,r=0,a=0;const i=t.match(/^(\d{4})(\d{2})(\d{2})$/),l=Ll(t),c=t.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(i)n=Number(i[1]),r=Number(i[2]),a=Number(i[3]);else{if(l)return l.dateKey;if(c)n=Number(c[1]),r=Number(c[2]),a=Number(c[3]);else{const u=new Date(t);if(Number.isNaN(u.getTime()))return 0;n=u.getFullYear(),r=u.getMonth()+1,a=u.getDate()}}if(n<2020||n>2099||r<1||r>12||a<1||a>31)return 0;const d=new Date(Date.UTC(n,r-1,a));return d.getUTCFullYear()!==n||d.getUTCMonth()!==r-1||d.getUTCDate()!==a?0:n*1e4+r*100+a}function Ui(e){const t=String(Math.round(Number(e)||0)).padStart(8,"0");return/^\d{8}$/.test(t)?`${t.slice(6,8)}-${t.slice(4,6)}-${t.slice(0,4)}`:""}function Gn(e){return e.timestamp??e.time??e.datetime??e.date_time??e.dateTime}function Ll(e){if(e==null||e==="")return null;const t=String(e).trim(),n=t.match(/^(\d{4})-(\d{2})-(\d{2})[T\s](\d{1,2})(?::(\d{2}))?(?::(\d{2})(?:\.\d+)?)?(?:Z|[+-]\d{2}:?\d{2})?$/i);if(!n)return null;const r=/(?:Z|[+-]\d{2}:?\d{2})$/i.test(t),a=Number(n[1]),i=Number(n[2]),l=Number(n[3]),c=Number(n[4]),d=Number(n[5]||"0"),u=Number(n[6]||"0");if([a,i,l,c,d,u].some(f=>Number.isNaN(f)))return null;const g=r?new Date(t):new Date(a,i-1,l,c,d,u,0);if(Number.isNaN(g.getTime()))return null;const b=g.getFullYear(),h=g.getMonth()+1,y=g.getDate(),p=g.getHours();return b<2020||b>2099||h<1||h>12||y<1||y>31?null:{dateKey:b*1e4+h*100+y,hour:p}}function Ol(e){if(e==null||e==="")return null;const t=Number(String(e).trim().replace(",","."));return!Number.isFinite(t)||t<0||t>=4294967295?null:Math.round(t)}function ct(e,t,n=null){for(const r of t){if(!Object.prototype.hasOwnProperty.call(e,r))continue;const a=Ol(e[r]);if(a!==null)return a}return n}function pn(e,t){return ct(e,t)!==null}function Fl(e){const t=Rl(e.date_key??e.dateKey??e.date??e.from??Gn(e));if(!t)return null;const n=ct(e,Ae.electricalInput),r=ct(e,Ae.heatpumpHeatOutput);if(n===null||r===null)return null;const a=ct(e,Ae.heatingInput,n),i=ct(e,Ae.coolingInput,0),l=ct(e,Ae.heatpumpCoolingOutput,0),c=ct(e,Ae.boilerHeatOutput,0),d=ct(e,Ae.systemHeatOutput,r+c),u=pn(e,Ae.heatingInput)||pn(e,Ae.coolingInput)||pn(e,Ae.heatpumpCoolingOutput)||pn(e,Ae.systemHeatOutput);return[a,i,l,c,d].some(g=>g===null)?null:{dateKey:t,electricalInputWh:n,heatingInputWh:a,coolingInputWh:i,heatpumpHeatOutputWh:r,heatpumpCoolingOutputWh:l,boilerHeatOutputWh:c,systemHeatOutputWh:d,hasFullImportFields:u}}function cg(e){const t=Ol(e.hour??e.hour_of_day??e.hourOfDay);if(t!==null&&t>=0&&t<=23)return t;const n=Gn(e);if(n){const r=String(n).trim(),a=Ll(r);if(a)return a.hour;const i=new Date(r);if(!Number.isNaN(i.getTime()))return i.getHours();const l=r.match(/^(\d{1,2})(?::\d{2})/);if(l){const c=Number(l[1]);if(c>=0&&c<=23)return c}}return-1}function ug(e){const t=Fl(e),n=cg(e);return!t||n<0||n>23?null:{...t,hour:n}}function dg(e){const t=[];let n=[],r="",a=!1;const i=()=>{n.push(r),r=""},l=()=>{i(),n.some(d=>String(d).trim()!=="")&&t.push(n),n=[]};for(let d=0;d<e.length;d+=1){const u=e[d];a?u==='"'&&e[d+1]==='"'?(r+='"',d+=1):u==='"'?a=!1:r+=u:u==='"'?a=!0:u===","?i():u===`
`?l():u!=="\r"&&(r+=u)}if((r||n.length)&&l(),!t.length)return[];const c=t.shift().map(d=>String(d||"").trim());return t.map(d=>{const u={};return c.forEach((g,b)=>{g&&(u[g]=d[b]??"")}),u})}function gn(e){return!e||typeof e!="object"||Array.isArray(e)||!e.summary||typeof e.summary!="object"||Array.isArray(e.summary)?e:{...e.summary,...e}}function pg(e){return Object.prototype.hasOwnProperty.call(e,"hour")||Object.prototype.hasOwnProperty.call(e,"hour_of_day")||Object.prototype.hasOwnProperty.call(e,"hourOfDay")}function gg(e){return e.some(t=>Gn(t)!==void 0)}function mg(e){const t=new Set;for(const n of e){const r=Rl(n.date_key??n.dateKey??n.date??n.from??Gn(n));if(r){if(t.has(r))return!0;t.add(r)}}return!1}function xl(e){return e.some(pg)||gg(e)&&mg(e)}function hg(e){const t=[],n=[];if(Array.isArray(e)){const l=e.map(gn);return xl(l)?n.push(...l):t.push(...l),{dailyRows:t,hourlyRows:n,source:"JSON"}}const r=String(e?.schema||e?.import_schema||"JSON").trim()||"JSON",a=Array.isArray(e?.days)?e.days:Array.isArray(e?.daily)?e.daily:Array.isArray(e?.openquatt_import?.daily)?e.openquatt_import.daily:[],i=Array.isArray(e?.hourly)?e.hourly:Array.isArray(e?.hours)?e.hours:Array.isArray(e?.openquatt_import?.hourly)?e.openquatt_import.hourly:[];return t.push(...a.map(gn)),n.push(...i.map(gn)),a.forEach(l=>{Array.isArray(l?.samples)&&l.samples.forEach(c=>{n.push(gn({...c,date:c.date??l.date}))})}),{dailyRows:t,hourlyRows:n,source:r}}function fg(e,t){const n=String(t||"").trim();if(!n)throw new Error("Bestand is leeg.");let r=[],a=[],i="";if(n[0]==="{"||n[0]==="["){const p=hg(JSON.parse(n));r=p.dailyRows,a=p.hourlyRows,i=p.source}else{const p=dg(n);xl(p)||String(e||"").toLowerCase().includes("hour")?a=p:r=p,i="CSV"}const l=new Map,c=new Map;let d=0,u=0;r.forEach(p=>{const f=Fl(p);if(!f){u+=1;return}l.has(f.dateKey)&&(d+=1),l.set(f.dateKey,f)}),a.forEach(p=>{const f=ug(p);if(!f){u+=1;return}const S=`${f.dateKey}:${f.hour}`;c.has(S)&&(d+=1),c.set(S,f)});const g=[...l.values()].sort((p,f)=>p.dateKey-f.dateKey),b=[...c.values()].sort((p,f)=>p.dateKey-f.dateKey||p.hour-f.hour);if(!g.length&&!b.length)throw new Error("Geen ondersteunde dag- of uurrecords gevonden.");const h=[...g.map(p=>p.dateKey),...b.map(p=>p.dateKey)].sort((p,f)=>p-f),y=h.length?`${Ui(h[0])} t/m ${Ui(h[h.length-1])}`:"";return{records:g,hourRecords:b,source:i,range:y,duplicates:d,invalid:u}}function bg(e){return e.hasFullImportFields?["day",e.dateKey,e.electricalInputWh,e.heatingInputWh,e.coolingInputWh,e.heatpumpHeatOutputWh,e.heatpumpCoolingOutputWh,e.boilerHeatOutputWh,e.systemHeatOutputWh].join("|"):["day",e.dateKey,e.electricalInputWh,e.heatpumpHeatOutputWh,e.boilerHeatOutputWh].join("|")}function vg(e){const t=new Map;return e.forEach(n=>{t.has(n.dateKey)||t.set(n.dateKey,new Map),t.get(n.dateKey).set(n.hour,n)}),[...t.entries()].sort((n,r)=>n[0]-r[0]).map(([n,r])=>{let a=0;const i=[],l=[...r.values()].some(c=>c.hasFullImportFields);for(let c=0;c<24;c+=1){const d=r.get(c);d&&(a|=1<<c),l?i.push(d?.electricalInputWh??0,d?.heatingInputWh??0,d?.coolingInputWh??0,d?.heatpumpHeatOutputWh??0,d?.heatpumpCoolingOutputWh??0,d?.boilerHeatOutputWh??0,d?.systemHeatOutputWh??0):i.push(d?.electricalInputWh??0,d?.heatpumpHeatOutputWh??0,d?.boilerHeatOutputWh??0)}return["hourday",n,a,...i].join("|")})}function Dl(e){const t=new URLSearchParams;return t.set("records",[ng,...e].join(`
`)),o.energyHistoryCsrfToken&&t.set("csrf_token",o.energyHistoryCsrfToken),t}function yg(e){const t=[];let n=[];return e.forEach(r=>{const a=[...n,r];n.length&&String(Dl(a)).length>rg?(t.push(n),n=[r]):n=a}),n.length&&t.push(n),t}function wg(e){const t=[];e.written>0&&t.push(`${e.written} dagrecords`),e.hourWritten>0&&t.push(`${e.hourWritten} uurdagen`);const n=t.length?`${t.join(" en ")} ge\xEFmporteerd.`:"Geen nieuwe records ge\xEFmporteerd.",r=[];return e.duplicates>0&&r.push(`${e.duplicates} al aanwezig`),e.skipped>0&&r.push(`${e.skipped} overgeslagen`),e.invalid>0&&r.push(`${e.invalid} ongeldig`),e.unsupported>0&&r.push(`${e.unsupported} onbekend`),r.length?`${n} (${r.join(", ")}.)`:n}async function Sg(e){const t=await fetch(`${Xe()}/energy/history/import`,{method:"POST",cache:"no-store",headers:{"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8"},body:Dl(e)}),n=await t.text();let r={};try{r=n?JSON.parse(n):{}}catch{r={}}if(!t.ok||r.ok===!1){const a=r.error?String(r.error):"";throw new Error(ag[a]||a||`HTTP ${t.status}`)}return r}function Il(e){const t=String(e||"").split(/\r?\n/).find(n=>n.startsWith("@csrf|"));return t?t.slice(6):""}async function qg(){if(Jo())return;const e=await fetch(`${Xe()}/energy/history?meta=1`,{cache:"no-store"});if(!e.ok)throw new Error(`HTTP ${e.status}`);const t=Il(await e.text());if(!t)throw new Error("Beveiligingstoken ontbreekt. Vernieuw de pagina en probeer opnieuw.");o.energyHistoryCsrfToken=t}function kg(e,t){o.energyHistoryImportProgressPercent=t>0?Math.min(99,Math.max(1,Math.round(e/t*100))):0,m()}async function Cg(e){if(Nl(),!e){m();return}o.energyHistoryImportFileName=e.name||"exportbestand";try{const t=fg(e.name||"",await e.text());o.energyHistoryImportRecords=t.records,o.energyHistoryImportHourRecords=t.hourRecords,o.energyHistoryImportSource=t.source,o.energyHistoryImportRange=t.range,o.energyHistoryImportDuplicateCount=t.duplicates,o.energyHistoryImportInvalidCount=t.invalid}catch(t){o.energyHistoryImportError=`Bestand kon niet worden gelezen. ${t.message}`}m()}function Tg(){const e=document.createElement("input");e.type="file",e.accept=".json,.csv,application/json,text/csv,text/plain",e.style.position="fixed",e.style.left="-1000px",e.style.top="0",e.addEventListener("change",()=>{const t=e.files&&e.files[0]?e.files[0]:null;window.setTimeout(()=>e.remove(),0),Cg(t)},{once:!0}),document.body.appendChild(e),e.click()}async function Eg(){if(o.energyHistoryImportBusy)return;const e=[...o.energyHistoryImportRecords.map(bg),...vg(o.energyHistoryImportHourRecords)];if(!e.length){o.energyHistoryImportError="Kies eerst een exportbestand met dag- of uurrecords.",m();return}if(o.energyHistoryImportBusy=!0,o.energyHistoryImportError="",o.energyHistoryImportNotice="",o.energyHistoryImportProgressPercent=1,m(),Jo()){const r=new Set(o.energyHistoryImportHourRecords.map(a=>a.dateKey)).size;o.energyHistoryImportBusy=!1,o.energyHistoryImportProgressPercent=0,o.energyHistoryImportNotice=`Preview: ${o.energyHistoryImportRecords.length} dagrecords en ${r} uurdagen zouden worden ge\xEFmporteerd.`,m();return}const t={written:0,hourWritten:0,duplicates:0,skipped:0,invalid:0,unsupported:0};let n=0;try{await qg();const r=yg(e);for(const a of r){const i=await Sg(a);t.written+=Number(i.written||0),t.hourWritten+=Number(i.hour_written||0),t.duplicates+=Number(i.duplicates||0),t.skipped+=Number(i.skipped||0),t.invalid+=Number(i.invalid||0),t.unsupported+=Number(i.unsupported||0),n+=a.length,kg(n,e.length)}o.energyHistoryImportProgressPercent=100,o.energyHistoryImportNotice=wg(t),o.energyHistoryImportError="",o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,await Ba({forceMissing:!0,forceEnergyHistory:!0})}catch(r){o.energyHistoryImportError=`Importeren mislukt. ${r.message}`}finally{o.energyHistoryImportBusy=!1,o.energyHistoryImportProgressPercent=0,m()}}function Qn(){return o.appView==="settings"&&o.settingsGroup==="system"}function $g(){const e=typeof window<"u"?Number(window.__OQ_DEV_LOAD_DELAY_MS||0):0;return Number.isFinite(e)&&e>0?e:0}const Wl=["strategy","controlModeLabel","openquattEnabled","installationTopology","hpGeneration","totalPower","flowSelected","totalCop","manualCoolingEnable","silentModeOverride","totalHeat","totalCoolingPower"],Ag=["strategy","controlModeLabel","hpGeneration"],Hg=["totalPower","flowSelected"],Mg=["totalHeat","totalCoolingPower"],Pg=2e3,Ng=250,zi={installation:["hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower","flowControlMode","flowSetpoint","manualIpwm","silentStartTime","silentEndTime","maxWater","minRuntime"],service:["compressorStarts2hWarningLimit","compressorStarts72hWarningLimit","compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","commissioningStatus","cm100Active"],heating:["strategy"],cooling:["manualCoolingEnable","coolingWithoutDewPointMode"],integrations:["otEnabled","cicPollingEnabled","flowSource"],system:["setupComplete","projectVersionText","releaseChannelText","firmwareUpdateChannel"]},Rg=5e3,Lg=250,Og={installation:["setupComplete","installationTopology","hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower",...Ye,...qn,...Po,...Zs,...kn,...Cn,"maxWater",...oa],service:[...aa,...ia,...kn,...Cn,"boilerCvAssistEnabled","boilerRatedHeatPower","flowSelected","flowKp","flowKi"],heating:["strategy",...Ht,...Mo,"dayMax","silentMax"],cooling:["manualCoolingEnable","coolingWithoutDewPointMode","coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingSupplyTarget","coolingSupplyError",...Js],integrations:[...Us,...Gs,...zs,...Qs,...sa,...Ys,...Ks],system:["setupComplete",...Mt,"firmwareUpdateChannel","projectVersionText","releaseChannelText",...Wa,"webServerLogHistoryEnabled","debugLevel"]};function Va(e=o.settingsGroup){const t=Be.has(e)?e:Se[0].id;return[...new Set(["setupComplete","strategy",...ze,...Og[t]||[]])]}function Bl(){const e=Be.has(o.settingsGroup)?o.settingsGroup:Se[0].id;return[...new Set(zi[e]||zi.installation)]}const Fg=1200,xg=1800,Dg=0,Ig=3500;function Ir(){return["setupComplete","strategy",...ze]}function Wg(){const e=new Set;return el.forEach(t=>{(t.categories||[]).forEach(n=>{(n.groups||[]).forEach(r=>{(r.rows||[]).forEach(a=>{const i=Array.isArray(a)?a[1]:"";i&&e.add(i)})})})}),[...e]}function Bg(e=o.currentStep){const t=["setupComplete","strategy",...ze];return e==="generation"?[...new Set([...t,"installationTopology",...bn,"hpGeneration"])]:e==="flow-source"?[...new Set([...t,"hpGeneration",...Je])]:e==="thermostat-source"?[...new Set([...t,...Ho])]:e==="boiler"?[...new Set([...t,"boilerCvAssistEnabled","boilerRatedHeatPower"])]:e==="strategy"?[...new Set([...t,"strategy"])]:e==="heating"?[...new Set([...t,...Ht,...Mo,"dayMax","silentMax"])]:e==="flow"?[...new Set([...t,...Ye,...qn])]:e==="water"?[...new Set([...t,"maxWater"])]:e==="silent"?[...new Set([...t,...Po])]:e==="confirm"?[...new Set([...t,"installationTopology","hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower",...Je,...Ho,...Ye,...qn,...Ht,...Mo,"maxWater",...Po])]:t}async function qr(e=o.currentStep){const t=Bg(e);try{await D(t,"all",{concurrency:_o}),o.quickStartModalOpen&&o.currentStep===e&&!o.nativeOpen&&m()}catch{}}function xo(e,t={}){const n=t.forceFast===!0,r=t.includeBulk===!0;return e==="energy"||e==="results"?[...new Set([...Ir(),...e==="energy"?Wl:[],...Wg(),...e==="results"?og:[]])]:[...new Set([...Ir(),...n||!r?Xs:ca,...e==="diagnosis"?tg:[]])]}function _a(e=o.appView){return e==="diagnosis"||e==="results"?Dg:xg}function Vl(e=_a()){o.nativeOpen||(o.supplementaryPrimeTimer&&window.clearTimeout(o.supplementaryPrimeTimer),o.supplementaryPrimeTimer=window.setTimeout(()=>{o.supplementaryPrimeTimer=null,Am()},e))}function Vg(e={}){const t=o.pendingEntitySyncOptions||{},n={...t,...e};t.forceBulk||e.forceBulk?(n.forceBulk=!0,n.forceFast=!1):(t.forceFast||e.forceFast)&&(n.forceFast=!0),o.pendingEntitySyncOptions=n}function ja(e){const t=String(E(e)??"").trim().toLowerCase();return t!==""&&t!=="unknown"&&t!=="unavailable"&&t!=="nan"}function Gi(e){return ja(e)&&Number.isFinite(Ze(E(e)))}function Ka(){return o.appView==="overview"||o.appView==="diagnosis"||o.appView==="energy"}function _g(){return wd.filter(e=>{const t=o.entities[e];return t?!String(t.uom??t.unit_of_measurement??"").trim():!L[e]?.optional})}async function _l(){if(o.nativeOpen||!Ka()||o.overviewMetadataHydrated||o.overviewMetadataHydrating)return!1;const e=_g();if(!e.length)return o.overviewMetadataHydrated=!0,!1;o.overviewMetadataHydrating=!0;try{return await D(e,"all",{concurrency:At}),o.overviewMetadataHydrated=!0,!0}catch{return!1}finally{o.overviewMetadataHydrating=!1,o.mounted&&!o.nativeOpen&&m()}}function Qi(){return Ka()?Ag.every(ja)&&Hg.every(Gi)&&Mg.some(Gi):!0}function jg(){return o.appView==="settings"}function Yi(){return jg()?Bl().every(e=>L[e]?.optional&&!o.entities[e]?!0:ja(e)):!0}async function Kg(){if(Qi())return;const e=Date.now()+Pg;for(;!o.nativeOpen&&!Qi()&&Date.now()<e;){await new Promise(t=>window.setTimeout(t,Ng));try{await D(Wl,"state")}catch{return}}}async function Ug(){if(Yi())return;const e=Date.now()+Rg;for(;!o.nativeOpen&&!Yi()&&Date.now()<e;){await new Promise(t=>window.setTimeout(t,Lg));try{await D(Bl(),"all")}catch{return}}}function j(e,t=E(e)){if(t===""||t===null||Number.isNaN(Number(t)))return"\u2014";const n=tt(e),r=n.step<1?Math.min(4,Math.max(1,String(n.step).split(".")[1]?.length||1)):0;return`${Number(t).toFixed(r)}${n.uom?` ${n.uom}`:""}`}function we(e,t){const n=tt(e),r=Ze(t);if(Number.isNaN(r)){const d=Ze(o.entities[e]?.value??o.entities[e]?.state??"");return Number.isNaN(d)?n.min:d}const a=Math.min(n.max,Math.max(n.min,r)),i=Math.round((a-n.min)/n.step),l=n.min+i*n.step,c=n.step<1?Math.min(4,Math.max(1,String(n.step).split(".")[1]?.length||1)):0;return Number(l.toFixed(c))}function jl(){const e=pe[Math.floor(pe.length/2-1)],t=pe[Math.floor(pe.length/2)];if(!e||!t||!v("curveFallbackSupply"))return null;const n=we(e.key,E(e.key)),r=we(t.key,E(t.key)),a=(n+r)/2,i=we("curveFallbackSupply",a);return{value:i,label:j("curveFallbackSupply",i),basis:`Afgeleid uit het midden van je stooklijn (${e.label} en ${t.label}).`,isCurrent:we("curveFallbackSupply",E("curveFallbackSupply"))===i}}const zg=8e3,Kl=3e3,Ji="/openquatt/entities",Gg=900;function Qg(){return o.deviceReconnectMode||o.busyAction==="restartAction"||o.updateInstallBusy||o.updateInstallPhaseHint?Kl:zg}function Ul(e){const t=String(e||"").toLowerCase();return t.includes("failed to fetch")||t.includes("load failed")||t.includes("networkerror")||t.includes("network request failed")||t.includes("connection refused")||t.includes("connection reset")||t.includes("err_connection")||t.includes("timeout")}const Yg=300*1e3;function Jg(){if(o.optionalMissingEntities)for(const e of Object.keys(o.optionalMissingEntities))delete o.optionalMissingEntities[e]}function Zg(){const e=Date.now();o.lastEntitySyncAt=e,o.lastEntitySyncSuccessAt=e,o.entitySyncFailureCount=0,!!o.deviceReconnectMode&&typeof Vi=="function"&&Vi()&&(o.lastFastEntitySyncAt=0,o.lastBulkEntitySyncAt=0,o.lastStaticEntitySyncAt=0,o.trendHistoryRaw="",o.trendHistoryError="",o.trendHistorySignature="",o.trendHistoryNowMs=Number.NaN,o.trendHistoryLastFetchAt=0,typeof ds=="function"?ds():(Ge(),Jn(),o.webServerLogEnabled=null,o.webServerLogConnected=!1),Jg())}function zl(e){if(!Ul(e)){o.entitySyncFailureCount=0,wl();return}o.entitySyncFailureCount=Number(o.entitySyncFailureCount||0)+1,o.deviceReconnectLastError=String(e||""),(o.deviceReconnectMode||o.busyAction==="restartAction"||o.updateInstallBusy||o.updateInstallPhaseHint||o.entitySyncFailureCount>=2)&&Na(o.updateInstallBusy||o.updateInstallPhaseHint?"ota":o.busyAction==="restartAction"?"restart":"reconnect",e)}function Xg(e=Date.now(),t={}){if(t.forceProbe===!0||o.deviceReconnectMode||o.busyAction==="restartAction"||o.updateInstallBusy||o.updateInstallPhaseHint||Number(o.entitySyncFailureCount||0)>0)return!0;const n=Number(o.lastEntitySyncSuccessAt||o.lastEntitySyncAt||o.lastEntityResponseAt||0);if(!n)return!0;const r=document.hidden?ua:Ed;return e-n>=r}async function em(){const e=L.status||L.setupComplete;if(!e)return{ok:!0,message:""};const t=o.deviceReconnectMode?Kl:Td,n=G(e.domain,e.name);if(typeof AbortController=="function"){const r=new AbortController,a=window.setTimeout(()=>r.abort(),t);try{const i=await fetch(n,{cache:"no-store",signal:r.signal});return o.lastEntityResponseAt=Date.now(),{ok:i.ok||i.status===404,message:i.ok||i.status===404?"":`${e.name} HTTP ${i.status}`}}catch(i){return{ok:!1,message:r.signal.aborted?`${e.name} request timed out after ${t}ms`:i.message||String(i)}}finally{window.clearTimeout(a)}}try{const r=await fetch(n,{cache:"no-store"});return o.lastEntityResponseAt=Date.now(),{ok:r.ok||r.status===404,message:r.ok||r.status===404?"":`${e.name} HTTP ${r.status}`}}catch(r){return{ok:!1,message:r.message||String(r)}}}function tm(e,t=Date.now()){const n=o.optionalMissingEntities?.[e];return!L[e]?.optional||!n?!1:t-Number(n)<Yg}function om(e,t=Date.now()){o.optionalMissingEntities&&(o.optionalMissingEntities[e]=t)}function nm(e){const t=L[e];return t?`${e}	${t.domain}	${t.name}`:""}function Zi(e,t){const n=new URLSearchParams;return n.set("detail",t==="all"?"all":"state"),n.set("entities",e.join(`
`)),n.toString()}function Gl(e,t){const n=[];let r=[],a=[],i="";return e.forEach(l=>{const c=nm(l);if(!c)return;const d=[...a,c],u=Zi(d,t);if(a.length&&u.length>Gg){n.push({keys:r,body:i}),r=[l],a=[c],i=Zi(a,t);return}r=[...r,l],a=d,i=u}),a.length&&n.push({keys:r,body:i}),n}async function rm(e){const t=Qg(),n={method:"POST",cache:"no-store",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:e.body};if(typeof AbortController=="function"){const a=new AbortController,i=window.setTimeout(()=>a.abort(),t);try{const l=await fetch(Ji,{...n,signal:a.signal});if(!l.ok)throw new Error(`bulk entities HTTP ${l.status}`);return l.json()}catch(l){throw a.signal.aborted?new Error(`bulk entities request timed out after ${t}ms`):l}finally{window.clearTimeout(i)}}const r=await fetch(Ji,n);if(!r.ok)throw new Error(`bulk entities HTTP ${r.status}`);return r.json()}async function D(e,t="state",n={}){const r=Date.now(),a=n.forceMissing===!0,i=e.filter(h=>a||!tm(h,r));if(!i.length)return;const l=Number(n.concurrency),c=Number.isFinite(l)&&l>0?Math.floor(l):At,d=Gl(i,t),u=Math.max(1,Math.min(c,At)),g=[];for(let h=0;h<d.length;h+=u){const y=d.slice(h,h+u),p=await Promise.allSettled(y.map(async f=>({chunk:f,payload:await rm(f)})));g.push(...p)}g.some(h=>h.status==="fulfilled")&&(o.lastEntityResponseAt=Date.now());let b="";g.forEach(h=>{if(h.status!=="fulfilled"){const w=h.reason.message||String(h.reason);b||(b=w);return}const{chunk:y,payload:p}=h.value,f=p?.entities&&typeof p.entities=="object"?p.entities:{},S=new Set(Array.isArray(p?.missing)?p.missing:[]);y.keys.forEach(w=>{if(Object.prototype.hasOwnProperty.call(f,w)){o.optionalMissingEntities&&delete o.optionalMissingEntities[w],o.entities[w]=am(w,o.entities[w],f[w]);return}const q=L[w];q?.optional?S.has(w)&&om(w,r):b||(b=`${q?.name||w} ontbreekt in bulk response`)})}),Cm(),Bc(ar()),b?(zl(b),o.deviceReconnectMode?o.controlError="":o.controlError=`Niet alle helpervelden konden worden ververst. ${b}`):o.busyAction||(Zg(),o.controlError="")}function am(e,t={},n={}){const r={...t||{},...n||{}};return L[e]?.domain==="select"&&(!String(n.state??"").trim()&&String(t?.state??"").trim()&&(r.state=t.state),!String(n.value??"").trim()&&String(t?.value??"").trim()&&(r.value=t.value),!Array.isArray(n.option)&&Array.isArray(t?.option)&&(r.option=t.option),!Array.isArray(n.options)&&Array.isArray(t?.options)&&(r.options=t.options)),r}function Xi(e=o.authStatus||{}){return[e.enabled?"on":"off",e.setup_window_active?"armed":"locked",String(e.username||""),String(e.source||""),String(e.csrf_token||"")].join(":")}function Ql(){const e=o.authStatus||{};o.authDraftUsername=e.enabled?String(e.username||"").trim():"",o.authDraftCurrentPassword="",o.authDraftNewPassword="",o.authDraftConfirmPassword=""}function Wr(e=o.apiSecurityStatus||{}){return[e.enabled?"on":"off",e.transport_active?"active":"idle",e.pending_restart?"pending":"settled",String(e.key||""),String(e.source||""),String(e.csrf_token||"")].join(":")}function Yl(e,t={},n=$d){if(t.force===!0)return!0;const r=Number(e||0);return!r||Date.now()-r>=n}function im(){return o.systemModal==="login"||o.systemModal==="api-security"||Qn()}function sm(){return o.systemModal==="api-security"||Qn()}async function co(e={}){if(!Yl(o.lastAuthStatusRefreshAt,e))return!1;o.lastAuthStatusRefreshAt=Date.now();try{const t=await fetch("/auth/status",{cache:"no-store"});if(!t.ok)throw new Error(`HTTP ${t.status}`);const n=await t.json(),r={enabled:!!n.enabled,setup_window_active:!!n.setup_window_active,username:String(n.username||""),source:String(n.source||""),csrf_token:String(n.csrf_token||"")},a=Xi(),i=Xi(r);return o.authStatus=r,a!==i&&Ql(),o.systemModal==="login"&&(o.authError=""),a!==i}catch(t){return o.systemModal==="login"&&(o.authError=`Loginstatus kon niet worden geladen. ${t.message}`),!1}}function yn(){return o.nativeOpen||o.systemModal!=="login"?!1:(o.authStatus||{}).setup_window_active!==!0}function wn(){o.loginAuthStatusPollTimer&&(window.clearTimeout(o.loginAuthStatusPollTimer),o.loginAuthStatusPollTimer=null)}function Jl(e=Ad){o.loginAuthStatusPollTimer||!yn()||(o.loginAuthStatusPollTimer=window.setTimeout(async()=>{if(o.loginAuthStatusPollTimer=null,!yn())return;const t=o.authError;(await co({force:!0})||o.authError!==t)&&o.systemModal==="login"&&m(),yn()&&Jl()},Math.max(0,Number(e)||0)))}async function lm(e={}){if(o.systemModal!=="login")return!1;const t=o.authError,n=await co({force:!0});return(n||o.authError!==t)&&o.systemModal==="login"&&m(),e.poll!==!1&&yn()&&Jl(),n}async function uo(e={}){if(!Yl(o.lastApiSecurityStatusRefreshAt,e))return!1;o.lastApiSecurityStatusRefreshAt=Date.now();try{const t=await fetch("/api-security/status",{cache:"no-store"});if(!t.ok)throw new Error(`HTTP ${t.status}`);const n=await t.json(),r={enabled:!!n.enabled,transport_active:!!n.transport_active,pending_restart:!!n.pending_restart,key:String(n.key||""),source:String(n.source||""),csrf_token:String(n.csrf_token||"")},a=Wr(),i=Wr(r);return o.apiSecurityStatus=r,o.apiSecurityError="",a!==i&&(o.apiSecurityNotice=""),a!==i}catch(t){return o.apiSecurityError=`API-beveiliging kon niet worden geladen. ${t.message}`,!1}}async function Zl(e){if(!e)return!1;if(window.navigator?.clipboard?.writeText&&window.isSecureContext)return await window.navigator.clipboard.writeText(e),!0;const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.top="-1000px",t.style.opacity="0",document.body.appendChild(t),t.focus(),t.select();let n=!1;try{n=document.execCommand("copy")}finally{document.body.removeChild(t)}return n}async function cm(){await Ut("restartAction",{successNotice:"OpenQuatt wordt opnieuw opgestart om de API-beveiliging toe te passen.",errorPrefix:"Herstart mislukt",reconnectMode:"restart"})}async function um(){const e=o.apiSecurityStatus||{};if(!e.csrf_token){o.apiSecurityError="API-beveiliging laden nog. Probeer het zo opnieuw.",m();return}o.apiSecurityBusy=!0,o.apiSecurityNotice="",o.apiSecurityError="",m();try{const t=new URLSearchParams;t.set("csrf_token",e.csrf_token);const n=await fetch("/api-security/enable",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:t.toString()}),r=await n.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!n.ok||!r.ok)throw new Error(r.error||`HTTP ${n.status}`);await uo({force:!0}),o.apiSecurityNotice="API-beveiliging is opgeslagen. Kopieer de sleutel en kies daarna Opslaan en herstarten.",o.apiSecurityError="",m()}catch(t){o.apiSecurityError=`Inschakelen is mislukt. ${t.message}`,m()}finally{o.apiSecurityBusy=!1,m()}}async function dm(){const e=o.apiSecurityStatus||{};if(!e.csrf_token){o.apiSecurityError="API-beveiliging laden nog. Probeer het zo opnieuw.",m();return}o.apiSecurityBusy=!0,o.apiSecurityNotice="",o.apiSecurityError="",m();try{const t=new URLSearchParams;t.set("csrf_token",e.csrf_token);const n=await fetch("/api-security/rotate",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:t.toString()}),r=await n.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!n.ok||!r.ok)throw new Error(r.error||`HTTP ${n.status}`);await uo({force:!0}),o.apiSecurityNotice="API-sleutel is opgeslagen. Kopieer de nieuwe sleutel en kies daarna Opslaan en herstarten.",o.apiSecurityError="",m()}catch(t){o.apiSecurityError=`Roteren is mislukt. ${t.message}`,m()}finally{o.apiSecurityBusy=!1,m()}}async function pm(){const e=o.apiSecurityStatus||{};if(!e.csrf_token){o.apiSecurityError="API-beveiliging laden nog. Probeer het zo opnieuw.",m();return}if(!e.enabled){o.apiSecurityNotice="API-encryptie staat al uit.",o.apiSecurityError="",m();return}o.apiSecurityBusy=!0,o.apiSecurityNotice="",o.apiSecurityError="",m();try{const t=new URLSearchParams;t.set("csrf_token",e.csrf_token);const n=await fetch("/api-security/disable",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:t.toString()}),r=await n.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!n.ok||!r.ok)throw new Error(r.error||`HTTP ${n.status}`);await uo({force:!0}),o.apiSecurityNotice="API-beveiliging is opgeslagen. Kies daarna Opslaan en herstarten om dit toe te passen.",o.apiSecurityError="",m()}catch(t){o.apiSecurityError=`Uitzetten is mislukt. ${t.message}`,m()}finally{o.apiSecurityBusy=!1,m()}}async function gm(){const e=String(o.apiSecurityStatus?.key||"").trim();if(!e){o.apiSecurityError="Er is nog geen API-sleutel om te kopi\xEBren.",m();return}try{if(!await Zl(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.apiSecurityNotice="API-sleutel gekopieerd.",o.apiSecurityError="",m()}catch(t){o.apiSecurityError=`Kopi\xEBren is mislukt. ${t.message}`,m()}}function Br(){o.settingsBackupDraft=null,o.settingsBackupError="",o.settingsBackupBusy=!1}function mm(){return{device:Me(),installation:Uo(),topology:typeof Z=="function"?Z():"",firmware_version:oe(),firmware_channel:String(E("firmwareUpdateChannel")||E("releaseChannelText")||"").trim()}}function Xl(e){const t=L[e];if(!t)return;if(e==="setupComplete")return uc();const n=E(e);if(n===""||n===null||n===void 0)return;if(t.domain==="switch"||t.domain==="binary_sensor")return A(e);if(t.domain==="number"){const a=Ze(n);return Number.isNaN(a)?void 0:a}return t.domain==="time"?so(n)||void 0:t.domain==="datetime"?ot(n)||void 0:String(n||"").trim()||void 0}function ec(){const e={};return Zt.forEach(t=>{const n={};t.keys.forEach(r=>{const a=Xl(r);a!==void 0&&(n[r]=a)}),e[t.id]=n}),{schema_version:ol,exported_at:new Date().toISOString(),source:mm(),settings:e}}function hm(e=ec()){const t=String(e.exported_at||new Date().toISOString()).replace(/[:.]/g,"-").replace(/T/,"_").replace(/Z$/,"Z");return`${String(e.source?.installation||"OpenQuatt").replace(/\s+/g,"-").toLowerCase()}-settings-backup-${t}.json`}function fm(e,t){const n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),r=URL.createObjectURL(n),a=document.createElement("a");a.href=r,a.download=e,a.rel="noreferrer",document.body.appendChild(a),a.click(),a.remove(),window.setTimeout(()=>URL.revokeObjectURL(r),0)}function bm(e){const t=L[e];return t?.name?t.name:e.replaceAll(/([a-z])([A-Z])/g,"$1 $2").replaceAll(/_/g," ").trim()}function es(e,t){if(t==null||t==="")return"\u2014";const n=L[e];return n?n.domain==="number"?j(e,t):n.domain==="time"?so(t)?.slice(0,5)||"\u2014":n.domain==="datetime"?ot(t)||"\u2014":n.domain==="switch"||n.domain==="binary_sensor"?t?"Aan":"Uit":String(t).trim()||"\u2014":String(t).trim()||"\u2014"}function vm(e){switch(e){case"same":return"Gelijk";case"different":return"Wijkt af";case"missing":return"Ontbreekt in backup";case"current-missing":return"Niet op huidige installatie";case"optional-missing":case"optional-unavailable":return"Ontbreekt";default:return"Onbekend"}}function tc(e){const t=e?.settings&&typeof e.settings=="object"?e.settings:{},n=e?.source&&typeof e.source=="object"?e.source:{},r=Sd;let a=0,i=0,l=0,c=0,d=0,u=0,g=0,b=0;const h=Zt.map(y=>{const p=t[y.id]&&typeof t[y.id]=="object"?t[y.id]:{};let f=0,S=0,w=0,q=0,T=0,k=0,M=0;const x=y.keys.map(F=>{const C=!!L[F]?.optional,$=Object.prototype.hasOwnProperty.call(p,F),N=$?p[F]:void 0,W=Xl(F),K=v(F),R=$?es(F,N):C?"Niet op huidige installatie":"Ontbreekt in backup",V=K?es(F,W):C?"Niet beschikbaar op huidige installatie":"Ontbreekt op huidige installatie";let P="same";return!$&&C?P="optional-missing":$?K?JSON.stringify(W)!==JSON.stringify(N)&&(P="different"):P=C?"optional-unavailable":"current-missing":P="missing",K&&(M+=1,b+=1),P!=="same"&&(k+=1,g+=1),C?(T+=1,$?(w+=1,l+=1):(q+=1,c+=1)):$?(f+=1,a+=1):(S+=1,i+=1),{key:F,label:bm(F),optional:C,hasBackupValue:$,backupDisplay:R,currentDisplay:V,status:P,statusLabel:vm(P)}});return u+=y.keys.filter(F=>!L[F]?.optional).length,{id:y.id,label:y.label,present:f,currentPresent:M,requiredTotal:y.keys.filter(F=>!L[F]?.optional).length,optionalTotal:T,optionalPresent:w,optionalMissing:q,requiredMissing:S,total:y.keys.length,differenceCount:k,rows:x}});return Object.entries(t).forEach(([y,p])=>{if(!Zt.some(f=>f.id===y)){d+=1;return}!p||typeof p!="object"||Object.keys(p).forEach(f=>{r.has(f)||(d+=1)})}),{source:n,sectionSummaries:h,requiredPresent:a,requiredMissing:i,requiredAvailable:u,optionalPresent:l,optionalMissing:c,unknown:d,differenceCount:g,currentPresent:b,requiredTotal:u,total:ao.length}}function ym(e,t=""){const n=JSON.parse(e);if(!n||typeof n!="object")throw new Error("Backupbestand bevat geen JSON-object.");const r=Number(n.schema_version??n.schemaVersion??0);if(!Number.isInteger(r)||r<ol)throw new Error("Onbekende backupversie.");const a=n.settings&&typeof n.settings=="object"?n.settings:{},i={schema_version:r,exported_at:String(n.exported_at||""),source:n.source&&typeof n.source=="object"?n.source:{},settings:a,file_name:t||""};return i.summary=tc(i),i}async function wm(){o.settingsBackupBusy=!0,o.controlError="",o.controlNotice="",m();try{return await D(ao,"all"),ec()}finally{o.settingsBackupBusy=!1,m()}}async function Sm(){if(!o.settingsBackupBusy)try{const e=await wm();fm(hm(e),e),o.controlNotice="Settings-backup gedownload.",m()}catch(e){o.controlError=`Backup exporteren mislukt. ${e.message}`,m()}}async function qm(e){if(!(!e||o.settingsBackupBusy)){o.settingsBackupBusy=!0,o.settingsBackupDraft=null,o.settingsBackupError="",o.controlError="",o.controlNotice="",m();try{const t=await e.text();await D(ao,"all");const n=ym(t,e.name||"");o.settingsBackupDraft=n,o.systemModal="settings-backup-restore"}catch(t){o.settingsBackupDraft=null,o.settingsBackupError=`Backupbestand kon niet worden gelezen. ${t.message}`}finally{o.settingsBackupBusy=!1,m()}}}async function Do(e,t){const n=L[e];if(!n)throw new Error(`Onbekend veld ${e}.`);if(n.domain==="select"){const r=String(t||"").trim(),a=await fetch(`${G(n.domain,n.name,"set")}?option=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return r}if(n.domain==="number"){const r=we(e,t),a=await fetch(`${G(n.domain,n.name,"set")}?value=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return r}if(n.domain==="time"){const r=so(t),a=await fetch(`${G(n.domain,n.name,"set")}?value=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return r}if(n.domain==="datetime"){const r=ot(t),a=await fetch(`${G(n.domain,n.name,"set")}?value=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return r}if(n.domain==="text"){const r=String(t||"").trim(),a=await fetch(`${G(n.domain,n.name,"set")}?value=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return r}if(n.domain==="switch"||n.domain==="binary_sensor"){const r=!!t,a=r?"turn_on":"turn_off",i=await fetch(G(n.domain,n.name,a),{method:"POST"});if(!i.ok)throw new Error(`HTTP ${i.status}`);return r}throw new Error(`${n.name} kan niet worden hersteld.`)}async function km(){const e=o.settingsBackupDraft;if(!e||o.settingsBackupBusy)return;o.settingsBackupBusy=!0,o.settingsBackupError="",o.controlError="",o.controlNotice="",m();const t=[],n=[];let r=!1;try{await D(ao,"all");for(const i of Zt){const l=e.settings?.[i.id]&&typeof e.settings[i.id]=="object"?e.settings[i.id]:{};for(const c of i.keys){if(!Object.prototype.hasOwnProperty.call(l,c)){n.push(c);continue}const d=l[c];if(c==="setupComplete"){r=d===!0;continue}if(c==="openquattEnabled")continue;if(!L[c]||!v(c)){n.push(c);continue}try{await Do(c,d),t.push(c)}catch{n.push(c)}}}const a=e.settings?.operation?.openquattEnabled;if(Object.prototype.hasOwnProperty.call(e.settings?.operation||{},"openquattEnabled")&&v("openquattEnabled")&&(await Do("openquattEnabled",a),t.push("openquattEnabled")),r&&L.apply){const i=await fetch(G("button","Complete setup","press"),{method:"POST"});if(!i.ok)throw new Error(`Setup bevestigen mislukt (HTTP ${i.status}).`);t.push("setupComplete")}else Object.prototype.hasOwnProperty.call(e.settings?.installation||{},"setupComplete")&&n.push("setupComplete");o.systemModal="settings-backup-success",Br(),o.controlNotice=`Backup hersteld (${t.length} toegepast${n.length?`, ${n.length} overgeslagen`:""}).`,await ae()}catch(a){o.settingsBackupError=`Backup herstellen mislukt. ${a.message}`}finally{o.settingsBackupBusy=!1,m()}}function Jo(){return!!(typeof window<"u"&&window.__OQ_DEV_CONTROLS__||typeof window<"u"&&window.__OQ_DEV_META)}async function Ua(e={}){if(!po()){const r=!!(o.trendHistoryRaw||o.trendHistoryError);return o.trendHistoryRaw="",o.trendHistoryError="",o.trendHistorySignature="",o.trendHistoryNowMs=Number.NaN,o.trendHistoryLastFetchAt=0,r}if(Jo())return!1;const t=e.force===!0,n=Date.now();if(!t&&o.trendHistoryFetchPromise)return o.trendHistoryFetchPromise;if(!t&&(o.trendHistoryRaw||o.trendHistoryError)&&n-Number(o.trendHistoryLastFetchAt||0)<Ws)return!1;o.trendHistoryFetchPromise=(async()=>{const r=da(o.trendWindowHours||Xt);r!==o.trendWindowHours&&pa(r);const a=await fetch(`${Xe()}/trends/history?hours=${encodeURIComponent(String(r))}`,{cache:"no-store"});if(!a.ok)throw new Error(`HTTP ${a.status}`);const i=await a.text(),l=i.split(/\r?\n/);let c=Number.NaN,d=i;l.length&&l[0].startsWith("@now|")&&(c=Number(l[0].slice(5)),d=l.slice(1).join(`
`));const u=`${r}|${d.length}|${d.slice(0,120)}|${d.slice(-120)}`,g=Number.isFinite(o.trendHistoryNowMs),h=Number.isFinite(c)?!g||o.trendHistoryNowMs!==c:g,y=d!==o.trendHistoryRaw||o.trendHistoryError!==""||o.trendHistorySignature!==u||h;return o.trendHistoryRaw=d,o.trendHistoryError="",o.trendHistorySignature=u,o.trendHistoryNowMs=Number.isFinite(c)?c:Number.NaN,o.trendHistoryLastFetchAt=Date.now(),y})();try{return await o.trendHistoryFetchPromise}catch(r){const a=`Trendhistorie kon niet worden geladen. ${r.message}`,i=o.trendHistoryError!==a;return o.trendHistoryError=a,o.trendHistoryRaw="",o.trendHistorySignature="",o.trendHistoryNowMs=Number.NaN,o.trendHistoryLastFetchAt=Date.now(),i}finally{o.trendHistoryFetchPromise=null}}async function Nt(e={}){if(!v("lifetimeEnergyHistoryEnabled")&&!Jo()){const a=!!(o.energyHistoryRaw||o.energyHistoryError);return o.energyHistoryRaw="",o.energyHistoryError="",o.energyHistorySignature="",o.energyHistoryNowMs=Number.NaN,o.energyHistoryLastFetchAt=0,o.energyHistoryRequestQuery="",o.energyHistoryFetchQuery="",o.energyHistoryCsrfToken="",a}const t=e.force===!0,n=Date.now(),r=e.metaOnly===!0?"?meta=1":typeof hn=="function"?hn():"";if(!t&&o.energyHistoryFetchPromise&&o.energyHistoryFetchQuery===r)return o.energyHistoryFetchPromise;if(!t&&o.energyHistoryRequestQuery===r&&(o.energyHistoryRaw||o.energyHistoryError)&&n-Number(o.energyHistoryLastFetchAt||0)<Ws)return!1;o.energyHistoryFetchQuery=r,o.energyHistoryFetchPromise=(async()=>{const a=async f=>{const S=await fetch(`${Xe()}/energy/history${f}`,{cache:"no-store"});if(!S.ok)throw new Error(`HTTP ${S.status}`);return S.text()};let i=r,l=await a(i);if(e.metaOnly!==!0&&i.includes("meta=1")&&typeof hn=="function"){const f=o.energyHistoryRaw;o.energyHistoryRaw=l;const S=hn();o.energyHistoryRaw=f,S&&S!==i&&(i=S,l=await a(i))}const c=l.split(/\r?\n/),d=Il(l)||o.energyHistoryCsrfToken;let u=Number.NaN;c.forEach(f=>{f.startsWith("@now|")&&(u=Number(f.slice(5)))});const g=`${l.length}|${l.slice(0,120)}|${l.slice(-120)}`,b=Number.isFinite(o.energyHistoryNowMs),y=Number.isFinite(u)?!b||o.energyHistoryNowMs!==u:b,p=l!==o.energyHistoryRaw||o.energyHistoryError!==""||o.energyHistorySignature!==g||y||d!==o.energyHistoryCsrfToken;return o.energyHistoryRaw=l,o.energyHistoryError="",o.energyHistorySignature=g,o.energyHistoryNowMs=Number.isFinite(u)?u:Number.NaN,o.energyHistoryLastFetchAt=Date.now(),o.energyHistoryRequestQuery=i,o.energyHistoryCsrfToken=d,p})();try{return await o.energyHistoryFetchPromise}catch(a){const i=`Energiehistorie kon niet worden geladen. ${a.message}`,l=o.energyHistoryError!==i;return o.energyHistoryError=i,o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryNowMs=Number.NaN,o.energyHistoryLastFetchAt=Date.now(),o.energyHistoryRequestQuery=r,o.energyHistoryCsrfToken="",l}finally{o.energyHistoryFetchPromise=null}}function Cm(){o.complete=uc(),o.stage=o.complete===!0?"Gereed":o.complete===!1?"Quick Start":"Laden...",o.summary=dh(),o.appView==="diagnosis"&&!po()&&Et(eo(),{syncMode:"replace",forceSync:!0}),o.appView||Et(fa()||eo(),{syncMode:"replace",forceSync:!0})}function Tm(){const e=Ir();return o.appView==="settings"?[...new Set([...e,...Va()])]:o.appView==="energy"||o.appView==="results"?xo(o.appView,{forceFast:!0}):o.appView==="overview"||o.appView==="diagnosis"?xo(o.appView,{forceFast:!0}):[...new Set(e)]}function Em(e=[]){const t=new Set(e);return(o.appView==="settings"?Va():o.appView==="overview"||o.appView==="diagnosis"?[...new Set([...xo(o.appView,{includeBulk:!0}),...Mt])]:o.appView==="energy"||o.appView==="results"?[...new Set([...xo(o.appView,{forceFast:!0}),...Mt])]:[...new Set(["setupComplete","strategy",...ze])]).filter(r=>!t.has(r))}async function $m(e,t="state"){if(!(!e.length||o.nativeOpen)){o.entitySyncInFlight=!0;try{await D(e,t,{concurrency:t==="all"?At:_o})}finally{o.entitySyncInFlight=!1;const n=o.pendingEntitySyncOptions;o.pendingEntitySyncOptions=null,n&&!o.nativeOpen&&window.setTimeout(()=>{ae(n)},0)}o.mounted&&!o.nativeOpen&&m()}}function oc(){if(o.nativeOpen||o.appView!=="settings")return;const e=()=>{if(!(o.nativeOpen||o.appView!=="settings")){if(o.loadingEntities||o.focusedField||o.draggingCurveKey||o.busyAction||o.settingsInteractionLock){window.setTimeout(oc,250);return}ae({prefetchView:"overview",forceFast:!0})}};if(typeof window.requestIdleCallback=="function"){window.requestIdleCallback(e,{timeout:2e3});return}window.setTimeout(e,0)}function ts(e=Date.now(),t={}){return t.forceBulk===!0?!0:e-Number(o.lastBulkEntitySyncAt||0)>=kd}async function Am(){if(!o.nativeOpen)try{Ka()&&await _l(),(o.appView==="overview"||o.appView==="diagnosis")&&await Ua({force:!0}),o.appView==="results"&&await Nt({force:!0}),await co({force:!0}),Qn()&&await uo({force:!0})}finally{o.mounted&&!o.nativeOpen&&m(),oc()}}async function Hm(){if(o.nativeOpen)return;o.loadingEntities=!0,m();const e=$g();e>0&&await new Promise(i=>window.setTimeout(i,e));const t=Tm(),n=Em(t),r=o.appView==="settings"?"all":"state";try{await D(t,r,{concurrency:r==="all"?At:_o}),o.appView==="settings"?await Ug():await Kg()}finally{o.loadingEntities=!1,m()}const a=o.appView==="settings"?"all":"state";window.setTimeout(()=>{$m(n,a)},Fg),Vl(_a())}async function ae(e={}){if(o.nativeOpen||o.loadingEntities||o.draggingCurveKey||o.busyAction||o.settingsInteractionLock)return;if(o.updateInstallBusy||yl()){o.pendingEntitySyncOptions=null;return}if(o.focusedField&&o.appView!=="settings")return;if(o.entitySyncInFlight){Vg(e);return}const t=Date.now();if(document.hidden&&t-Number(o.lastEntitySyncAttemptAt||0)<ua)return;const n=o.appView,r=e.prefetchView==="overview"&&!e.forceBulk&&n==="settings",a=r?"overview":n,i=a==="overview"||a==="diagnosis"||a==="energy"||a==="results",l=e.forceFast===!0&&!e.forceBulk,c=!l&&!r&&ts(t,e),u=t-Number(o.lastStaticEntitySyncAt||0)>=Cd||o.updateInstallBusy||o.updateInstallPhaseHint?Mt:[],g=o.quickStartModalOpen&&o.currentStep==="flow-source"?Je:[],b=o.quickStartModalOpen&&o.currentStep==="thermostat-source"?Ho:[],h=o.appView==="settings"&&o.systemModal==="history-storage"?Eo():[],y=r?[...Xs,...ze,"setupComplete",...u]:i?[...xo(a,{forceFast:l,includeBulk:c}),...u]:n==="settings"?[...new Set([...Va(),...h,...u])]:c?["setupComplete",...u,...ze,"strategy",...jo,...Ye,...ce()?pe.map(p=>p.key):Ht]:["setupComplete",...ze,"strategy",...u];o.entitySyncInFlight=!0,o.lastEntitySyncAttemptAt=t;try{const p=o.deviceReconnectMode,f=Xg(t,e)?await em():{ok:!0,message:""};if(!f.ok){zl(f.message),r||m();return}if(await D([...new Set([...y,...g,...b])],r?"state":n==="settings"?"all":"state",{concurrency:l&&i?_o:At}),o.lastFastEntitySyncAt=Date.now(),c&&(a==="overview"||a==="diagnosis")&&!r&&(o.lastBulkEntitySyncAt=o.lastFastEntitySyncAt),u.length&&(o.lastStaticEntitySyncAt=o.lastFastEntitySyncAt),r)return;i&&!o.overviewMetadataHydrated&&!o.overviewMetadataHydrating&&_l();const S=p!==o.deviceReconnectMode,w=l&&i,q=w?!1:a==="overview"||a==="diagnosis"?await Ua():!1,T=w?!1:o.appView==="results"?await Nt():!1,k=w||!im()?!1:await co(),M=w||!sm()?!1:await uo(),x=Or();if(w&&!o.nativeOpen&&Vl(_a(a)),S){m();return}if(q&&o.appView==="diagnosis"&&!o.root?.querySelector(".oq-overview-trends")){m();return}if(T&&o.appView==="results"&&!o.root?.querySelector(".oq-energy-history")){m();return}if(k&&(o.systemModal==="login"||Qn())){m();return}if(M&&o.appView==="settings"){m();return}const F=!!(o.updateModalOpen||o.systemModal||o.interfacePanelOpen);if(x!==o.headerRenderSignature)if(F&&Fr())o.headerRenderSignature=x;else{m();return}else Fr();if(o.appView==="settings"&&String(o.systemModal||"").startsWith("service-task-")){Vr()!==o.settingsRenderSignature&&m();return}if(F)return;if(o.appView==="settings"){const U=Vr();if(U!==o.settingsRenderSignature&&!o.focusedField){m();return}if(!_f()){o.focusedField||m();return}o.focusedField&&(o.settingsRenderSignature=U);return}if(o.appView==="diagnosis"){Nv()||m();return}if(o.appView==="energy"){hy()||m();return}if(o.appView==="results"){fy()||m();return}_y()||m()}catch(p){r||(o.controlError=`Helperstatus kon niet worden geladen. ${p.message}`,m())}finally{o.entitySyncInFlight=!1;const p=o.pendingEntitySyncOptions;o.pendingEntitySyncOptions=null,p&&!o.nativeOpen&&window.setTimeout(()=>{ae(p)},0),l&&(a==="overview"||a==="diagnosis")&&!r&&!o.nativeOpen&&!p&&ts(Date.now())&&window.setTimeout(()=>{ae({forceBulk:!0})},Ig)}}function os(){window.setTimeout(()=>{const e=document.activeElement;o.focusedField=e&&e.dataset&&e.dataset.oqField||"",o.settingsInteractionLock=!!(e&&e.closest&&e.closest(".oq-ph-concept-hotspot"))},0)}function Mm(e){e.target.closest(".oq-ph-concept-hotspot")&&(o.settingsInteractionLock=!0)}function Pm(e){const t=e.target.closest(".oq-ph-concept-hotspot");if(!t||e.relatedTarget&&t.contains(e.relatedTarget))return;const n=o.root&&o.root.querySelector(".oq-ph-concept-hotspot:hover"),r=document.activeElement&&document.activeElement.closest?document.activeElement.closest(".oq-ph-concept-hotspot"):null;o.settingsInteractionLock=!!(n||r)}function re(e){const t=o.entities[e];if(!t)return o.optionalMissingEntities?.[e]?`${e}:__optional_missing__`:`${e}:__missing__`;const n=t.state??t.value??"",r=Array.isArray(t.option)?t.option.join(","):Array.isArray(t.options)?t.options.join(","):"",a=[t.min_value??"",t.max_value??"",t.step??"",t.uom??""].join(",");return`${e}:${n}::${r}::${a}`}function Vr(){return[o.appView,o.settingsGroup,o.busyAction,o.loadingEntities?"loading":"ready",Wr(),re("setupComplete"),...tl.map(e=>re(e))].join("|")}function be(e){try{return JSON.stringify(e)}catch{return String(e??"")}}function nc(){return[o.appView,o.busyAction,re("openquattEnabled"),re("openquattResumeAt"),re("manualCoolingEnable"),re("silentModeOverride"),re("controlModeLabel"),re("coolingPermitted"),re("coolingRequestActive"),re("coolingBlockReason"),re("silentActive")].join("|")}function Nm(e){if(e.target.dataset.oqFirmwareConnectionConfirm){o.firmwareConnectionSwitchConfirmed=!!e.target.checked,m();return}if(e.target.dataset.oqFirmwareTopologyConfirm){o.firmwareTopologySwitchConfirmed=!!e.target.checked,m();return}if(e.target.dataset.oqFirmwareTestConfirm){o.updateTestFirmwareConfirmed=!!e.target.checked,o.updateTestFirmwareError="";const n=e.target.closest(".oq-helper-modal-callout"),r=n?.querySelector('[data-oq-action="install-firmware-test"]');r&&(r.disabled=!o.updateTestFirmwareConfirmed||!Fo()),n?.querySelector('[data-oq-firmware-test-runtime-error="true"]')?.remove();return}if(e.target.dataset.oqFirmwareTestPr){o.updateTestFirmwarePr=String(e.target.value||""),o.updateTestFirmwareConfirmed=!1,o.updateTestFirmwareError="",o.updateTestFirmwareBuild=null;const n=e.target.closest(".oq-helper-modal-callout"),r=n?.querySelector('[data-oq-firmware-test-confirm="true"]');r&&(r.checked=!1);const a=n?.querySelector('[data-oq-action="install-firmware-test"]');a&&(a.disabled=!0);const i=_n(),l=qa(Fo(),i),c=n?.querySelector('[data-oq-firmware-test-asset-note="true"]');c&&(c.textContent=l?i.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen."),n?.querySelector('[data-oq-firmware-test-build-row="true"]')?.remove(),n?.querySelector('[data-oq-firmware-test-runtime-error="true"]')?.remove();return}const t=e.target.dataset.oqField;if(!t){if(e.target.dataset.oqQuickstartCicUrl!==void 0){o.quickStartCicFeedUrlDraft=String(e.target.value||"");return}if(e.target.dataset.oqQuickstartThermostatSource!==void 0){o.quickStartThermostatSourceDraft=String(e.target.value||""),m();return}const n=e.target.dataset.oqAuthField;if(!n)return;o.authNotice="",o.authError="",n==="username"?o.authDraftUsername=String(e.target.value||""):n==="currentPassword"?o.authDraftCurrentPassword=String(e.target.value||""):n==="newPassword"?o.authDraftNewPassword=String(e.target.value||""):n==="confirmPassword"&&(o.authDraftConfirmPassword=String(e.target.value||""));return}if(e.target.dataset.oqPauseDraft){o.pauseResumeDraft=String(e.target.value||"");return}if(L[t]?.domain==="text"){o.inputDrafts[t]=String(e.target.value||"");return}if(e.target.type==="range"||e.target.type==="number"){e.target.type==="number"&&(o.inputDrafts[t]=e.target.value);const n=Ze(e.target.value);if(!Number.isNaN(n)){const r=we(t,e.target.value);if(o.drafts[t]=r,e.target.type==="range"){const a=e.target.closest(".oq-helper-slider-field")?.querySelector(".oq-helper-slider-meta strong");a&&(a.textContent=j(t,r))}}}}function Rm(e){Zf(e)}function ns(e,t){return e.deltaMode===1?t*16:e.deltaMode===2?t*window.innerHeight:t}function Lm(e){let t=e?e.parentElement:null;for(;t&&t!==document.body&&t!==document.documentElement;){const n=window.getComputedStyle(t),r=/(auto|scroll)/.test(n.overflowY)&&t.scrollHeight>t.clientHeight,a=/(auto|scroll)/.test(n.overflowX)&&t.scrollWidth>t.clientWidth;if(r||a)return t;t=t.parentElement}return document.scrollingElement||document.documentElement}function Om(e){const t=e.target&&e.target.closest?e.target.closest('input[type="number"]'):null;if(!t||!o.root||!o.root.contains(t)||document.activeElement!==t)return;e.preventDefault(),t.blur();const n=Lm(t);n&&typeof n.scrollBy=="function"&&n.scrollBy({left:ns(e,e.deltaX||0),top:ns(e,e.deltaY||0),behavior:"auto"})}function Fm(e){if(e.target.dataset.oqDevControl==="boiler"&&typeof window.__OQ_SET_MOCK_BOILER__=="function"){window.__OQ_SET_MOCK_BOILER__(e.target.value);return}if(e.target.dataset.oqBackupFileInput){const r=e.target.files&&e.target.files[0]?e.target.files[0]:null;e.target.value="",qm(r);return}if(e.target.dataset.oqFirmwareUploadFileInput){const r=e.target.files&&e.target.files[0]?e.target.files[0]:null;e.target.value="",r?(o.firmwareAdvancedOpen=!0,o.updateManualUploadOpen=!0,o.updateManualUploadFile=r,o.updateManualUploadFileName=r.name||"",o.updateManualUploadError=""):fe(),m();return}if(e.target.dataset.oqEnergyHistoryPeriodInput){typeof Fn=="function"&&Fn(e.target.dataset.oqEnergyHistoryPeriodInput,e.target.value);return}if(e.target.dataset.oqEnergyHistoryExportMode!==void 0){o.energyHistoryExportMode=zn(e.target.value),o.energyHistoryExportError="",o.energyHistoryExportNotice="",m();return}const t=e.target.dataset.oqField;if(!t)return;const n=L[t];if(n){if(n.domain==="select"){_r(t,String(e.target.value));return}if(n.domain==="number"){za(t,e.target.value);return}if(n.domain==="text"){rh(t,e.target.value);return}if(n.domain==="time"){const r=so(e.target.value);if(!r){o.controlError=`${n.name} verwacht tijd als HH:MM.`,m();return}nh(t,r);return}if(n.domain==="datetime"){const r=ot(e.target.value);if(!r){o.controlError=`${n.name} verwacht datum en tijd.`,m();return}ah(t,r);return}}}function xm(e){const t=e.target.closest(".oq-settings-control--time, .oq-settings-control--datetime");if(t){const u=t.querySelector("input[data-oq-field]");if(u&&(u.type==="time"||u.type==="datetime-local")&&typeof u.showPicker=="function")try{u.showPicker()}catch{}}const n=e.target.closest('[data-oq-action="toggle-settings-info"]'),r=e.target.closest("[data-oq-settings-info]"),a=e.target.closest(".oq-helper-hub"),i=e.target.closest("[data-oq-modal]");if(n){const u=n.dataset.infoId||"";o.settingsInfoOpen=o.settingsInfoOpen===u?"":u,m();return}const l=e.target.closest("[data-oq-action]"),c=o.interfacePanelOpen&&!a;if(!l){let u=!1;if(o.settingsInfoOpen&&!r&&(o.settingsInfoOpen="",u=!0),c&&(wr(!1),u=!0),i&&e.target===i){if(i.dataset.oqModal==="quickstart-forced")return;o.updateModalOpen&&(o.updateModalOpen=!1,o.firmwareAdvancedOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareTopologySwitchOpen=!1,o.updateManualUploadOpen=!1,o.updateTestFirmwareOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),xe(),u=!0),o.systemModal&&(Br(),wn(),o.systemModal="",u=!0)}u&&m();return}c&&l.dataset.oqAction!=="toggle-interface-panel"&&wr(!1);const d=l.dataset.oqAction;if(d==="set-mock-boiler"&&typeof window.__OQ_SET_MOCK_BOILER__=="function"){window.__OQ_SET_MOCK_BOILER__(l.dataset.boilerMode||"off");return}if(d==="toggle-interface-panel"){wr(!o.interfacePanelOpen),m();return}if(d==="toggle-dev-panel"){Id(!o.devPanelOpen),m();return}if(d==="toggle-installation-monitoring-details"){e.preventDefault();const u=l.closest(".oq-settings-monitoring-details");o.installationMonitoringDetailsOpen=!(u&&u.hasAttribute("open")),m();return}if(d==="toggle-integration-diagnostics"){e.preventDefault();const u=l.closest(".oq-settings-integration-diagnostics");o.integrationDiagnosticsOpen=!(u&&u.hasAttribute("open")),m();return}if(d==="toggle-odu-runtime-frequency-details"){e.preventDefault();const u=l.closest(".oq-settings-odu-runtime-details");o.oduRuntimeFrequencyDetailsOpen=!(u&&u.hasAttribute("open")),m();return}if(d==="toggle-storage-technical-details"){e.preventDefault();const u=l.closest(".oq-settings-storage-technical");o.settingsStorageDetailsOpen=!(u&&u.hasAttribute("open")),m();return}if(d==="select-view"){if((l.dataset.viewId||"")==="diagnosis"&&!po())return;const u=l.dataset.viewId||"overview";Et(u,{syncMode:"push"}),m(),ae({forceFast:!0});return}if(d==="select-trend-window"){if(l.disabled)return;pa(Number(l.dataset.trendHours||24)),m(),Ua({force:!0}).then(u=>{u&&m()});return}if(d==="select-energy-history-view"){if(l.disabled||typeof Ms!="function")return;Ms(l.dataset.energyHistoryView||"day");return}if(d==="shift-energy-history-period"){if(l.disabled||typeof Ls!="function")return;Ls(o.energyHistoryView||"day",l.dataset.energyHistoryDirection||"1");return}if(d==="select-energy-history-now"){if(l.disabled||typeof Os!="function")return;Os(o.energyHistoryView||"day");return}if(d==="select-settings-group"){vn(l.dataset.groupId||Se[0].id),m(),ae({forceFast:!0});return}if(d==="open-update-modal"){o.updateModalOpen=!0,m(),Ym();return}if(d==="open-webserver-log-modal"){xh();return}if(d==="open-debug-recording-modal"){o.systemModal="debug-recording",o.debugRecordingError="",o.debugRecordingNotice="",m(),ei();return}if(d==="open-login-modal"){o.systemModal="login",Ql(),o.authNotice="",o.authError="",m(),lm({poll:!0});return}if(d==="open-api-security-modal"){o.systemModal="api-security",o.apiSecurityNotice="",o.apiSecurityError="",m(),uo({force:!0});return}if(d==="copy-api-security-key"){gm();return}if(d==="enable-api-security"){um();return}if(d==="rotate-api-security"){dm();return}if(d==="disable-api-security"){pm();return}if(d==="restart-api-security"){cm();return}if(d==="flush-trend-history"){Ut("trendHistoryFlush",{successNotice:"Diagnosegeschiedenis is opgeslagen.",errorPrefix:"Diagnosegeschiedenis kon niet worden opgeslagen",refreshKeys:Eo(),refreshDelayMs:500}).then(()=>{Co()});return}if(d==="save-lifetime-energy-history"){Ut("lifetimeEnergyHistoryCapture",{successNotice:"Energiehistorie is opgeslagen.",errorPrefix:"Energiehistorie kon niet worden opgeslagen",refreshKeys:Eo(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,Co(),o.appView==="results"&&Nt({force:!0}).then(()=>m())});return}if(d==="clear-lifetime-energy-history"){if(!window.confirm(`Energiehistorie wissen?

Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return;Ut("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:Eo(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,Co(),o.appView==="results"&&Nt({force:!0}).then(()=>m())});return}if(d==="select-energy-history-import-file"){Tg();return}if(d==="clear-energy-history-import-file"){Nl(),m();return}if(d==="import-energy-history-file"){Eg();return}if(d==="export-energy-history"){lg();return}if(d==="open-history-storage-modal"){o.systemModal="history-storage",m(),Ba({forceMissing:!0}).finally(()=>{o.systemModal==="history-storage"&&m()}),Co([1e3,3e3,7e3]);return}if(d==="open-connectivity-modal"){o.systemModal="connectivity",m();return}if(d==="open-restart-confirm"){o.systemModal="restart-confirm",m();return}if(d==="download-settings-backup"){Sm();return}if(d==="open-settings-backup-import"){o.systemModal="settings-backup-import",m();return}if(d==="open-silent-settings-modal"){o.systemModal="silent-settings",m();return}if(d==="open-openquatt-pause-modal"){o.pauseResumeDraft=Ml(),o.systemModal="openquatt-pause",m();return}if(d==="enable-openquatt-now"){lh();return}if(d==="apply-openquatt-preset"){const u=Hl(l.dataset.pausePreset||"");o.pauseResumeDraft=u,kr(u);return}if(d==="apply-openquatt-indefinite"){kr("");return}if(d==="apply-openquatt-custom-pause"){if(!String(o.pauseResumeDraft||"").trim()){o.controlError="Kies eerst een datum en tijd om automatisch te hervatten.",m();return}kr(o.pauseResumeDraft||"");return}if(d==="close-update-modal"){o.updateModalOpen=!1,o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.firmwareAdvancedOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareTopologySwitchOpen=!1,o.updateManualUploadOpen=!1,o.updateTestFirmwareOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),xe(),m();return}if(d==="close-quickstart-modal"){o.quickStartModalOpen=!1,m();return}if(d==="open-quickstart-modal"){o.currentStep="generation",o.quickStartModalMode="wizard",o.quickStartModalOpen=!0,m();return}if(d==="open-generation-modal"){o.currentStep="generation",o.quickStartModalMode="generation",o.quickStartModalOpen=!0,m();return}if(d==="open-cm100-commissioning-modal"){o.systemModal="",Et("settings"),vn("service"),m(),ae({forceFast:!0});return}if(d==="open-installation-monitoring"){o.systemModal="",Et("settings"),vn("service"),m(),ae({forceFast:!0});return}if(d==="open-service-task-modal"){const u=String(l.dataset.serviceTask||"").trim();["autotune","boiler","purge","manual-flow","manual-hp","hp-water-calibration"].includes(u)&&(o.systemModal=`service-task-${u}`,m(),ae({forceFast:!0}));return}if(d==="press-named-button"){const u=String(l.dataset.oqButtonKey||l.dataset.buttonKey||l.getAttribute("data-oq-button-key")||"").trim();if(u){u==="commissioningCm100Start"?(o.pendingCommissioningCm100Start=!0,o.commissioningTaskLock="cm100",o.commissioningBoilerHeatPowerDisplay=""):u==="commissioningCm100Stop"?(o.pendingCommissioningCm100Start=!1,o.pendingBoilerPowerTestStart=!1,o.pendingFlowAutotuneStart=!1,o.pendingAirPurgeStart=!1,o.pendingManualFlowStart=!1,o.pendingManualHpStart=!1,o.pendingHpWaterCalibrationStart=!1,o.commissioningTaskLock="",o.commissioningBoilerHeatPowerDisplay=""):u==="boilerPowerTestStart"?(o.pendingBoilerPowerTestStart=!0,o.pendingFlowAutotuneStart=!1,o.pendingAirPurgeStart=!1,o.pendingManualFlowStart=!1,o.pendingManualHpStart=!1,o.pendingHpWaterCalibrationStart=!1,o.commissioningTaskLock="boiler",o.commissioningBoilerHeatPowerDisplay=""):u==="boilerPowerTestAbort"||u==="boilerPowerTestApply"?o.commissioningTaskLock="boiler":u==="flowAutotuneStart"?(o.pendingFlowAutotuneStart=!0,o.pendingBoilerPowerTestStart=!1,o.pendingAirPurgeStart=!1,o.pendingManualFlowStart=!1,o.pendingManualHpStart=!1,o.pendingHpWaterCalibrationStart=!1,o.commissioningTaskLock="autotune"):u==="flowAutotuneAbort"||u==="flowAutotuneApply"?o.commissioningTaskLock="autotune":u==="airPurgeStart"?(o.pendingAirPurgeStart=!0,o.pendingBoilerPowerTestStart=!1,o.pendingFlowAutotuneStart=!1,o.pendingManualFlowStart=!1,o.pendingManualHpStart=!1,o.pendingHpWaterCalibrationStart=!1,o.commissioningTaskLock="purge"):u==="airPurgeAbort"?o.commissioningTaskLock="purge":u==="manualFlowStart"?(o.pendingManualFlowStart=!0,o.pendingBoilerPowerTestStart=!1,o.pendingFlowAutotuneStart=!1,o.pendingAirPurgeStart=!1,o.pendingManualHpStart=!1,o.pendingHpWaterCalibrationStart=!1,o.commissioningTaskLock="manual-flow"):u==="manualFlowAbort"?o.commissioningTaskLock="manual-flow":u==="manualHpStart"?(o.pendingManualHpStart=!0,o.pendingBoilerPowerTestStart=!1,o.pendingFlowAutotuneStart=!1,o.pendingAirPurgeStart=!1,o.pendingManualFlowStart=!1,o.pendingHpWaterCalibrationStart=!1,o.commissioningTaskLock="manual-hp"):u==="hpWaterCalibrationStart"?(o.pendingHpWaterCalibrationStart=!0,o.pendingBoilerPowerTestStart=!1,o.pendingFlowAutotuneStart=!1,o.pendingAirPurgeStart=!1,o.pendingManualFlowStart=!1,o.pendingManualHpStart=!1,o.commissioningTaskLock="hp-water-calibration"):u==="hpWaterCalibrationAbort"||u==="hpWaterCalibrationApply"?o.commissioningTaskLock="hp-water-calibration":u==="manualHpAbort"&&(o.commissioningTaskLock="manual-hp");const g=[];let b=0,h="",y="";if(u==="acknowledgeCompressorCyclingAlert")g.push(...aa);else if(u==="commissioningCm100Start"||u==="commissioningCm100Stop")g.push("commissioningStatus","cm100Active","boilerPowerTestStatus","boilerPowerTestActive","flowAutotuneStatus","airPurgeStatus","airPurgeActive","manualFlowStatus","manualFlowActive","manualHpStatus","manualHpGuardStatus","manualHpActive","hpWaterCalibrationStatus","hpWaterCalibrationActive");else if(u==="boilerPowerTestStart"||u==="boilerPowerTestAbort"||u==="boilerPowerTestApply")g.push("commissioningStatus","boilerPowerTestStatus","boilerPowerTestActive","boilerHeatPower","boilerPowerTestResult","boilerRatedHeatPower");else if(u==="flowAutotuneStart"||u==="flowAutotuneAbort"||u==="flowAutotuneApply")g.push("commissioningStatus","flowAutotuneStatus","flowKpSuggested","flowKiSuggested","flowKp","flowKi");else if(u==="airPurgeStart"||u==="airPurgeAbort")g.push("commissioningStatus","airPurgeStatus","airPurgeActive","airPurgeRemaining","airPurgePhase","airPurgeTargetIpwm","flowMode");else if(u==="hpWaterCalibrationStart"||u==="hpWaterCalibrationAbort"||u==="hpWaterCalibrationApply")g.push("commissioningStatus","hpWaterCalibrationStatus","hpWaterCalibrationActive","hpWaterCalibrationRemaining","hpWaterCalibrationPhase","hpWaterCalibrationSpread","hpWaterCalibrationSupplyDelta","hpWaterCalibrationStableProgress","hpWaterCalibrationStableRequired","hpWaterCalibrationResultReference","hpWaterCalibrationResultSpreadBefore","hpWaterCalibrationResultExpectedSpread","hpWaterCalibrationResultHp1InRawAvg","hpWaterCalibrationResultHp1OutRawAvg","hpWaterCalibrationResultHp2InRawAvg","hpWaterCalibrationResultHp2OutRawAvg","hp1WaterInRaw","hp1WaterOutRaw","hp2WaterInRaw","hp2WaterOutRaw","hp1WaterIn","hp1WaterOut","hp2WaterIn","hp2WaterOut","hp1WaterInOffset","hp1WaterOutOffset","hp2WaterInOffset","hp2WaterOutOffset","hp1WaterInOffsetSuggested","hp1WaterOutOffsetSuggested","hp2WaterInOffsetSuggested","hp2WaterOutOffsetSuggested","flowMode");else if(u==="manualFlowStart"||u==="manualFlowAbort"||u==="manualFlowApplyHeating"||u==="manualFlowApplyCooling")g.push("commissioningStatus","manualFlowStatus","manualFlowActive","manualFlowSetpoint","manualFlowTargetIpwm","flowSelected","flowMode","flowSetpoint","coolingFlowSetpoint");else if(u==="manualHpStart"||u==="manualHpAbort")g.push("commissioningStatus","manualHpStatus","manualHpGuardStatus","manualHpActive","manualHp1Mode","manualHp2Mode","manualHp1Level","manualHp2Level","flowSelected","hp1Compressor","hp1Freq","hp1Failures","hp2Compressor","hp2Freq","hp2Failures","hp1Mode","hp2Mode");else if(js.has(u)){const p=gd(u);p&&(g.push(..._s(p)),b=u.endsWith("Load")?1200:3200,h=u.endsWith("Load")?`HP${p} ODU runtime tabel lezen aangevraagd.`:`HP${p} ODU runtime write aangevraagd; controleer status/readback.`,y=`ODU runtime actie mislukt voor HP${p}`)}Ut(u,{...g.length?{refreshKeys:g}:{},...b?{refreshDelayMs:b}:{},...h?{successNotice:h}:{},...y?{errorPrefix:y}:{}})}return}if(d==="close-system-modal"){wn(),mo(),o.systemModal="",o.authDraftCurrentPassword="",o.authDraftNewPassword="",o.authDraftConfirmPassword="",o.authNotice="",o.authError="",o.apiSecurityNotice="",o.apiSecurityError="",Br(),m(),or();return}if(d==="clear-webserver-log-output"){Jn();return}if(d==="copy-webserver-log-output"){tf();return}if(d==="start-debug-recording"){hf(l.dataset.debugMinutes||15);return}if(d==="start-rolling-debug-recording"){ff();return}if(d==="select-debug-recording-duration"){af(l.dataset.debugMinutes||15);return}if(d==="stop-debug-recording"){yf();return}if(d==="freeze-debug-recording"){vf();return}if(d==="download-debug-recording"){Cf();return}if(d==="copy-debug-recording"){Tf();return}if(d==="confirm-settings-backup-restore"){km();return}if(d==="confirm-restart"){Ut("restartAction",{successNotice:"OpenQuatt wordt opnieuw opgestart. Wacht even tot de webinterface weer terugkomt.",errorPrefix:"Herstart mislukt",reconnectMode:"restart"});return}if(d==="select-surface"){const u=l.dataset.surface==="native";if(o.nativeOpen===u){o.nativeOpen&&Lr();return}o.nativeOpen=u,nl(o.nativeOpen?"native":"app"),o.controlError="",o.controlNotice="",o.settingsInfoOpen="",o.updateModalOpen=!1,o.firmwareAdvancedOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareTopologySwitchOpen=!1,o.updateManualUploadOpen=!1,o.updateTestFirmwareOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),xe(),wn(),o.systemModal="",o.nativeOpen&&Lr(),m(),ha(),window.requestAnimationFrame(()=>{o.nativeOpen?o.nativeApp&&o.nativeApp.scrollIntoView({behavior:"smooth",block:"start"}):window.scrollTo({top:0,behavior:"smooth"})});return}if(d==="toggle-overview-theme"){Ld(o.overviewTheme==="light"?"dark":"light"),m();return}if(d==="select-hp-visual"){Bd(l.dataset.hpVisual==="compact"?"compact":"schematic"),m();return}if(d==="select-hp-layout"){_d(l.dataset.hpLayout||"equal"),m();return}if(d==="select-step"){o.currentStep=l.dataset.stepId||"generation",m(),qr(o.currentStep);return}if(d==="apply-quickstart-flow-source"){Vm();return}if(d==="refresh-quickstart-flow-signal"){_m();return}if(d==="start-quickstart-flow-test"){Um();return}if(d==="abort-quickstart-flow-test"){zm();return}if(d==="apply-quickstart-thermostat-source"){Gm();return}if(d==="previous-step"){$s(-1),m(),qr(o.currentStep);return}if(d==="next-step"){$s(1),m(),qr(o.currentStep);return}if(d==="select-settings-option"){const u=l.dataset.selectKey||"",g=l.dataset.selectOption||"";u&&g&&String(E(u)||"")!==g&&_r(u,g);return}if(d==="toggle-overview-control"){const u=l.dataset.controlKey||"",g=(l.dataset.controlState||"").toLowerCase();u&&(g==="on"||g==="off")&&Bm(u,g==="on");return}if(d==="select-overview-control-option"){const u=l.dataset.controlKey||"",g=l.dataset.controlOption||"";u&&g&&String(E(u)||"")!==g&&_r(u,g);return}if(d==="suggest-curve-fallback"){const u=jl();u&&za("curveFallbackSupply",u.value,"Fallback-aanvoertemperatuur uit de stooklijn overgenomen.");return}if(d==="apply"||d==="reset"){ch(d);return}if(d==="run-firmware-check"){Qm();return}if(d==="install-firmware-update"){Jm();return}if(d==="install-firmware-connection-switch"){Zm();return}if(d==="install-firmware-topology-switch"){Xm();return}if(d==="toggle-firmware-advanced"){o.firmwareAdvancedOpen||o.firmwareConnectionSwitchOpen||o.firmwareTopologySwitchOpen||o.updateManualUploadOpen||o.updateTestFirmwareOpen?(o.firmwareAdvancedOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchOpen=!1,o.firmwareTopologySwitchConfirmed=!1,o.updateManualUploadOpen=!1,o.updateTestFirmwareOpen=!1,fe(),xe()):o.firmwareAdvancedOpen=!0,m();return}if(d==="toggle-firmware-connection-switch"){o.firmwareConnectionSwitchOpen=!o.firmwareConnectionSwitchOpen,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareConnectionSwitchOpen&&(o.firmwareAdvancedOpen=!0,o.firmwareTopologySwitchOpen=!1,o.firmwareTopologySwitchConfirmed=!1,o.updateManualUploadOpen=!1,o.updateTestFirmwareOpen=!1,fe(),xe()),m();return}if(d==="toggle-firmware-topology-switch"){o.firmwareTopologySwitchOpen=!o.firmwareTopologySwitchOpen,o.firmwareTopologySwitchConfirmed=!1,o.firmwareTopologySwitchOpen&&(o.firmwareAdvancedOpen=!0,o.firmwareConnectionSwitchOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.updateManualUploadOpen=!1,o.updateTestFirmwareOpen=!1,fe(),xe()),m();return}if(d==="toggle-firmware-upload"){o.updateManualUploadOpen?(o.updateManualUploadOpen=!1,fe()):(o.firmwareAdvancedOpen=!0,o.updateManualUploadOpen=!0,o.firmwareConnectionSwitchOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchOpen=!1,o.firmwareTopologySwitchConfirmed=!1,o.updateTestFirmwareOpen=!1,xe(),o.updateManualUploadError=""),m();return}if(d==="upload-firmware-file"){oh();return}if(d==="toggle-firmware-test"){o.updateTestFirmwareOpen?(o.updateTestFirmwareOpen=!1,xe()):(o.firmwareAdvancedOpen=!0,o.updateTestFirmwareOpen=!0,o.updateManualUploadOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchOpen=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),o.updateTestFirmwareError=""),m();return}if(d==="install-firmware-test"){th();return}if(d==="save-web-auth"){ih();return}if(d==="disable-web-auth"){sh();return}}function Dm(e){const t=e.target.closest("[data-curve-key]");!t||!ce()||(o.draggingCurveKey=t.dataset.curveKey||"",sc(e.clientY))}function Im(e){typeof xs=="function"&&xs(e),o.draggingCurveKey&&sc(e.clientY)}function Wm(){if(!o.draggingCurveKey)return;const e=o.draggingCurveKey,t=we(e,E(e));o.draggingCurveKey="",za(e,t,"Curvepunt bijgewerkt.")}async function _r(e,t){const n=L[e];o.busyAction=`save-${e}`,o.controlNotice="",o.controlError="",o.entities[e]={...o.entities[e]||{},state:t,value:t},m();try{const r=await fetch(`${G(n.domain,n.name,"set")}?option=${encodeURIComponent(t)}`,{method:"POST"});if(!r.ok)throw new Error(`HTTP ${r.status}`);delete o.drafts[e],delete o.inputDrafts[e],o.controlNotice=`${n.name} bijgewerkt.`,e==="firmwareUpdateChannel"?(o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.entities.firmwareUpdateChannel={...o.entities.firmwareUpdateChannel||{},state:t,value:t},Ra(t),m(),await La(),o.controlNotice="Releasekanaal bijgewerkt."):e==="debugLevel"?(o.controlNotice="Logger level bijgewerkt.",o.systemModal==="webserver-logs"&&Pn()):e==="webServerLogHistoryEnabled"?(enabled?(o.webServerLogHistoryLoaded=!1,Pn()):Jn(),o.systemModal==="webserver-logs"&&m()):o.appView==="settings"?await D(lo(),"all"):await D(["setupComplete","strategy","openquattEnabled","manualCoolingEnable","silentModeOverride",...Ye,...jo],"state"),e==="strategy"&&o.appView!=="settings"&&await D(ce(t)?pe.map(a=>a.key):Ht,"state")}catch(r){o.controlError=`${n.name} kon niet worden bijgewerkt. ${r.message}`}finally{o.busyAction="",m()}}async function Bm(e,t){const n=L[e];if(n){o.busyAction=`switch-${e}`,o.controlNotice="",o.controlError="",m();try{const r=t?"turn_on":"turn_off",a=await fetch(G(n.domain,n.name,r),{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);o.entities[e]={...o.entities[e]||{},value:t,state:t},o.controlNotice=`${n.name} ${t?"ingeschakeld":"uitgeschakeld"}.`,o.busyAction="",o.appView==="overview"?await D([...ca,...ze,"setupComplete",...Mt],"state"):o.appView==="settings"?(await D(lo(),"all"),Wa.includes(e)&&Co()):await D(["setupComplete","strategy","openquattEnabled","manualCoolingEnable","silentModeOverride",...Ye,...jo],"state"),m()}catch(r){o.controlError=`${n.name} aanpassen mislukt (${r.message}).`,m()}finally{o.busyAction="",m()}}}async function Vm(){const e=en();if(!e.canApply){o.controlError=e.requiresCic?"Vul eerst een geldig CiC-adres of een geldige feed-URL in.":"De vereiste flowbroninstelling is niet beschikbaar in deze firmware.",m();return}o.busyAction="quickstart-flow-source",o.controlNotice="",o.controlError="",m();const t=async(n,r)=>{if(!v(n))return;const a=E(n);if(typeof r=="boolean"&&A(n)===r||typeof r!="boolean"&&String(a)===String(r))return;const i=await Do(n,r);o.entities[n]={...o.entities[n]||{},value:i,state:i}};try{e.requiresCic?(await t("cicFeedUrl",e.normalizedDraftUrl),await t("cicPollingEnabled",!0),await t("flowSource","CIC"),o.quickStartCicFeedUrlDraft=null,o.controlNotice="CiC-flowmeting ingesteld. OpenQuatt controleert nu de JSON-feed."):(e.qFlowTarget&&await t("qFlowSource",e.qFlowTarget),await t("flowSource","Outdoor unit"),o.controlNotice=e.qFlowTarget==="Local"?"De lokale flowmeter op de Q-edition controller is ingesteld.":"De flowmeter in de buitenunit is ingesteld als Modbus-bron."),await D(Je,"all")}catch(n){o.controlError=`Flowconfiguratie kon niet volledig worden toegepast. ${n.message}`}finally{o.busyAction="",m()}}async function _m(){o.busyAction="quickstart-flow-refresh",o.controlNotice="",o.controlError="",m();try{await D(Je,"all");const e=en();o.controlNotice=e.flowAvailable?e.flowValue>0?`Flowsignaal bijgewerkt: ${Math.round(e.flowValue)} L/h.`:"Het flowsignaal is beschikbaar; momenteel is er geen circulatie.":"Nog geen actuele flowwaarde ontvangen."}catch(e){o.controlError=`Flowsignaal controleren mislukt. ${e.message}`}finally{o.busyAction="",m()}}async function rc(e,t){const n=L[e];if(!n||!v(e))throw new Error("Deze firmware bevat de vereiste testbediening niet.");const r=await fetch(G(n.domain,n.name,t?"turn_on":"turn_off"),{method:"POST"});if(!r.ok)throw new Error(`HTTP ${r.status}`)}async function jm(){const e=["commissioningCm100Start","commissioningCm100Stop","quickFlowTest"];e.forEach(n=>{o.optionalMissingEntities&&delete o.optionalMissingEntities[n],delete o.entities[n]}),await D(e,"all");const t=e.filter(n=>!o.entities[n]);if(t.length){const n=t.map(r=>L[r]?.name||r).join(", ");throw new Error(`Interne waterpomptestbediening ontbreekt: ${n}.`)}}async function Km(){for(let e=0;e<40;e+=1){await new Promise(t=>window.setTimeout(t,1e3));try{await D(Je,"state")}catch{return}if(!A("quickFlowTest")){o.busyAction!=="quickstart-flow-test-abort"&&(o.controlNotice="Waterpomptest afgerond. OpenQuatt is teruggekeerd naar de normale regeling."),m();return}}}async function Um(){if(!en().canRunFlowTest){o.controlError="Activeer eerst de flowconfiguratie of installeer firmware met de waterpomptest.",m();return}o.busyAction="quickstart-flow-test-start",o.controlNotice="",o.controlError="",m();let t=!1;try{if(await jm(),!A("cm100Active")){const a=L.commissioningCm100Start,i=await fetch(G(a.domain,a.name,"press"),{method:"POST"});if(!i.ok)throw new Error(`CM100 starten gaf HTTP ${i.status}`);t=!0}let n=A("cm100Active")&&String(E("commissioningStatus")||"").trim()==="CM100 READY";for(let a=0;!n&&a<20;a+=1)await new Promise(i=>window.setTimeout(i,500)),await D(["commissioningStatus","cm100Active"],"state"),n=A("cm100Active")&&String(E("commissioningStatus")||"").trim()==="CM100 READY";if(!n){const a=String(E("commissioningStatus")||"").trim();throw a?new Error(`Service-stand werd niet gereed: ${a}.`):new Error("Service-stand CM100 werd niet op tijd gereed.")}await rc("quickFlowTest",!0),await D(Je,"all");const r=String(E("commissioningStatus")||"").trim();if(!A("quickFlowTest"))throw new Error(r||"De waterpomptest kon niet worden gestart.");o.controlNotice="Waterpomptest gestart: alleen de pomp draait 30 seconden op 400 iPWM.",Km()}catch(n){if(t&&!A("quickFlowTest"))try{const r=L.commissioningCm100Stop;await fetch(G(r.domain,r.name,"press"),{method:"POST"})}catch{}o.controlError=`Waterpomptest starten mislukt. ${n.message}`}finally{o.busyAction="",m()}}async function zm(){o.busyAction="quickstart-flow-test-abort",o.controlNotice="",o.controlError="",m();try{await rc("quickFlowTest",!1),await D(Je,"all"),o.controlNotice="Waterpomptest gestopt. OpenQuatt keert terug naar de normale regeling."}catch(e){o.controlError=`Waterpomptest stoppen mislukt. ${e.message}`}finally{o.busyAction="",m()}}async function Gm(){const e=ai();if(!e.canApply){o.controlError=e.selectedSource==="CIC"?"Vul eerst een geldig CiC-adres of een geldige feed-URL in.":"De vereiste thermostaatbroninstelling is niet beschikbaar in deze firmware.",m();return}o.busyAction="quickstart-thermostat-source",o.controlNotice="",o.controlError="",m();const t=async(n,r)=>{if(!v(n))return;const a=E(n);if(typeof r=="boolean"&&A(n)===r||typeof r!="boolean"&&String(a)===String(r))return;const i=await Do(n,r);o.entities[n]={...o.entities[n]||{},value:i,state:i}};try{e.selectedSource==="OT thermostat"?await t("otEnabled",!0):e.selectedSource==="CIC"&&(await t("cicFeedUrl",e.normalizedDraftUrl),await t("cicPollingEnabled",!0),o.quickStartCicFeedUrlDraft=null),await t("roomTempSource",e.selectedSource),await t("roomSetpointSource",e.selectedSource),o.controlNotice=e.selectedSource==="OT thermostat"?"Kamertemperatuur en setpoint zijn gekoppeld aan OpenTherm.":e.selectedSource==="CIC"?"Kamertemperatuur en setpoint zijn gekoppeld aan de CiC JSON-feed.":"Kamertemperatuur en setpoint zijn gekoppeld aan Home Assistant.",await D(Ho,"all")}catch(n){o.controlError=`Thermostaatconfiguratie kon niet volledig worden toegepast. ${n.message}`}finally{o.busyAction="",m()}}async function Qm(){const e=L.checkFirmwareUpdates;if(e){o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.updateCheckBusy=!0,o.controlError="",o.controlNotice="",m();try{await Yn("current build",{poll:!1,force:!0}),Ra();const t=await fetch(G(e.domain,e.name,"press"),{method:"POST"});if(!t.ok)throw new Error(`HTTP ${t.status}`);await La(),o.controlNotice="Firmwarecontrole bijgewerkt."}catch(t){o.controlError=`Firmwarecontrole mislukte. ${t.message}`}finally{o.updateCheckBusy=!1,m()}}}async function Ym(){try{await D(la,"all",{concurrency:At,forceMissing:!0}),o.updateModalOpen&&m()}catch{}}async function Yn(e,t={}){const n=L.firmwareUpdateTarget;if(!n||!v("firmwareUpdateTarget"))return!1;const r=String(e||"").trim();if(!r)return!1;if(!t.force&&String(E("firmwareUpdateTarget")||"").trim()===r)return!0;o.entities.firmwareUpdateTarget={...o.entities.firmwareUpdateTarget||{},state:r,value:r};const a=await fetch(`${G(n.domain,n.name,"set")}?option=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return t.poll!==!1?(Ra(),await La({expectedBuildLabel:t.expectedBuildLabel||""})):!0}async function Jm(){const e=ie();if(e){o.firmwareAdvancedOpen=!1,o.updateManualUploadOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareTopologySwitchOpen=!1,o.updateTestFirmwareOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),xe(),o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.updateInstallBusy=!0,o.updateInstallTargetVersion=Pt(e),o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.updateInstallMode="normal",o.updateInstallTargetConnection="",o.updateInstallTargetTopology="",o.controlError="",o.controlNotice="",m();try{await Yn("current build",{poll:!1,force:!0}),o.updateInstallTargetVersion=Pt(ie()||{})||o.updateInstallTargetVersion,Un();const t=L.installFirmwareUpdateTarget,n=t&&v("installFirmwareUpdateTarget")?G(t.domain,t.name,"press"):G("update","Firmware Update","install"),r=await fetch(n,{method:"POST"});if(!r.ok)throw new Error(`HTTP ${r.status}`);await Yo({initialDelayMs:Ko,pollDelayMs:Wn})?(o.updateInstallCompleted=!0,o.updateInstallCompletedVersion=oe()||o.updateInstallTargetVersion,o.controlNotice=""):o.controlNotice="OTA-update gestart. Wacht tot het device weer online is."}catch(t){o.controlError=`OTA-update kon niet worden gestart. ${t.message}`}finally{Go(),m()}}}async function Zm(){const e=wa(),t=L.installFirmwareUpdateTarget;if(!(!e||!e.canSwitch||!t)){if(!o.firmwareConnectionSwitchConfirmed){o.controlError="Bevestig eerst de waarschuwing voor de verbindingswissel.",m();return}o.updateManualUploadOpen=!1,o.firmwareTopologySwitchOpen=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.updateInstallBusy=!0,o.updateInstallMode="connection-switch",o.updateInstallTargetConnection=e.targetConnection,o.updateInstallTargetTopology=Z(),o.updateInstallTargetVersion=oe()||"",o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.controlError="",o.controlNotice="",m();try{if(!await Yn("alternate connection",{force:!0,expectedBuildLabel:e.targetBuildLabel}))throw new Error("Doelmanifest is nog niet geladen. Probeer het over enkele seconden opnieuw.");o.updateInstallTargetVersion=Pt(ie()||{})||oe()||"",o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,m(),Un();const r=await fetch(G(t.domain,t.name,"press"),{method:"POST"});if(!r.ok)throw new Error(`HTTP ${r.status}`);if(await Yo({initialDelayMs:Ko,pollDelayMs:Wn}))o.updateInstallCompleted=!0,o.updateInstallCompletedVersion=oe()||o.updateInstallTargetVersion||"",o.firmwareConnectionSwitchConfirmed=!1,o.controlNotice="";else{const i=De(e.targetConnection);o.controlNotice=`Verbindingswissel naar ${i} is gestart. Wacht tot het device via die verbinding terugkomt.`}}catch(n){o.controlError=`Verbindingswissel kon niet worden gestart. ${n.message}`}finally{Go(),m()}}}async function Xm(){const e=Sa(),t=L.installFirmwareUpdateTarget;if(!(!e||!e.canSwitch||!t)){if(!o.firmwareTopologySwitchConfirmed){o.controlError="Bevestig eerst de waarschuwing voor de opstellingswissel.",m();return}o.updateManualUploadOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchOpen=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.updateInstallBusy=!0,o.updateInstallMode="topology-switch",o.updateInstallTargetConnection=e.targetConnection,o.updateInstallTargetTopology=e.targetTopology,o.updateInstallTargetVersion=oe()||"",o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.controlError="",o.controlNotice="",m();try{if(!await Yn("alternate topology",{force:!0,expectedBuildLabel:e.targetBuildLabel}))throw new Error("Doelmanifest is nog niet geladen. Probeer het over enkele seconden opnieuw.");o.updateInstallTargetVersion=Pt(ie()||{})||oe()||"",o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,m(),Un();const r=await fetch(G(t.domain,t.name,"press"),{method:"POST"});if(!r.ok)throw new Error(`HTTP ${r.status}`);if(await Yo({initialDelayMs:Ko,pollDelayMs:Wn}))o.updateInstallCompleted=!0,o.updateInstallCompletedVersion=oe()||o.updateInstallTargetVersion||"",o.firmwareTopologySwitchConfirmed=!1,o.controlNotice="";else{const i=Lo(e.targetTopology);o.controlNotice=`Opstellingswissel naar ${i} is gestart. Wacht tot het device met die opstelling terugkomt.`}}catch(n){o.controlError=`Opstellingswissel kon niet worden gestart. ${n.message}`}finally{Go(),m()}}}async function eh(e,t){const n=qa(e,t);if(!n)throw new Error("Geen geldig PR-target gevonden.");const r=await fetch(n.releaseApiUrl,{cache:"no-store",headers:{Accept:"application/vnd.github+json"}});if(r.status===404)throw new Error(`Geen testfirmware gevonden voor PR ${e}. Controleer of het label de build al heeft gepubliceerd.`);if(!r.ok)throw new Error(`GitHub API gaf HTTP ${r.status}`);const a=await r.json(),i=Array.isArray(a.assets)?a.assets:[],l=i.find(g=>g&&g.name===t.otaFileName),c=i.find(g=>g&&g.name===t.md5FileName);if(!l||!l.browser_download_url)throw new Error(`PR ${e} bevat geen OTA-build voor ${t.label}.`);if(!c||!c.browser_download_url)throw new Error(`PR ${e} mist de md5-controle voor ${t.label}.`);const d=String(a.name||a.tag_name||`PR ${e}`).trim(),u=String(l.updated_at||a.published_at||"").trim();return{otaUrl:l.browser_download_url,md5Url:c.browser_download_url,label:u?`${d} \xB7 ${u.replace("T"," ").replace("Z"," UTC")}`:d}}async function rs(e,t){if(!v(e))throw new Error(`${L[e]?.name||e} is niet beschikbaar op deze firmware.`);const n=await Do(e,t);o.entities[e]={...o.entities[e]||{},state:n,value:n}}async function th(){const e=Fo(),t=_n(),n=L.installFirmwareTestOta;if(!e){o.updateTestFirmwareError="Vul een geldig PR-nummer in.",m();return}if(!t.available){o.updateTestFirmwareError=t.error||"Dit firmwaretarget wordt niet herkend.",m();return}if(!o.updateTestFirmwareConfirmed){o.updateTestFirmwareError="Bevestig eerst dat je testfirmware wilt installeren.",m();return}if(!n||!v("installFirmwareTestOta")){o.updateTestFirmwareError="Deze firmware bevat de testfirmware-installatieknop nog niet.",m();return}o.updateManualUploadOpen=!1,o.firmwareConnectionSwitchOpen=!1,o.firmwareConnectionSwitchConfirmed=!1,o.firmwareTopologySwitchOpen=!1,o.firmwareTopologySwitchConfirmed=!1,fe(),o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.updateInstallBusy=!0,o.updateInstallTargetVersion="",o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.updateInstallMode="test-firmware",o.updateInstallTargetConnection="",o.updateInstallTargetTopology="",o.controlError="",o.controlNotice="",o.updateTestFirmwareError="",o.updateTestFirmwareBuild=null,m();let r=!1;try{const a=await eh(e,t);o.updateTestFirmwareBuild=a.label,m(),await rs("firmwareTestOtaUrl",a.otaUrl),await rs("firmwareTestOtaMd5Url",a.md5Url),r=!0,Un();const i=await fetch(G(n.domain,n.name,"press"),{method:"POST"});if(!i.ok)throw new Error(`HTTP ${i.status}`);await Yo({initialDelayMs:Ko,pollDelayMs:Wn})?(o.updateInstallCompleted=!0,o.updateInstallCompletedVersion=oe()||`PR ${e}`,o.updateTestFirmwareOpen=!1,xe(),o.controlNotice=""):o.controlNotice=`Testfirmware uit PR ${e} is gestart. Wacht tot het device weer online is.`}catch(a){r&&Ul(a.message)?o.controlNotice=`Testfirmware uit PR ${e} is gestart. Wacht tot het device weer online is.`:o.updateTestFirmwareError=`Testfirmware installeren mislukte. ${a.message}`}finally{Go(),m()}}async function oh(){const e=o.updateManualUploadFile;if(!e){o.updateManualUploadError="Kies eerst een firmwarebestand.",m();return}o.updateInstallCompleted=!1,o.updateInstallCompletedVersion="",o.updateInstallBusy=!0,o.updateInstallTargetVersion=oe()||"",o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.updateInstallMode="",o.updateInstallTargetConnection="",o.updateInstallTargetTopology="",o.controlError="",o.controlNotice="",o.updateManualUploadError="",m();try{const t=new FormData;t.append("update",e,e.name||"firmware.bin");const n=await fetch("/update",{method:"POST",body:t});if(!n.ok)throw new Error(`HTTP ${n.status}`);o.updateManualUploadOpen=!1,fe(),await Yo()?(o.updateInstallCompleted=!0,o.updateInstallCompletedVersion=oe()||o.updateInstallTargetVersion||"",o.controlNotice=""):o.controlNotice="Handmatige OTA-upload gestart. Wacht tot het device weer online is."}catch(t){o.updateManualUploadError=`Handmatige upload mislukte. ${t.message}`}finally{Go(),m()}}async function za(e,t,n=""){const r=L[e],a=we(e,t);o.busyAction=`save-${e}`,o.controlNotice="",o.controlError="",o.inputDrafts[e]=String(t??""),o.drafts[e]=a,m();try{const i=await fetch(`${G(r.domain,r.name,"set")}?value=${encodeURIComponent(a)}`,{method:"POST"});if(!i.ok)throw new Error(`HTTP ${i.status}`);delete o.drafts[e],delete o.inputDrafts[e],o.controlNotice=n||`${r.name} bijgewerkt.`,await D(o.appView==="settings"?lo():[...new Set([e,"setupComplete","strategy",...Ye,...jo])],"state")}catch(i){o.inputDrafts[e]=String(a).replace(".",","),o.controlError=`${r.name} kon niet worden bijgewerkt. ${i.message}`}finally{o.busyAction="",m()}}async function nh(e,t){const n=L[e],r=so(t);o.busyAction=`save-${e}`,o.controlNotice="",o.controlError="",m();try{const a=await fetch(`${G(n.domain,n.name,"set")}?value=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);o.controlNotice=`${n.name} bijgewerkt.`,await D(o.appView==="settings"?lo():[e,"setupComplete"],"state")}catch(a){o.controlError=`${n.name} kon niet worden bijgewerkt. ${a.message}`}finally{o.busyAction="",m()}}async function rh(e,t){const n=L[e],r=String(t||"").trim();o.busyAction=`save-${e}`,o.controlNotice="",o.controlError="",o.inputDrafts[e]=String(t??""),o.drafts[e]=r,m();try{const a=await fetch(`${G(n.domain,n.name,"set")}?value=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);o.entities[e]={...o.entities[e]||{},value:r,state:r},delete o.drafts[e],delete o.inputDrafts[e],o.controlNotice=`${n.name} bijgewerkt.`,await D(o.appView==="settings"?lo():[e,"setupComplete"],"state")}catch(a){o.inputDrafts[e]=r,o.controlError=`${n.name} kon niet worden bijgewerkt. ${a.message}`}finally{o.busyAction="",m()}}async function jr(e,t){const n=L[e],r=ot(t)||No,a=await fetch(`${G(n.domain,n.name,"set")}?value=${encodeURIComponent(r)}`,{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return o.entities[e]={...o.entities[e]||{},value:r,state:r},r}async function ac(e,t){const n=L[e],r=t?"turn_on":"turn_off",a=await fetch(G(n.domain,n.name,r),{method:"POST"});if(!a.ok)throw new Error(`HTTP ${a.status}`);return o.entities[e]={...o.entities[e]||{},value:t,state:t},t}async function ic(){await D([...new Set([...ca,...ze,"setupComplete",...Mt])],"state")}async function ah(e,t){const n=L[e],r=ot(t);o.busyAction=`save-${e}`,o.controlNotice="",o.controlError="",m();try{await jr(e,r),o.controlNotice=`${n.name} bijgewerkt.`,await D(o.appView==="settings"?lo():[e,"setupComplete","openquattEnabled"],"state")}catch(a){o.controlError=`${n.name} kon niet worden bijgewerkt. ${a.message}`}finally{o.busyAction="",m()}}async function ih(){const e=o.authStatus||{},t=e.enabled===!0,n=e.setup_window_active===!0,r=String(o.authDraftCurrentPassword||""),a=String(o.authDraftUsername||"").trim(),i=String(o.authDraftNewPassword||""),l=String(o.authDraftConfirmPassword||"");if(!a||!i){o.authError="Vul een gebruikersnaam en wachtwoord in.",m();return}if(i!==l){o.authError="De twee wachtwoorden zijn niet gelijk.",m();return}if(t&&!r){o.authError="Vul je huidige wachtwoord in.",m();return}if(!t&&!n){o.authError="Houd de herstelknop 5 seconden vast.",m();return}if(!e.csrf_token){o.authError="Logingegevens laden nog. Probeer het zo opnieuw.",m();return}o.authBusy=!0,o.authError="",o.authNotice="",m();try{const c=new URLSearchParams;c.set("csrf_token",e.csrf_token),c.set("current_password",r),c.set("new_username",a),c.set("new_password",i);const d=await fetch("/auth/change",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:c.toString()}),u=await d.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!d.ok||!u.ok)throw new Error(u.error||`HTTP ${d.status}`);await co({force:!0}),o.authDraftCurrentPassword="",o.authDraftNewPassword="",o.authDraftConfirmPassword="",o.authDraftUsername=String(o.authStatus?.username||a).trim(),o.authNotice=t?"Login aangepast.":"Login staat nu aan.",o.authError="",m()}catch(c){o.authError=`Opslaan is mislukt. ${c.message}`,m()}finally{o.authBusy=!1,m()}}async function sh(){const e=o.authStatus||{};if(!e.enabled){o.authNotice="Login staat al uit.",o.authError="",m();return}const t=String(o.authDraftCurrentPassword||"");if(!t){o.authError="Vul je huidige wachtwoord in.",m();return}if(!e.csrf_token){o.authError="Logingegevens laden nog. Probeer het zo opnieuw.",m();return}o.authBusy=!0,o.authError="",o.authNotice="",m();try{const n=new URLSearchParams;n.set("csrf_token",e.csrf_token),n.set("current_password",t);const r=await fetch("/auth/disable",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=UTF-8"},body:n.toString()}),a=await r.json().catch(()=>({ok:!1,error:"invalid_response"}));if(!r.ok||!a.ok)throw new Error(a.error||`HTTP ${r.status}`);await co({force:!0}),o.authDraftCurrentPassword="",o.authDraftNewPassword="",o.authDraftConfirmPassword="",o.authDraftUsername="",o.authNotice="Login staat nu uit.",o.authError="",m()}catch(n){o.authError=`Uitzetten is mislukt. ${n.message}`,m()}finally{o.authBusy=!1,m()}}async function kr(e){const t=ot(e);if(e&&!t){o.controlError="Kies een geldig hervatmoment om automatisch weer in te schakelen.",m();return}if(t&&!v("openquattResumeAt")){o.controlError="Automatisch hervatten is op deze firmware nog niet beschikbaar.",m();return}o.busyAction="openquatt-regulation",o.controlNotice="",o.controlError="",m();let n=!1;try{v("openquattResumeAt")&&(await jr("openquattResumeAt",t||No),n=!!t),await ac("openquattEnabled",!1),o.pauseResumeDraft=t?Dr(t):"",o.systemModal="",o.controlNotice=t?`Openquatt regeling is tijdelijk uitgeschakeld tot ${Ia(t)}.`:"Openquatt regeling is uitgeschakeld zonder eindmoment.",await ic()}catch(r){if(n&&v("openquattResumeAt"))try{await jr("openquattResumeAt",No)}catch{}o.controlError=`Openquatt regeling kon niet worden bijgewerkt. ${r.message}`}finally{o.busyAction="",m()}}async function lh(){o.busyAction="openquatt-regulation",o.controlNotice="",o.controlError="",m();try{await ac("openquattEnabled",!0),o.pauseResumeDraft="",o.systemModal="",o.controlNotice="Openquatt regeling is weer actief.",await ic()}catch(e){o.controlError=`Openquatt regeling kon niet worden ingeschakeld. ${e.message}`}finally{o.busyAction="",m()}}async function ch(e){const t=L[e];o.busyAction=e,o.controlError="",o.controlNotice="",m();try{const n=await fetch(G(t.domain,t.name,"press"),{method:"POST"});if(!n.ok)throw new Error(`HTTP ${n.status}`);o.controlNotice=e==="apply"?"Setup gemarkeerd als afgerond.":"Quick Start teruggezet naar het begin. Huidige tuningwaarden blijven voorlopig staan.",await D(["setupComplete"],"state"),e==="reset"&&(o.currentStep=Dn[0].id,o.quickStartModalMode="wizard",o.quickStartModalOpen=!0),o.quickStartModalOpen=e!=="apply",Et("overview",{syncMode:"replace"}),ae({forceFast:!0})}catch(n){o.controlError=`Actie mislukt voor "${t.name}". ${n.message}`}finally{o.busyAction="",m()}}function uh(){window.requestAnimationFrame(()=>{if(!o.root||o.systemModal!=="service-task-hp-water-calibration")return;const e=o.root.querySelector("[data-oq-service-task-scroller]"),t=o.root.querySelector("[data-oq-hp-water-calibration-actions]");if(!e||!t)return;const n=e.getBoundingClientRect(),r=t.getBoundingClientRect(),a=e.scrollTop+r.top-n.top-24;e.scrollTop=Math.max(0,a)})}async function Ut(e,t={}){const n=L[e];if(n){o.busyAction=e,o.controlError="",o.controlNotice="",m();try{const r=await fetch(G(n.domain,n.name,"press"),{method:"POST"});if(!r.ok)throw new Error(`HTTP ${r.status}`);if(["commissioningCm100Start","commissioningCm100Stop","boilerPowerTestStart","boilerPowerTestAbort","boilerPowerTestApply","flowAutotuneStart","flowAutotuneAbort","flowAutotuneApply","airPurgeStart","airPurgeAbort","hpWaterCalibrationStart","hpWaterCalibrationAbort","hpWaterCalibrationApply","manualFlowStart","manualFlowAbort","manualFlowApplyHeating","manualFlowApplyCooling","manualHpStart","manualHpAbort","trendHistoryFlush","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear"].includes(e)||js.has(e)||(wn(),o.systemModal=""),o.controlNotice=t.successNotice||`${n.name} gestart.`,t.reconnectMode&&Na(t.reconnectMode),Array.isArray(t.refreshKeys)&&t.refreshKeys.length){const i=Number(t.refreshDelayMs||0);Number.isFinite(i)&&i>0&&await new Promise(l=>window.setTimeout(l,i)),await D(t.refreshKeys,"state")}}catch(r){e==="commissioningCm100Start"?(o.pendingCommissioningCm100Start=!1,o.commissioningTaskLock=""):e==="boilerPowerTestStart"?(o.pendingBoilerPowerTestStart=!1,o.commissioningTaskLock=""):e==="flowAutotuneStart"?(o.pendingFlowAutotuneStart=!1,o.commissioningTaskLock=""):e==="airPurgeStart"?(o.pendingAirPurgeStart=!1,o.commissioningTaskLock=""):e==="hpWaterCalibrationStart"?(o.pendingHpWaterCalibrationStart=!1,o.commissioningTaskLock=""):e==="manualFlowStart"?(o.pendingManualFlowStart=!1,o.commissioningTaskLock=""):e==="manualHpStart"&&(o.pendingManualHpStart=!1,o.commissioningTaskLock=""),o.controlError=`${t.errorPrefix||`Actie mislukt voor "${n.name}"`}. ${r.message}`}finally{o.busyAction="",m(),e==="hpWaterCalibrationApply"&&uh()}}}function sc(e){const t=o.root?o.root.querySelector(".oq-helper-curve-svg"):null;if(!t||!o.draggingCurveKey)return;const n=t.getBoundingClientRect(),r=22,a=180,i=(e-n.top)/n.height*240,c=70-(Math.min(r+a,Math.max(r,i))-r)/a*50,d=we(o.draggingCurveKey,c);String(E(o.draggingCurveKey))!==String(d)&&(o.drafts[o.draggingCurveKey]=d,m())}function Zo({key:e,value:t,meta:n,controlClass:r,inputClass:a="oq-helper-input",inputAttributes:i="",unitMarkup:l=""}){return`
      <label class="${r}">
        <input
          class="${a}"
          type="number"
    ...
    `}function dh(){const e=[];e.push(ce()?"Stooklijn":"Power House");const t=String(E(ce()?"curveControlProfile":"phResponseProfile")||"").trim();t&&e.push(`profiel ${t}`);const n=String(E("flowControlMode")||"").trim();return n&&e.push(`flow ${n==="Manual PWM"?"handmatig":"setpoint"}`),n==="Manual PWM"&&v("manualIpwm")?e.push(`iPWM ${j("manualIpwm")}`):v("flowSetpoint")&&e.push(`flow ${j("flowSetpoint")}`),v("dayMax")&&e.push(`dag ${j("dayMax")}`),v("silentMax")&&e.push(`silent ${j("silentMax")}`),v("maxWater")&&e.push(`max water ${j("maxWater")}`),e.filter(Boolean).join(", ")||"Instellingen beschikbaar"}function v(e){return!!o.entities[e]}function B(e,t="\u2014"){const n=o.entities[e];if(!n)return t;if(typeof n.state=="string"&&n.state.trim()!=="")return n.state;const r=n.value??n.state;return r==null||r===""?t:typeof r=="boolean"?r?"Aan":"Uit":typeof r=="number"&&!Number.isNaN(r)&&n.uom?`${r} ${n.uom}`:String(r)}function H(e){const t=Number(E(e));return Number.isNaN(t)?NaN:t}function lc(e){const t=String(e||"").toLowerCase();return t.includes("cop")||t.includes("eer")}function cc(e){const t=String(e||"");if(t==="totalEer"){const n=H("totalCoolingPower"),r=H("coolingPowerInput"),a=Number.isNaN(r)?H("totalPower"):r;return!Number.isNaN(n)&&!Number.isNaN(a)&&a>=5?n/a:NaN}if(t==="totalCop"){const n=H("totalHeat"),r=H("heatingPowerInput"),a=Number.isNaN(r)?H("totalPower"):r;return!Number.isNaN(n)&&!Number.isNaN(a)&&a>=5?n/a:NaN}return NaN}function $o(e,t=""){const n=String(o.entities[e]?.uom||"").trim();return n||{totalPower:"W",heatingPowerInput:"W",coolingPowerInput:"W",totalHeat:"W",totalCoolingPower:"W",boilerHeatPower:"W",systemHeatPower:"W",hpCapacity:"W",hpDeficit:"W",flowSelected:"L/h",hp1Flow:"L/h",hp2Flow:"L/h",supplyTemp:"\xB0C",curveSupplyTarget:"\xB0C",coolingSupplyTarget:"\xB0C",coolingEffectiveMinSupplyTemp:"\xB0C",coolingDemandRaw:"W",hp1EvaporatorCoilTemp:"\xB0C",hp1InnerCoilTemp:"\xB0C",hp1OutsideTemp:"\xB0C",hp1CondenserPressure:"bar",hp1DischargeTemp:"\xB0C",hp1EvaporatorPressure:"bar",hp1ReturnTemp:"\xB0C",hp1WaterIn:"\xB0C",hp1WaterOut:"\xB0C",hp2EvaporatorCoilTemp:"\xB0C",hp2InnerCoilTemp:"\xB0C",hp2OutsideTemp:"\xB0C",hp2CondenserPressure:"bar",hp2DischargeTemp:"\xB0C",hp2EvaporatorPressure:"bar",hp2ReturnTemp:"\xB0C",hp2WaterIn:"\xB0C",hp2WaterOut:"\xB0C"}[e]||t}function Ie(e){const t=o.entities[e],n=cc(e);if(!t)return Number.isNaN(n)?"\u2014":I(n,1,$o(e));const r=H(e);if(Number.isNaN(r))return Number.isNaN(n)?B(e):I(n,1,$o(e));const a=r>0||Number.isNaN(n)?r:n,i=lc(e)?1:0;return I(a,i,$o(e))}function A(e){const t=o.entities[e];if(!t)return!1;if(typeof t.value=="boolean")return t.value;const n=String(t.state??t.value??"").toLowerCase();return n==="on"||n==="true"||n==="1"}function po(){return!v("trendHistoryEnabled")||A("trendHistoryEnabled")}function uc(){const e=o.entities.setupComplete;if(!e)return null;const t=String(e.state??e.value??"").trim().toLowerCase();return!t||t==="unknown"||t==="unavailable"?null:t==="on"||t==="true"||t==="1"?!0:t==="off"||t==="false"||t==="0"?!1:null}function ph(){return`
      <div class="oq-helper-app-nav">
        ${na.filter(e=>e.id!=="diagnosis"||po()).map(e=>`
          <button
...
`).replace(/\r/g,`
`).trimEnd()}catch{}return t}function jh(e){return String(e??"").replace(/\x1b\[[0-9;]*m/g,"")}function Kh(e){const t=String(e??""),n=Array.from(t.matchAll(/\x1b\[([0-9;]*)m/g));for(let i=n.length-1;i>=0;i-=1){const l=n[i][1].split(";").map(c=>Number(c)).filter(c=>Number.isFinite(c));for(let c=l.length-1;c>=0;c-=1){const d=l[c];if(d===31||d===91)return"error";if(d===33||d===93)return"warning";if(d===32||d===92)return"info";if(d===36||d===96||d===34||d===35)return"debug";if(d===37||d===90||d===38||d===97)return"verbose"}}const r=t.match(/\[(E|W|I|D|V|VV)\]/i);if(!r)return"plain";const a=r[1].toUpperCase();return a==="E"?"error":a==="W"?"warning":a==="I"?"info":a==="D"?"debug":"verbose"}function Uh(e){for(;o.webServerLogEntries.length>dc;)o.webServerLogEntries.shift(),e&&e.firstElementChild&&e.removeChild(e.firstElementChild)}function zh(){return o.root?o.root.querySelector("[data-oq-webserver-log-output]"):null}function Zn(){return o.root?o.root.querySelector("[data-oq-webserver-log-scroller]"):null}function Ya(e){return e?e.scrollHeight-e.scrollTop-e.clientHeight<48:!1}function Gh(e,t){if(!(!t||e.length===0)){t.dataset.webServerLogEmpty==="true"&&(t.dataset.webServerLogEmpty="false",t.innerHTML="");for(const n of e)t.insertAdjacentHTML("beforeend",Sc(n))}}function Sc(e){const t=mc(e.receivedAt),n=vh(e.receivedAt);return`
  ...
  `}function Qh(e=o.webServerLogEntries){return e.length?e.map(t=>Sc(t)).join(""):`
      <p class="oq-webserver-log-empty">Nog geen logregels ontvangen. Open de log en wacht op een nieuwe melding.</p>
    `}function Yh(){const e=[];return o.webServerLogHistoryLoading&&e.push('<p class="oq-helper-modal-note">Recente firmwarelogs worden opgehaald...</p>'),o.webServerLogCopyMessage&&e.push(`
  ...
  `}function Zh(){const e=Ga();if(!e)return"";const t=hc(e),n=Sh(e),r=o.loadingEntities||o.busyAction==="save-debugLevel";return`
  ...
  `}function Xh(){return o.webServerLogEntries.map(e=>{const t=String(e.raw??e.text??"").trimEnd();return t.trim()?`${mc(e.receivedAt)} ${t}`:""}).filter(e=>e.trim()!=="").join(`
`)}async function ef(e){if(!e)return!1;if(window.navigator?.clipboard?.writeText&&window.isSecureContext)return await window.navigator.clipboard.writeText(e),!0;const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.top="-1000px",t.style.opacity="0",document.body.appendChild(t),t.focus(),t.select();let n=!1;try{n=document.execCommand("copy")}finally{document.body.removeChild(t)}return n}async function tf(){const e=Xh();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",m();return}try{if(!await ef(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&m()}function of(){const e=go();return`
    <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
  ...
  `}function We(){return o.debugRecordingDeviceStatus?Math.max(0,Number(o.debugRecordingDeviceStatus.sample_count||0)):Array.isArray(o.debugRecordingSamples)?o.debugRecordingSamples.length:0}function Ve(e=o.debugRecordingDeviceStatus){return e?.rolling===!0||String(e?.mode||"").toLowerCase()==="rolling"}function Xn(e=o.debugRecordingDeviceStatus){return Ve(e)&&e?.frozen===!0&&!e?.active}function $t(e){const t=Math.max(0,Math.round(Number(e||0)/1e3)),n=Math.floor(t/3600),r=Math.floor(t%3600/60),a=t%60;return n>0?`${n}u ${String(r).padStart(2,"0")}m`:r>0?`${r}m ${String(a).padStart(2,"0")}s`:`${a}s`}function qc(){return o.debugRecordingDeviceStatus?Math.max(0,Number(o.debugRecordingDeviceStatus.retained_duration_s||0)*1e3):kc()}function kc(){if(o.debugRecordingDeviceStatus)return Math.max(0,Number(o.debugRecordingDeviceStatus.elapsed_s||0)*1e3);if(!o.debugRecordingStartedAt)return 0;const e=o.debugRecordingActive?Date.now():Number(o.debugRecordingLastSampleAt||Date.now());return Math.max(0,e-Number(o.debugRecordingStartedAt||e))}function er(){return o.debugRecordingDeviceStatus&&o.debugRecordingDeviceStatus.available===!1?"Niet beschikbaar":Xn()?"Rolling gestopt":o.debugRecordingActive&&Ve()?"Rolling actief":o.debugRecordingActive?"Bezig met opnemen":We()>0?"Voltooid":"Niet gestart"}function Ja(){return Xn()?"Rolling debug is gestopt. De recente samples blijven bewaard tot je downloadt, kopieert, hervat of een nieuwe opname start.":o.debugRecordingActive&&Ve()?"Rolling debug bewaart continu de recente samples. Download of kopieer maakt een momentopname; rolling blijft daarna doorlopen.":o.debugRecordingActive?"De opname loopt in apparaatgeheugen. Je kunt deze pagina sluiten en later het bestand downloaden.":We()>0?"De opname is klaar. Download het supportbestand en voeg dit toe aan je supportverzoek.":o.debugRecordingDeviceStatus&&o.debugRecordingDeviceStatus.available===!1?"Debugopname in apparaatgeheugen is niet beschikbaar op deze firmware.":"Neem tijdelijk supportgegevens op voor analyse. De opname wordt lokaal in het apparaatgeheugen opgeslagen. Er wordt niets automatisch verzonden."}function nf(){return Xn()?"Gestopt":o.debugRecordingActive&&Ve()?`Rolling \xB7 ${$t(qc())}`:o.debugRecordingActive?`Loopt \xB7 ${$t(Cc())}`:We()>0?"Klaar":er()}function rf(){const e=Number(o.debugRecordingSelectedMinutes||15);return Rr.map(n=>Number(n.minutes)).includes(e)?e:Number(Rr[0]?.minutes||15)}function af(e){o.debugRecordingActive||(o.debugRecordingSelectedMinutes=Math.max(1,Number(e)||15),o.debugRecordingNotice="",o.debugRecordingError="",m())}function Cc(){return Ve()?0:o.debugRecordingDeviceStatus?Math.max(0,Number(o.debugRecordingDeviceStatus.remaining_s||0)*1e3):o.debugRecordingActive?Math.max(0,Number(o.debugRecordingEndsAt||0)-Date.now()):0}function sf(){if(o.debugRecordingDeviceStatus){if(Ve()){const a=Math.max(1,Number(o.debugRecordingDeviceStatus.sample_capacity||0));return Math.max(0,Math.min(100,We()/a*100))}const n=Math.max(1,Number(o.debugRecordingDeviceStatus.duration_s||0)),r=Math.max(0,Number(o.debugRecordingDeviceStatus.elapsed_s||0));return!o.debugRecordingActive&&We()>0?100:Math.max(0,Math.min(100,r/n*100))}if(!o.debugRecordingActive||!o.debugRecordingStartedAt||!o.debugRecordingEndsAt)return We()>0?100:0;const e=Math.max(1,Number(o.debugRecordingEndsAt)-Number(o.debugRecordingStartedAt)),t=Math.max(0,Date.now()-Number(o.debugRecordingStartedAt));return Math.max(0,Math.min(100,t/e*100))}function Tc(e=o.debugRecordingDeviceStatus){return String(e?.recording_id??e?.recording?.recording_id??"").trim()}function lf(){try{return String(window.localStorage.getItem("oq-debug-recording-acknowledged-id")||"")}catch{return""}}function Ec(e){if(e?.recording?.active)return;const t=Tc(e);if(t){o.debugRecordingAcknowledgedId=t;try{window.localStorage.setItem("oq-debug-recording-acknowledged-id",t)}catch{}}}function $c(){const e=o.debugRecordingDeviceStatus,t=Math.max(0,Number(e?.sample_count||0));if(!e||e.available===!1||!e.active&&t===0)return"";const n=!!e.active;if(!n&&Tc(e)===o.debugRecordingAcknowledgedId)return"";const r=Ve(e),a=$t(Math.max(0,Number(e.retained_duration_s||0))*1e3),i=$t(Math.max(0,Number(e.remaining_s||0))*1e3),l=n?r?`Rolling debug \xB7 ${a}`:`Debug loopt \xB7 ${i}`:r?"Rolling gestopt":"Debug klaar",c=n?r?`Rolling debug loopt, laatste ${a} beschikbaar`:`Debugopname loopt, nog ${i}`:r?"Rolling debug gestopt; recente buffer klaar om te downloaden":"Debugopname klaar om te downloaden";return`
    <button
  ...
  `}function cf(){if(!o.root)return;const e=o.root.querySelector('[data-oq-diagnostics-row="debugRecording"]');if(!e)return;const t=e.querySelector(".oq-settings-system-row-value"),n=e.querySelector(".oq-settings-system-row-note");t&&(t.textContent=er()),n&&(n.textContent=Ja())}function Za(e){const t={activity:'<svg viewBox="0 0 24 24" focusable="false"><path d="M3 12h4l2-7 4 14 2-7h6"/></svg>',status:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="4"/></svg>',clock:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="8"/><path d="M12 7v5l3 2"/></svg>',samples:'<svg viewBox="0 0 24 24" focusable="false"><path d="M4 16h3l2-7 4 9 2-5h5"/></svg>',changes:'<svg viewBox="0 0 24 24" focusable="false"><path d="M18 8a7 7 0 1 0 1 7"/><path d="M18 4v4h-4"/></svg>',file:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 3h7l4 4v14H7z"/><path d="M14 3v5h5"/></svg>',storage:'<svg viewBox="0 0 24 24" focusable="false"><ellipse cx="12" cy="6" rx="7" ry="3"/><path d="M5 6v6c0 1.7 3.1 3 7 3s7-1.3 7-3V6"/><path d="M5 12v6c0 1.7 3.1 3 7 3s7-1.3 7-3v-6"/></svg>',play:'<svg viewBox="0 0 24 24" focusable="false"><path d="M8 5v14l11-7z"/></svg>',stop:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 7h10v10H7z"/></svg>',download:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 4v10"/><path d="m8 10 4 4 4-4"/><path d="M5 19h14"/></svg>',copy:'<svg viewBox="0 0 24 24" focusable="false"><rect x="8" y="8" width="10" height="10" rx="2"/><path d="M6 14H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1"/></svg>',check:'<svg viewBox="0 0 24 24" focusable="false"><path d="m5 13 4 4L19 7"/></svg>',alert:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 8v5"/><path d="M12 17h.01"/><path d="M10.3 4.7 2.8 18a2 2 0 0 0 1.7 3h15a2 2 0 0 0 1.7-3L13.7 4.7a2 2 0 0 0-3.4 0z"/></svg>'};return t[e]||t.status}function uf(e){return`<span class="oq-debug-recording-icon" aria-hidden="true">${Za(e)}</span>`}function Ke(e){return`<span class="oq-debug-recording-button-icon" aria-hidden="true">${Za(e)}</span>`}function df(){return[...Gt]}function pf(){const e=[];return Gt.forEach((t,n)=>{const r=o.entities?.[t]||{},a=String(r.uom??r.unit_of_measurement??"").trim();a&&e.push([n,a])}),e}function gf(e){return Array.isArray(e)?e.map((t,n)=>t===null?null:[n,t]).filter(Boolean):[]}function tr(){o.debugRecordingTimer&&(window.clearTimeout(o.debugRecordingTimer),o.debugRecordingTimer=null)}function mo(){o.debugRecordingDevicePollTimer&&(window.clearTimeout(o.debugRecordingDevicePollTimer),o.debugRecordingDevicePollTimer=null)}function yt(e){return`${Xe()}/openquatt/debug-recording/${e}`}function ho(e){const t=e&&typeof e=="object"?e:{};o.debugRecordingDeviceStatus=t,o.debugRecordingActive=!!t.active,o.debugRecordingStartedAt=t.active||Number(t.sample_count||0)>0?Date.now()-Math.max(0,Number(t.elapsed_s||0)*1e3):0,o.debugRecordingEndsAt=t.active?Date.now()+Math.max(0,Number(t.remaining_s||0)*1e3):0,o.debugRecordingLastSampleAt=Number(t.sample_count||0)>0?Date.now():0}function Xa(){ho({ok:!1,available:!1,active:!1,mode:"manual",rolling:!1,frozen:!1,storage:"unavailable",interval_s:0,duration_s:0,elapsed_s:0,remaining_s:0,sample_count:0,sample_capacity:0,estimated_size:0,buffer:"unavailable"})}async function mf(){const e=await window.fetch(yt("status"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);const t=await e.json();return ho(t),t}function or(e=2e3){mo(),o.debugRecordingActive&&(o.debugRecordingDevicePollTimer=window.setTimeout(()=>{ei({silent:!0})},Math.max(0,Number(o.systemModal==="debug-recording"?e:5e3)||0)))}async function ei(e={}){e.silent||(o.debugRecordingBusy=!0,o.debugRecordingError="",m());try{await mf(),!o.debugRecordingActive&&e.silent&&(o.debugRecordingNotice="Debugopname is afgerond."),or()}catch(t){Xa(),o.debugRecordingError=`Status kon niet worden opgehaald. ${t.message||String(t)}`}finally{e.silent||(o.debugRecordingBusy=!1),!e.silent||o.systemModal==="debug-recording"?m():(Qp(),cf())}}async function Ac(){const e=Gl(Gt,"state");let t=null;for(let n=0;n<e.length;n+=1){const r=await window.fetch(yt(`configure?reset=${n===0?"1":"0"}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store","Content-Type":"application/x-www-form-urlencoded"},body:e[n].body});if(!r.ok)throw new Error(`configuratie HTTP ${r.status}`);t=await r.json()}if(Number(t?.entity_field_count||0)!==Gt.length)throw new Error(`onvolledige debugset (${Number(t?.entity_field_count||0)}/${Gt.length})`);return t}async function hf(e){const t=Math.max(1,Number(e)||15);tr(),mo(),o.debugRecordingBusy=!0,o.debugRecordingError="",o.debugRecordingNotice="",o.debugRecordingSamples=[],o.debugRecordingEvents=[],o.debugRecordingInitialValues=null,o.debugRecordingLastValues=null,o.debugRecordingDeviceBundle=null,o.debugRecordingLastSampleAt=0,o.debugRecordingSequence=0,m();try{await Ac();const n=await window.fetch(yt(`start?duration_s=${encodeURIComponent(t*60)}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!n.ok)throw new Error(`HTTP ${n.status}`);const r=await n.json();ho(r),or()}catch(n){Xa(),o.debugRecordingError=`Debugopname kon niet worden gestart. ${n.message||String(n)}`}finally{o.debugRecordingBusy=!1,m()}}async function ff(){tr(),mo(),o.debugRecordingBusy=!0,o.debugRecordingError="",o.debugRecordingNotice="",o.debugRecordingSamples=[],o.debugRecordingEvents=[],o.debugRecordingInitialValues=null,o.debugRecordingLastValues=null,o.debugRecordingDeviceBundle=null,o.debugRecordingLastSampleAt=0,o.debugRecordingSequence=0,m();try{await Ac();const e=await window.fetch(yt("start?rolling=1"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);const t=await e.json();ho(t),or()}catch(e){Xa(),o.debugRecordingError=`Rolling debug kon niet worden gestart. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,m()}}async function bf(){const e=await window.fetch(yt("freeze"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);const t=await e.json();return ho(t),mo(),t}async function vf(){tr(),o.debugRecordingBusy=!0,o.debugRecordingError="",m();try{await bf(),o.debugRecordingNotice="Rolling debug is gestopt. De recente buffer blijft bewaard."}catch(e){o.debugRecordingError=`Rolling debug kon niet worden gestopt. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,m()}}async function yf(e={}){tr(),mo(),o.debugRecordingBusy=!0,o.debugRecordingError="",m();try{const t=await window.fetch(yt("stop"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);const n=await t.json();ho(n),o.debugRecordingNotice=e.completed?"Debugopname is afgerond.":"Debugopname is gestopt."}catch(t){o.debugRecordingError=`Debugopname kon niet worden gestopt. ${t.message||String(t)}`}finally{o.debugRecordingBusy=!1,m()}}function gs(e={}){const t=o.debugRecordingActive?Date.now():Number(o.debugRecordingLastSampleAt||Date.now());return{format:"openquatt-debug-v2",schema_version:2,kind:"openquatt_debug_recording",encoding:"column-delta-json-v2",exported_at:new Date().toISOString(),source:e.source||{},recording:{started_at:o.debugRecordingStartedAt?new Date(Number(o.debugRecordingStartedAt)).toISOString():"",ended_at:t?new Date(t).toISOString():"",active:!!o.debugRecordingActive,duration_s:o.debugRecordingStartedAt?Math.round(Math.max(0,t-Number(o.debugRecordingStartedAt))/1e3):0,interval_s:Math.round(vd/1e3),sample_count:We(),column_count:Gt.length,storage:"browser"},columns:df(),units:pf(),initial:gf(o.debugRecordingInitialValues),samples:o.debugRecordingSamples||[],events:o.debugRecordingEvents||[],...e.logs?{logs:e.logs}:{}}}function Nn(e){return JSON.stringify(e)}function wf(){const e=Number(o.debugRecordingDeviceStatus?.estimated_size||0);if(e>0)return e;try{return new Blob([Nn(gs())]).size}catch{return Nn(gs()).length}}function Sf(e){const t=Math.max(0,Number(e)||0);return t>=1024*1024?`${(t/1024/1024).toFixed(1)} MB`:t>=1024?`${(t/1024).toFixed(1)} kB`:`${Math.round(t)} B`}function qf(e,t){const n=new Blob([t],{type:"application/json"}),r=URL.createObjectURL(n),a=document.createElement("a");a.href=r,a.download=e,a.rel="noreferrer",document.body.appendChild(a),a.click(),a.remove(),window.setTimeout(()=>URL.revokeObjectURL(r),0)}function kf(e){const t=e?.exported_at||(e?.exported_at_ms?new Date(Number(e.exported_at_ms)).toISOString():new Date().toISOString()),n=String(t).replace(/[:.]/g,"-").replace(/T/,"_").replace(/Z$/,"Z");return`${String(e?.source?.installation||"OpenQuatt").replace(/\s+/g,"-").toLowerCase()}-debug-recording-${n}.oqdebug.json`}async function Cf(){if(We()===0){o.debugRecordingError="Er is nog geen debugopname om te downloaden.",m();return}o.debugRecordingBusy=!0,o.debugRecordingError="";const e=o.debugRecordingActive&&Ve();m();try{const t=await window.fetch(yt("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);const n=await t.json();o.debugRecordingDeviceBundle=n,qf(kf(n),Nn(n)),Ec(n),o.debugRecordingNotice=e?"Momentopname gedownload. Rolling debug loopt door.":"Supportbestand gedownload."}catch{o.debugRecordingError="Download mislukt. Probeer opnieuw of kopieer de data."}finally{o.debugRecordingBusy=!1,m()}}async function Tf(){if(We()===0){o.debugRecordingError="Er is nog geen debugopname om te kopi\xEBren.",m();return}o.debugRecordingBusy=!0,o.debugRecordingError="";const e=o.debugRecordingActive&&Ve();m();try{const t=await window.fetch(yt("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);const n=await t.json();if(o.debugRecordingDeviceBundle=n,!await Zl(Nn(n)))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");Ec(n),o.debugRecordingNotice=e?"Momentopname gekopieerd. Rolling debug loopt door.":"Supportbestand gekopieerd."}catch{o.debugRecordingError="Kopi\xEBren mislukt. Probeer opnieuw of download het supportbestand."}finally{o.debugRecordingBusy=!1,m()}}function Ef(){const e=o.debugRecordingActive,t=Ve(),n=Xn(),r=We(),a=o.debugRecordingBusy,i=Sf(wf()),l=Array.isArray(o.debugRecordingDeviceBundle?.events)?o.debugRecordingDeviceBundle.events.length:Array.isArray(o.debugRecordingEvents)?o.debugRecordingEvents.length:0,c=rf(),d=Cc(),u=qc(),g=sf(),b=r>0,h=`${g.toFixed(1)}%`,y=[{icon:"status",label:"Status",value:er()},{icon:"clock",label:t?"Retentie":"Duur",value:$t(t?u:kc())},{icon:"samples",label:"Samples",value:String(r)},{icon:"changes",label:"Statuswijzigingen",value:String(l)},{icon:"file",label:"Geschatte grootte",value:`\xB1 ${i}`},{icon:"storage",label:"Opslag",value:o.debugRecordingDeviceStatus?.available===!1?"Niet beschikbaar":"Apparaatgeheugen"}],p=o.debugRecordingError?{kind:"error",icon:"alert",text:o.debugRecordingError}:o.debugRecordingNotice?{kind:"success",icon:"check",text:o.debugRecordingNotice}:null;return`
    <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      <section class="oq-helper-modal oq-debug-recording-modal" role="dialog" aria-modal="true" aria-labelledby="oq-debug-recording-modal-title">
          ...
          ${e?`
            <div class="oq-debug-recording-progress">
              <div class="oq-debug-recording-progress-head">
                <span>${s(t?`Laatste ${$t(u)} bewaard`:`Nog ${$t(d)}`)}</span>
        ...
        `:`
          <section class="oq-debug-recording-duration" aria-label="Duur">
            ...
            <div class="oq-debug-recording-segments" role="group" aria-label="Kies opnameduur">
              ${Rr.map(f=>{const S=Number(f.minutes)===c;return`
                  <button
        ...
        <div class="oq-debug-recording-actions">
          ${e&&t?`
            <button class="oq-helper-button oq-helper-button--warning oq-debug-recording-primary" type="button" data-oq-action="freeze-debug-recording" ${a?"disabled":""}>${Ke("stop")}Stop rolling</button>
          `:e?`
            <button class="oq-helper-button oq-helper-button--warning oq-debug-recording-primary" type="button" data-oq-action="stop-debug-recording" ${a?"disabled":""}>${Ke("stop")}Stop opname</button>
          `:n?`
            <button class="oq-helper-button oq-helper-button--primary oq-debug-recording-primary" type="button" data-oq-action="start-debug-recording" data-debug-minutes="${c}" ${a||o.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Ke("play")}Start opname</button>
            <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="start-rolling-debug-recording" ${a||o.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Ke("activity")}Hervat rolling</button>
          `:`
            <button class="oq-helper-button oq-helper-button--primary oq-debug-recording-primary" type="button" data-oq-action="start-debug-recording" data-debug-minutes="${c}" ${a||o.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Ke("play")}Start opname</button>
            <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="start-rolling-debug-recording" ${a||o.debugRecordingDeviceStatus?.available===!1?"disabled":""}>${Ke("activity")}Start rolling</button>
          `}
          <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="download-debug-recording" ${!b||a?"disabled":""}>${Ke("download")}${e&&t?"Download tot nu toe":"Download supportbestand"}</button>
          <button class="oq-helper-button oq-helper-button--ghost" type="button" data-oq-action="copy-debug-recording" ${!b||a?"disabled":""}>${Ke("copy")}${e&&t?"Kopieer tot nu toe":"Kopieer data"}</button>
          ${p?`
  ...
  `}function fo(e,t,n){return n?`
    ...
    `:""}function qe(e,t,n,r,a="",i=""){return`<article class="oq-settings-field${a?` ${a}`:""}" data-oq-settings-field="${s(e)}"><div class="oq-settings-field-head"><h3>${s(t)}</h3>${fo(e,t,n)}</div><div class="oq-settings-field-control">${r}</div>${i}</article>`}function X(e,t,n,r,a=""){return qe(e,t,n,`<div class="oq-settings-static-value">${s(r)}</div>`,a)}function ne(e,t={}){const n=typeof t=="number"?{decimals:t}:t||{},r=o.entities[e];if(!r)return"\u2014";const a=Number(r.value);if(!Number.isNaN(a)){const l=Number.isInteger(a)?0:Number.isFinite(n.decimals)?n.decimals:1;let c=a.toFixed(Math.max(0,l));return n.trimTrailingZeros&&c.includes(".")&&(c=c.replace(/\.?0+$/,"")),`${c}${r.uom?` ${r.uom}`:""}`}return String(r.state??r.value??"").trim()||"\u2014"}function nr(e,t="\u2014"){const n=o.entities[e];if(!n)return t;const r=String(n.state??n.value??"").trim();return!r||r==="0"||r==="\u2014"?t:r}function to(e,t="",n=2){const r=Number(e);return Number.isFinite(r)?`${r.toFixed(Math.max(0,n))}${t?` ${t}`:""}`:"\u2014"}function de(e,t=2){return ne(e,{decimals:t})}function ti(e,t,n){const r=H(t),a=H(n);if(Number.isFinite(r)&&Number.isFinite(a))return r-a;const i=H(e);return Number.isFinite(i)?i:NaN}function ms(e,t){const n=H(e),r=H(t),a=Number.isNaN(n)?"Lvl \u2014":`Lvl ${Math.round(n)}`,i=Number.isNaN(r)?"\u2014 Hz":`${Math.round(r)} Hz`;return`${a} (${i})`}function $f(e){const t=String(e||"").trim().toUpperCase();return!t||t==="0"||t==="IDLE"||t==="CM100 READY"||t==="CM100 STOPPED"||t.includes("DONE")||t.includes("FAILED")||t.includes("ABORT")||t.includes("APPLIED")||t.includes("REFUSED")?!1:t.includes("REQUESTED")||t.includes("WAITING")||t.includes("WACHTEN")||t.includes("SETTLING")||t.includes("MEASUR")||t.includes("COOLDOWN")||t.includes("RUNNING")||t.includes("VALIDATING")||t.includes("STARTED")||t.includes("RECOVER")||t.includes("PHASE")||t.includes("STEADY")||t.includes("PULSE")||t.includes("STABILIZE")||t.includes("STEP")}function te(e){const t=String(e||"").trim().toUpperCase();return t?t.includes("DONE")||t.includes("FAILED")||t.includes("ABORT")||t.includes("APPLIED")||t.includes("REFUSED"):!1}function kt(e){const t=String(e||"").trim().toUpperCase();return t.includes("WAITING_FOR_CM100")||t.includes("CM100 REQUESTED")||t.includes("WACHTEN OP CM100")||t==="WACHTEN"}function Wt(e){return $f(e)&&!kt(e)}function Bt(e,t="IDLE"){const n=nr(e,t),r=String(n??"").trim();return!r||r==="0"||r==="UNKNOWN"||r==="UNAVAILABLE"||r==="NAN"?t:r}function Hc(){const e=nr("commissioningStatus",""),t=A("cm100Active"),n=String(e||"").trim().toUpperCase();return(t||n==="CM100 READY"||n==="CM100 STOPPED"||n.includes("DONE")||n.includes("FAILED")||n.includes("ABORT")||n.includes("APPLIED")||n.includes("REFUSED"))&&(o.pendingCommissioningCm100Start=!1),n&&n!=="0"?n==="IDLE"&&o.pendingCommissioningCm100Start?"CM100 REQUESTED":n:o.pendingCommissioningCm100Start?"CM100 REQUESTED":t?"CM100 READY":"IDLE"}function Cr(e,t,n="",r=!1){return`
      <div class="oq-settings-storage-summary-metric${r?" is-on":""}">
        <span>${s(e)}</span>
        <strong>${s(t)}</strong>
        ${n?`<em>${s(n)}</em>`:""}
      </div>
    `}function Mc(e){const t=String(e||"").trim(),n=t.match(/^(\d+(?:[.,]\d+)?)\s+records?$/i);return n?`${n[1]} ${n[1]==="1"?"dag":"dagen"}`:t}function Tr(e,t,n,r="",a="",i=""){if(!v(e))return"";const l=!!E(e),c=o.loadingEntities||o.busyAction===`switch-${e}`;return`
    ...
    `}function Af(e,t,n,r=""){if(!v(e))return"";const a=o.entities[e],i=Array.isArray(a?.option)?a.option:[],l=String(E(e)||"");return i.length?`
      <article class="oq-settings-storage-row oq-settings-storage-row--select" data-oq-settings-field="${s(e)}">
        ...
        <label class="oq-settings-storage-select">
          <select class="oq-helper-select" data-oq-field="${s(e)}" ${o.loadingEntities?"disabled":""}>
            ${i.map(c=>`<option value="${s(c)}" ${c===l?"selected":""}>${s(Pe(c))}</option>`).join("")}
          </select>
          <span class="oq-settings-select-caret" aria-hidden="true"></span>
        </label>
      </article>
    `:""}function Hf(e){return v(e)||!!L[e]&&!o.optionalMissingEntities?.[e]}function Er(e,t,n,r={}){if(!Hf(e))return"";const a=v(e),i=a&&(o.loadingEntities||o.busyAction===e),l=r.disabled===!0||!a,c=r.buttonClass||"oq-helper-button oq-helper-button--ghost";return`
      <button
        class="${s(c)}"
        type="button"
        data-oq-action="${s(n)}"
    ...
    `}function He(e,t="\u2014"){return v(e)?ne(e):t}function Mf(e,t="Geen data"){const n=Number(e);return!Number.isFinite(n)||n<=0?t:`${Math.round(n)} ${Math.round(n)===1?"dag":"dagen"}`}function Pf(e,t="\u2014"){const n=Number(e);return!Number.isFinite(n)||n<=0?t:`${Math.round(n)} kB`}function Nf(e,t="0"){const n=Number(e);return!Number.isFinite(n)||n<=0?t:String(Math.round(n))}function hs(e){const t=typeof Q=="function"?Q(e):null;return t?t.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit",year:"numeric"}):"Geen data"}function Rf(e,t="Geen data"){const n=Number(e);if(!Number.isFinite(n)||n<=0)return t;const r=new Date(n*1e3),a=r.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit"}),i=r.toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"});return`${a} ${i}`}function Lf(){return typeof On!="function"?{}:On()}function Of(e){const t=Array.isArray(e.items)?e.items:[];return`
    ...
    `}function Ff(e){const t=e.filter(Boolean);return t.length?`
    ...
    `:""}function Pe(e){const t=String(e||"").trim();return t?{None:"Geen",Manual:"Handmatig",Balanced:"Gebalanceerd",Stable:"Stabiel",Responsive:"Direct",Calm:"Rustig",Custom:"Aangepast",[Vs]:"Stooklijn",[Bs]:"Power House","Dew point required":"Dauwpuntmeting vereist","Allow without dew point":"Dauwpuntsbenadering","Allow without dew point, use fallback":"Dauwpuntsbenadering","Allow without dew point, use dew point approximation":"Dauwpuntsbenadering","Allow without dew point, user responsibility":"Expliciet toestaan",Local:"Lokaal",CIC:"CIC","HA input":"HA-invoer","CIC + HA input":"CIC + HA-invoer","OT thermostat":"OT-thermostaat","Outdoor unit":"Buitenunit",Auto:"Auto","CIC or HA input":"CIC of HA-invoer","Flowmeter HP1":"Flowmeter HP1","Flowmeter HP2":"Flowmeter HP2","Local aggregate HP1/HP2":"Gecombineerde flow HP1/HP2"}[t]||t:""}function Pc(e){const t=String(e||"").trim();return t?{Ready:"Gereed","Waiting for room request":"Wacht op kamervraag","No dew point source":"Geen dauwpuntbron","OpenQuatt paused":"OpenQuatt gepauzeerd","Cooling disabled":"Koeling uitgeschakeld","Cooling minimum unavailable":"Minimale koel-aanvoer onbekend","Flow too low":"Flow te laag","Fallback active":"Dauwpuntsbenadering actief","Fallback active (+0.5\xB0C warm night)":"Dauwpuntsbenadering actief (+0,5\xB0C warme nacht)","Fallback active (+1.0\xB0C very warm night)":"Dauwpuntsbenadering actief (+1,0\xB0C zeer warme nacht)","Fallback active (+1.5\xB0C tropical night)":"Dauwpuntsbenadering actief (+1,5\xB0C tropische nacht)","User responsibility (no dew point or fallback)":"Expliciet toegestaan (geen dauwpunt of benadering)","Fallback cooling active":"Dauwpuntsbenadering actief","Fallback corrected by warm night":"Dauwpuntsbenadering gecorrigeerd door warme nacht","Fallback blocked by tropical night":"Dauwpuntsbenadering geblokkeerd door tropische nacht"}[t]||t:""}function rr({key:e,option:t,currentValue:n,busy:r,copy:a="",meta:i="",image:l="",imageAlt:c="",infoTitle:d="",infoCopy:u="",infoId:g=""}){const b=t===n,h=`
      <button
      ...
      >
        <span class="oq-settings-choice-head">
          <span class="oq-settings-choice-title">${s(Pe(t))}</span>
          ${i?`<span class="oq-settings-choice-meta"><span class="oq-settings-choice-meta-text">${s(i)}</span></span>`:""}
        </span>
        ${l?`<span class="oq-settings-choice-media"><img src="${s(l)}" alt="${s(c||Pe(t))}" loading="lazy" decoding="async"></span>`:""}
        ${a?`<span class="oq-settings-choice-copy">${s(a)}</span>`:""}
      </button>
    `;if(!u)return h;const y=d||Pe(t),p=g||`${e}-${t}`;return`
      <article class="oq-settings-choice-card-shell${b?" is-active":""}${l?" oq-settings-choice-card-shell--with-image":""}">
        ${h}
        ${fo(p,y,u)}
      </article>
    `}function bo(e={}){return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function oo(e,t,n,r=""){if(!v(e))return"";const a=o.entities[e]||{},i=String(E(e)||""),l=bo(a);return qe(e,t,n,`<label class="oq-settings-control oq-settings-control--select"><select class="oq-helper-select" data-oq-field="${s(e)}" ${o.loadingEntities?"disabled":""}>${l.map(c=>`<option value="${s(c)}" ${c===i?"selected":""}>${s(Pe(c))}</option>`).join("")}</select><span class="oq-settings-select-caret" aria-hidden="true"></span></label>`,r)}function xf(e,t,n="Aan",r="Uit"){return`<span class="oq-settings-toggle-state${t?" is-on":""}" data-oq-switch-pill="${s(e)}" data-on-label="${s(n)}" data-off-label="${s(r)}">${s(t?n:r)}</span>`}function Xo(e,t,n,r,a="Aan",i="Uit",l=!0){const c=n?a:i,d=n?"off":"on";return`
    ...
    `}function Df(e,t,n="",r=""){const a=t?n:r;return a?`<p data-oq-switch-copy="${s(e)}" data-on-copy="${s(n)}" data-off-copy="${s(r)}">${s(a)}</p>`:""}function If(e,t,n,r,a=""){if(!v(e))return"";const i=!!E(e),l=o.loadingEntities||o.busyAction===`switch-${e}`;return qe(e,t,n,`
        <div class="oq-settings-compact-switch-field">
          ${Xo(e,t,i,l)}
          ${r?`<p>${s(r)}</p>`:""}
        </div>
      `,a)}function $r(e,t,n){if(!v(e))return"";const r=!!E(e),a=o.loadingEntities||o.busyAction===`switch-${e}`;return`
    ...
    `}function zt({active:e,startKey:t,stopKey:n,startLabel:r,stopLabel:a,startClass:i="oq-helper-button oq-helper-button--primary",stopClass:l="oq-helper-button oq-helper-button--ghost",startDisabled:c=!1,stopDisabled:d=!1}){return Ne(e?n:t,e?a:r,e?l:i,e?d:c)}function Wf(e,t,n,r,a=""){if(!v(e))return"";const i=o.entities[e]||{},l=String(E(e)||""),c=bo(i),d=o.loadingEntities||o.busyAction===`save-${e}`,u=`
      <div class="oq-settings-choice-grid">
        ${c.map(g=>{const b=r[g]||"",h=typeof b=="string"?b:b.copy||"",y=typeof b=="string"?"":b.image||"",p=typeof b=="string"?"":b.alt||"";return rr({key:e,option:g,currentValue:l,busy:d,copy:h,image:y,imageAlt:p})}).join("")}
      </div>
    `;return qe(e,t,n,u,a)}function ee(e,t,n,r="",a={}){if(!v(e))return"";const i=tt(e),l=Re(e),c=a.unitOverride||i.uom||"",d=a.showUnit!==!1&&!!c,u=d&&a.unitMode!=="outside",g=Zo({key:e,value:l,meta:i,controlClass:`oq-helper-control${d&&!u?" oq-helper-control--split":""}${u?" oq-helper-control--suffix":""}`,unitMarkup:d?u?`<span class="oq-helper-unit-chip">${s(c)}</span>`:`<span class="oq-helper-unit">${s(c)}</span>`:""});return qe(e,t,n,g,r,a.footerMarkup||"")}function pt(e,t,n,r="",a={}){if(!v(e))return"";const i=tt(e),l=we(e,E(e)),c=a.minLabel||`${i.min}${i.uom||""}`,d=a.maxLabel||`${i.max}${i.uom||""}`,u=a.valueLabel||j(e,l);return qe(e,t,n,`<label class="oq-helper-slider-field"><div class="oq-helper-slider-meta"><span>${s(c)}</span><strong>${s(u)}</strong><span>${s(d)}</span></div><input class="oq-helper-range" type="range" data-oq-field="${s(e)}" min="${i.min}" max="${i.max}" step="${i.step}" value="${l}" ${o.loadingEntities?"disabled":""}></label>`,r)}function fs(e,t,n,r={}){if(!v(e))return"";const a=tt(e),i=Re(e),l=r.compact===!0,c=r.embedded===!0,d=r.infoId||e,u=r.showCopy!==!1;return`
      <article class="oq-settings-mini-field${l?" oq-settings-mini-field--compact":""}${c?" oq-settings-mini-field--embedded":""}">
        ...
        ${Zo({key:e,value:i,meta:a,controlClass:"oq-helper-control oq-helper-control--suffix",inputClass:"oq-helper-input oq-helper-input--compact-number",unitMarkup:a.uom?`<span class="oq-helper-unit-chip">${s(a.uom)}</span>`:""})}
      </article>
    `}function bs(e,t,n,r=""){if(!v(e))return"";const a=xr(E(e));return qe(e,t,n,`<label class="oq-settings-control oq-settings-control--time"><input class="oq-helper-input oq-helper-input--time" type="time" step="60" lang="nl-NL" inputmode="numeric" data-oq-field="${s(e)}" value="${s(a)}" ${o.loadingEntities?"disabled":""}><span class="oq-settings-time-icon" aria-hidden="true"><svg viewBox="0 0 20 20" focusable="false"><circle cx="10" cy="10" r="6.5" fill="none" stroke="currentColor" stroke-width="1.6" /><path d="M10 6.2 V10 L12.9 11.8" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" /></svg></span></label>`,r||"oq-settings-field--time")}function se(e,t,n,r,a=""){return`<section class="oq-settings-section"><div class="oq-settings-section-head"><div class="oq-settings-section-head-meta"><p class="oq-helper-label">${s(e)}</p>${a?`<div class="oq-settings-section-head-meta-badge">${a}</div>`:""}</div><h3>${s(t)}</h3><p>${s(n)}</p></div>${r}</section>`}function Bf(){const e=Be.has(o.settingsGroup)?o.settingsGroup:Se[0].id;return`
      <nav class="oq-settings-group-nav" aria-label="Instellingen groepen">
        ${Se.map(t=>`
          ...
          >
            ${ra(t.icon,"oq-settings-group-button-icon")}
            <span class="oq-settings-group-button-label">${s(t.label)}</span>
          </button>
        `).join("")}
      </nav>
    `}function Vf(){const e=Be.has(o.settingsGroup)?o.settingsGroup:Se[0].id;return`
      <div class="oq-settings-group-stack">
        ${(e==="installation"?[mb(),hb(),rb(),Pb(),qb(),Mb(),eb()]:e==="service"?[cb(),pb()]:e==="heating"?[Sb()]:e==="cooling"?[Rb()]:e==="integrations"?[kb(),Cb()]:[fb(),bb(),Tb(),Eb(),Hb()]).filter(Boolean).join("")}
      </div>
    `}function _f(){if(!o.root||o.appView!=="settings")return!1;const e=o.root.querySelector(".oq-settings-group-nav"),t=o.root.querySelector(".oq-settings-group-stack");if(!e||!t)return!1;const n=Be.has(o.settingsGroup)?o.settingsGroup:Se[0].id;if(n==="service")return!1;const r=e.querySelectorAll(".oq-settings-group-button");if(r.length!==Se.length)return!1;r.forEach(p=>{const S=String(p.dataset.groupId||"")===n;p.classList.toggle("is-active",S),p.setAttribute("aria-pressed",S?"true":"false")}),t.querySelectorAll(".oq-settings-info").forEach(p=>{const f=String(p.dataset.oqSettingsInfo||""),S=o.settingsInfoOpen===f;p.classList.toggle("is-open",S);const w=p.querySelector(".oq-settings-info-popover");w&&(w.hidden=!S);const q=p.querySelector(".oq-settings-info-button");q&&q.setAttribute("aria-expanded",S?"true":"false")}),t.querySelectorAll("[data-oq-settings-field]").forEach(p=>{const f=String(p.dataset.oqSettingsField||"");if(!f)return;const S=p.querySelector(".oq-settings-static-value");if(S){const T=B(f);S.textContent!==T&&(S.textContent=T)}p.querySelectorAll("select[data-oq-field]").forEach(T=>{const k=String(T.dataset.oqField||f),M=String(E(k)||"");T.value!==M&&(T.value=M)}),p.querySelectorAll("input[data-oq-field]").forEach(T=>{const k=String(T.dataset.oqField||f),M=String(Re(k)||"");T.value!==M&&(T.value=M)});const w=p.querySelector(".oq-helper-slider-meta strong"),q=p.querySelector('input[type="range"][data-oq-field]');if(w&&q){const T=j(f,we(f,E(f)));w.textContent!==T&&(w.textContent=T)}}),t.querySelectorAll("[data-select-key]").forEach(p=>{const f=String(p.dataset.selectKey||""),S=String(p.dataset.selectOption||""),w=String(E(f)||""),q=S===w;p.classList.toggle("is-active",q),p.setAttribute("aria-pressed",q?"true":"false"),f==="strategy"?p.disabled=o.loadingEntities||o.busyAction==="save-strategy":f==="hpGeneration"?p.disabled=o.loadingEntities||o.busyAction==="save-hpGeneration":f==="curveControlProfile"?p.disabled=o.loadingEntities||o.busyAction==="save-curveControlProfile":f==="phResponseProfile"&&(p.disabled=o.loadingEntities||o.busyAction==="save-phResponseProfile");const T=p.closest(".oq-settings-choice-card-shell");T&&T.classList.toggle("is-active",q)});const a=t.querySelector(".oq-settings-choice-card--static.oq-settings-choice-card--custom");if(a){const p=String(E("phResponseProfile")||"")==="Custom";a.classList.toggle("is-active",p),a.querySelectorAll("input[data-oq-field]").forEach(S=>{const w=String(S.dataset.oqField||""),q=String(Re(w)||"");S.value!==q&&(S.value=q)})}t.querySelectorAll('[data-oq-action="toggle-overview-control"][data-control-key]').forEach(p=>{const f=String(p.dataset.controlKey||""),S=!!E(f),w=String(p.dataset.onLabel||"Aan"),q=String(p.dataset.offLabel||"Uit"),T=String(p.dataset.switchTitle||f),k=S?w:q;p.dataset.controlState=S?"off":"on",p.classList.toggle("is-on",S),p.setAttribute("aria-checked",S?"true":"false"),p.setAttribute("aria-label",`${T}: ${k}`),p.disabled=o.loadingEntities||o.busyAction===`switch-${f}`}),t.querySelectorAll("[data-oq-switch-pill]").forEach(p=>{const f=String(p.dataset.oqSwitchPill||""),S=!!E(f),w=String(p.dataset.onLabel||"Aan"),q=String(p.dataset.offLabel||"Uit"),T=S?w:q;p.classList.toggle("is-on",S),p.textContent!==T&&(p.textContent=T)}),t.querySelectorAll("[data-oq-switch-copy]").forEach(p=>{const f=String(p.dataset.oqSwitchCopy||""),S=!!E(f),w=String(p.dataset.onCopy||""),q=String(p.dataset.offCopy||""),T=S?w:q;p.hidden=!T,p.textContent!==T&&(p.textContent=T)});const i=t.querySelector('button[data-oq-action="open-generation-modal"]')?.closest(".oq-settings-quickstart-status");if(i){const p=i.querySelector(".oq-settings-quickstart-status-value"),f=i.querySelector(".oq-settings-quickstart-status-copy"),S=i.querySelector('button[data-oq-action="open-generation-modal"]'),w=Uo(),q=o.entities.hpGeneration||{},T=v("hpGeneration")&&bo(q).length>0;if(p){const k=w||"Onbekend";p.textContent!==k&&(p.textContent=k)}if(f){const k="Pas dit aan als je een andere Quatt Hybrid hebt.";f.textContent!==k&&(f.textContent=k)}S&&(S.disabled=!T||o.loadingEntities||o.busyAction==="save-hpGeneration")}const l=t.querySelector('button[data-oq-action="open-cm100-commissioning-modal"]')?.closest(".oq-settings-quickstart-status");if(l){const p=l.querySelector(".oq-settings-quickstart-status-value"),f=l.querySelector(".oq-settings-quickstart-status-copy"),S=l.querySelector('button[data-oq-action="open-cm100-commissioning-modal"]'),w=Hc(),q=A("cm100Active");p&&p.textContent!==w&&(p.textContent=w);const T=q?"CM100 is actief en klaar voor commissioning.":"Open de modal om CM100 te starten en de taken hieronder te ontgrendelen.";f&&f.textContent!==T&&(f.textContent=T),S&&(S.disabled=o.loadingEntities)}const c=t.querySelector('button[data-oq-action="reset"]')?.closest(".oq-settings-quickstart-status");if(c){const p=c.querySelector(".oq-settings-quickstart-status-value"),f=c.querySelector(".oq-settings-quickstart-status-copy"),S=c.querySelector('button[data-oq-action="reset"]'),w=o.complete===!0?"Afgerond":o.complete===!1?"Open":"Laden...",q=o.complete===!0?"Quick Start is afgerond. Je kunt de status hier altijd weer openen met een reset.":o.complete===!1?"Quick Start staat nog open. Gebruik de resetknop om opnieuw te beginnen.":"De status van Quick Start wordt nog geladen.";p&&p.textContent!==w&&(p.textContent=w),f&&f.textContent!==q&&(f.textContent=q),S&&(S.disabled=o.busyAction==="reset")}const d=t.querySelectorAll("[data-oq-access-security-item]");d.length&&d.forEach(p=>{const f=String(p.dataset.oqAccessSecurityItem||""),S=p.querySelector(".oq-settings-quickstart-status-value"),w=p.querySelector(".oq-settings-quickstart-status-copy"),q=p.querySelector("button[data-oq-action]");if(f==="login"){const T=Fa(),k=xa();S&&S.textContent!==T&&(S.textContent=T),w&&w.textContent!==k&&(w.textContent=k)}else if(f==="api"){const T=ni(),k=ri();S&&S.textContent!==T&&(S.textContent=T),w&&w.textContent!==k&&(w.textContent=k)}q&&(q.disabled=!1)});const u=t.querySelector(".oq-settings-system-summary");if(u){const p=u.querySelectorAll(".oq-settings-system-row"),f={uptime:ka(),ip:Ca(),updates:zo(),datetime:ml(),espTemp:kl(),restart:"Opnieuw opstarten"};p.forEach(q=>{const T=q.querySelector(".oq-settings-system-row-value"),k=q.dataset.oqDiagnosticsRow||"";if(T&&Object.prototype.hasOwnProperty.call(f,k)){const M=f[k];T.textContent!==M&&(T.textContent=M)}});const S=u.querySelector('button[data-oq-action="open-update-modal"]');S&&(S.disabled=!1);const w=u.querySelector('button[data-oq-action="open-restart-confirm"]');if(w){const q=o.busyAction==="restartAction";w.disabled=q,w.textContent=q?"Herstarten...":"Herstarten"}}t.querySelectorAll(".oq-settings-hp-offset-row").forEach(p=>{const f=String(p.dataset.oqSettingsField||""),S=String(p.dataset.oqHpOffsetRawKey||""),w=String(p.dataset.oqHpOffsetFinalKey||"");if(!f||!S||!w)return;const q=tt(f),T=ti(S,w,f),k=Ze(Re(f)),M=Number.isFinite(T)&&Number.isFinite(k)?to(T+k,q.uom||"\xB0C",2):de(w,2),x=p.querySelector("[data-oq-hp-offset-active]");if(x){const C=`${de(w,2)} actief`;x.textContent!==C&&(x.textContent=C)}const F=p.querySelector("[data-oq-hp-offset-raw]");if(F){const C=Number.isFinite(T)?to(T,q.uom||"\xB0C",2):de(S,2);F.textContent!==C&&(F.textContent=C)}const U=p.querySelector("[data-oq-hp-offset-final]");U&&U.textContent!==M&&(U.textContent=M)});const g=t.querySelector(".oq-settings-curve-shell"),b=ce();if(!!g!==b)return!1;const h=!!a,y=String(E("phResponseProfile")||"")==="Custom";return h===y}function jf(e=!1){const t=jl();return t?`
    ...
    `}function Uf(){return In.filter(e=>v(le(e,"Status"))||v(le(e,"Load"))||v(Jt(e,"cooling",0)))}function zf(e){return Ze(Re(e))}function Gf(e){const t=[];return ta.forEach(n=>{let r=-1/0;Ao.forEach(a=>{const i=Jt(e,n,a),l=zf(i);(!Number.isFinite(l)||l<0||l>120||l<r)&&t.push(`${n==="cooling"?"C":"H"}F${a}`),Number.isFinite(l)&&(r=l)})}),{valid:t.length===0,invalid:t}}function Qf(e){const t=String(E(`hp${e}Mode`)||"").trim(),n=Ze(E(`hp${e}Freq`)),r=t&&t!=="Onbekend"&&t!=="Unknown",a=Number.isFinite(n),i=r&&/standby|stand-by/i.test(t),l=a&&n<=.5,c=r?i?a?l?"Standby en compressor uit.":`Compressor draait op ${n.toFixed(0)} Hz.`:"Compressorfrequentie is onbekend.":`ODU staat in ${t}.`:"ODU status is onbekend.";return{mode:r?t:"Onbekend",freq:Number.isFinite(n)?`${n.toFixed(0)} Hz`:"Onbekend",safe:i&&l,reason:c}}function Yf(e){const t=String(e||"").toUpperCase();return!e||t==="UNKNOWN"||t==="UNAVAILABLE"?"Nog geen readback of apply-status ontvangen.":t.includes("APPLIED")?"Runtime registers zijn geschreven en via readback bevestigd. Een ODU powercycle zet de originele tabel terug.":t.includes("GUARD_READ_REQUESTED")?"Firmware leest actuele ODU mode en compressorfrequentie voordat er geschreven wordt.":t.includes("WRITE_QUEUED")||t.includes("WRITE_CONFIRMED")?"Runtime write loopt; wacht op bevestigde readback voordat je de waarden vertrouwt.":t.includes("FAILED")?"Firmware kon de runtime tabel niet volledig bevestigen. Laad opnieuw voordat je verder test.":t.includes("LOADED")?"Readback is in de velden geladen. Controleer de waarden voordat je schrijft.":t.includes("BLOCKED")?"Firmware heeft de actie geblokkeerd; controleer enable, standby en compressorstatus.":t.includes("LOAD_REQUESTED")?"Readback is aangevraagd bij de ODU.":"Laatste status van de experimentele runtime tabel."}function vs(e,t){return v(e)?Zo({key:e,value:Re(e),meta:tt(e),controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-odu-runtime-control",inputClass:"oq-helper-input oq-helper-input--compact-number oq-settings-odu-runtime-input",inputAttributes:`data-oq-odu-runtime-tab-index="${t}"`,unitMarkup:'<span class="oq-helper-unit-chip">Hz</span>'}):'<span class="oq-settings-odu-runtime-missing">-</span>'}function Jf(e){const t=Ao.length;return`
    ...
    `}function Zf(e){if(e.key!=="Tab"||e.altKey||e.ctrlKey||e.metaKey)return;const t=e.target&&e.target.closest?e.target.closest("input[data-oq-odu-runtime-tab-index]"):null,n=t?t.closest(".oq-settings-odu-runtime-table"):null;if(!t||!n)return;const r=Array.from(n.querySelectorAll("input[data-oq-odu-runtime-tab-index]:not(:disabled)")).sort((l,c)=>Number(l.dataset.oqOduRuntimeTabIndex||0)-Number(c.dataset.oqOduRuntimeTabIndex||0)),a=r.indexOf(t),i=r[a+(e.shiftKey?-1:1)];a<0||!i||(e.preventDefault(),i.focus(),typeof i.select=="function"&&i.select())}function Xf(e){const t=le(e,"Enable"),n=le(e,"Load"),r=le(e,"Apply"),a=le(e,"Status"),i=String(E(a)||"").trim()||"Nog niet geladen",l=Gf(e),c=Qf(e),d=!!E(t),u=o.loadingEntities||o.busyAction===n||o.busyAction===r,g=u||!d||!l.valid||!c.safe||!v(r),b=l.valid?"Waarden zijn 0-120 Hz en per tabel oplopend.":`Controleer ${l.invalid.slice(0,5).join(", ")}${l.invalid.length>5?"...":""}.`;return`
      <article class="oq-settings-odu-runtime-panel">
        <div class="oq-settings-odu-runtime-panel-head">
          ...
          <div class="oq-settings-odu-runtime-actions">
            ${v(n)?Ne(n,o.busyAction===n?"Lezen...":"Uit ODU laden","oq-helper-button oq-helper-button--ghost",u):""}
      ${v(t)?Xo(t,`HP${e} writes vrijgeven`,d,u,"Enable","Locked"):""}
    ...
    `}function eb(){const e=Uf();return e.length?`
    ...
    `:""}function Oc(e="oq-settings-grid"){return`
      <div class="${s(e)}">
    ...
    `}function Fc(e="oq-settings-grid"){const t=tb();return`
      <div class="${s(e)}">
        ...
        <article class="oq-settings-hp-offset-row" data-oq-settings-field="${s(n.offsetKey)}" data-oq-hp-offset-raw-key="${s(n.rawKey)}" data-oq-hp-offset-final-key="${s(n.finalKey)}">
          ...
          <div class="oq-settings-hp-offset-equation" aria-label="${s(`${n.label} correctie`)}">
            ...
            <label class="oq-settings-hp-offset-input">
              <span>Correctie</span>
              ${Zo({key:n.offsetKey,value:Re(n.offsetKey),meta:r,controlClass:"oq-helper-control oq-helper-control--suffix",inputClass:"oq-helper-input oq-helper-input--compact-number",unitMarkup:r.uom?`<span class="oq-helper-unit-chip">${s(r.uom)}</span>`:""})}
            </label>
            <span class="oq-settings-hp-offset-operator">=</span>
    ...
    `}function oi(e="oq-settings-grid"){return`
      <div class="${s(e)}">
        ...
        ${pt("silentMax","Maximaal niveau tijdens stille uren","Zo ver mag het systeem nog opschalen tijdens stille uren.")}
        ${pt("dayMax","Maximaal niveau overdag","Zo ver mag het systeem overdag opschalen.")}
      </div>
    `}function xc(){const e=ce();return`
    ...
    `}function ob(){if(!v("phResponseProfile"))return"";const e=String(E("phResponseProfile")||""),t=o.loadingEntities||o.busyAction==="save-phResponseProfile",r=`
    ...
    `;return qe("phResponseProfile","Power House responsprofiel","Kies hoe rustig of direct Power House mag reageren op veranderingen in je woning.",r,"oq-settings-field--span-2")}function Dc(){if(!v("curveControlProfile"))return"";const e=String(E("curveControlProfile")||""),t=o.loadingEntities||o.busyAction==="save-curveControlProfile",r=`
    ...
    `;return qe("curveControlProfile","Regelprofiel","Kies of de stooklijn vooral comfortabel, gebalanceerd of rustig moet reageren.",r,"oq-settings-field--span-2")}function nb(){const e=(R,V=0)=>{const P=H(R);return Number.isNaN(P)?V:Math.max(0,P)},n=e("phComfortBelow",.1),r=e("phComfortAbove",.3),a=e("phKp",3e3),i=20-n,l=20+r,c=620,d=184,u=46,g=24,b=18,h=40,y=96,p=c-u-g,f=Math.min(20-1.2,i-.35),S=Math.max(20+1.2,l+.35),w=R=>u+(R-f)/Math.max(.01,S-f)*p,q=w(f),T=w(S),k=w(i),M=w(20),x=w(l),F=Math.abs(i-20)>.001,U=Math.abs(l-20)>.001,C=b+24,$=d-h,N=y-44,W=(R,V,P,O="")=>{const ge=Math.max(q+4,Math.min(T-110-4,R-55)),ue=R-14,J=N,at=28,ke=y-N+16;return`
        <g class="oq-ph-concept-hotspot" tabindex="0" role="img" aria-label="${s(`${V} ${P}`)}">
          <rect class="oq-ph-concept-hit" x="${ue}" y="${J}" width="${at}" height="${ke}" rx="10"></rect>
      ...
      `},K=[`M ${q.toFixed(1)} ${C.toFixed(1)}`,`L ${k.toFixed(1)} ${y.toFixed(1)}`,`L ${x.toFixed(1)} ${y.toFixed(1)}`,`L ${T.toFixed(1)} ${$.toFixed(1)}`].join(" ");return`
      <div class="oq-ph-concept-card">
        <div class="oq-ph-concept-visual">
          ...
          <svg class="oq-ph-concept-svg" viewBox="0 0 ${c} ${d}" role="img" aria-label="Grafiek voor Power House tuning">
            ...
            <rect x="${k.toFixed(1)}" y="${b}" width="${Math.max(20,x-k).toFixed(1)}" height="${(d-b-h).toFixed(1)}" rx="18" class="oq-ph-concept-band oq-ph-concept-band--calm"></rect>
            <rect x="${x.toFixed(1)}" y="${b}" width="${Math.max(20,T-x).toFixed(1)}" height="${(d-b-h).toFixed(1)}" rx="18" class="oq-ph-concept-band oq-ph-concept-band--above"></rect>
            ...
            ${F?`<line x1="${k}" y1="${y-12}" x2="${k}" y2="${y+12}" class="oq-ph-concept-marker oq-ph-concept-marker--below"></line>`:""}
            <line x1="${M}" y1="${y-14}" x2="${M}" y2="${y+14}" class="oq-ph-concept-marker oq-ph-concept-marker--setpoint"></line>
            ${U?`<line x1="${x}" y1="${y-12}" x2="${x}" y2="${y+12}" class="oq-ph-concept-marker oq-ph-concept-marker--above"></line>`:""}
            ${F?`<circle cx="${k}" cy="${y}" r="5" class="oq-ph-concept-point oq-ph-concept-point--below"></circle>`:""}
            <circle cx="${M}" cy="${y}" r="6" class="oq-ph-concept-point oq-ph-concept-point--setpoint"></circle>
            ${U?`<circle cx="${x}" cy="${y}" r="5" class="oq-ph-concept-point oq-ph-concept-point--above"></circle>`:""}
            ${F?W(k,"Comfort onder setpoint",I(i,1,"\xB0C"),"below"):""}
            ${W(M,"Setpoint",I(20,1,"\xB0C"),"setpoint")}
            ${U?W(x,"Comfort boven setpoint",I(l,1,"\xB0C"),"above"):""}
            ...
            <text x="${M}" y="${d-14}" text-anchor="middle" class="oq-ph-concept-tick-value oq-ph-concept-tick-value--setpoint">${s(I(20,1,"\xB0C"))}</text>
            ${U?`<text x="${x+5}" y="${d-14}" text-anchor="start" class="oq-ph-concept-tick-value">${s(I(l,1,"\xB0C"))}</text>`:""}
          </svg>
        </div>
    ...
    `:""}function rb(){const e=Kf();return se("Installatie","Flowregeling","Kies hoe de pomp wordt geregeld en stel de flow-instellingen direct als installatieparameter in. De autotune vind je later bij Service & commissioning.",`
        ${Lc()}
        ${e?`
          <div class="oq-settings-subpanel oq-settings-subpanel--nested">
            <div class="oq-settings-subpanel-head">
        ...
        `:""}
      `)}function z(e){return v(e)&&A(e)}function ft(e){return!v(e)||A(e)}function ws(e){return v(e)?Wo(B(e,"None")):""}const ab=new Set(["compressor oil return"]);function ib(e){const t=Wo(e);return t==="Geen actieve storingen"?[]:t.split(",").map(n=>n.trim()).filter(n=>n&&!ab.has(n.toLowerCase()))}function Wc(e){const t=ib(e);return t.length>0?t.join(", "):"Geen actieve storingen"}function Kr(e){return v(e)?Wc(B(e,"None")):""}function Rn(e){const t=Kr(e).trim().toLowerCase();return!!t&&t!=="geen actieve storingen"}function ar(){const e=[],t=z("compressorCyclingWarning2h")||z("compressorCyclingWarning72h")||z("alternatingCompressorStartsWarning"),n=z("compressorCyclingAlertLatched"),r=ft("cicPollingEnabled"),a=ft("otEnabled"),i=(c,d)=>{z(c)&&e.push({key:c,label:d})};i("compressorCyclingWarning2h","Te veel compressorstarts in 2 uur"),i("compressorCyclingWarning72h","Te veel compressorstarts in 72 uur"),i("alternatingCompressorStartsWarning","Warmtepompen starten opvallend vaak om en om"),i("lowflowFaultActive","Te lage flow"),i("flowMismatch","Flowverschil tussen warmtepomp 1 en 2"),r&&i("cicDataStale","CIC-data is verouderd"),a&&i("otLinkProblem","OpenTherm-verbinding meldt een probleem"),Rn("hp1Failures")&&e.push({key:"hp1Failures",label:`Warmtepomp 1: ${Kr("hp1Failures")}`}),Rn("hp2Failures")&&e.push({key:"hp2Failures",label:`Warmtepomp 2: ${Kr("hp2Failures")}`});const l=e.length;return n&&!t&&e.unshift({key:"compressorCyclingAlertLatched",label:"Pendelen eerder gedetecteerd; melding nog niet bevestigd"}),{problems:e,active:e.length>0,cyclingAlertLatched:n,cyclingAlertActive:t,cyclingAlertRecovered:n&&!t,title:l>0?"Aandacht nodig":n?"Eerdere waarschuwing nog niet bevestigd":"Geen bijzonderheden",copy:l>0?`${e.length} aandachtspunt${e.length===1?"":"en"} zichtbaar. Bekijk hieronder de details.`:n?"Het pendelen is hersteld. De melding blijft zichtbaar totdat je haar bevestigt.":"OpenQuatt ziet op dit moment geen actieve aandachtspunten in de bewaakte signalen."}}function Ln(e,t="Aandacht",n="OK"){return`<span class="oq-settings-monitoring-badge${e?" is-warning":" is-clear"}">${s(e?t:n)}</span>`}function _t({label:e,value:t,note:n="",active:r=!1}){return`
    ...
    `}function dt(e){const t=H(e);return Number.isNaN(t)?"\u2014":String(Math.max(0,Math.round(t)))}function sb(e){const t=H(e);if(Number.isNaN(t))return"Nog niet gemeten";if(t<1)return"Zojuist";if(t<60)return`${Math.round(t)} min geleden`;const n=Math.floor(t/60),r=Math.round(t%60);return`${n}u ${r}m geleden`}function Ss(e){const t=H(e);return Number.isNaN(t)||t<=0?"Tijdstip onbekend":new Intl.DateTimeFormat("nl-NL",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}).format(new Date(t*1e3))}function lb(e){if(!e.cyclingAlertLatched)return"";const t=z("compressorCyclingAlertAlternating"),n=dt("compressorCyclingAlertHp1Peak2h"),r=dt("compressorCyclingAlertHp1Peak72h"),a=v("compressorCyclingAlertHp2Peak2h")?dt("compressorCyclingAlertHp2Peak2h"):"",i=v("compressorCyclingAlertHp2Peak72h")?dt("compressorCyclingAlertHp2Peak72h"):"";return`
      <div class="oq-settings-monitoring-incident${e.cyclingAlertActive?" is-active":" is-recovered"}">
        <div class="oq-settings-monitoring-incident-head">
          ...
          ${Ln(e.cyclingAlertActive,"Actief","Hersteld")}
        </div>
    ...
    `}function qs(e,t){return v(`${t}CompressorStarts2h`)?`
      <div class="oq-settings-monitoring-compressor-unit">
        ...
        <dl>
          <div><dt>2 uur</dt><dd>${s(dt(`${t}CompressorStarts2h`))}</dd></div>
          <div><dt>6 uur</dt><dd>${s(dt(`${t}CompressorStarts6h`))}</dd></div>
          <div><dt>24 uur</dt><dd>${s(dt(`${t}CompressorStarts24h`))}</dd></div>
          <div><dt>72 uur</dt><dd>${s(dt(`${t}CompressorStarts72h`))}</dd></div>
        </dl>
      </div>
    `:""}function Bc(e){const t=e.active?e.problems.map(n=>n.key).sort().join("|"):"";if(!t){o.installationMonitoringProblemSignature="";return}t!==o.installationMonitoringProblemSignature&&(o.installationMonitoringProblemSignature=t,o.installationMonitoringDetailsOpen=!0)}function cb(){const e=ar();Bc(e);const t=ft("cicPollingEnabled"),n=ft("otEnabled"),r=[v("lowflowFaultActive")?_t({label:"Flow",value:z("lowflowFaultActive")?"Te lage flow gemeld":"Geen lage-flowmelding",active:z("lowflowFaultActive")}):"",v("flowMismatch")?_t({label:"Flowvergelijking duo",value:z("flowMismatch")?"Afwijking tussen warmtepompen":"Geen afwijking gemeld",active:z("flowMismatch")}):""].filter(Boolean).join(""),a=[v("cicDataStale")?_t({label:"CIC-data",value:t?z("cicDataStale")?"Verouderd":"Geen probleem gemeld":"Polling uitgeschakeld",active:t&&z("cicDataStale")}):"",v("otLinkProblem")?_t({label:"OpenTherm",value:n?z("otLinkProblem")?"Verbindingsprobleem":"Geen probleem gemeld":"Uitgeschakeld",active:n&&z("otLinkProblem")}):""].filter(Boolean).join(""),i=[v("hp1Failures")?_t({label:"Warmtepomp 1",value:ws("hp1Failures"),active:Rn("hp1Failures")}):"",v("hp2Failures")?_t({label:"Warmtepomp 2",value:ws("hp2Failures"),active:Rn("hp2Failures")}):""].filter(Boolean).join(""),l=H("compressorStarts2hWarningLimit"),c=H("compressorStarts72hWarningLimit"),d=z("compressorCyclingWarning2h")||z("compressorCyclingWarning72h")||z("alternatingCompressorStartsWarning")||e.cyclingAlertLatched,u=r?`
    ...
    `:"";return se("Bewaking","Installatiebewaking","Lokale diagnose voor compressorstarts, hydrauliek en verbindingen. Hiervoor is geen Home Assistant nodig.",`
        <div class="oq-settings-monitoring-summary${e.active?" is-warning":" is-clear"}">
          ...
          ${Ln(e.active,"Aandacht nodig","Alles rustig")}
        </div>
        ...
        <div class="oq-settings-monitoring-grid">
          ...
          <article class="oq-settings-monitoring-card">
            ...
            ${pt("compressorStarts2hWarningLimit","Alarmwaarde voor aantal starts per 2 uur","Aantal starts per warmtepomp binnen 2 uur.","oq-settings-field--compact",{minLabel:"1",maxLabel:"20",valueLabel:Number.isNaN(l)?"\u2014":`${Math.round(l)} starts / 2 uur`})}
            ${pt("compressorStarts72hWarningLimit","Alarmwaarde voor aantal starts per 72 uur","Aantal starts per warmtepomp binnen 72 uur.","oq-settings-field--compact",{minLabel:"1",maxLabel:"120",valueLabel:Number.isNaN(c)?"\u2014":`${Math.round(c)} starts / 72 uur`})}
          </article>
          ${g}
          </div>
          <div class="oq-settings-monitoring-column">
      ...
      `)}function ub({status:e,running:t,resultReady:n,startDisabled:r,abortDisabled:a,applyDisabled:i,busy:l,controlsAvailable:c}){const d=String(e||"").toUpperCase(),u=d.includes("FAILED")||d.includes("REFUSED")||d.includes("ABORT"),g=d.includes("APPLIED"),b=v("hp2WaterIn")||v("hp2WaterOut")||v("hp2WaterInRaw")||v("hp2WaterOutRaw"),h=H("hpWaterCalibrationStableProgress"),y=H("hpWaterCalibrationStableRequired"),p=H("hpWaterCalibrationRemaining"),f=Math.round(H("hpWaterCalibrationPhase")),S=t&&(f===1||d.includes("MIXING")),w=t&&!S,q=300,T=60,k=Number.isFinite(p)?Math.max(0,q-p):NaN,M=Number.isFinite(k)?Math.max(0,T-k):NaN,x=S&&Number.isFinite(k)?Math.max(0,Math.min(100,k/T*100)):w&&Number.isFinite(h)&&Number.isFinite(y)&&y>0?Math.max(0,Math.min(100,h/y*100)):t&&Number.isFinite(p)?Math.max(0,Math.min(100,100-p/q*100)):n?100:0,F=n&&v("hpWaterCalibrationResultSpreadBefore")?de("hpWaterCalibrationResultSpreadBefore",2):de("hpWaterCalibrationSpread",2),U=S?"Water mengen":Number.isFinite(h)&&Number.isFinite(y)&&y>0?h>0?`${Math.round(Math.max(0,h))} / ${Math.round(y)} s binnen grenzen`:"Nog niet binnen grenzen":"Wachten op stabiel venster",C=n?3:t?2:1,$=g?"Offsets toegepast":n?`Meting klaar - spreiding ${F}`:t?S?`Water mengen${Number.isFinite(M)&&M>0?` - meting start over ${Math.round(M)} s`:""}`:`Meting bezig - ${Number.isFinite(p)&&p>0?`max. ${Math.round(p)} s resterend`:U}`:u?"Meting niet voltooid":"Voorbereiding",N=g?"De voorgestelde offsets zijn opgeslagen.":n?"Controleer de voorgestelde offsets en pas ze toe.":t?S?"De waterpomp circuleert zonder compressor zodat de watertemperaturen eerst kunnen mengen.":"De firmware stopt zodra het laatste meetvenster binnen de spreiding- en driftgrenzen valt.":u?nr("hpWaterCalibrationStatus","Controleer de voorwaarden en start opnieuw."):b?"Start alleen wanneer compressor en boiler uit zijn. HP1 en HP2 water in/out worden samen naar een relatieve referentie gebracht.":"Start alleen wanneer compressor en boiler uit zijn. Bij single setup wordt HP1 water in/out onderling gelijkgetrokken; supply blijft diagnose.",W=[{label:"HP1 water in",rawKey:"hp1WaterInRaw",liveKey:"hp1WaterIn",resultRawKey:"hpWaterCalibrationResultHp1InRawAvg",offsetKey:"hp1WaterInOffset",suggestedKey:"hp1WaterInOffsetSuggested"},{label:"HP1 water uit",rawKey:"hp1WaterOutRaw",liveKey:"hp1WaterOut",resultRawKey:"hpWaterCalibrationResultHp1OutRawAvg",offsetKey:"hp1WaterOutOffset",suggestedKey:"hp1WaterOutOffsetSuggested"},{label:"HP2 water in",rawKey:"hp2WaterInRaw",liveKey:"hp2WaterIn",resultRawKey:"hpWaterCalibrationResultHp2InRawAvg",offsetKey:"hp2WaterInOffset",suggestedKey:"hp2WaterInOffsetSuggested"},{label:"HP2 water uit",rawKey:"hp2WaterOutRaw",liveKey:"hp2WaterOut",resultRawKey:"hpWaterCalibrationResultHp2OutRawAvg",offsetKey:"hp2WaterOutOffset",suggestedKey:"hp2WaterOutOffsetSuggested"}].filter(P=>v(P.liveKey)||v(P.rawKey)||v(P.offsetKey)),K=(P,O)=>{const _=C>P;return`
        <div class="oq-settings-hp-calibration-step${_?" is-done":""}${C===P?" is-active":""}">
          <span>${_?"\u2713":P}</span>
          <strong>${s(O)}</strong>
        </div>
      `},R=P=>`
      ...
      `,V=P=>{const O=H(P.resultRawKey),_=Number.isFinite(O)?O:ti(P.rawKey,P.liveKey,P.offsetKey),Y=H(P.suggestedKey),ge=Number.isFinite(_)&&Number.isFinite(Y)?to(_+Y,o.entities[P.suggestedKey]?.uom||"\xB0C",2):"\u2014";return`
        <tr>
      ...
      <div class="oq-settings-hp-calibration">
        ...
        <div class="oq-settings-hp-calibration-status${n?" is-success":t?" is-active":u?" is-warning":""}">
          <div>
            <strong>${s($)}</strong>
            <p>${s(N)}</p>
          </div>
    ...
    `}function Vc(){const e=v("boilerCvAssistEnabled")&&A("boilerCvAssistEnabled"),t=Hc(),n=A("cm100Active"),r=String(t||"").trim().toUpperCase(),a=kt(t),i=!a&&(n||r==="CM100 READY"),l=o.commissioningTaskLock==="cm100",c=o.loadingEntities||o.busyAction==="commissioningCm100Start"||o.busyAction==="commissioningCm100Stop"||l,d=!!o.pendingCommissioningCm100Start,u=c||i||a,g=c||!i,b=Bt("boilerPowerTestStatus","IDLE"),h=mn(b,"boiler"),y=A("boilerPowerTestActive"),p=o.loadingEntities||o.busyAction==="boilerPowerTestStart"||o.busyAction==="boilerPowerTestAbort"||o.busyAction==="boilerPowerTestApply",f=!!(o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort||o.entities.boilerPowerTestApply),S=!!o.pendingBoilerPowerTestStart,w=o.commissioningTaskLock==="boiler",q=kt(b),k=!te(b)&&(y||S||w||Wt(b))&&!q,M=ne("boilerRatedHeatPower"),x=ne("boilerHeatPower"),F=H("boilerHeatPower"),U=F>0?x:k&&o.commissioningBoilerHeatPowerDisplay?o.commissioningBoilerHeatPowerDisplay:x;F>0&&(o.commissioningBoilerHeatPowerDisplay=x);const C=Bt("flowAutotuneStatus","IDLE"),$=mn(C,"autotune"),N=o.loadingEntities||o.busyAction==="flowAutotuneStart"||o.busyAction==="flowAutotuneAbort"||o.busyAction==="flowAutotuneApply",W=!!(o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort||o.entities.flowAutotuneApply),K=!!o.pendingFlowAutotuneStart,R=o.commissioningTaskLock==="autotune",V=kt(C),O=!te(C)&&(K||R||Wt(C))&&!V,_=Bt("airPurgeStatus","IDLE"),Y=mn(_,"purge"),ge=A("airPurgeActive"),ue=o.loadingEntities||o.busyAction==="airPurgeStart"||o.busyAction==="airPurgeAbort",J=!!(o.entities.airPurgeStart||o.entities.airPurgeAbort),at=!!o.pendingAirPurgeStart,ke=o.commissioningTaskLock==="purge",me=!te(_)&&(ge||at||ke||Wt(_)),hr=/DONE/.test(String(_||"").toUpperCase()),he=!!(J||o.entities.airPurgeStatus||o.entities.airPurgeReturnToAuto),fr=ne("airPurgeRemaining",{decimals:0}),wo=H("airPurgePhase"),rn=wo===1?"Rustig":wo===2?"Pulsen":wo===3?"Stabiliseren":Y.phase,St=Bt("manualFlowStatus","IDLE"),Ft=A("manualFlowActive"),je=o.loadingEntities||o.busyAction==="manualFlowStart"||o.busyAction==="manualFlowAbort",So=!!(o.entities.manualFlowStart||o.entities.manualFlowAbort),xt=!!o.pendingManualFlowStart,Le=o.commissioningTaskLock==="manual-flow",Ce=!te(St)&&(Ft||xt||Le||Wt(St)),it=Bt("manualHpStatus","IDLE"),qo=A("manualHpActive"),Dt=o.loadingEntities||o.busyAction==="manualHpStart"||o.busyAction==="manualHpAbort",an=!!(o.entities.manualHpStart||o.entities.manualHpAbort),It=!!o.pendingManualHpStart,Oe=o.commissioningTaskLock==="manual-hp",Fe=!te(it)&&(qo||It||Oe||Wt(it)),Ci=/SAFETY STOP/.test(String(it||"").toUpperCase()),Ti=/STOPPING/.test(String(it||"").toUpperCase()),st=Bt("hpWaterCalibrationStatus","IDLE"),ju=mn(st,"hp-water-calibration"),Ei=A("hpWaterCalibrationActive"),sn=o.loadingEntities||o.busyAction==="hpWaterCalibrationStart"||o.busyAction==="hpWaterCalibrationAbort"||o.busyAction==="hpWaterCalibrationApply",$i=!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort||o.entities.hpWaterCalibrationApply),ln=!!o.pendingHpWaterCalibrationStart,lt=o.commissioningTaskLock==="hp-water-calibration",ye=!te(st)&&(Ei||ln||lt||Wt(st)),cn=/DONE|APPLIED/.test(String(st||"").toUpperCase()),Ai=/APPLIED/.test(String(st||"").toUpperCase()),Ku=ne("flowKpSuggested",{decimals:5,trimTrailingZeros:!0}),Uu=ne("flowKiSuggested",{decimals:5,trimTrailingZeros:!0}),Hi=/DONE|APPLIED/.test(String(b||"").toUpperCase()),Mi=/DONE|APPLIED/.test(String(C||"").toUpperCase()),br=i?q?"Wachten op CM100":k?h.phase:Hi?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",vr=i?V?"Wachten op CM100":O?$.phase:Mi?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",yr=i?me?Y.phase:hr?"Klaar":"Klaar om te starten":"Wachten op CM100",Pi=i?Ce?"Actief":"Klaar om te starten":"Wachten op CM100",Ni=i?Fe?Ti?"Bezig met stoppen":Ci?"Veiligheidsstop":"Actief":"Klaar om te starten":"Wachten op CM100",Ri=i?ye?ju.phase:Ai?"Offsets toegepast":cn?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",Li=!i||p||!f||O||me||Ce||Fe||ye||k||R||ke||Le||Oe||lt||S,zu=p||!(k||w||S),Gu=p||Li||!Hi||O||me||ye,Oi=!i||N||!W||k||me||Ce||Fe||ye||O||w||ke||Le||Oe||lt||K,Qu=N||!(O||R||K),Yu=N||Oi||!Mi||k||me||ye,Ju=!i||ue||!J||k||O||Ce||Fe||ye||me||w||R||Le||Oe||lt||at,Zu=ue||!(me||ke||at),Xu=!i||je||!So||k||O||me||Fe||ye||Ce||w||R||ke||Oe||lt||xt,ed=je||!(Ce||Le||xt),td=!i||Dt||!an||k||O||me||Ce||ye||Fe||w||R||ke||Le||lt||It,od=Dt||!(Fe||Oe||It),nd=!i||sn||!$i||k||O||me||Ce||Fe||ye||w||R||ke||Le||Oe||ln,rd=sn||!(ye||lt||ln),ad=sn||ye||!cn||Ai;d&&i&&(o.pendingCommissioningCm100Start=!1),l&&(i||/READY|STOPPED|DONE|FAILED|ABORT|APPLIED|REFUSED/.test(r))&&(o.commissioningTaskLock=""),S&&(y||te(b))&&(o.pendingBoilerPowerTestStart=!1),w&&te(b)&&(o.commissioningTaskLock=""),K&&te(C)&&(o.pendingFlowAutotuneStart=!1),R&&te(C)&&(o.commissioningTaskLock=""),at&&(ge||te(_))&&(o.pendingAirPurgeStart=!1),ke&&te(_)&&(o.commissioningTaskLock=""),xt&&(Ft||te(St))&&(o.pendingManualFlowStart=!1),Le&&(Ft||te(St))&&(o.commissioningTaskLock=""),It&&(qo||te(it))&&(o.pendingManualHpStart=!1),Oe&&(qo||te(it))&&(o.commissioningTaskLock=""),ln&&(Ei||te(st))&&(o.pendingHpWaterCalibrationStart=!1),lt&&te(st)&&(o.commissioningTaskLock="");const id=a?"Wachten op CM100":t,sd=a?"Service-stand wordt geopend. Wacht tot CM100 klaar staat.":i?"CM100 is actief en klaar voor service-taken.":"Start de service-stand voordat je een taak uitvoert.",ld=[{key:"hp-water-calibration",title:"Temperatuursensoren kalibreren",label:"Sensor kalibratie",summary:"Laat de waterpomp draaien zonder compressor en bepaal offsets voor HP1/HP2 water in/out.",status:Ri,available:!!($i||o.entities.hpWaterCalibrationStatus),openDisabled:!i,cardMarkup:Vt({taskKey:"hp-water-calibration",title:"Temperatuursensoren kalibreren",copy:"Doorloop voorbereiding, meting en toepassen in vaste volgorde. De meting stopt eerder zodra de sensoren stabiel genoeg zijn.",subcopy:"De voorgestelde waarden worden pas actief wanneer je ze toepast; supply blijft een diagnosewaarde.",status:Ri,statusCopy:ye?"De pomp draait en de firmware wacht op een stabiel temperatuurbeeld.":cn?"Controleer de voorgestelde offsets voordat je ze toepast.":i?"CM100 staat klaar. Start de meting wanneer compressor en boiler uit zijn.":"Start CM100 eerst.",progressTask:"hp-water-calibration",controls:ub({status:st,running:ye,resultReady:cn,startDisabled:nd,abortDisabled:rd,applyDisabled:ad,busy:sn,controlsAvailable:!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort)}),className:"oq-settings-commissioning-card--hp-water-calibration"})},{key:"manual-flow",title:"Handmatige flowregeling",label:"Handmatige flow",summary:"Laat de waterpomp draaien op een tijdelijk flow-setpoint en luister naar het leidingwerk.",status:Pi,available:!!(So||o.entities.manualFlowStatus),openDisabled:!i,cardMarkup:Vt({taskKey:"manual-flow",title:"Handmatige flowregeling",copy:"Gebruik een tijdelijk flow-setpoint om het leidingwerk rustig te controleren. De normale instellingen wijzigen pas wanneer je een waarde bewust overneemt.",subcopy:"De bestaande PI-regeling blijft de pomp aansturen.",status:Pi,statusCopy:Ce?"De waterpomp draait. Pas het tijdelijke setpoint aan en controleer de gemeten flow.":i?"CM100 staat klaar. Kies een tijdelijk setpoint en start de waterpomp.":"Start CM100 eerst.",progressTask:"",controls:`
            <div class="oq-settings-manual-flow-control">
              ${pt("manualFlowSetpoint","Tijdelijke gewenste flow","Pas deze waarde aan terwijl de waterpomp draait.","oq-settings-field--compact")}
              ${o.entities.manualFlowStart||o.entities.manualFlowAbort?zt({active:Ce,startKey:"manualFlowStart",stopKey:"manualFlowAbort",startLabel:"Waterpomp starten",stopLabel:"Waterpomp stoppen",startDisabled:je||Xu,stopDisabled:je||ed}):""}
            </div>
          `,metrics:`
        ...
        `},{key:"manual-hp",title:"Handmatige warmtepompbediening",label:"Handmatige warmtepomp",summary:"Selecteer een werkmodus en vraag per warmtepomp een compressorstand aan binnen de bestaande bewaking.",status:Ni,available:!!(an||o.entities.manualHpStatus),openDisabled:!i,cardMarkup:Vt({taskKey:"manual-hp",title:"Handmatige warmtepompbediening",copy:"Start eerst de service-taak zodat de waterpomp draait. Zodra voldoende flow is gemeten kun je per warmtepomp vanuit Standby naar verwarmen of koelen schakelen en daarna een compressorstand aanvragen.",subcopy:"Low-flow, maximale watertemperatuur, minimum draaitijd, minimum uit-tijd en veilige modusovergangen blijven actief. De koelvloer, silent-modus, dag/nacht-cap en normaal uitgesloten compressorstanden worden voor deze handmatige test bewust genegeerd.",status:Ni,statusCopy:Fe?Ti?"De compressorvraag staat op 0. De waterpomp blijft draaien totdat de minimale draaitijd veilig is afgerond.":Ci?"De bewaking heeft de aangevraagde standen teruggezet naar 0. Controleer de oorzaak voordat je opnieuw opschaalt.":"De service-taak is actief. Een veiligheidsstop zet de aangevraagde standen terug naar 0; opnieuw opschalen vereist een bewuste handeling.":i?"CM100 staat klaar. Start de taak om handmatige warmtepompbediening vrij te geven.":"Start CM100 eerst.",progressTask:"",actions:`
          ...
          `,controls:`
            <div class="oq-settings-manual-hp-controls">
              <div class="oq-settings-manual-hp-unit">
                ...
                ${pt("manualHp1Level","Warmtepomp 1 compressorstand","Aangevraagde stand 0 tot en met 10. Kies eerst een werkmodus. Normaal uitgesloten standen mogen tijdens deze handmatige test bewust worden gekozen.","oq-settings-field--compact")}
              </div>
              ${v("hp2ExcludedA")?`
                <div class="oq-settings-manual-hp-unit">
                  ...
                  ${pt("manualHp2Level","Warmtepomp 2 compressorstand","Aangevraagde stand 0 tot en met 10. Kies eerst een werkmodus. Normaal uitgesloten standen mogen tijdens deze handmatige test bewust worden gekozen.","oq-settings-field--compact")}
                </div>
              `:""}
            </div>
          `,metrics:`
            ...
            <div class="oq-settings-manual-hp-results">
              ...
              ${v("hp2Compressor")?X("hp2Compressor","Warmtepomp 2 actueel","Door de actuator werkelijk toegepaste compressorstand en gemeten compressorfrequentie.",ms("hp2Compressor","hp2Freq"),"oq-settings-field--compact"):""}
            </div>
            ...
            <div class="oq-settings-manual-hp-statuses">
              ${X("hp1Failures","Warmtepomp 1 statusmelding","Actuele melding die de warmtepomp zelf rapporteert.",Wo(B("hp1Failures","None")),"oq-settings-field--compact")}
              ${v("hp2Failures")?X("hp2Failures","Warmtepomp 2 statusmelding","Actuele melding die de warmtepomp zelf rapporteert.",Wo(B("hp2Failures","None")),"oq-settings-field--compact"):""}
            </div>
          `})},{key:"autotune",title:"Flow autotune",label:"Autotune",summary:"Berekent een voorstel voor de flowregeling en kan Kp/Ki daarna toepassen.",status:vr,available:!0,openDisabled:kt(vr),cardMarkup:Vt({taskKey:"autotune",title:"Flow autotune",copy:"Bereken een voorstel voor de flowregeling en pas dat daarna toe in de installatie-instellingen. Autotune duurt meestal ongeveer 5 tot 10 minuten.",subcopy:"Na toepassen worden de flow-instellingen bijgewerkt.",status:vr,statusCopy:V?"Wacht totdat CM100 actief is voordat je autotune start.":O?"Autotune draait op dit moment.":i?"CM100 staat klaar. Start de autotune wanneer je wilt.":"Start CM100 eerst en voer daarna autotune uit.",progressTask:"autotune",actions:`
            ${o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort?zt({active:O,startKey:"flowAutotuneStart",stopKey:"flowAutotuneAbort",startLabel:"Autotune starten",stopLabel:"Autotune stoppen",startDisabled:N||Oi,stopDisabled:N||Qu}):""}
            ${o.entities.flowAutotuneApply?Ne("flowAutotuneApply","Toepassen","oq-helper-button oq-helper-button--ghost",N||Yu):""}
          `,metrics:`
            ${X("flowKpSuggested","Voorgestelde Kp","Kp bepaalt hoe sterk de regeling meteen corrigeert.",Ku,"oq-settings-field--compact")}
            ${X("flowKiSuggested","Voorgestelde Ki","Ki corrigeert kleine afwijkingen langzaam weg.",Uu,"oq-settings-field--compact")}
          `})},{key:"boiler",title:"Boiler power test",label:"Boiler test",summary:"Meet het effectieve boilervermogen bij stabiele flow en kan het resultaat toepassen.",status:br,available:e,openDisabled:kt(br),cardMarkup:Vt({taskKey:"boiler",title:"Boiler power test",copy:"Meet het effectieve boilervermogen bij stabiele flow en schrijf daarna een afgerond voorstel weg naar de boilerinstelling. Boilertest duurt meestal ongeveer 5 tot 10 minuten.",subcopy:`Ingesteld boilervermogen: ${s(M)}`,status:br,statusCopy:q?"Wacht totdat CM100 actief is voordat je de boiler-test start.":k?"De boiler-test draait op dit moment.":i?"CM100 staat klaar. Start de boiler-test wanneer je wilt.":"Start CM100 eerst en voer daarna de boilervermogentest uit.",progressTask:"boiler",actions:`
            ${o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort?zt({active:k,startKey:"boilerPowerTestStart",stopKey:"boilerPowerTestAbort",startLabel:"Boiler test starten",stopLabel:"Boiler test stoppen",startDisabled:p||Li,stopDisabled:p||zu}):""}
            ${o.entities.boilerPowerTestApply?Ne("boilerPowerTestApply","Toepassen","oq-helper-button oq-helper-button--ghost",p||Gu):""}
          `,metrics:`
          ...
          `})},{key:"purge",title:"Ontluchten",label:"Ontluchten",summary:"Draait een vaste ontluchtingsrun van 5 minuten met rustige flow, pomp-pulsen en stabilisatie.",status:yr,available:he,openDisabled:kt(yr),cardMarkup:Vt({taskKey:"purge",title:"Ontluchten",copy:"Draait 5 minuten met rustige doorstroming, korte pomp-pulsen en een stabilisatiefase.",subcopy:"Na afloop kan OpenQuatt de service mode (CM100) afsluiten of actief laten.",status:yr,statusCopy:me?"Ontluchten loopt vast 5 minuten door en stopt daarna automatisch.":i?"CM100 staat klaar. Start ontluchten wanneer het circuit open staat.":"Start CM100 eerst en voer daarna ontluchten uit.",progressTask:"purge",className:"oq-settings-commissioning-card--air-purge",actions:`
            ${o.entities.airPurgeStart||o.entities.airPurgeAbort?zt({active:me,startKey:"airPurgeStart",stopKey:"airPurgeAbort",startLabel:"Ontluchten starten",stopLabel:"Ontluchten stoppen",startDisabled:ue||Ju,stopDisabled:ue||Zu}):""}
          `,metrics:`
            ${X("airPurgeRemaining","Resterende tijd","Ontluchten loopt maximaal 5 minuten.",fr,"oq-settings-field--compact")}
            ${X("airPurgePhase","Fase","Laat zien welk deel van het ontluchten nu actief is.",rn,"oq-settings-field--compact")}
            ${X("flowSelected","Actuele flow","Gemeten flow tijdens het ontluchten.",ne("flowSelected"),"oq-settings-field--compact")}
            ${If("airPurgeReturnToAuto","Na afloop","","Service mode (CM100) afsluiten","oq-settings-field--span-2 oq-settings-field--compact")}
          `})}].filter(cd=>cd.available);return{cm100Status:id,cm100StartDisabled:u,cm100StopDisabled:g,serviceStatusCopy:sd,tasks:ld}}function db(e){return`
    ...
    `}function pb(){const e=Vc();return se("Service","Service & commissioning","Gebruik de service-stand (controlmode CM100) voor testen, afstelling en onderhoudstaken.",`
        <div class="oq-settings-service-shell">
          ...
          <div class="oq-settings-system-summary oq-settings-service-task-list">
            ${e.tasks.map(t=>db(t)).join("")}
          </div>
        </div>
      `)}function gb(){const e=String(o.systemModal||"").replace(/^service-task-/,""),n=Vc().tasks.find(r=>r.key===e);return n?`
      <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
    ...
    `:""}function ks(){if(!v("hpGeneration"))return"";const e={V1:{copy:"Voor Quatt V1 en Quatt V1 + V1.5 combinaties.",image:ss,alt:"Quatt Hybrid V1 en V1.5",infoTitle:"V1",infoCopy:`Model: AMM4
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`},V2:{copy:"Voor Quatt V2.",image:mh,alt:"Quatt Hybrid V2",infoTitle:"V2",infoCopy:`Model: AMH6 of AMH6-2
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},n=String(E("hpGeneration")||""),r=bo(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function mb(){const e=Uo(),t=o.entities.hpGeneration||{},n=v("hpGeneration")&&bo(t).length>0;return!e&&!n?"":se("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function _c(e="oq-settings-grid oq-settings-boiler-simple-grid"){if(!v("boilerCvAssistEnabled"))return"";const t=A("boilerCvAssistEnabled"),n=v("boilerRatedHeatPower"),r=tt("boilerRatedHeatPower"),a=Re("boilerRatedHeatPower"),i=o.loadingEntities||o.busyAction==="switch-boilerCvAssistEnabled",c=n?Zo({key:"boilerRatedHeatPower",value:a,meta:r,controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-boiler-power-control",unitMarkup:'<span class="oq-helper-unit-chip">W</span>'}):`
      ...
      `,d=t&&n?'<p class="oq-settings-boiler-power-note">Je kunt deze waarde altijd handmatig aanpassen.</p>':"";return`
        <div class="${s(e)}">
          ${qe("boilerCvAssistEnabled","CV-ketel / boiler aanwezig","Geef aan of OpenQuatt deze installatie als ondersteuning mag gebruiken.",`
              <div class="oq-settings-compact-switch-field">
                ${Xo("boilerCvAssistEnabled","CV-ketel / boiler aanwezig",t,i)}
              </div>
      ...
      `)}function bb(){if(!v("trendHistoryEnabled")&&!v("lifetimeEnergyHistoryEnabled"))return"";const e=A("trendHistoryEnabled"),t=e&&A("trendHistoryFlashEnabled"),n=e&&v("trendHistoryFlashAvailable"),r=v("lifetimeEnergyHistoryEnabled"),a=r&&A("lifetimeEnergyHistoryEnabled"),i=v("lifetimeEnergyHistoryAvailable"),l=n?ne("trendHistoryFlashAvailable"):"Alleen live",c=i?Mc(ne("lifetimeEnergyHistoryAvailable")):"Geen data";return se("Diagnose","Gegevens bewaren","Bepaal welke gegevens OpenQuatt bewaart voor grafieken, resultaten en hulp bij problemen.",`
        <article class="oq-settings-storage-summary">
          ...
          <div class="oq-settings-storage-summary-metrics" aria-label="Opslagstatus">
            ${v("trendHistoryEnabled")?Cr("Live diagnose",e?"Aan":"Uit","Live",e):""}
            ${v("trendHistoryFlashEnabled")?Cr("Diagnosehistorie",l,t?"Permanent geheugen":"Uit",t):""}
      ...
      `)}function vb(){if(!v("lifetimeEnergyHistoryEnabled"))return"";const e=o.energyHistoryImportRecords.length,t=new Set(o.energyHistoryImportHourRecords.map(c=>c.dateKey)).size,n=[];e>0&&n.push(`${e} dagrecords`),t>0&&n.push(`${t} uurdagen`),o.energyHistoryImportRange&&n.push(o.energyHistoryImportRange),o.energyHistoryImportSource&&n.push(o.energyHistoryImportSource),o.energyHistoryImportInvalidCount>0&&n.push(`${o.energyHistoryImportInvalidCount} regels niet gebruikt`);const r=!!o.energyHistoryImportFileName,a=e>0||t>0,i=Number(o.energyHistoryImportProgressPercent||0),l=o.energyHistoryImportBusy?`Importeren...${i>0?` (${i}%)`:""}`:"Importeren";return`
    ...
    `}function yb(){if(!v("lifetimeEnergyHistoryEnabled"))return"";const e=zn(o.energyHistoryExportMode),t=Hn.map(r=>`
          ...
          <div class="oq-settings-storage-domain-grid">
            <section class="oq-settings-storage-domain oq-settings-storage-domain--trend">
              ...
              <div class="oq-settings-storage-domain-rows">
                ${Tr("trendHistoryEnabled","Recente diagnosegegevens","Bewaar de laatste meetpunten zolang de controller online is.","Na een herstart of update zijn deze tijdelijke gegevens niet meer beschikbaar.","Nieuwe tijdelijke diagnosegegevens worden niet bijgehouden.","Tijdelijk")}
                ${Tr("trendHistoryFlashEnabled","Diagnosegeschiedenis bewaren","Bewaar recente diagnosegegevens ook na een herstart of update.","OpenQuatt slaat deze gegevens ongeveer elk uur op.","Alleen recente diagnosegegevens; bestaande geschiedenis blijft staan.","Permanent geheugen")}
                ${c?`
                  <div class="oq-settings-storage-inline-action">
                    ...
                    ${Er("trendHistoryFlush","Nu opslaan","flush-trend-history",{disabled:!t,busyLabel:"Opslaan..."})}
                  </div>
                `:""}
              </div>
            </section>
            <section class="oq-settings-storage-domain oq-settings-storage-domain--energy">
              ...
              <div class="oq-settings-storage-domain-rows">
                ${Tr("lifetimeEnergyHistoryEnabled","Dagtotalen bewaren","Bewaar elke dag een samenvatting van je energiegegevens.","Zo blijven je resultaten ook na een herstart of update beschikbaar. OpenQuatt slaat dit op aan het einde van de dag en bij een normale afsluiting.","Nieuwe dagtotalen worden niet bewaard; bestaande historie blijft staan.","Permanent geheugen")}
                ${Af("lifetimeEnergyHourRetention","Uurdetail bewaren","Kies hoelang OpenQuatt detail per uur mag bewaren voor de daggrafiek.","Geavanceerd")}
                ${d?`
                  <div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--split">
                    ...
                    <div class="oq-settings-storage-action-stack">
                      ${Er("lifetimeEnergyHistoryCapture","Vandaag opslaan","save-lifetime-energy-history",{disabled:!r,busyLabel:"Opslaan..."})}
                    </div>
                  </div>
                `:""}
                ${yb()}
                ...
                ${v("lifetimeEnergyHistoryClear")?`
                  <div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--danger">
                    ...
                    <div class="oq-settings-storage-action-stack">
                      ${Er("lifetimeEnergyHistoryClear","Historie wissen","clear-lifetime-energy-history",{disabled:!i,buttonClass:"oq-helper-button oq-helper-button--warning",busyLabel:"Wissen..."})}
                    </div>
                  </div>
                `:""}
              </div>
    ...
    `}function Sb(){const e=ce()?`
      ...
      `;return se("Regeling","Verwarmingsstrategie","Kies hier hoe OpenQuatt je verwarming regelt. De instellingen hieronder passen zich automatisch aan.",`
        ...
        ${xc()}
        ${e}
      `)}function qb(){return se("Beveiliging","Watertemperatuur","Beschermt het systeem tegen te hoge aanvoertemperaturen. OpenQuatt regelt richting deze grens terug en grijpt 5\xB0C erboven hard in.",Fc())}function kb(){const e=v("otEnabled"),t=v("cicPollingEnabled")||v("cicFeedUrl"),n=v("cicCompatibilityMode"),r=v("otLinkProblem")||v("cicDataStale")||v("cicJsonFeedOk");if(!e&&!t&&!n&&!r)return"";const a=ft("cicPollingEnabled"),i=ft("otEnabled"),l=({label:p,value:f,active:S=!1})=>`
      <div class="oq-settings-integration-diagnostic-item${S?" is-warning":""}">
        <dt>${s(p)}</dt>
        <dd>${s(f)}</dd>
      </div>
    `,c=(p,f,S="Actief",w="Normaal",q={})=>{if(!v(p))return"";const T=z(p);return l({label:f,value:T?S:w,active:q.warningWhenActive?T:!1})},d=(p,f,S={})=>{const w=S.fallbackKey||"";return!v(p)&&!(w&&v(w))?"":l({label:f,value:ne(v(p)?p:w,S)})},u=(p,f)=>{const S=f.filter(Boolean).join("");return S?`
    ...
    `:"",b=u("OpenTherm",[v("otLinkProblem")?l({label:"OT-link",value:i?z("otLinkProblem")?"Probleem":"OK":"Uitgeschakeld",active:i&&z("otLinkProblem")}):"",c("otThermostatChEnable","Thermostaat CH","Actief","Normaal"),c("otThermostatCoolingEnable","Thermostaat koeling","Actief","Normaal"),d("otControlSetpoint","Control setpoint"),d("otRoomSetpoint","Room setpoint",{fallbackKey:"roomSetpoint"}),d("otRoomTemp","Room temperature",{fallbackKey:"roomTemp"})]),h=u("CIC-feed",[v("cicJsonFeedOk")?l({label:"JSON-feed",value:a?z("cicJsonFeedOk")?"OK":"Probleem":"Polling uit",active:a&&!z("cicJsonFeedOk")}):"",v("cicDataStale")?l({label:"Data",value:a?z("cicDataStale")?"Verouderd":"Actueel":"Polling uit",active:a&&z("cicDataStale")}):"",c("cicChEnabled","CH-vraag","Actief","Normaal"),c("cicCoolingEnabled","Koeling","Actief","Normaal"),d("cicControlSetpoint","Control setpoint"),d("cicRoomSetpoint","Room setpoint"),d("cicRoomTemp","Room temperature"),d("cicFlowrate","Flow"),d("cicLastSuccessAge","Laatste succes")]),y=b||h?`
    ...
    `:"";return se("Integratie","OpenTherm & CIC-polling","Configureer de directe thermostaatbus, externe CIC-feed en Quatt app-compatibiliteit.",`
        <div class="oq-settings-integration-grid">
          ${$r("otEnabled","OpenTherm","Thermostaatbus voor warmtevraag en kamerwaarden.")}
          ${$r("cicPollingEnabled","CIC-polling","JSON-feed uitlezen voor setpoint, kamerwaarden en flow.")}
          ${$r("cicCompatibilityMode","CiC-compatibiliteit","Gegevens doorgeven zodat de Quatt app kan blijven meekijken.")}
          ${g}
        </div>
        ${y}
      `)}function Cb(){if(!sa.some(C=>v(C)))return"";const t=ft("cicPollingEnabled"),n=ft("otEnabled"),r=(C={})=>C.haValueKey||(C.haKeys||[]).find($=>!/valid$/i.test($))||"",a=(C={})=>C.haValidKey||(C.haKeys||[]).find($=>/valid$/i.test($))||"",i=(C="",$="")=>!!C&&!!$&&v(C)&&v($)&&z($),l=(C={})=>i(r(C),a(C)),c=(C,$={})=>C==="CIC"?t:C==="OT thermostat"?n:C==="HA input"?l($):C==="CIC or HA input"?t||l($):C==="Flowmeter HP2"?v("hp2Flow"):C==="Local aggregate HP1/HP2"?v("flowLocal")||v("hp2Flow"):!0,d=(C,$={})=>C==="CIC"&&!t?"CIC-polling staat uit":C==="OT thermostat"&&!n?"OpenTherm staat uit":C==="HA input"&&!l($)?"HA-bron ongeldig":C==="CIC or HA input"&&!t&&!l($)?"CIC en HA ontbreken":C==="Flowmeter HP2"&&!v("hp2Flow")?"HP2-flow ontbreekt":C==="Local aggregate HP1/HP2"&&!v("flowLocal")&&!v("hp2Flow")?"Lokale flow ontbreekt":"",u=(C,$="Actief",N="Normaal")=>v(C)?z(C)?$:N:"",g=(C,$={})=>{const N=String(C||"").trim();return N?$.optionLabels?.[N]||Pe(N):""},b=(C,$={})=>{const N=String(E(C)||"").trim();return N?g(N,$):""},h=C=>{const $=nr(C,"");return $?Pe($):""},y=(...C)=>C.find($=>String($||"").trim())||"",p=()=>{const C=b("waterSupplySource");if(String(E("waterSupplySource")||"")==="Local"&&v("localWaterSupplyTempSource")){const $=b("localWaterSupplyTempSource");return $?`${C} - ${$}`:C}return C},f=()=>{const C=String(E("flowSource")||"").trim();if(C==="Outdoor unit"){if(v("qFlowSource")){const $=String(E("qFlowSource")||"").trim(),N=String(E("hpGeneration")||"").trim();return $==="Local"||$==="Auto"&&N==="V1"?$==="Auto"?"Lokaal (auto)":"Lokaal":y(b("outdoorUnitFlowMode"),$==="Auto"?"Buitenunit (auto)":"Buitenunit")}return y(b("outdoorUnitFlowMode"),"Quatt-flow")}return Pe(C)},S=()=>{const C=String(E("outsideTempSource")||"").trim();if(C!=="Auto")return Pe(C);const $=H("outsideTempLocalAggregated"),N=H("outsideTempHa"),W=!Number.isNaN($),K=v("outsideTempHaValid")?z("outsideTempHaValid")&&!Number.isNaN(N):!Number.isNaN(N);return W&&K?N<=$?"HA-invoer":"Buitenunit":K?"HA-invoer":W?"Buitenunit":"Auto"},w=({label:C,value:$="",key:N="",active:W=!1})=>{const K=$||(N?ne(N):"");return K?`
        <div class="oq-settings-source-row${W?" is-warning":""}">
          <span>${s(C)}</span>
          <strong>${s(K)}</strong>
        </div>
      `:""},q=({label:C="HA input",valueKey:$="",validKey:N="",value:W=""})=>i($,N)?[w({label:C,key:$,value:W}),w({label:"HA status",value:"Geldig"})]:[],T=(C,$={})=>{if(!v(C))return{markup:"",warning:""};const N=o.entities[C]||{},W=String(E(C)||""),R=bo(N).filter(Y=>c(Y,$)),V=W&&!c(W,$),P=W==="HA input"&&$.keepUnavailableCurrent!==!0,_=(V&&!P&&!R.includes(W)?[W,...R]:R).map(Y=>{const ge=!c(Y,$),ue=g(Y,$),J=ge?`${ue} (${d(Y,$)||"niet beschikbaar"})`:ue;return`<option value="${s(Y)}" ${Y===W?"selected":""}>${s(J)}</option>`}).join("");return{markup:`
          <label class="oq-settings-source-select">
            <span class="oq-settings-source-select-head">
              <span>${s($.label||"Bron")}</span>
              ${$.infoCopy?fo($.infoId||C,$.infoTitle||$.label||"Bron",$.infoCopy):""}
            </span>
            <select class="oq-helper-select" data-oq-field="${s(C)}" ${o.loadingEntities?"disabled":""}>
              ${_}
            </select>
          </label>
        `,warning:V?`Huidige bron niet beschikbaar: ${d(W,$)}`:""}},k=({key:C,title:$,select:N,secondarySelect:W=null,secondarySelects:K=null,rows:R=[]})=>{const V=N&&N.when!==!1?T(N.key,N):{markup:"",warning:""},O=(Array.isArray(K)?K:W?[W]:[]).filter(J=>J&&J.when!==!1).map(J=>T(J.key,J)).filter(J=>J.markup),_=O.map(J=>J.markup).join(""),Y=O.map(J=>J.warning).find(Boolean)||"",ge=R.filter(Boolean).join(""),ue=`${V.markup}${_}`;return!ue&&!ge?"":`
          ...
          <div class="oq-settings-quickstart-status" data-oq-access-security-item="login">
            <div class="oq-settings-quickstart-status-row">
              <div>
                ...
                <strong class="oq-settings-quickstart-status-value">${s(Fa())}</strong>
      ...
      `)}function ni(){const e=o.apiSecurityStatus;return e?e.pending_restart?"Herstart nodig":e.transport_active===!0?"Aan":e.transport_active===!1?"Uit":e.enabled?"Aan":"Uit":"Laden..."}function ri(){const e=o.apiSecurityStatus;return e?e.pending_restart?e.key?"Deze wijziging wordt actief na herstart. De sleutel blijft opgeslagen voor later gebruik.":"Deze wijziging wordt actief na herstart.":e.transport_active===!0?"API-encryptie staat aan. Gebruik dezelfde sleutel in Home Assistant.":e.key?"De sleutel blijft opgeslagen, maar de native API staat nu open op je lokale netwerk.":"Er is nog geen API-sleutel opgeslagen.":"API-encryptie wordt geladen."}function Eb(){const e=o.settingsBackupBusy,t=ao.length,n=Zt.length;return se("Beheer","Backup en restore","Sla een JSON-backup op van de instellingen die OpenQuatt in deze web-app beheert, en zet die later weer terug na een factory-bin update.",`
      ...
      `)}function $b(){const e=o.settingsBackupBusy;return`
      <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
    ...
    `}function Ab(){const e=o.settingsBackupDraft;if(!e)return"";const t=e.summary||tc(e),n=String(e.source?.installation||e.source?.device||"Onbekend"),r=Uo(),a=String(e.source?.firmware_version||"Onbekend"),i=String(e.source?.firmware_channel||"").trim()||"Onbekend",l=String(e.source?.topology||"").trim()||"Onbekend",c=oe(),d=typeof Z=="function"?Z():"",u=l!=="Onbekend"&&d&&l!==d,g=n!=="Onbekend"&&n!==r,b=u||g?"De backup lijkt van een andere installatie te komen. Je kunt nog steeds doorzetten, maar controleer de secties even goed.":t.requiredMissing?"Ontbrekende velden houden hun firmware-default.":"Velden zonder waarde worden overgeslagen.";return`
      <div class="oq-helper-modal-backdrop${o.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
    ...
    `}function Hb(){const e=zo(),t=ml(),n=o.busyAction==="restartAction";return se("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
        <div class="oq-settings-system-summary">
          ...
          <div class="oq-settings-system-row" data-oq-diagnostics-row="ip">
            ...
            <strong class="oq-settings-system-row-value">${s(Ca())}</strong>
          </div>
          ...
          <div class="oq-settings-system-row oq-settings-system-row--with-action" data-oq-diagnostics-row="webserverLog">
            <div class="oq-settings-system-row-copy">
              ...
              <strong class="oq-settings-system-row-value">${s(gc())}</strong>
            </div>
            <button
              class="oq-helper-button oq-helper-button--ghost"
              type="button"
          ...
          <div class="oq-settings-system-row" data-oq-diagnostics-row="espTemp">
            ...
            <strong class="oq-settings-system-row-value">${s(kl())}</strong>
          </div>
      ...
      `)}function Mb(){const e=[ys("Warmtepomp 1","hp1ExcludedA","hp1ExcludedB"),ys("Warmtepomp 2","hp2ExcludedA","hp2ExcludedB")].filter(Boolean).join("");return se("Installatie","Compressorinstellingen","Stel hier de minimale draaitijd in en bepaal per warmtepomp welke compressorstanden je wilt overslaan.",`
        <div class="oq-settings-subpanel">
          <div class="oq-settings-subpanel-head">
      ...
      `)}function Pb(){return se("Comfort","Stille uren","Kies wanneer het systeem stiller moet werken, en hoe ver het dan nog mag opschalen.",oi())}function Nb(){return oi("oq-settings-grid oq-settings-grid--modal")}function Rb(){const e=[ee("coolingMinimumSupplyTemp","Minimale koel-aanvoer","Ondergrens voor het koeldoel. OpenQuatt gebruikt de hoogste waarde van deze instelling en de dauwpuntveilige grens."),pt("coolingDemandMax","Maximale koelsterkte","Bepaalt hoe krachtig OpenQuatt mag koelen. Lager geeft langere, rustigere runs; hoger geeft meer koelvermogen bij warm weer.","",{minLabel:"Rustig",maxLabel:"Krachtig",valueLabel:`${j("coolingDemandMax")} max`}),ee("coolingRestartDelta","Herstartmarge watertemperatuur","Na het bereiken van het koel-aanvoerdoel start de watercyclus pas opnieuw zodra de aanvoer deze marge boven het doel ligt."),ee("coolingRequestOnDelta","Koelvraag start boven setpoint","Koelvraag wordt actief zodra de kamer warmer is dan setpoint plus deze marge."),ee("coolingRequestOffDelta","Koelvraag stopt boven setpoint","Koelvraag valt weer af zodra de kamer koeler is dan setpoint plus deze marge."),ee("coolingSafetyMargin","Dauwpunt veiligheidsmarge","Extra marge boven het geselecteerde dauwpunt voor de minimale veilige watertemperatuur.")].filter(Boolean),t=v("coolingWithoutDewPointMode"),n=[v("coolingGuardMode")?X("coolingGuardMode","Actieve beveiligingsroute","Laat zien of koeling nu via dauwpuntmeting, dauwpuntsbenadering of expliciet toestaan wordt begrensd.",B("coolingGuardMode","Onbekend")):"",v("coolingFallbackNightMinOutdoorTemp")?X("coolingFallbackNightMinOutdoorTemp","Nachtminimum buitentemperatuur","Minimum buitentemperatuur van de afgelopen nacht. Warme nachten maken de dauwpuntsbenadering conservatiever.",B("coolingFallbackNightMinOutdoorTemp","\u2014")):"",v("coolingFallbackMinSupplyTemp")?X("coolingFallbackMinSupplyTemp","Berekende minimum watertemperatuur","De conservatieve ondergrens die OpenQuatt gebruikt bij de dauwpuntsbenadering. Als die grens door warm weer hoger wordt dan zinvol is, houdt OpenQuatt rekening met de kamertemperatuur.",B("coolingFallbackMinSupplyTemp","\u2014")):"",v("coolingEffectiveMinSupplyTemp")?X("coolingEffectiveMinSupplyTemp","Actieve minimum ondergrens","De ondergrens die de koeling nu daadwerkelijk gebruikt: dauwpunt plus marge, dauwpuntsbenadering, of de ingestelde minimumgrens bij expliciet toestaan.",B("coolingEffectiveMinSupplyTemp","\u2014")):""].filter(Boolean);if(!e.length&&!t&&!n.length)return"";const r={"Dew point required":"Koel alleen als er een betrouwbare dauwpuntmeting beschikbaar is. Zonder dauwpuntmeting blijft koeling geblokkeerd.","Allow without dew point":"Gebruik een echte dauwpuntmeting als die beschikbaar is. Ontbreekt die, koel dan alleen via een conservatieve dauwpuntsbenadering.","Allow without dew point, use fallback":"Gebruik een echte dauwpuntmeting als die beschikbaar is. Ontbreekt die, koel dan alleen via een conservatieve dauwpuntsbenadering.","Allow without dew point, use dew point approximation":"Gebruik een echte dauwpuntmeting als die beschikbaar is. Ontbreekt die, koel dan alleen via een conservatieve dauwpuntsbenadering.","Allow without dew point, user responsibility":"Sta koeling expliciet toe zonder dauwpuntgrens. Ook een beschikbare dauwpuntmeting wordt dan genegeerd; alleen de ingestelde minimale koel-aanvoer geldt."};return se("Koeling","Koelingsinstellingen","Stel hier in wanneer koelvraag ontstaat, hoe koud het water mag worden en hoeveel het water mag opwarmen voor herstart.",`
        ...
        ${t||n.length?`
          <div class="oq-settings-grid">
            ${t?Wf("coolingWithoutDewPointMode","Keuze koelbeveiliging","Kies welke veiligheidsgrens OpenQuatt gebruikt: dauwpuntmeting, dauwpuntsbenadering bij ontbrekende meting, of expliciet toestaan zonder dauwpuntgrens.",r,"oq-settings-field--span-2"):""}
            ${t?`
        ...
        `:""}
      `)}function jc(){const n={top:22,right:18,bottom:38,left:34},r=560-n.left-n.right,a=240-n.top-n.bottom,i=pe[0].outdoor,l=pe[pe.length-1].outdoor,c=y=>n.left+(y-i)/(l-i)*r,d=y=>n.top+(70-y)/50*a,u=[20,30,40,50,60,70].map(y=>{const p=d(y);return`
        ...
        `}).join(""),g=pe.map(y=>`
        <text x="${c(y.outdoor)}" y="228" text-anchor="middle" class="oq-helper-curve-axis-label">${s(y.label)}</text>
      `).join(""),b=pe.map(y=>`${c(y.outdoor)},${d(we(y.key,E(y.key)))}`).join(" "),h=pe.map(y=>{const p=we(y.key,E(y.key));return`
          <g>
            <circle
              cx="${c(y.outdoor)}"
              cy="${d(p)}"
            ...
            />
            <text x="${c(y.outdoor)}" y="${d(p)-14}" text-anchor="middle" class="oq-helper-curve-point-label">${p.toFixed(1)}\xB0</text>
          </g>
        `}).join("");return`
    ...
    `}function Kc(e="wizard"){return e==="picker"?`
    ...
    `}function Lb(e){const t=String(e||"").trim();if(!t)return"";try{const n=new URL(/^[a-z][a-z0-9+.-]*:\/\//i.test(t)?t:`http://${t}`);return n.protocol!=="http:"&&n.protocol!=="https:"?"":(n.port||(n.port="8080"),(!n.pathname||n.pathname==="/")&&(n.pathname="/beta/feed/data.json"),n.toString())}catch{return""}}function Uc(){const e=String(E("cicFeedUrl")||"").trim(),t=o.quickStartCicFeedUrlDraft===null?e:String(o.quickStartCicFeedUrlDraft||"");return{configuredUrl:e,draftUrl:t,normalizedDraftUrl:Lb(t)}}function zc(e,t){return`
    ...
    `}function Cs(e){const t=String(e||"").trim().toLowerCase();return t==="heatpump_controller_q"||t.includes("q-edition")||t.includes("controller q")?"heatpump_controller_q":t==="heatpump_listener"||t.includes("listener")?"heatpump_listener":t==="waveshare"||t.includes("waveshare")?"waveshare":""}function Gc(){let e=Cs(E("hardwareProfileText")),t=!1;return e||(e=Cs(bt().hardwareProfile)),!e&&v("qFlowSource")?(e="heatpump_controller_q",t=!0):!e&&v("flowSource")&&v("cicPollingEnabled")&&(e="remote",t=!0),{profile:e,inferred:t,isQEdition:e==="heatpump_controller_q",isRemoteProfile:e==="heatpump_listener"||e==="waveshare"||e==="remote",hardwareKnown:!!e,hardwareLabel:e==="heatpump_controller_q"?"Heatpump Controller Q-edition":e==="heatpump_listener"?"Heatpump Listener":e==="waveshare"?"Waveshare":e==="remote"?"Heatpump Listener / Waveshare":"Onbekend hardwareprofiel"}}function en(){const e=String(E("hpGeneration")||"").trim(),t=Gc(),n=e==="V1",{isQEdition:r,isRemoteProfile:a,hardwareKnown:i}=t,l=n&&a,c=r?n?"Local":"Outdoor unit":"",d=l?"CIC":"Outdoor unit",u=String(E("flowSource")||"").trim(),g=String(E("qFlowSource")||"").trim(),b=A("cicPollingEnabled"),h=A("cicJsonFeedOk"),y=A("cicDataStale"),p=Uc(),f=u===d&&(!c||g===c),S=l?f&&b&&!!p.configuredUrl:f,w=l?"cicFlowrate":r&&n?"controllerFlow":Z()==="duo"?"flowLocal":"hp1Flow",q=H(w),T=Number.isFinite(q),k=A("quickFlowTest");let M=i?l?"Nog configureren":"Nog activeren":"Hardwareprofiel niet herkend";l&&S?M=h&&T?q>0?"Geldig":"Bron actief, geen circulatie":y?"Geen actuele CiC-data":h?"Verbonden, wacht op flow":"Verbinding controleren":!l&&S&&(M=T?q>0?"Geldig":"Bron actief, geen circulatie":"Wacht op actuele flow");const x=l?"CiC JSON-feed":r&&n?"Lokale flowmeter op de controller":"Flowmeter in de buitenunit via Modbus",F=l?"Een Quatt V1 heeft op dit hardwareprofiel geen lokaal aangesloten flowmeter. Configureer daarom de lokale CiC JSON-feed.":r&&n?"Bij Quatt V1 is de centrale flowmeter lokaal aangesloten op de Q-edition controller.":`Bij Quatt ${e||"V1.5/V2"} zit de flowmeter in de buitenunit en leest OpenQuatt deze via Modbus.`;return{generation:e,hardwareLabel:t.hardwareLabel,requiresCic:l,qFlowTarget:c,flowSourceTarget:d,configurationApplied:S,sourceLabel:x,explanation:F,status:M,flowValue:q,flowAvailable:T,flowTestActive:k,canRunFlowTest:S,...p,canApply:i&&v("flowSource")&&(!c||v("qFlowSource"))&&(!l||v("cicPollingEnabled")&&v("cicFeedUrl")&&!!p.normalizedDraftUrl)}}function ai(){const e=Gc(),{isQEdition:t,isRemoteProfile:n}=e,r=String(E("roomTempSource")||"").trim(),a=String(E("roomSetpointSource")||"").trim(),i=r===a&&["CIC","OT thermostat","HA input"].includes(r)?r:"",l=t?"OT thermostat":o.quickStartThermostatSourceDraft||(i==="CIC"||i==="HA input"?i:"CIC"),c=Uc(),u=r===l&&a===l&&(l!=="OT thermostat"||A("otEnabled"))&&(l!=="CIC"||A("cicPollingEnabled")&&!!c.configuredUrl),g=l==="OT thermostat"?["otRoomTemp","otRoomSetpoint"]:l==="CIC"?["cicRoomTemp","cicRoomSetpoint"]:["roomTempHa","roomSetpointHa"],b=H(g[0]),h=H(g[1]),y=Number.isFinite(b)&&Number.isFinite(h),p=l==="OT thermostat"?A("otEnabled")&&!A("otLinkProblem")&&y:l==="CIC"?A("cicJsonFeedOk")&&!A("cicDataStale")&&y:A("roomTempHaValid")&&A("roomSetpointHaValid")&&y;let f=t||n?"Nog activeren":"Hardwareprofiel niet herkend";u&&(f=p?"Geldig":l==="OT thermostat"?"OpenTherm-verbinding controleren":l==="CIC"?"CiC-feed controleren":"HA-proxy's controleren");const S=l==="OT thermostat"?"OpenTherm-thermostaat":l==="CIC"?"CiC JSON-feed":"Home Assistant-proxy's",w=t?"De Q-edition leest kamertemperatuur en kamer-setpoint rechtstreeks uit via OpenTherm.":l==="CIC"?"OpenQuatt leest beide thermostaatwaarden samen uit de lokale CiC JSON-feed.":"OpenQuatt gebruikt de vaste HA-proxy's voor kamertemperatuur en kamer-setpoint.";return{hardwareLabel:e.hardwareLabel,isQEdition:t,isRemoteProfile:n,selectedSource:l,sourceLabel:S,explanation:w,configurationApplied:u,status:f,roomTempValue:b,roomSetpointValue:h,valuesAvailable:y,...c,canApply:(t||n)&&v("roomTempSource")&&v("roomSetpointSource")&&(l!=="OT thermostat"||v("otEnabled"))&&(l!=="CIC"||v("cicPollingEnabled")&&v("cicFeedUrl")&&!!c.normalizedDraftUrl)}}function Ob(){const e=en(),t=o.busyAction==="quickstart-flow-source"||o.busyAction==="quickstart-flow-refresh",n=o.busyAction==="quickstart-flow-test-start"||o.busyAction==="quickstart-flow-test-abort",r=t||n||e.flowTestActive,a=e.status==="Geldig"||e.status==="Bron actief, geen circulatie"?" is-active":"",i=e.flowAvailable?`${Math.round(e.flowValue)} L/h`:"Nog geen actuele waarde",l=e.requiresCic?zc(e,r):"";return`
      <section class="oq-helper-panel">
        ...
        ${nt({nextDisabled:!e.configurationApplied||e.flowTestActive||n,nextDisabledLabel:n?"Even wachten":e.flowTestActive?"Test loopt":e.requiresCic?"Sla eerst op":"Activeer eerst"})}
      </section>
    `}function Fb(){const e=ai(),t=o.busyAction==="quickstart-thermostat-source",n=e.status==="Geldig"?" is-active":"",r=e.isRemoteProfile?`
    ...
    `:"",a=e.selectedSource==="CIC"?zc(e,t):"",i=e.selectedSource==="HA input"?`
    ...
    `:"";return`
      <section class="oq-helper-panel">
        ...
        ${nt({nextDisabled:!e.configurationApplied,nextDisabledLabel:e.isQEdition?"Activeer eerst":"Sla eerst op"})}
      </section>
    `}function xb(){return!o.quickStartModalOpen||o.loadingEntities||o.complete===null||o.complete&&o.quickStartModalMode!=="generation"?"":o.quickStartModalMode==="generation"?`
      ...
      `:`
      <div class="oq-helper-modal-backdrop oq-helper-modal-backdrop--quickstart" data-oq-modal="quickstart-forced">
        <section class="oq-helper-modal oq-helper-modal--wide oq-helper-modal--quickstart" data-oq-quickstart-scroller data-oq-quickstart-step="${s(Qb().id)}" role="dialog" aria-modal="true" aria-labelledby="oq-quickstart-modal-title">
          <div class="oq-helper-modal-head">
            <div>
    ...
    `}function Qc(){return o.root?o.root.querySelector("[data-oq-quickstart-scroller]"):null}function Db(){const e=Qc();return e?{stepId:String(e.dataset.oqQuickstartStep||""),scrollHeight:e.scrollHeight,scrollTop:e.scrollTop,stickToBottom:Ya(e)}:null}function Ib(e){if(!e)return;const t=Qc();if(!t||String(t.dataset.oqQuickstartStep||"")!==e.stepId)return;if(e.stickToBottom){t.scrollTop=t.scrollHeight;return}const n=e.scrollTop+(t.scrollHeight-e.scrollHeight);t.scrollTop=Math.max(0,n)}function Ts(e,t=!0){if(!e)return;const n=Number(o.quickStartScrollRestoreToken||0)+1;o.quickStartScrollRestoreToken=n;const r=()=>{o.quickStartScrollRestoreToken!==n||!o.quickStartModalOpen||Ib(e)};if(t){window.requestAnimationFrame(r);return}r()}function Es(){return`
      <section class="oq-helper-panel">
    ...
    `}function Wb(){return`
      <section class="oq-helper-panel">
        ...
        ${_c("oq-settings-grid oq-settings-grid--quickstart oq-settings-boiler-simple-grid")}
        ${nt()}
      </section>
    `}function Bb(){return`
      <section class="oq-helper-panel">
    ...
    `}function Vb(){return`
      <section class="oq-helper-panel">
        ...
        ${ce()?`
            <div class="oq-settings-grid oq-settings-grid--quickstart">${Dc()}</div>
            <div class="oq-settings-curve-shell">
              ${jc()}
            </div>
            ${Nc()}
    ...
    `}function _b(){return`
      <section class="oq-helper-panel">
        ...
        ${Fc("oq-settings-grid oq-settings-grid--quickstart")}
        ${nt()}
      </section>
    `}function jb(){return`
      <section class="oq-helper-panel">
        ...
        ${oi("oq-settings-grid oq-settings-grid--quickstart")}
        ${nt()}
      </section>
    `}function Kb(){return`
      <section class="oq-helper-panel">
    ...
    `}function Ub(){return o.currentStep==="generation"?Kc():o.currentStep==="boiler"?v("boilerCvAssistEnabled")?Wb():Es():o.currentStep==="flow-source"?Ob():o.currentStep==="thermostat-source"?Fb():o.currentStep==="flow"?Bb():o.currentStep==="heating"?Vb():o.currentStep==="water"?_b():o.currentStep==="silent"?jb():o.currentStep==="confirm"?Kb():Es()}function Ot(){return Dn.filter(e=>!e.optionalEntity||v(e.optionalEntity))}function _e(e){const t=Ot().findIndex(n=>n.id===e);return`Stap ${Math.max(0,t)+1}`}function zb(e){const t=ir(),n=e===t,r=o.complete===!0||e<t;return{tone:n?"current":r?"done":"upcoming",label:n?"Actief":r?"Gereed":"Volgend",current:n}}function Gb(e=!1){return Ot().map((t,n)=>{const r=zb(n);return`
        <button
      ...
      `}).join("")}function Qb(){const e=Ot();return e.find(t=>t.id===o.currentStep)||e[0]||Dn[0]}function ir(){return Math.max(0,Ot().findIndex(e=>e.id===o.currentStep))}function $s(e){const t=Ot(),n=Math.min(t.length-1,Math.max(0,ir()+e));o.currentStep=t[n]?.id||Dn[0].id}function nt(e={}){const t=ir(),n=Ot(),r=t>0?n[t-1]:null,a=t<n.length-1?n[t+1]:null;return`
    ...
    `}function Yb(){const e=ir(),t=Ot();return`
    ...
    `;return`
      <div class="oq-helper-fields oq-helper-fields--review">
        ...
        ${f("Flowmeting",c,l.sourceLabel)}
        ${f("Verwarmingsstrategie",a,t)}
        ${f("Watertemperatuur",h)}
        ${f("Thermostaatgegevens",u,d.sourceLabel)}
        ${f("Flowregeling",g)}
        ${b.length?f("CV-ketel / boiler",b):""}
        ${f("Stille uren",y)}
      </div>
    `}function Zb({label:e,value:t,tone:n,note:r,status:a=!1}){return`
      <article class="oq-overview-stat oq-overview-stat--${s(n)}${a?" oq-overview-stat--status":""}">
        <p>${s(e)}</p>
        <strong>${s(t)}</strong>
        <span>${s(r)}</span>
      </article>
    `}function sr(e,t=!1){return e.map(n=>Zb({...n,value:Object.prototype.hasOwnProperty.call(n,"key")?Ie(n.key):n.value,status:t})).join("")}function ii(e){return`
      <div class="oq-overview-sectionhead">
        <h3>${s(e)}</h3>
      </div>
    `}function Yc(){const e=ar();return`
    ...
    `}function Jc({className:e,title:t,copy:n,body:r,signature:a=""}){const i=a?` data-render-signature="${s(a)}"`:"";return`
      <section class="${s(e)}"${i}>
        ${t?`<div class="oq-overview-system-copy"><h3>${s(t)}</h3><p>${s(n)}</p></div>`:""}
        ${r}
      </section>
    `}function Zc(e,t){return t?"Actief":e==="Stand-by"?"Stand-by":e==="Onbekend"?"Onbekend":"Niet actief"}function Xb(e,t){const n=t?"active":"neutral",r=Zc(e,t);return`<span class="oq-overview-chip oq-overview-chip--${s(n)}" data-oq-bind="panel-status">${s(r)}</span>`}function ev(e){return`
      <span
    ...
    `}function Xc(e,t,n,r){return`${n?ev(r):""}${Xb(e,t)}`}function tv(e,t,n,r,a){if(!e)return;const i=be({mode:t,running:n,warningActive:r,failureText:a});e.dataset.renderSignature!==i&&(gt(e,Xc(t,n,r,a)),e.dataset.renderSignature=i)}function Ur(e,t,n=""){return`
      <div class="oq-overview-row">
        <span>${s(e)}</span>
        <strong>${s(n||B(t))}</strong>
      </div>
    `}function ov(e,t,n="blue",r=""){return`
      <article class="oq-overview-metric oq-overview-metric--${s(n)}">
        <span>${s(e)}</span>
        <strong>${s(t)}</strong>
        ${r?`<p>${s(r)}</p>`:""}
      </article>
    `}function nv(e){return Number.isNaN(e)?"\u2014":`${e>0?"+":""}${e.toFixed(1)} \xB0C`}function I(e,t,n=""){const r=Number(e);return Number.isNaN(r)?"\u2014":`${r.toFixed(t)}${n?` ${n}`:""}`}function rv(e){if(!Number.isFinite(e)||e<0)return"\u2014";const t=Math.floor(e),n=Math.floor(t/1440),r=Math.floor(t%1440/60),a=t%60;return n>0?`${n}d ${r}u`:r>0?`${r}u ${a}m`:`${a}m`}function av(e){const n=String(e||"").trim().match(/^(\d{1,2}):(\d{2})$/);if(!n)return Number.NaN;const r=Number(n[1]),a=Number(n[2]);return Number.isNaN(r)||Number.isNaN(a)||r<0||r>23||a<0||a>59?Number.NaN:r*60+a}function iv(e){const t=av(B("timeNowHhmm",""));if(!Number.isFinite(t))return"";const n=Math.round(e),r=((t-n)%1440+1440)%1440,a=Math.floor(r/60),i=r%60;return`${String(a).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function sv(e,t){const n=Math.max(0,(Number(t)-Number(e))/6e4),r=rv(n),a=v("timeValid")&&A("timeValid")?iv(n):"";return a?{value:a,note:`${r} geleden`}:{value:`${r} geleden`,note:"Geen tijdsync"}}function lv(e){const t=Number(e);return Number.isNaN(t)?"\u2014":`${t>0?"+":t<0?"-":""}${Math.abs(t).toFixed(0)} W`}function eu(){return["outsideTempSelected","hp1OutsideTemp","hp2OutsideTemp"].find(e=>v(e))||""}function cv(){return["hp1WaterIn","hp2WaterIn"].find(e=>v(e))||""}function tu(e=B("controlModeLabel","")){const t=String(e||"").toLowerCase();return t.includes("cm5")||t.includes("cooling")||t.includes("koeling")}function wt(){return tu()}function ou(e,t){const n=String(e||"").trim().toLowerCase();return n==="waiting for room request"||n==="wacht op kamervraag"?!0:t?!1:n==="flow too low"||n==="flow te laag"||n==="flow unavailable"}function nu(){return wt()?"Koeling":ce()?"Stooklijn":"Power House"}function uv(){const e=["phouseReq","strategyRequestedPower"];for(const t of e){const n=H(t);if(!Number.isNaN(n))return n}return Number.NaN}function ru(){const e=uv(),t=H("phouseHouse"),n=H("totalHeat"),r=H("hpCapacity"),a=Number.isNaN(e)||Number.isNaN(t)?Number.NaN:e-t;let i="Nog aan het opbouwen",l="Zodra alle vermogens beschikbaar zijn, zie je hier hoe de warmtevraag is opgebouwd.";return!Number.isNaN(e)&&!Number.isNaN(r)&&e>r+150?(i="Capaciteit begrenst",l="De gevraagde warmtevraag ligt boven wat de warmtepomp nu ongeveer kan leveren."):!Number.isNaN(e)&&!Number.isNaN(n)&&n<e-250?(i="Levert minder dan gevraagd",l="De actuele warmteafgifte blijft nog onder de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(n)&&n>e+250?(i="Levert meer dan gevraagd",l="De actuele warmteafgifte ligt nu boven de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(n)&&(i="In balans",l="Gevraagde warmtevraag en actuele levering liggen nu dicht bij elkaar."),{requestedText:I(e,0,"W"),houseText:I(t,0,"W"),correctionText:lv(a),capacityText:Ie("hpCapacity"),statusTitle:i,statusCopy:l}}function au(){const e=H("curveSupplyTarget"),t=H("supplyTemp"),n=eu(),r=n?H(n):Number.NaN,a=Number.isNaN(e)||Number.isNaN(t)?Number.NaN:t-e,i=!!n&&Number.isNaN(r);let l="Stuurt op buitentemperatuur",c="De doelaanvoer volgt de huidige buitentemperatuur en vergelijkt die met de actuele aanvoer.";return i?(l="Fallback actief",c="De buitentemperatuur ontbreekt, dus de regeling valt terug op de ingestelde fallback-aanvoer."):!Number.isNaN(a)&&a<-1?(l="Nog onder doel",c="De actuele aanvoertemperatuur ligt nog onder de doelaanvoer."):!Number.isNaN(a)&&a>1?(l="Boven doel",c="De actuele aanvoertemperatuur ligt nu boven de doelaanvoer."):Number.isNaN(a)||(l="Dicht bij doel",c="De actuele aanvoertemperatuur sluit nu goed aan op de doelaanvoer."),{targetText:Ie("curveSupplyTarget"),supplyText:Ie("supplyTemp"),deltaText:nv(a),capacityText:Ie("hpCapacity"),statusTitle:l,statusCopy:c}}function iu(){const e=H("supplyTemp"),t=B("coolingGuardMode",""),n=B("coolingFallbackNightMinOutdoorTemp","\u2014"),r=H("coolingSupplyError"),a=H("coolingDemandRaw"),i=A("coolingPermitted"),l=A("coolingRequestActive"),c=B("coolingBlockReason","Onbekend"),d=Pc(c),u=ou(c,l);let g="Wacht op koelvraag",b="Zodra er koelvraag is, zie je hier hoe de regeling de aanvoer richting het koeldoel stuurt.";return u?(g="Wacht op koelvraag",b="Koeling staat aan en wacht nog op actieve koelvraag vanuit de kamerregeling."):i?l?!Number.isNaN(a)&&a<=0?(g="Houdt doel vast",b="De koelvraag loopt nog, maar de compressor hoeft nu niet harder te werken."):!Number.isNaN(r)&&r>1?(g="Trekt aanvoer omlaag",b="De actuele aanvoertemperatuur ligt nog ruim boven het koeldoel."):!Number.isNaN(r)&&r>.2?(g="Benadert koeldoel",b="De regeling koelt nog door, maar zit al dicht bij de gewenste aanvoertemperatuur."):Number.isNaN(r)||(g="Koelt rustig door",b="De aanvoertemperatuur zit dicht bij het koeldoel en de regeling werkt nu op laag pitje."):(g="Koeling gereed",b="Koeling is toegestaan, maar wacht nog op actieve koelvraag vanuit de kamerregeling."):(g="Koeling geblokkeerd",b=`Blokkade: ${d}.`),{targetText:Ie("coolingSupplyTarget"),supplyText:Ie("supplyTemp"),safeFloorText:Ie("coolingEffectiveMinSupplyTemp"),guardMode:t,fallbackNightMin:n,demandText:Ie("coolingDemandRaw"),statusTitle:g,statusCopy:b,permitted:i,requestActive:l,blockReason:d,waitingForRoomRequest:u}}function zr(){if(wt()){const t=iu(),n=t.guardMode.toLowerCase(),r=n.includes("user responsibility"),a=n.includes("fallback");return{title:"Koelregeling",copy:r?"Koeling draait expliciet zonder dauwpuntmeting of dauwpuntsbenadering. De ingestelde minimale koel-aanvoer blijft gelden.":"Koeling laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die bij de veilige grens zit.",focusLabel:"Koeldoel",focusValue:t.targetText,focusCopy:t.statusCopy,metrics:[{label:"Actuele aanvoertemperatuur",value:t.supplyText,tone:"orange",note:"Wat nu door het systeem loopt."},{label:r?"Ingestelde grens":a?"Berekende grens":"Veilige aanvoergrens",value:t.safeFloorText,tone:"blue",note:r?"Geen dauwpuntmeting of benadering; dit is de ingestelde minimale koel-aanvoer.":a?`Conservatieve dauwpuntsbenadering. Nachtminimum: ${t.fallbackNightMin}.`:"Dauwpunt plus veiligheidsmarge."},{label:"Koelvraag",value:t.demandText,tone:"sky",note:"De huidige koelvraag van de regelaar."}]}}if(ce()){const t=au();return{title:"Stooklijnregeling",copy:"De stooklijn laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die al benaderd wordt.",focusLabel:"Doelaanvoer",focusValue:t.targetText,focusCopy:"De aanvoertemperatuur waar de regeling nu naartoe werkt.",metrics:[{label:"Actuele aanvoertemperatuur",value:t.supplyText,tone:"orange",note:"Wat nu wordt geleverd."},{label:"Afwijking doelaanvoer",value:t.deltaText,tone:"blue",note:"Verschil met het doel."},{label:"Beschikbare warmtecapaciteit",value:t.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}const e=ru();return{title:"Vermogensbalans",copy:"Power House laat zien waar de warmtevraag nu vandaan komt en of de warmtepomp dat kan volgen.",focusLabel:"Gevraagd vermogen",focusValue:e.requestedText,focusCopy:"De warmtevraag waar Power House nu naartoe stuurt.",metrics:[{label:"Berekende huisvraag",value:e.houseText,tone:"blue",note:"Op basis van woning en buitentemperatuur."},{label:"Kamercorrectie",value:e.correctionText,tone:"orange",note:"Extra bijsturing rond setpoint."},{label:"Beschikbare warmtecapaciteit",value:e.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}function su(e){return Jc({className:"oq-overview-system",title:e.title,copy:e.copy,signature:be(e),body:`
        ...
        <div class="oq-overview-metrics oq-overview-metrics--three-column">
          ${e.metrics.map(t=>ov(t.label,t.value,t.tone,t.note)).join("")}
        </div>
      `})}function dv(){if(!A("openquattEnabled"))return{label:"Regeling nu",value:"Regeling tijdelijk uit",tone:"orange"};if(wt()){const r=iu(),a=r.waitingForRoomRequest?"neutral":r.permitted?r.statusTitle==="Koelt rustig door"||r.statusTitle==="Houdt temperatuur vast"?"green":r.statusTitle==="Koeling gereed"?"neutral":"sky":"orange";return{label:"Regeling nu",value:r.statusTitle,tone:a}}if(by())return{label:"Regeling nu",value:"Stand-by",tone:"neutral"};const t=(ce()?au():ru()).statusTitle;return{label:"Regeling nu",value:t,tone:t==="In balans"||t==="Dicht bij doel"?"green":t==="Nog aan het opbouwen"||t==="Stuurt op buitentemperatuur"?"neutral":"orange"}}function pv(){return A("openquattEnabled")?wt()?A("coolingPermitted")?A("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:B("coolingBlockReason","Koeling geblokkeerd"),tone:"orange"}:A("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:A("stickyActive")?{label:"Systeem",value:"Pompbescherming actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:"Vorstbeveiliging blijft actief",tone:"neutral"}}function lu(e,t){const n=dv(),r=pv();return[{label:"Strategie",value:e,tone:"orange",note:"regelstrategie"},{label:"Controlmode",value:t,tone:"orange",note:"actieve modus"},{label:"Regeling",value:n.value,tone:"orange",note:"wat OpenQuatt nu doet"},{label:"Systeem",value:r.value,tone:"orange",note:"actieve randvoorwaarde"}]}function cu(e,t){const n=lu(e,t);return`
    ...
    `}function uu(){const e=wt();return[{key:"totalPower",label:"Elektrisch vermogen",tone:"blue",note:"hele systeem"},{key:e?"totalCoolingPower":"totalHeat",label:e?"Koelvermogen":"Verwarmingsvermogen",tone:"orange",note:"thermisch vermogen"},{key:e?"totalEer":"totalCop",label:e?"COP (EER)":"COP",tone:"green",note:"rendement"},{key:"flowSelected",label:"Flow",tone:"sky",note:"watercircuit"}]}function gv(){const e=A("openquattEnabled"),t=E("openquattResumeAt"),n=Da(t),r=(o.loadingEntities||o.entitySyncInFlight)&&!v("openquattResumeAt"),a=A("manualCoolingEnable"),i=String(E("silentModeOverride")||"Schedule"),l=!A("coolingPermitted"),c=A("coolingRequestActive"),d=tu(),u=B("coolingBlockReason",""),g=ou(u,c);let b="Uit",h="Koeling staat uit.";a&&d?(b="Actief",h="Koeling draait nu."):a&&g?(b="Aan",h="Koeling staat aan en wacht op koelvraag."):a&&l?(b="Geblokkeerd",h=Pc(u||"Koeling wacht nog op veilige condities.")):a&&c?(b="Start bijna",h="Er is koelvraag. Koeling start zodra dat kan."):a&&(b="Aan",h="Koeling staat aan en wacht op koelvraag.");let y="Uit",p="Stille modus staat uit.",f="neutral";return i==="On"?(y="Aan",p="Stille modus staat geforceerd aan, ook buiten het tijdvenster.",f="orange"):i==="Schedule"&&(y="Schema",A("silentActive")?(p="Stille modus staat nu aan via het tijdvenster.",f="violet"):p="Stille modus volgt het tijdvenster."),[{key:"openquattEnabled",label:"Openquatt regeling",status:e?"Actief":"Tijdelijk uit",copy:e?"Verwarmen en koelen worden automatisch geregeld.":n?"Verwarming en koeling zijn tijdelijk uitgeschakeld. Beveiligingen blijven actief.":"Verwarming en koeling zijn uitgeschakeld. Beveiligingen blijven actief.",tone:e?"green":"orange",kind:"openquatt-control",meta:e?[]:[r?{label:"Hervatten",value:"Laden\u2026",tone:"neutral",loading:!0}:{label:n?"Hervat automatisch":"Hervatten",value:n?Ia(t,!0):"Handmatig",tone:n?"orange":"neutral"}]},{key:"manualCoolingEnable",label:"Koeling",status:b,copy:h,buttonLabel:a?"Zet uit":"Zet aan",nextState:a?"off":"on",tone:a?d?"blue":"sky":"neutral"},{key:"silentModeOverride",label:"Stille modus",status:y,copy:p,tone:f,kind:"select",selectedOption:i,settingsAction:!0,options:[{value:"Off",label:"Uit"},{value:"On",label:"Aan"},{value:"Schedule",label:"Schema"}]}].filter(S=>v(S.key))}function mv(e=[]){return e.length?`
    ...
    `:""}function jt({className:e,action:t,label:n,busy:r=!1,loading:a=!1,attrs:i=""}){return`
      ...
      `:s(r?"Bezig...":n)}</button>
    `}function hv(e){if(e.kind==="openquatt-control"){const t=o.busyAction==="openquatt-regulation",n=(o.loadingEntities||o.entitySyncInFlight)&&!v("openquattResumeAt");return A("openquattEnabled")?`<div class="oq-overview-controlpanel-actions">${jt({className:"oq-overview-controlpanel-toggle",action:"open-openquatt-pause-modal",label:"Tijdelijk uitschakelen",busy:t})}</div>`:`
          <div class="oq-overview-controlpanel-actions oq-overview-controlpanel-actions--split">
            ...
            ${jt(n?{className:"oq-overview-controlpanel-segment oq-overview-controlpanel-segment--loading",action:"",label:"Hervatopties laden\u2026",loading:!0}:{className:"oq-overview-controlpanel-segment",action:"open-openquatt-pause-modal",label:Da()?"Moment wijzigen":"Automatisch hervatten"})}
          </div>
    ...
    `}function du(){const e=gv();return e.length?`
    ...
    `:""}function fv(e){const t=B("controlModeLabel");return`
      <section class="oq-overview-summary-shell">
        ...
        <div class="oq-overview-summary-layout">
          ...
          <aside class="oq-overview-summary-side" data-render-signature="${s(nc())}">
            ${du()}
          </aside>
        </div>
      </section>
    `}function si(){const e=eu(),t=cv();return wt()?{title:"Koeltemperaturen",copy:"De belangrijkste temperaturen voor kamercomfort, koeldoel en dauwpuntveiligheid.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},{label:"Koeldoel",key:"coolingSupplyTarget"},{label:"Veilige aanvoergrens",key:"coolingMinimumSafeSupplyTemp"},{label:"Dauwpunt",key:"coolingDewPointSelected"}]}:{title:"Temperaturen",copy:"De belangrijkste temperaturen voor comfort en regeling.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},...t?[{label:"Retourtemperatuur",key:t}]:[],e?{label:"Buitentemperatuur",key:e}:{label:"Buitentemperatuur",key:"",value:"\u2014"}]}}function pu(e=si()){return be({...e,values:e.rows.map(t=>t.value||B(t.key))})}function gu(){const e=si();return Jc({className:"oq-overview-temps",title:e.title,copy:e.copy,signature:pu(e),body:`
        <div class="oq-overview-temps-list">
          ${e.rows.map(t=>Ur(t.label,t.key,t.value||"")).join("")}
        </div>
      `})}const As=360;function rt(){const e=da(o.trendWindowHours||Xt);return e!==o.trendWindowHours&&pa(e),e}function mu(e=rt()){return Math.max(1,Number(e)||24)*60*60*1e3}function bv(e=rt()){const t=Number(e)||24;return t>=72&&t%24===0?`${t/24}d`:`${t}u`}function li(e=rt()){const t=Number(e)||24;if(t>=72&&t%24===0){const n=t/24;return`${n} ${n===1?"dag":"dagen"}`}return`${t} uur`}function Ar(e){if(!Number.isFinite(e))return"\u2014";const t=new Date(e);if(Number.isNaN(t.getTime()))return"\u2014";const n={day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"};try{return new Intl.DateTimeFormat("nl-NL",n).format(t)}catch{return t.toLocaleString("nl-NL",n)}}function vv(e){const t=String(e||"").trim().split("|");if(t.length<5)return null;const n=Number(t[0]);if(!Number.isFinite(n))return null;const r=a=>{const i=Number(a);return Number.isFinite(i)?i:null};return{t:n,outside:r(t[1]),supply:r(t[2]),room:t.length>=8?r(t[3]):null,roomSetpoint:t.length>=8?r(t[4]):null,flow:t.length>=8?r(t[5]):null,input:t.length>=8?r(t[6]):r(t[3]),output:t.length>=8?r(t[7]):r(t[4])}}function Gr(){return!!(typeof window<"u"&&window.__OQ_DEV_CONTROLS__||typeof window<"u"&&window.__OQ_DEV_META)}function Hr(e=rt()){return typeof window>"u"||!window.__OQ_DEV_TREND_MOCKS__||typeof window.__OQ_DEV_TREND_MOCKS__.buildTrendPreviewSamples!="function"?[]:window.__OQ_DEV_TREND_MOCKS__.buildTrendPreviewSamples(e)}function hu(){const e=mu(),t=String(o.trendHistoryRaw||"").trim();if(!t)return Gr()?Hr():[];const n=t.split(/\r?\n/).map(vv).filter(Boolean),r=n.length?n[n.length-1].t:Number.NaN,a=Number.isFinite(o.trendHistoryNowMs)?o.trendHistoryNowMs:Number.isFinite(r)?r:Number.NaN;if(!Number.isFinite(a))return n.length?n.slice(-As):Hr();const i=Math.max(0,a-e),l=n.filter(c=>c.t>=i).slice(-As);return l.length?l:Gr()?Hr(windowHours):[]}function ci(){const e=rt(),t=li(e),n=hu(),r=Gr()&&n.length===0,a=wt();return[{id:"temperatures",title:"Temperaturen",copy:`Buiten- en aanvoertemperatuur van de laatste ${t}.`,tone:"orange",samples:n,mock:r,windowHours:e,series:[{id:"outside",sampleKey:"outside",currentKey:"outsideTempSelected",label:"Buiten",tone:"orange",decimals:1,unit:" \xB0C"},{id:"supply",sampleKey:"supply",currentKey:"supplyTemp",label:"Aanvoer",tone:"blue",decimals:1,unit:" \xB0C"}]},{id:"power",title:"Vermogen",copy:`Elektrisch vermogen en verwarmingsvermogen van de laatste ${t}.`,tone:"green",samples:n,mock:r,windowHours:e,series:[{id:"input",sampleKey:"input",currentKey:"totalPower",label:"Elektrisch vermogen",tone:"green",decimals:0,unit:" W"},{id:"output",sampleKey:"output",currentKey:a?"totalCoolingPower":"totalHeat",label:a?"Koelvermogen":"Verwarmingsvermogen",tone:"sky",decimals:0,unit:" W"}]},{id:"rendement",title:"Rendement",copy:`COP van de laatste ${t}.`,tone:"slate",samples:n,mock:r,windowHours:e,series:[{id:"cop",label:"COP",tone:"slate",decimals:1,unit:"",currentKey:a?"totalEer":"totalCop",derive:i=>{const l=Number(i?.input),c=Number(i?.output);return!Number.isFinite(l)||!Number.isFinite(c)||l<=0?Number.NaN:c/l}}]},{id:"comfort",title:"Comfort",copy:`Kamertemperatuur en setpoint van de laatste ${t}.`,tone:"blue",samples:n,mock:r,windowHours:e,series:[{id:"roomTemp",sampleKey:"room",currentKey:"roomTemp",label:"Kamertemperatuur",tone:"blue",decimals:1,unit:" \xB0C"},{id:"roomSetpoint",sampleKey:"roomSetpoint",currentKey:"roomSetpoint",label:"Kamer setpoint",tone:"orange",decimals:1,unit:" \xB0C"}]},{id:"flow",title:"Flow",copy:`Flow van de laatste ${t}.`,tone:"sky",samples:n,mock:r,windowHours:e,series:[{id:"flow",sampleKey:"flow",currentKey:"flowSelected",label:"Flow",tone:"sky",decimals:0,unit:" L/h",axisMin:0,axisTickStep:250}]}]}function yv(e){const t=e.samples[e.samples.length-1]||null;return be({id:e.id,windowHours:e.windowHours,sampleCount:e.samples.length,firstTimestamp:e.samples[0]?.t||0,lastTimestamp:t?.t||0,trendSignature:o.trendHistorySignature||"",latestValues:t?[t.outside,t.supply,t.room,t.roomSetpoint,t.flow,t.input,t.output]:[]})}function Io(e,t){if(!e||!t)return Number.NaN;const n=typeof e.derive=="function"?e.derive(t):t?.[e.sampleKey],r=Number(n);return Number.isFinite(r)?r:Number.NaN}function wv(e,t){const n=[];return e.forEach(r=>{t.forEach(a=>{const i=Io(a,r);Number.isFinite(i)&&n.push(i)})}),n.length?{min:Math.min(...n),max:Math.max(...n)}:{min:0,max:1}}function Sv(e){if(!Number.isFinite(e)||e<=0)return 1;const t=Math.floor(Math.log10(e)),n=e/10**t;let r;return n<=1?r=1:n<=2?r=2:n<=5?r=5:r=10,r*10**t}function qv(e,t){const n=Number.isFinite(e?.min)?e.min:0,r=Number.isFinite(e?.max)?e.max:1,a=Math.max(r-n,1),i=Array.isArray(t)?t.map(h=>Number(h?.axisMin)).find(h=>Number.isFinite(h)):Number.NaN,l=Array.isArray(t)?t.map(h=>Number(h?.axisMax)).find(h=>Number.isFinite(h)):Number.NaN,c=Array.isArray(t)?t.map(h=>Number(h?.axisTickStep)).find(h=>Number.isFinite(h)&&h>0):Number.NaN,d=Math.max(1,Number.isFinite(c)?c:Sv(a/4)),u=[];if(Number.isFinite(i)||Number.isFinite(l)){const h=Number.isFinite(i)?i:0,y=Number.isFinite(l)?l:Math.ceil(r/d)*d,p=Math.floor(h/d)*d,f=Math.ceil(y/d)*d;for(let S=p;S<=f+d*.5;S+=d)u.push(S)}else{const h=a/d,y=h<=1.8?3:h<=4.25?5:7,p=Math.floor(y/2),f=(n+r)/2,S=Math.round(f/d)*d;for(let w=-p;w<=p;w+=1)u.push(S+w*d)}const g=u[0],b=u[u.length-1];return{ticks:u,axisMin:g,axisMax:b,axisDecimals:0}}function fu(e,t,n={}){const r=Number(n.windowHours),a=Number.isFinite(r)?r:rt(),i=mu(a),l=640,c=220,d=46,u=18,g=18,b=34,h=l-d-u,y=c-g-b,p=e[e.length-1],f=!!n.mockData,S=f?i:Number.isFinite(o.trendHistoryNowMs)?o.trendHistoryNowMs:p?p.t:0,w=f?0:S-i,q=Math.max(S-w,1),T=q,k=wv(e,t),M=k.min===k.max?{min:k.min-1,max:k.max+1}:{min:k.min-Math.max((k.max-k.min)*.12,1),max:k.max+Math.max((k.max-k.min)*.12,1)},x=qv(k,t),F=R=>d+(R-w)/q*h,U=R=>{if(!Number.isFinite(R))return Number.NaN;const V=(R-M.min)/Math.max(M.max-M.min,1);return g+(1-Math.min(1,Math.max(0,V)))*y},C=[0,.5,1].map(R=>d+h*R),$=x.ticks.map(R=>U(R)),N=x.ticks.map((R,V)=>({x:d-10,y:$[V],text:I(R,x.axisDecimals)})),W=e.map(R=>{const V=F(R.t),P=t.map(O=>{const _=Io(O,R);return Number.isFinite(_)?{seriesId:O.id||O.sampleKey||O.label,tone:O.tone,label:O.label,decimals:O.decimals,unit:O.unit,value:_,x:V,y:U(_)}:null});return{sample:R,x:V,values:P}}),K=t.flatMap(R=>{const V=[];let P=[];return e.forEach(O=>{const _=Io(R,O);if(!Number.isFinite(_)){P.length&&(V.push(P),P=[]);return}P.push({x:F(O.t),y:U(_)})}),P.length&&V.push(P),V.map(O=>O.length<2?{tone:R.tone,points:O,path:""}:{tone:R.tone,points:O,path:O.map((_,Y)=>`${Y===0?"M":"L"} ${_.x.toFixed(1)} ${_.y.toFixed(1)}`).join(" ")})});return{width:l,height:c,left:d,right:u,top:g,bottom:b,plotWidth:h,plotHeight:y,latest:p,uptimeMs:T,endTime:S,startTime:w,span:q,windowHours:a,range:k,displayRange:M,gridXs:C,gridYs:$,yAxisLabels:N,points:W,tracks:K,series:t}}function ui(){return be({windowHours:rt(),trendSignature:o.trendHistorySignature||"",trendNowMs:Number.isFinite(o.trendHistoryNowMs)?o.trendHistoryNowMs:0,coolingActive:wt()})}function kv(e){return ci().find(t=>t.id===e)||null}function Cv(e,t){if(!e||!Array.isArray(e.points)||e.points.length===0)return-1;let n=0,r=Math.abs(e.points[0].x-t);return e.points.forEach((a,i)=>{const l=Math.abs(a.x-t);l<r&&(n=i,r=l)}),n}function Tv(e,t){const n=bu(e,t);return`
      <div class="oq-overview-trend-pill oq-overview-trend-pill--${s(e.tone)}" data-oq-trend-current="${s(e.id)}">
        <span>${s(e.label)}</span>
        <strong>${s(I(n,e.decimals,e.unit))}</strong>
      </div>
    `}function bu(e,t){if(e?.currentKey&&v(e.currentKey)){const n=H(e.currentKey);if(Number.isFinite(n))return n}return Io(e,t)}function vu(e){e&&ci().forEach(t=>{const n=e.querySelector(`[data-oq-trend-card="${t.id}"]`),r=t.samples[t.samples.length-1]||null;n&&t.series.forEach(a=>{const l=n.querySelector(`[data-oq-trend-current="${a.id}"]`)?.querySelector("strong"),c=I(bu(a,r),a.decimals,a.unit);l&&l.textContent!==c&&(l.textContent=c)})})}function Ev(e,t,n=!1,r=rt()){const a=fu(e,t,{mockData:n,windowHours:r}),i=li(r),l=Ar(a.startTime),c=Ar(a.startTime+a.span/2),d=Ar(a.endTime),u=a.tracks.flatMap(g=>{if(g.points.length<2){const b=g.points[0];return b?`
          <circle
            cx="${b.x.toFixed(1)}"
            cy="${b.y.toFixed(1)}"
            r="3.8"
    ...
    `}function $v(e){const t=e.samples[e.samples.length-1]||null,n=li(e.windowHours);return`
      <article class="oq-overview-trendcard oq-overview-trendcard--${s(e.tone)}" data-oq-trend-card="${s(e.id)}" data-render-signature="${s(yv(e))}">
        ...
        ${Ev(e.samples,e.series,e.mock,e.windowHours)}
    ...
    `}function di(){const e=ci();return`
      <section class="oq-overview-trends" aria-label="Diagnose" data-render-signature="${s(ui())}">
    ...
    `}function Hv(){const e=rt(),t=rl();return`
    ...
    `}function Mv(){const e="overview-trends-history",t=o.settingsInfoOpen===e;return`
    ...
    `}function Pv(){const e=po(),n=hu().length>0;return`
    ...
    `}function Nv(){if(!o.root||o.appView!=="diagnosis")return!1;const e=o.root.querySelector(".oq-overview-board");if(!e)return!1;const t=e.querySelector(".oq-overview-trends");return t?(ut(t,ui(),di()),vu(e),gi(e),!0):!1}function pi(e){if(!e)return null;const t=e.__oqTrendHoverNodes;if(t&&t.chart&&t.hoverLayer&&t.hoverPanel)return t;const n=e.querySelector("[data-oq-trend-hover-layer]"),r={chart:e.querySelector(".oq-overview-trend-chart"),hoverLayer:n,hoverPanel:e.querySelector("[data-oq-trend-hover]"),hoverTime:e.querySelector("[data-oq-trend-hover-time]"),hoverNote:e.querySelector("[data-oq-trend-hover-note]"),hoverValues:e.querySelector("[data-oq-trend-hover-values]"),hoverLine:n?n.querySelector(".oq-overview-trend-hover-line"):null,hoverDots:{}};return n&&n.querySelectorAll("[data-oq-trend-hover-dot]").forEach(a=>{r.hoverDots[a.getAttribute("data-oq-trend-hover-dot")]=a}),e.__oqTrendHoverNodes=r,r}function Hs(e,t,n,r=pi(e)){if(!e||!t||!Array.isArray(t.points)||t.points.length===0)return;const a=Math.max(0,Math.min(t.points.length-1,n)),i=t.points[a];if(!i||!r||!r.chart||!r.hoverLayer||!r.hoverPanel||!r.hoverTime||!r.hoverNote||!r.hoverValues)return;const l=String(a);if(!r.hoverPanel.hidden&&e.dataset.oqTrendHoverIndex===l)return;const c=sv(i.sample.t,t.endTime);r.hoverPanel.hidden=!1,r.hoverLayer.removeAttribute("hidden"),r.hoverTime.textContent=c.value,r.hoverNote.textContent=c.note,r.hoverLine&&(r.hoverLine.setAttribute("x1",i.x.toFixed(1)),r.hoverLine.setAttribute("x2",i.x.toFixed(1)));const d=[];t.series.forEach(u=>{const g=Io(u,i.sample),b=u.id||u.sampleKey||u.label,h=r.hoverDots[b];if(!Number.isFinite(g)){h&&h.setAttribute("display","none");return}const y=i.values.find(p=>p.seriesId===b);h&&y&&(h.removeAttribute("display"),h.setAttribute("cx",y.x.toFixed(1)),h.setAttribute("cy",y.y.toFixed(1))),d.push(`
        <div class="oq-overview-trend-hover-row oq-overview-trend-hover-row--${s(u.tone)}">
          <span>${s(u.label)}</span>
          <strong>${s(I(g,u.decimals,u.unit))}</strong>
        </div>
      `)}),r.hoverValues.innerHTML=d.join(""),e.dataset.oqTrendHoverIndex=l}function Rv(e){if(!e)return;const t=pi(e);t?.hoverPanel&&(t.hoverPanel.hidden=!0),t?.hoverLayer&&t.hoverLayer.setAttribute("hidden",""),delete e.dataset.oqTrendHoverIndex}function gi(e=o.root){if(!e)return;e.querySelectorAll("[data-oq-trend-card]").forEach(n=>{const r=n.dataset.renderSignature||"";if(n.__oqTrendBoundSignature===r)return;typeof n.__oqTrendCleanup=="function"&&n.__oqTrendCleanup(),n.__oqTrendHoverNodes=null,n.__oqTrendBoundSignature=r;const a=n.querySelector(".oq-overview-trend-chart");if(!a)return;const i=kv(n.dataset.oqTrendCard);if(!i)return;const l=fu(i.samples,i.series,{mockData:i.mock});n.__oqTrendModel=l;const c=pi(n);let d=0,u=null;const g=()=>{const y=u;u=null,d=0;const p=a.getBoundingClientRect();if(!p.width||!p.height)return;const f=Number(y?.clientX);if(!Number.isFinite(f)){Hs(n,l,l.points.length-1,c);return}const w=Math.min(p.width,Math.max(0,f-p.left))/p.width*l.width,q=Cv(l,w);Hs(n,l,q,c)},b=y=>{u=y,d||(d=window.requestAnimationFrame(g))},h=()=>{d&&(window.cancelAnimationFrame(d),d=0),u=null,Rv(n)};a.addEventListener("pointermove",b),a.addEventListener("pointerenter",b),a.addEventListener("pointerleave",h),a.addEventListener("focus",b),a.addEventListener("blur",h),a.addEventListener("touchstart",b,{passive:!0}),n.__oqTrendCleanup=()=>{d&&(window.cancelAnimationFrame(d),d=0),u=null,a.removeEventListener("pointermove",b),a.removeEventListener("pointerenter",b),a.removeEventListener("pointerleave",h),a.removeEventListener("focus",b),a.removeEventListener("blur",h),a.removeEventListener("touchstart",b)}})}function Lv([e,t]){const n=cc(t);if(!v(t)&&Number.isNaN(n))return"";const r=lc(t)?Ie(t):B(t);return`
      <div class="oq-overview-energy-row">
        <span>${s(e)}</span>
        <strong>${s(r)}</strong>
      </div>
    `}function Ov(e){const t=e.rows.map(Lv).filter(Boolean).join("");return t?`
    ...
    `:""}function Fv(e){const t=e.groups.map(Ov).filter(Boolean).join("");return t?`
    ...
    `:""}function xv(e){const t=e.categories.map(Fv).filter(Boolean).join("");return t?`
    ...
    `:""}function mi(){const e=el.map(xv).filter(Boolean),t=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:t}}function yu(e=mi()){return be(e)}function wu(e=mi()){return`
      <section class="oq-overview-energy oq-overview-energy--solo" data-render-signature="${s(yu(e))}">
        <div class="${s(e.gridClassName)}">
          ${e.renderedColumns.join("")}
        </div>
      </section>
    `}const lr=["electricalInputWh","heatingInputWh","coolingInputWh","heatpumpHeatOutputWh","heatpumpCoolingOutputWh","boilerHeatOutputWh","systemHeatOutputWh"],Su=[{id:"day",label:"Dag"},{id:"week",label:"Week"},{id:"month",label:"Maand"},{id:"year",label:"Jaar"},{id:"all",label:"Alles"}],Dv=new Set(["day","week","month","year"]),Iv=["Zo","Ma","Di","Wo","Do","Vr","Za"];function ve(e){const t=String(e||"").trim();return Su.some(n=>n.id===t)?t:"day"}function Ms(e){const t=ve(e);o.energyHistoryView!==t&&(o.energyHistoryView=t,o.energyHistoryLastFetchAt=0,m(),qu())}function qu(){typeof Nt=="function"&&Nt({force:!0}).then(e=>{e&&m()})}function vo(e){return Dv.has(ve(e))}function cr(){const e=new Date;return e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate()}function On(){const e=String(o.energyHistoryRaw||""),t={storedDayCount:0,oldestDateKey:null,newestDateKey:null,hourStoredDayCount:0,hourOldestDateKey:null,hourNewestDateKey:null,hourRequestedRetentionDays:0,hourSlotCount:0,hourPartitionAvailable:!1,hourRecordCount:0,hourWriteCount:0,hourStorageKb:0,hourLastWriteTimestampS:0};return e.split(/\r?\n/).forEach(n=>{if(!n.startsWith("@bounds|")&&!n.startsWith("@hour_retention|"))return;const r=n.split("|");n.startsWith("@bounds|")?(t.storedDayCount=Number(r[1])||0,t.oldestDateKey=Number(r[2])||null,t.newestDateKey=Number(r[3])||null,t.hourStoredDayCount=Number(r[4])||0,t.hourOldestDateKey=Number(r[5])||null,t.hourNewestDateKey=Number(r[6])||null):n.startsWith("@hour_retention|")&&(t.hourRequestedRetentionDays=Number(r[1])||0,t.hourSlotCount=Number(r[2])||0,t.hourPartitionAvailable=Number(r[3])===1,t.hourRecordCount=Number(r[4])||0,t.hourWriteCount=Number(r[5])||0,t.hourStorageKb=Number(r[6])||0,t.hourLastWriteTimestampS=Number(r[7])||0)}),t}function hi(){const e=String(o.energyHistoryRaw||"");let t=null;return e.split(/\r?\n/).forEach(n=>{const r=Mu(n);r&&(t=r.dateKey)}),t}function Wv(e=[],t=!0){const n=hi(),r=On(),a=(Array.isArray(e)?e:[]).map(i=>Number(i?.dateKey)).filter(Number.isFinite);return Number.isFinite(Number(r.newestDateKey))&&a.push(Number(r.newestDateKey)),Number.isFinite(Number(n))&&a.push(Number(n)),t&&ur().forEach(i=>{const l=Number(i?.dateKey);Number.isFinite(l)&&a.push(l)}),a.length?Math.max(...a):cr()}function Ee(e){return e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate()}function ku(e,t,n){return new Date(e,t-1,n,12,0,0)}function Cu(e,t){return new Date(e,t,0).getDate()}function Ps(e){return String(e).padStart(2,"0")}function Mr(e){const t=Q(e);return t?`${t.year}-${Ps(t.month)}-${Ps(t.day)}`:""}function Tu(e){const t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(String(e||"").trim());if(!t)return null;const n=Number(t[1]),r=Number(t[2]),a=Number(t[3]),i=ku(n,r,a);return i.getFullYear()!==n||i.getMonth()+1!==r||i.getDate()!==a?null:Q(Ee(i))}function Eu(e,t){return Number(e)*100+Number(t)}function Qr(e){return Eu(e.getFullYear(),e.getMonth()+1)}function no(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return null;const n=Math.floor(t/100),r=t%100;return n<2020||r<1||r>12?null:{key:t,year:n,month:r,date:new Date(n,r-1,1,12,0,0)}}function Bv(e){const t=String(e||"").trim(),n=/^(\d{4})-(\d{2})$/.exec(t);return no(n?Eu(Number(n[1]),Number(n[2])):t)}function $u(e,t){const n=no(e);if(!n)return"";const r=new Date(n.year,n.month-1+Number(t||0),1,12,0,0);return String(Qr(r))}function tn(e){const t=new Date(e.getTime()),n=t.getDay(),r=n===0?-6:1-n;return t.setDate(t.getDate()+r),t.setHours(12,0,0,0),t}function ro(e,t){const n=new Date(e.getTime());return n.setDate(n.getDate()+t),n.setHours(12,0,0,0),n}function Ns(e){return e.toLocaleDateString("nl-NL",{day:"numeric",month:"short"}).replace(/\./g,"")}function Au(e){const t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),n=(t.getUTCDay()+6)%7;t.setUTCDate(t.getUTCDate()-n+3);const r=t.getUTCFullYear(),a=new Date(Date.UTC(r,0,4)),i=(a.getUTCDay()+6)%7;return a.setUTCDate(a.getUTCDate()-i+3),{week:1+Math.round((t-a)/(10080*60*1e3)),year:r}}function Rs(e){return Ee(tn(e))}function Vv(e){const n=Tu(e)||Q(e);if(!n)return null;const r=tn(n.date);return Q(Ee(r))}function Hu(e){const t=Q(e);if(!t)return"Week";const n=tn(t.date),r=ro(n,6);return`Week ${Au(n).week} (${Ns(n)} - ${Ns(r)})`}function Q(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return null;const n=Math.floor(t/1e4),r=Math.floor(t/100)%100,a=t%100;return n<2020||r<1||r>12||a<1||a>31?null:{key:t,year:n,month:r,day:a,date:new Date(n,r-1,a,12,0,0)}}function Qe(e,t="day"){const n=Q(e);return n?t==="weekday"?Iv[n.date.getDay()]||"":t==="month"?n.date.toLocaleDateString("nl-NL",{month:"short"}):t==="year"?String(n.year):n.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"short"}):"\u2014"}function qt(e){const t=H(e);return!Number.isFinite(t)||t<0?null:Math.round(t*1e3)}function _v(e){const t=Number(e);return Number.isFinite(t)&&t>=0?t:null}function fi(e,t=0){const n={};return lr.forEach((r,a)=>{n[r]=_v(e[t+a])}),n}function jv(e){const t=String(e||"").trim();if(!t||t.startsWith("@"))return null;const n=t.split("|");if(n.length<10)return null;const r=Number(n[0]),a=Number(n[1]),i=Number(n[2]),l=Q(a);return!Number.isFinite(r)||!l?null:{sequence:r,dateKey:a,year:l.year,month:l.month,day:l.day,partial:!!(i&1),source:"flash",...fi(n,3)}}function Mu(e){const t=String(e||"").trim();if(!t.startsWith("@current|"))return null;const n=t.split("|");if(n.length<9)return null;const r=Number(n[1]),a=Q(r);return a?{sequence:Number.MAX_SAFE_INTEGER,dateKey:r,year:a.year,month:a.month,day:a.day,partial:!0,source:"current",...fi(n,2)}:null}function Kv(e){const t=String(e||"").trim();if(!t.startsWith("@hour|"))return null;const n=t.split("|");if(n.length<11)return null;const r=Number(n[1]),a=Number(n[2]),i=Number(n[3]),l=Q(a);return!Number.isFinite(r)||!l||!Number.isInteger(i)||i<0||i>23?null:{sequence:r,dateKey:a,year:l.year,month:l.month,day:l.day,hour:i,partial:!0,source:"hour",label:String(i),tooltipLabel:`${String(i).padStart(2,"0")}:00 - ${String((i+1)%24).padStart(2,"0")}:00`,sortKey:a*100+i,...fi(n,4)}}function Uv(){const e=hi()||cr(),t=Q(e);if(!t)return null;const n={sequence:Number.MAX_SAFE_INTEGER-1,dateKey:e,year:t.year,month:t.month,day:t.day,partial:!0,source:"sensors",electricalInputWh:qt("electricalEnergyDaily"),heatingInputWh:qt("heatingElectricalEnergyDaily"),coolingInputWh:qt("coolingElectricalEnergyDaily"),heatpumpHeatOutputWh:qt("heatpumpThermalEnergyDaily"),heatpumpCoolingOutputWh:qt("heatpumpCoolingEnergyDaily"),boilerHeatOutputWh:qt("boilerThermalEnergyDaily"),systemHeatOutputWh:qt("systemThermalEnergyDaily")};return lr.some(r=>Number.isFinite(n[r]))?n:null}function on(e,t){const n=Number(e?.[t]);return Number.isFinite(n)&&n>=0?n:0}function nn(){const e=new Map;String(o.energyHistoryRaw||"").split(/\r?\n/).forEach(i=>{const l=jv(i)||Mu(i);if(!l)return;const c=e.get(l.dateKey);(!c||l.sequence>=c.sequence)&&e.set(l.dateKey,l)});const n=Uv();n&&e.set(n.dateKey,n);const r=new Set(e.keys()),a=new Map;return ur().forEach(i=>{if(r.has(i.dateKey))return;let l=a.get(i.dateKey);if(!l){const c=Q(i.dateKey);if(!c)return;l=Ct({dateKey:c.key,year:c.year,month:c.month,day:c.day,label:Qe(c.key),sortKey:c.key,source:"hour-summary"}),l.tooltipLabel=`${Qe(i.dateKey)} \xB7 uurdata sinds herstart`,a.set(i.dateKey,l)}Tt(l,i)}),a.forEach((i,l)=>{e.set(l,i)}),[...e.values()].sort((i,l)=>i.dateKey-l.dateKey)}function ur(){const e=new Map;return String(o.energyHistoryRaw||"").split(/\r?\n/).forEach(n=>{const r=Kv(n);if(!r)return;const a=`${r.dateKey}:${r.hour}`,i=e.get(a);(!i||r.sequence>=i.sequence)&&e.set(a,r)}),[...e.values()].sort((n,r)=>n.sortKey-r.sortKey)}function zv(e){return ur().filter(t=>t.dateKey===Number(e))}function Kt(e,t){return e.reduce((n,r)=>n+on(r,t),0)}function Pu(e){return["heatpumpHeatOutputWh","heatpumpCoolingOutputWh","boilerHeatOutputWh"].reduce((t,n)=>t+on(e,n),0)}function Gv(e){return on(e,"electricalInputWh")+Pu(e)}function Sn(e,t){const n=Number(e),r=Number(t);return!Number.isFinite(n)||!Number.isFinite(r)||r<=0?"\u2014":(n/r).toFixed(2)}function Te(e,t=1){const n=Number(e);return Number.isFinite(n)?Math.abs(n)>=999500?`${(n/1e6).toFixed(2)} MWh`:Math.abs(n)<1e3?`${Math.round(n)} Wh`:`${(n/1e3).toFixed(t)} kWh`:"\u2014"}function Ct({dateKey:e,year:t,month:n,day:r,hour:a=null,label:i,tooltipLabel:l="",sortKey:c,source:d="bucket"}){return{sequence:0,dateKey:e,year:t,month:n,day:r,hour:a,label:i,tooltipLabel:l,sortKey:c??e,partial:!1,source:d,electricalInputWh:0,heatingInputWh:0,coolingInputWh:0,heatpumpHeatOutputWh:0,heatpumpCoolingOutputWh:0,boilerHeatOutputWh:0,systemHeatOutputWh:0}}function Tt(e,t){return lr.forEach(n=>{e[n]+=on(t,n)}),e.partial=e.partial||!!t?.partial,e.sequence=Math.max(Number(e.sequence||0),Number(t?.sequence||0)),e}function Qv(e){const t=new Map;return e.forEach(n=>{t.set(n.dateKey,n)}),t}function Nu(e,t){const n=ve(e);if(n==="day"){const r=Tu(t)||Q(t);return r?String(r.key):""}if(n==="week"){const r=Vv(t);return r?String(r.key):""}if(n==="month"){const r=Bv(t);return r?String(r.key):""}if(n==="year"){const r=Number(t);return Number.isInteger(r)&&r>=2020&&r<=2200?String(r):""}return""}function dr(e,t){const n=ve(t),r=Q(Wv(e,!0)),a=On(),i=ur(),l=[...e.map(y=>y.dateKey),...i.map(y=>y.dateKey)].filter(y=>Number.isFinite(Number(y)));Number.isFinite(Number(a.oldestDateKey))&&l.push(Number(a.oldestDateKey)),Number.isFinite(Number(a.newestDateKey))&&l.push(Number(a.newestDateKey));const c=l.length?Math.min(...l.map(Number)):r?.key,u=(c?Q(c):r)?.date||r?.date||new Date,g=r?.date||new Date;let b=r?.key||cr(),h=b;return n==="week"?(b=Rs(u),h=Rs(g)):n==="month"?(b=Qr(u),h=Qr(g)):n==="year"?(b=u.getFullYear(),h=g.getFullYear()):(b=Ee(u),h=Ee(g)),Number(b)>Number(h)&&(b=h),{min:String(b),max:String(h)}}function Ru(e,t){const n=Number(e);return Number.isFinite(n)?n<Number(t.min)?String(t.min):n>Number(t.max)?String(t.max):String(e):String(t.max)}function Yv(e,t,n=dr(e,t)){const r=ve(t),a=o.energyHistoryPeriodSelection?.[r],i=Nu(r,a);return Ru(i||n.max,n)}function Jv(e,t){const n=ve(e),r=[];let a=0;if(n==="week"){let i=String(t.max);for(;Number(i)>=Number(t.min)&&a<6e3;){const l=Q(i);r.push({value:i,label:Hu(i),group:l?String(Au(l.date).year):""}),i=l?String(Ee(ro(l.date,-7))):"",a+=1}return r}if(n==="month"){let i=String(t.max);for(;Number(i)>=Number(t.min)&&a<1200;){const l=no(i);if(!l)break;r.push({value:i,label:l.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"}),group:String(l.year)}),i=$u(i,-1),a+=1}return r}if(n==="year")for(let i=Number(t.max);i>=Number(t.min);i-=1)r.push({value:String(i),label:String(i)});return r}function pr(e,t){const n=ve(t);if(!vo(n))return{view:n,selectedValue:"",minValue:"",maxValue:"",canPrevious:!1,canNext:!1,isNow:!0,options:[]};const r=dr(e,n),a=Yv(e,n,r);return{view:n,selectedValue:a,minValue:r.min,maxValue:r.max,canPrevious:Number(a)>Number(r.min),canNext:Number(a)<Number(r.max),isNow:Number(a)===Number(r.max),options:Jv(n,r)}}function Zv(e,t){const n=ve(t);if(!vo(n))return{from:"",to:"",hours:"0"};const r=pr(e,n);if(n==="day")return{from:r.selectedValue,to:r.selectedValue,hours:"1"};if(n==="week"){const a=Q(r.selectedValue);if(!a)return{from:"",to:"",hours:"0"};const i=tn(a.date),l=ro(i,6);return{from:String(Ee(i)),to:String(Ee(l)),hours:"0"}}if(n==="month"){const a=no(r.selectedValue);return a?{from:String(a.year*1e4+a.month*100+1),to:String(a.year*1e4+a.month*100+Cu(a.year,a.month)),hours:"0"}:{from:"",to:"",hours:"0"}}if(n==="year"){const a=Number(r.selectedValue);return Number.isInteger(a)?{from:`${a}0101`,to:`${a}1231`,hours:"0"}:{from:"",to:"",hours:"0"}}return{from:"",to:"",hours:"0"}}function hn(){if(!String(o.energyHistoryRaw||"").trim())return"?meta=1";const e=nn(),t=Zv(e,o.energyHistoryView||"day"),n=new URLSearchParams;t.from&&n.set("from",t.from),t.to&&n.set("to",t.to),n.set("hours",t.hours);const r=n.toString();return r?`?${r}`:""}function Fn(e,t){const n=ve(e);if(!vo(n))return;const r=nn(),a=dr(r,n),i=Nu(n,t),l=Ru(i||a.max,a);o.energyHistoryPeriodSelection={...o.energyHistoryPeriodSelection,[n]:l},o.energyHistoryLastFetchAt=0,m(),qu()}function Ls(e,t){const n=ve(e);if(!vo(n))return;const r=nn(),a=pr(r,n),i=Number(t)<0?-1:1;let l=a.selectedValue;if(n==="day"){const c=Q(a.selectedValue);l=c?String(Ee(ro(c.date,i))):l}else if(n==="week"){const c=Q(a.selectedValue);l=c?String(Ee(ro(c.date,i*7))):l}else n==="month"?l=$u(a.selectedValue,i):n==="year"&&(l=String(Number(a.selectedValue)+i));Fn(n,l)}function Os(e){const t=ve(e);if(!vo(t))return;const n=nn(),r=dr(n,t);Fn(t,r.max)}function Xv(e,t,n=pr(e,t)){const r=ve(t),a=Qv(e);if(!e.length&&r==="all")return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};if(r==="day"){const c=Q(n.selectedValue);if(!c)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const d=zv(c.key);if(d.length){const y=new Map(d.map(f=>[f.hour,f])),p=[];for(let f=0;f<24;f+=1){const S=String(f),w=`${c.date.toLocaleDateString("nl-NL",{day:"numeric",month:"long"})} \xB7 ${String(f).padStart(2,"0")}:00 - ${String((f+1)%24).padStart(2,"0")}:00`,q=Ct({dateKey:c.key,year:c.year,month:c.month,day:c.day,hour:f,label:S,tooltipLabel:w,sortKey:f,source:"hour"}),T=y.get(f);T&&Tt(q,T),p.push(q)}return{buckets:p,title:"Dag",detail:`${c.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 uurdata sinds herstart`}}const u=a.get(c.key),g=hi()||cr(),b=c.key===g?"Vandaag":Qe(c.key),h=Ct({dateKey:c.key,year:c.year,month:c.month,day:c.day,label:b,sortKey:c.key,source:"day"});return u&&Tt(h,u),{buckets:[h],title:"Dag",detail:`${c.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 dagtotaal`}}if(r==="week"){const c=Q(n.selectedValue);if(!c)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const d=tn(c.date),u=[];for(let g=0;g<7;g+=1){const b=ro(d,g),h=Ee(b),y=Q(h),p=Ct({dateKey:h,year:y.year,month:y.month,day:y.day,label:Qe(h,"weekday"),sortKey:h}),f=a.get(h);f&&Tt(p,f),u.push(p)}return{buckets:u,title:"Week",detail:Hu(n.selectedValue)}}if(r==="month"){const c=no(n.selectedValue);if(!c)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const d=Cu(c.year,c.month),u=[];for(let g=1;g<=d;g+=1){const b=ku(c.year,c.month,g),h=Ee(b),y=Ct({dateKey:h,year:c.year,month:c.month,day:g,label:String(g),sortKey:h}),p=a.get(h);p&&Tt(y,p),u.push(y)}return{buckets:u,title:"Maand",detail:c.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"})}}if(r==="year"){const c=Number(n.selectedValue);if(!Number.isInteger(c))return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const d=[];for(let u=1;u<=12;u+=1){const g=c*1e4+u*100+1,b=Ct({dateKey:g,year:c,month:u,day:1,label:Qe(g,"month"),sortKey:u,source:"month"});e.filter(h=>h.year===c&&h.month===u).forEach(h=>Tt(b,h)),d.push(b)}return{buckets:d,title:"Jaar",detail:String(c)}}const i=new Map;e.forEach(c=>{i.has(c.year)||i.set(c.year,Ct({dateKey:c.year*1e4+101,year:c.year,month:1,day:1,label:String(c.year),sortKey:c.year,source:"year"})),Tt(i.get(c.year),c)});const l=[...i.values()].sort((c,d)=>c.sortKey-d.sortKey);return{buckets:l,title:"Alles",detail:l.length?`${l[0].label} - ${l[l.length-1].label}`:"Geen data"}}function ey(e){const t=Kt(e,"heatpumpHeatOutputWh"),n=Kt(e,"heatpumpCoolingOutputWh"),r=Kt(e,"boilerHeatOutputWh");return{electricalInputWh:Kt(e,"electricalInputWh"),heatingInputWh:Kt(e,"heatingInputWh"),coolingInputWh:Kt(e,"coolingInputWh"),heatOutputWh:t,coolingOutputWh:n,boilerOutputWh:r,outputWh:t+n+r}}function ty(e){const t=Number(e.heatOutputWh||0)+Number(e.coolingOutputWh||0),n=Number(e.boilerOutputWh||0),r=t+n;return!Number.isFinite(r)||r<=0?Number.NaN:t/r*100}function fn(e,t,n=""){return`
      <div class="oq-energy-history-stat">
        <span>${s(e)}</span>
        <strong>${s(t)}</strong>
        ${n?`<p>${s(n)}</p>`:""}
      </div>
    `}function Pr(e,t,n){const r=[];n.forEach(i=>{const l=String(i.group||"");let c=r[r.length-1];(!c||c.label!==l)&&(c={label:l,options:[]},r.push(c)),c.options.push(i)});const a=r.some(i=>i.label)?r.map(i=>i.label?`
    ...
    `}function Fs(e){return e.view==="day"?`
        <label class="oq-energy-history-period-field">
          <span>Datum</span>
          <input
            class="oq-energy-history-period-input"
      ...
      `:e.view==="week"?Pr(e,"Week",e.options):e.view==="month"?Pr(e,"Maand",e.options):e.view==="year"?Pr(e,"Jaar",e.options):`
      <div class="oq-energy-history-period-field oq-energy-history-period-field--static">
        <span>Periode</span>
        <strong>Volledig bereik</strong>
      </div>
    `}function oy(e){return vo(e.view)?`
    ...
    `:`
      ...
      `}function ny(){const e=document.activeElement;return!!(e&&e.closest&&e.closest(".oq-energy-history-period"))}function ry(e){return`
      <div class="oq-energy-history-view-tabs" role="tablist" aria-label="Energiehistorie weergave">
        ${Su.map(t=>{const n=t.id===e;return`
            <button
              type="button"
    ...
    `}function ay(e){const t=Number(e.electricalInputWh||0),n=Number(e.heatOutputWh||0),r=Number(e.coolingOutputWh||0),a=Number(e.boilerOutputWh||0),i=a>0?"boiler":"boiler-zero",l=Math.max(1,t+n+r+a),c=u=>`${Math.max(0,Number(u||0)/l*100).toFixed(2)}%`,d=ty(e);return`
    ...
    `}function iy(e){const t=Math.max(1,Number(e||0)/1e3),n=Math.pow(10,Math.floor(Math.log10(t))),r=t/n;return(r<=1.5?1.5:r<=3?3:r<=6?6:10)*n*1e3}function sy(e){const t=Number(e);return Number.isFinite(t)?t>=999500?`${Number((t/1e6).toFixed(1))}`:`${Number((t/1e3).toFixed(1))}`:""}function ly(e){return e>=999500?"MWh":"kWh"}function cy(e){const u=Math.max(1e3,...e.map(Gv)),g=iy(u),b=e.length?1218/e.length:1218,h=Math.max(6,Math.min(38,b*.68));return{width:1280,height:260,left:44,right:18,top:26,bottom:38,plotWidth:1218,plotHeight:196,axisMax:g,barSlot:b,barWidth:h,yOf:p=>26+(1-Math.min(1,Math.max(0,Number(p||0)/g)))*196}}function uy(e){const t=Sn(e.heatpumpHeatOutputWh,e.heatingInputWh),n=Sn(e.heatpumpCoolingOutputWh,e.coolingInputWh),r=Sn(Pu(e),e.electricalInputWh);return[e.tooltipLabel||e.label||Qe(e.dateKey),`Elektrisch: ${Te(e.electricalInputWh,1)}`,`Warmtepomp warmte: ${Te(e.heatpumpHeatOutputWh,1)}`,`Warmtepomp koeling: ${Te(e.heatpumpCoolingOutputWh,1)}`,`Cv-ketel: ${Te(e.boilerHeatOutputWh,1)}`,`COP verwarmen: ${t}`,`EER koelen: ${n}`,`Output / elektrisch: ${r}`].join(`
`)}function dy(e,t=""){if(!e.length)return`
      ...
      `;const n=cy(e),r=ly(n.axisMax),a=[0,.25,.5,.75,1].map(l=>n.axisMax*l),i=e.map((l,c)=>{const d=n.left+n.barSlot*c+n.barSlot/2,u=[{key:"electricalInputWh",className:"input",label:"Verbruikte elektriciteit"},{key:"heatpumpHeatOutputWh",className:"heat",label:"Warmte door warmtepomp"},{key:"heatpumpCoolingOutputWh",className:"cooling",label:"Koeling warmtepomp"},{key:"boilerHeatOutputWh",className:"boiler",label:"Cv-ketel"}];let g=n.height-n.bottom;const b=u.map(f=>{const S=on(l,f.key);if(S<=0)return"";const w=S/n.axisMax*n.plotHeight;return g-=w,`
          <rect
        ...
        `}).join(""),y=e.length<=12||c===0||c===e.length-1||c%3===0?`<text x="${d.toFixed(1)}" y="${n.height-18}" text-anchor="middle" class="oq-energy-history-axis-label">${s(l.label||Qe(l.dateKey))}</text>`:"",p=uy(l);return`
      ...
      <svg class="oq-energy-history-chart oq-energy-history-chart--${s(ve(t))}" viewBox="0 0 ${n.width} ${n.height}" role="img" aria-label="Energiehistorie">
        ...
        ${a.map(l=>{const c=n.yOf(l);return`
            ...
            <text x="${n.left-10}" y="${c.toFixed(1)}" text-anchor="end" dominant-baseline="middle" class="oq-energy-history-axis-label">${s(sy(l))}</text>
          `}).join("")}
        ${i}
      </svg>
    `}function py(e=null){const t=Number(e?.boilerOutputWh||0)>0?"boiler":"boiler-zero";return`
    ...
    `}function bi(){const e=nn(),t=ve(o.energyHistoryView),n=pr(e,t),r=Xv(e,t,n),a=ey(r.buckets);return{records:e,buckets:r.buckets,viewModel:r,periodControl:n,summary:a,activeView:t}}function Lu(e=bi()){return be({energyHistorySignature:o.energyHistorySignature||"",energyHistoryError:o.energyHistoryError||"",activeView:e.activeView,periodView:e.periodControl.view,periodValue:e.periodControl.selectedValue,periodMin:e.periodControl.minValue,periodMax:e.periodControl.maxValue,recordCount:e.records.length,bucketCount:e.buckets.length,latestDate:e.records[e.records.length-1]?.dateKey||0,currentValues:lr.map(t=>e.buckets[e.buckets.length-1]?.[t]??null)})}function Ou(e=bi()){const t=e.summary,n=e.buckets[0]?.dateKey?Qe(e.buckets[0].dateKey):"\u2014",r=e.buckets[e.buckets.length-1]?.dateKey?Qe(e.buckets[e.buckets.length-1].dateKey):"\u2014";return`
      <section class="oq-energy-history" data-render-signature="${s(Lu(e))}">
        ...
        <div class="oq-energy-history-stats">
          ${fn("Gemiddelde COP",Sn(t.heatOutputWh,t.heatingInputWh),`${s(n)} - ${s(r)}`)}
          ${fn("Elektrisch",Te(t.electricalInputWh,1),"verbruikt")}
          ${fn("Warmtepomp",Te(t.heatOutputWh+t.coolingOutputWh,1),"warmte en koeling")}
          ${fn("Cv-ketel",Te(t.boilerOutputWh,1),"thermisch")}
        </div>
        ${ay(t)}
    ...
    `;const i=n.getBoundingClientRect();r.classList.add("is-visible");const l=r.getBoundingClientRect(),c=Math.min(Math.max(8,e.clientX-i.left+14),Math.max(8,i.width-l.width-8)),d=Math.min(Math.max(8,e.clientY-i.top-l.height-12),Math.max(8,i.height-l.height-8));r.style.transform=`translate(${c.toFixed(0)}px, ${d.toFixed(0)}px)`}function gy(){return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(o.overviewTheme)}">
          <div class="oq-overview-head">
          <div>
    ...
    `}function hy(){if(!o.root||o.appView!=="energy")return!1;const e=o.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-overview-energy"):null;if(!e||!t)return!1;const n=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==n&&(e.className=n);const r=mi();return ut(t,yu(r),wu(r))}function fy(){if(!o.root||o.appView!=="results")return!1;const e=o.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-energy-history"):null;if(!e||!t)return!1;const n=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==n&&(e.className=n);const r=bi(),a=ny();return(a?!1:ut(t,Lu(r),Ou(r)))||a}function vi(e,t,n){const r=Du(B(t.mode,"Unknown")),a=A(t.defrost),i=Wo(B(t.failures,"None")),l=Wc(i),c=r==="Verwarmen"||r==="Koelen"||a;return{mode:r,defrostActive:a,failures:i,warningFailures:l,running:c,thermalKey:r==="Koelen"?t.cooling:t.heat,schematic:Ty(e,t,n,r,a,l,c)}}function Fu(e,t=null){return`<h3>${s(e)}</h3>${t?`<button class="oq-overview-hp-card-action" type="button" data-oq-action="select-hp-layout" data-hp-layout="${s(t.layout)}">${Py(t.layout==="equal"?"minus":"plus")}<span>${s(t.label)}</span></button>`:""}`}function Yr(e,t,n,r){return`<div class="oq-overview-hp-status">${Xc(e,t,n,r)}</div>`}function by(){return B("controlModeLabel","").toLowerCase().includes("standby")}function vy(e,t){return t?"ontdooit":e==="Verwarmen"?"verwarmt":e==="Koelen"?"koelt":e==="Stand-by"?"stand-by":"onbekend"}function xu(e){return!Array.isArray(e)||e.length===0?"":`<p class="oq-overview-hp-summary">${s(e.map(t=>`${t.title} ${vy(Du(B(t.keys.mode,"Unknown")),A(t.keys.defrost))}`).join(", "))}</p>`}function yy(e){const t=o.entities[e];if(!t)return"Positie: \xE2\u20AC\u201D";const n=H(e);return Number.isNaN(n)?`Positie: ${B(e)}`:`Positie: ${I(n,0,t.uom||"")}`}function wy(e){return v(e)?`Positie: ${A(e)?"Koelen/Defrost":"Verwarmen"}`:"Positie: \xE2\u20AC\u201D"}function Du(e){const t=String(e||"").trim();return!t||t==="Unknown"?"Onbekend":t==="Standby"?"Stand-by":t==="Heating"?"Verwarmen":t==="Cooling"?"Koelen":t}function Wo(e){const t=String(e||"").trim();return!t||t==="None"?"Geen actieve storingen":t}function Jr(e,t,n,r=!0,a="default"){return`
    ...
    `}function Sy(e,t,n){return e==="temperature"?`
        <svg
    ...
    `}function Bo({bind:e,modifier:t,x:n,y:r,width:a,kicker:i,detail:l,detailBind:c="",icon:d="heater",direction:u="down"}){const b=n+26,h=r+22,y=c?` data-oq-bind="${s(c)}"`:"";let p="";if(u==="up"){const f=n+Math.round(a*.52);p=`M${f-6} ${r} L${f} ${r-8} L${f+6} ${r} Z`}else if(u==="left"){const f=r+Math.round(22);p=`M${n} ${f-6} L${n-8} ${f} L${n} ${f+6} Z`}else if(u==="right"){const f=r+Math.round(22);p=`M${n+a} ${f-6} L${n+a+8} ${f} L${n+a} ${f+6} Z`}else{const f=n+Math.round(a*.52);p=`M${f-6} ${r+44} L${f} ${r+44+8} L${f+6} ${r+44} Z`}return`
      <g
    ...
    `}function Zr({bind:e,x:t,y:n,width:r,value:a,label:i,ariaLabel:l="",align:c="start"}){const d=l||`${i} temperatuur ${a}`,u=c==="end",g=c==="center",b=g?"middle":u?"end":"start",h=g?t+r/2:u?t+r-2:t+2;return`
      <g
    ...
    `}function qy({tooltip:e,...t}){return`${Zr(t)}${Bo({bind:t.bind,...e})}`}function ky({bind:e,ariaLabel:t,x:n,y:r,width:a,height:i,rx:l,tooltip:c}){return`
      ...
      <div class="${s(e.boardClass)}" data-oq-hp-board="${s(e.title)}">
        <div class="oq-hp-tech-shell">
          <div class="oq-hp-tech-visual">
            ...
            ${Object.entries(e.pipes).map(([u,g])=>Jr(u.replace(/[A-Z]/g,b=>`-${b.toLowerCase()}`),g.tone,g.d,g.animated,g.flowVariant)).join("")}
            ...
            ${c.map(qy).join("")}
            ${Nr({bind:"bottom-heater",className:"oq-hp-tech-bottom-heater",active:e.bottomPlateActive,ariaLabel:"Bottom plate heater actief",content:`
            ...
            ${Nr({bind:"crankcase-heater",className:"oq-hp-tech-crankcase-heater",active:e.crankcaseActive,ariaLabel:"Crank case heater actief",content:`
            ...
            ${Nr({bind:"defrost-badge",className:"oq-hp-tech-defrost-badge",active:e.defrostActive,activeClass:"",ariaLabel:e.defrostActive?"Defrost actief":"Defrost uit",attrs:'transform="translate(532 288)"',content:`
    ...
    `}function Iu(e,t,n,r="normal",a=null){if(!v(t.power))return"";const i=vi(e,t,n),{mode:l,defrostActive:c,running:d,thermalKey:u}=i,g=i.schematic;return o.hpVisualMode==="schematic"?`
        <section class="oq-overview-hp oq-overview-hp--${s(n)} oq-overview-hp--${s(r)}" data-oq-hp-panel="${s(e)}">
          <div class="oq-overview-hp-head">
            ...
            <div class="oq-overview-hp-head-side">
              ${Yr(l,d,g.warningActive,g.failureText)}
            </div>
          </div>
          ${Ey(g)}
        </section>
      ...
      <section class="oq-overview-hp oq-overview-hp--${s(n)} oq-overview-hp--${s(r)}" data-oq-hp-panel="${s(e)}">
        ...
        <div class="oq-overview-hp-stats">
          ${sr([{key:t.power,label:"Stroomverbruik",tone:"blue",note:"elektrisch verbruik"},{key:u,label:g.heatLabel,tone:"orange",note:g.heatDescription},{label:g.efficiencyLabel,value:g.efficiencyText,tone:"green",note:"actueel"}])}
        </div>
        ...
        <div class="oq-overview-temps-list">
          ${Ur("Water in",t.waterIn)}
          ${Ur("Water out",t.waterOut)}
        </div>
      </section>
    `}function yi(){return A("boilerCvAssistEnabled")&&v("boilerHeatPower")}function $y(){return(typeof Z=="function"?Z():"")!=="single"&&v("hp2WaterOut")?"hp2WaterOut":"hp1WaterOut"}function Ay(){return(typeof Z=="function"?Z():"")!=="single"&&v("hp2Flow")?"hp2Flow":"hp1Flow"}function gr(){const e=H("boilerHeatPower"),t=H(Ay()),n=v("boilerActive")?A("boilerActive"):!Number.isNaN(e)&&e>20,r=!Number.isNaN(t)&&t>0,a=I(e,0,"W"),i=I(t,0,"L/h"),l=I(H($y()),1,"\xB0C"),c=I(H("supplyTemp"),1,"\xB0C"),d=n?"Aan":"Uit",u=n?"Levert ondersteuning":"Geen ondersteuning",g=["oq-boiler-card",n?"is-running":"is-idle"].filter(Boolean).join(" ");return{active:n,flowActive:r,heatText:a,flowText:i,returnTempText:l,supplyTempText:c,statusText:d,statusCopy:u,boardClass:g,flowPathClass:r?"is-flowing":"is-static"}}function wi(e=gr()){return be({version:"boiler-visual-mode-v1",visualMode:o.hpVisualMode,boardClass:"oq-boiler-card"})}function Hy(e,t=gr()){const n=e.querySelector(".oq-boiler-card");n&&(n.className=["oq-boiler-card",t.active?"is-running":"is-idle",t.flowActive?"is-flowing":"is-static"].join(" "));const r=e.querySelector(".oq-overview-chip");r&&(r.className=`oq-overview-chip oq-overview-chip--${t.active?"active":"neutral"}`,r.textContent!==t.statusText&&(r.textContent=t.statusText));const a=e.querySelector(".oq-boiler-summary-box--support");a&&(a.classList.toggle("is-active",t.active),a.classList.toggle("is-idle",!t.active));const i=e.querySelector(".oq-boiler-summary-box--support strong");i&&i.textContent!==t.statusCopy&&(i.textContent=t.statusCopy);const l=e.querySelector("[data-oq-boiler-heat-value]");l&&l.textContent!==t.heatText&&(l.textContent=t.heatText),e.querySelectorAll("[data-oq-boiler-flow-value]").forEach(g=>{g.textContent!==t.flowText&&(g.textContent=t.flowText)});const c=e.querySelector("[data-oq-boiler-status-value]");c&&c.textContent!==t.statusCopy&&(c.textContent=t.statusCopy);const d=e.querySelector('[data-oq-bind="boiler-return-value"]');d&&d.textContent!==t.returnTempText&&(d.textContent=t.returnTempText);const u=e.querySelector('[data-oq-bind="boiler-supply-value"]');u&&u.textContent!==t.supplyTempText&&(u.textContent=t.supplyTempText)}function My(e){return`
      <section class="oq-overview-hp oq-overview-boiler oq-overview-boiler--compact" data-oq-boiler-panel data-render-signature="${s(wi(e))}">
        <div class="oq-overview-hp-head">
          <div>
    ...
    `}function Xr(){if(!yi())return"";const e=gr();return o.hpVisualMode!=="schematic"?My(e):`
      <section class="oq-overview-hp oq-overview-boiler" data-oq-boiler-panel data-render-signature="${s(wi(e))}">
          ...
          <div class="oq-boiler-card-main">
            ...
            <div class="oq-boiler-mini-schematic">
              <svg class="oq-boiler-mini-svg" viewBox="0 0 420 132" role="img" aria-label="Schematische weergave CV-ketel of boiler">
                ...
                ${Jr("boiler-return","return","M24 88 H166 C180 88 190 80 196 68",!0,"water")}
                ${Jr("boiler-supply","supply","M224 52 C232 40 244 36 258 36 H396",!0,"water")}
                ...
                ${Bo({bind:"boiler-return",modifier:"return",icon:"temperature",x:82,y:70,width:124,kicker:"Temperatuur",detail:"Retour",direction:"left"})}
                ...
                ${Bo({bind:"boiler-supply",modifier:"supply",icon:"temperature",x:294,y:14,width:124,kicker:"Temperatuur",detail:"Aanvoer",direction:"right"})}
              </svg>
    ...
    `}function Wu(){const e=typeof Z=="function"?Z():"";return fd.filter(t=>e==="single"&&t.title==="HP2"?!1:v(t.keys.power))}function Si(e){return!Array.isArray(e)||e.length<2||o.hpVisualMode!=="schematic"?"equal":o.hpLayoutMode==="focus-hp1"||o.hpLayoutMode==="focus-hp2"?o.hpLayoutMode:"equal"}function xn(e,t,n){return!Array.isArray(t)||t.length<2?"normal":n==="focus-hp1"?e===0?"focus":"muted":n==="focus-hp2"?e===1?"focus":"muted":"normal"}function ea(e,t,n){return!Array.isArray(t)||t.length<2||o.hpVisualMode!=="schematic"?null:xn(e,t,n)==="focus"?{layout:"equal",label:"Toon beide"}:{layout:e===0?"focus-hp1":"focus-hp2",label:"Vergroot"}}function Bu(e){return!Array.isArray(e)||e.length!==1?Si(e):yi()?"equal":"single"}function Py(e="plus"){return`
    ...
    `}function Ny(e,t){if(!e)return!1;const n=e.querySelector(".oq-overview-hp-tools-copy"),r=e.querySelector('[data-hp-visual="schematic"]'),a=e.querySelector('[data-hp-visual="compact"]');return!n||!r||!a?(gt(e,Vu(t)),!0):(gt(n,`
      <h3>Warmtepompen</h3>
      ${xu(t)}
    `),r.classList.toggle("is-active",o.hpVisualMode==="schematic"),a.classList.toggle("is-active",o.hpVisualMode==="compact"),!0)}function Ry(){const e=nu(),t=Wu(),n=Si(t),r=Bu(t),a=Vu(t);return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(o.overviewTheme)}">
          ${Yc()}
          ${fv(e)}
          ...
          <div class="oq-overview-hp-grid oq-overview-hp-grid--${s(r)}">
            ${t.map((i,l)=>Iu(i.title,i.keys,i.accent,xn(l,t,n),ea(l,t,n))).join("")}
            ${Xr()}
          </div>
        </div>
      </section>
    `}function Ly(e,t,n){if(!e)return;const r=e.querySelector(t);r&&r.textContent!==n&&(r.textContent=n)}function gt(e,t){e&&e.innerHTML!==t&&(e.innerHTML=t)}function ut(e,t,n){return!e||e.dataset.renderSignature===t?!1:(e.outerHTML=n,!0)}function Yt(e,t,n){e&&e.getAttribute(t)!==n&&e.setAttribute(t,n)}function Oy(e,t){t.forEach(([n,r])=>{Ly(e,`[data-oq-bind="${n}"]`,r)})}function Fy(e,t){t.forEach(([n,r])=>{Yt(e.querySelector(`[data-oq-bind="${n}"]`),"aria-label",r)})}function xy(e,t,n,r=""){const a=e.querySelector(`[data-oq-bind="${t}"]`);a&&(a.classList.toggle("is-active",n),Yt(a,"tabindex",n?"0":"-1"),!n&&r&&mr(e.querySelector(`[data-oq-bind="${r}"]`)))}function Dy(e,t,n){Yt(e.querySelector(`[data-oq-bind="${t}"]`),"fill",n)}function Vo(e,t,n,r){if(!e)return;const a=`${t}${n}`;r.map(l=>`${t}${l}`).find(l=>e.classList.contains(l))!==a&&(r.forEach(l=>e.classList.remove(`${t}${l}`)),e.classList.add(a))}function Iy(e,t,n,r){const a=e.querySelector(`[data-oq-pipe="${t}"]`);a&&(Vo(a,"oq-hp-tech-pipe--",n,["supply","return","hotgas","liquid","expansion","suction"]),a.querySelectorAll("path").forEach(i=>{i.getAttribute("d")!==r&&i.setAttribute("d",r)}))}function mr(e){e&&(e.classList.remove("is-active"),e.setAttribute("aria-hidden","true"))}function Ds(e,t,n){!e||!t||!n||(e.querySelectorAll(".oq-hp-tech-tooltip.is-active").forEach(r=>{r!==n&&mr(r)}),t.appendChild(n),n.classList.add("is-active"),n.setAttribute("aria-hidden","false"))}function Wy(e,t,n,r){if(!e||!t||!n||!r||n.dataset.oqTooltipWired==="true")return;n.dataset.oqTooltipWired="true";const a=()=>{n.matches(":hover")||document.activeElement===n||mr(r)};n.addEventListener("mouseenter",()=>Ds(e,t,r)),n.addEventListener("mouseleave",a),n.addEventListener("focus",()=>Ds(e,t,r)),n.addEventListener("blur",a)}function _u(e){if(!e)return;const t=e.querySelector(".oq-hp-tech-svg");if(!t)return;let n=t.querySelector(".oq-hp-tech-tooltip-layer");n||(n=document.createElementNS("http://www.w3.org/2000/svg","g"),n.setAttribute("class","oq-hp-tech-tooltip-layer"),t.appendChild(n)),Array.from(t.querySelectorAll(".oq-hp-tech-tooltip")).forEach(r=>{n.appendChild(r)}),e.querySelectorAll("[data-oq-tooltip-target]").forEach(r=>{const a=r.getAttribute("data-oq-tooltip-target");if(!a)return;const i=e.querySelector(`[data-oq-bind="${a}-tooltip"]`);Wy(e,n,r,i)})}function By(e=o.root){e&&e.querySelectorAll("[data-oq-hp-board]").forEach(t=>{_u(t)})}function Vy(e,t,n,r,a=null,i=null){if(!e)return;const l=i||vi(t,n,r),{mode:c,running:d}=l,u=l.schematic,g=e.querySelector(".oq-overview-hp-head-title");g&&gt(g,Fu(t,a));const b=e.querySelector(".oq-overview-hp-head-side");if(b){let S=b.querySelector(".oq-overview-hp-status");S||(gt(b,Yr(c,d,u.warningActive,u.failureText)),S=b.querySelector(".oq-overview-hp-status")),tv(S,c,d,u.warningActive,u.failureText)}const h=e.querySelector("[data-oq-hp-board]");if(!h)return;h.className!==u.boardClass&&(h.className=u.boardClass),Oy(h,[["status",u.statusText],["left-exchanger-title",u.leftExchangerTitle],["right-exchanger-title",u.rightExchangerTitle],["compressor-freq",u.compressorFreqText],["flow-value",u.flowText],["inner-coil-temp-value",u.innerCoilTempText],["evaporator-temp-value",u.evaporatorCoilTempText],["outside-temp-value",u.outsideTempText],["discharge-pressure-value",u.dischargePressureText],["discharge-temp-value",u.dischargeTempText],["suction-pressure-value",u.suctionPressureText],["suction-temp-value",u.suctionTempText],["supply-value",u.waterOutText],["return-value",u.waterInText],["footer-mode",u.mode],["footer-power",u.powerText],["footer-heat",u.heatText],["footer-efficiency-label",u.efficiencyLabel],["footer-efficiency",u.efficiencyText],["fan-speed-value",u.fanRpmText],["fourway-detail",u.fourWayPositionText],["eev-detail",u.eevPositionText]]);const y=h.querySelector('[data-oq-bind="footer-heat-label"]');if(y){Yt(y,"aria-label",u.heatLabel);const S=u.heatLabel==="Koelafgifte"?"Koel<br>afgifte":"Warmte<br>afgifte";y.innerHTML!==S&&(y.innerHTML=S)}[["bottom-heater",u.bottomPlateActive],["crankcase-heater",u.crankcaseActive]].forEach(([S,w])=>{xy(h,S,w,`${S}-tooltip`)});const p=h.querySelector('[data-oq-bind="defrost-badge"]');p&&(Yt(p,"tabindex",u.defrostActive?"0":"-1"),Yt(p,"aria-label",u.defrostActive?"Defrost actief":"Defrost uit"),u.defrostActive||mr(h.querySelector('[data-oq-bind="defrost-badge-tooltip"]'))),[["supply-tooltip",u.supplyLineTone],["return-tooltip",u.returnLineTone]].forEach(([S,w])=>{Vo(h.querySelector(`[data-oq-bind="${S}"]`),"oq-hp-tech-tooltip--",w,["warm","supply","return"])}),Fy(h,[["supply-reading",`Aanvoer temperatuur ${u.waterOutText}`],["flow-reading",`Flow ${u.flowText}`],["inner-coil-temp-reading",`Inner coil temperatuur ${u.innerCoilTempText}`],["evaporator-temp-reading",`Verdampertemperatuur ${u.evaporatorCoilTempText}`],["outside-temp-reading",`Buitentemperatuur ${u.outsideTempText}`],["compressor-freq-trigger",`Compressorfrequentie ${u.compressorFreqText}`],["fan-speed-reading",`Ventilatorsnelheid ${u.fanRpmText}`],["discharge-pressure-reading",`Persdruk ${u.dischargePressureText}`],["discharge-temp-reading",`Perstemperatuur ${u.dischargeTempText}`],["return-reading",`Retour temperatuur ${u.waterInText}`],["suction-pressure-reading",`Zuigdruk ${u.suctionPressureText}`],["suction-temp-reading",`Zuigtemperatuur ${u.suctionTempText}`],["fourway-trigger",`4-wegklep, ${u.fourWayPositionText}`],["eev-trigger",`Expansieventiel, ${u.eevPositionText}`]]),Vo(h.querySelector(".oq-hp-tech-pump"),"oq-hp-tech-pump--",u.returnLineTone,["supply","return"]);const f=String(u.title||"hp").toLowerCase().replace(/[^a-z0-9]+/g,"-");Dy(h,"cond-water",`url(#${u.reverseCycle?`${f}-cond-water-cool`:`${f}-cond-water-heat`})`),Object.entries(u.pipes).forEach(([S,w])=>{Iy(h,S.replace(/[A-Z]/g,q=>`-${q.toLowerCase()}`),w.tone,w.d)}),_u(h),va()}function _y(){if(!o.root||o.appView!=="overview")return!1;const e=o.root.querySelector(".oq-overview-board");if(!e)return!1;const t=`oq-overview-board oq-overview-board--${o.overviewTheme}`;e.className!==t&&(e.className=t);const n=nu(),r=e.querySelector("[data-oq-monitoring-notice]"),a=e.querySelector(".oq-overview-summary-shell"),i=e.querySelector(".oq-overview-system"),l=e.querySelector(".oq-overview-temps"),c=e.querySelector(".oq-overview-trends"),d=e.querySelector(".oq-overview-hp-tools"),u=e.querySelector(".oq-overview-hp-grid"),g=e.querySelector("[data-oq-boiler-panel]"),b=Wu();if(r){const q=ar();ut(r,be(q),Yc())}if(a){const q=a.querySelector(".oq-overview-top");q&&gt(q,sr(uu()));const T=a.querySelector(".oq-overview-statuspanel");if(T){const M=B("controlModeLabel");ut(T,be(lu(n,M)),cu(n,M))}const k=a.querySelector(".oq-overview-summary-side");if(k){const M=nc();k.dataset.renderSignature!==M&&(gt(k,du()),k.dataset.renderSignature=M)}}if(i&&ut(i,be(zr()),su(zr())),l){const q=si();ut(l,pu(q),gu())}if(c&&o.appView==="overview"&&(ut(c,ui(),di()),vu(e)),gi(e),!d||!u)return!1;const h=Si(b),y=Bu(b);if(Ny(d,b),Vo(u,"oq-overview-hp-grid--",y,["single","equal","focus-hp1","focus-hp2"]),o.hpVisualMode!=="schematic"){const q=[...b.map((k,M)=>Iu(k.title,k.keys,k.accent,xn(M,b,h),ea(M,b,h))),Xr()].join(""),T=be({visualMode:o.hpVisualMode,layout:y,markup:q});return u.dataset.renderSignature!==T&&(gt(u,q),u.dataset.renderSignature=T),!0}const p=yi()?gr():null,f=p?Xr():"",S=p?wi(p):"";return!!g!=!!f||(g&&g.dataset.renderSignature!==S?g.outerHTML=f:g&&p&&Hy(g,p),u.querySelectorAll("[data-oq-hp-panel]").length!==b.length)?!1:(b.forEach((q,T)=>{const k=e.querySelector(`[data-oq-hp-panel="${q.title}"]`);if(k){const M=vi(q.title,q.keys,q.accent);Vo(k,"oq-overview-hp--",xn(T,b,h),["normal","focus","muted"]),Vy(k,q.title,q.keys,q.accent,ea(T,b,h),M)}}),!0)}function jy(){return`
      <section class="oq-helper-panel">
    ...
    `}function Uy(){return o.appView==="overview"?Ry():o.appView==="energy"?gy():o.appView==="diagnosis"?Pv():o.appView==="results"?my():jy()}function zy(){const e=ql();return`
    ...
    `}function Gy(){const e=typeof document<"u"?document.activeElement:null;return!e||typeof e.matches!="function"?null:e.matches("select[data-oq-dev-control]")?e:null}function Qy(e){if(!e||o.deferDevControlSelectRender)return;o.deferDevControlSelectRender=!0;const t=()=>{e.removeEventListener("blur",t),e.removeEventListener("change",t),o.deferDevControlSelectRender=!1,window.setTimeout(()=>m(),0)};e.addEventListener("blur",t,{once:!0}),e.addEventListener("change",t,{once:!0})}function m(){if(!o.root)return;const e=Gy();if(e){Qy(e);return}const t=o.systemModal==="webserver-logs"?vt():null,n=o.systemModal==="cm100-commissioning"?$h():null,r=String(o.systemModal||"").startsWith("service-task-")?Hh():null,a=o.systemModal==="history-storage"?Ph():null,i=o.quickStartModalOpen?Db():null;if(o.nativeOpen){o.root.innerHTML=`
        ${ji()}
        ${Yp()}
      `,o.settingsRenderSignature="",o.headerRenderSignature=Or(),ga(),$n(),ps(),Ii(),is(),as(),ht(t),ls(n),cs(r),us(a),Ts(i);return}const l=Uy(),c=o.loadingEntities?`${l}${Ky()}`:l,d=o.appView==="overview"||o.appView==="energy"||o.appView==="diagnosis"||o.appView==="results";o.root.innerHTML=`
      ${ji()}
      ...
      ${Xp()}
      ${Pp()}
    `,o.settingsRenderSignature=o.appView==="settings"?Vr():"",o.headerRenderSignature=Or(),ba(),By(),ps(),ya(),gi(),$n(),Ii(),is(),as(),ht(t),ls(n),cs(r),us(a),Ts(i)}function s(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}ep();})();
