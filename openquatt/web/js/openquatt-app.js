...
(()=>{const Hu=`
  ...
  `,gi={main:"https://github.com/jeroen85/OpenQuatt/releases/latest",dev:"https://github.com/jeroen85/OpenQuatt/releases/tag/dev-latest"},ms="https://oi.esphome.io/v3/www.js",Ct=2,Lr=4,hs=6e4,fs="Power House",bs="Water Temperature Control (heating curve)",ho=[{id:"generation",kicker:"Stap 1",title:"Kies je Quatt Hybrid",copy:"Geef hier aan welke Quatt Hybrid je hebt. Dan zet OpenQuatt de juiste regeling klaar.",fields:[{title:"Quatt Hybrid-versie",copy:"Kies de versie die bij jouw Quatt hoort."}]},{id:"flow-source",kicker:"Stap 2",title:"Flowmeting configureren",copy:"Controleer en activeer de flowbron die bij jouw Quatt-versie en controller hoort.",fields:[{title:"Flowbron",copy:"De Quatt-versie en het hardwareprofiel bepalen automatisch welke flowbron OpenQuatt moet gebruiken."}]},{id:"thermostat-source",kicker:"Stap 3",title:"Thermostaatgegevens configureren",copy:"Leg vast waar OpenQuatt de kamertemperatuur en het kamer-setpoint samen vandaan haalt.",fields:[{title:"Thermostaatbron",copy:"Q-edition gebruikt OpenTherm. Listener en Waveshare gebruiken CiC of Home Assistant."}]},{id:"boiler",kicker:"Stap 4",title:"CV-ketel of boiler",copy:"Geef aan of OpenQuatt ondersteuning via een CV-ketel of boiler mag gebruiken.",optionalEntity:"boilerCvAssistEnabled",fields:[{title:"CV-ketel / boiler aanwezig",copy:"Kies of er ondersteuning beschikbaar is en vul eventueel het vermogen in."}]},{id:"strategy",kicker:"Stap 5",title:"Kies de verwarmingsstrategie",copy:"Kies hier hoe OpenQuatt je verwarming regelt. Daarna lopen we samen de belangrijkste instellingen langs.",fields:[{title:"Verwarmingsstrategie",copy:"Kies of OpenQuatt automatisch op je woning reageert, of werkt met een vaste stooklijn."}]},{id:"heating",kicker:"Stap 6",title:"Werk de regeling uit",copy:"Stel nu de gekozen regeling verder in. De inhoud hieronder past zich aan aan je keuze.",fields:[{title:"Instellingen voor jouw regeling",copy:"Je ziet hier alleen de instellingen die echt nodig zijn voor de gekozen regeling."}]},{id:"flow",kicker:"Stap 7",title:"Flowregeling en afstelling",copy:"Leg daarna vast hoe de pomp geregeld moet worden en welke waarden daarbij horen. De autotune staat later onder Instellingen \u2192 Installatie \u2192 Service & commissioning.",fields:[{title:"Flowregeling en tuning",copy:"Kies of OpenQuatt de pomp automatisch regelt, of dat je zelf een vaste pompstand instelt. Stel hier ook de flow-instellingen in."}]},{id:"water",kicker:"Stap 8",title:"Watertemperatuur beveiligen",copy:"Controleer de normale bovengrens en de tripgrens voor het watercircuit.",fields:[{title:"Watertemperatuur",copy:"Met deze grenzen voorkom je dat de watertemperatuur te hoog oploopt."}]},{id:"silent",kicker:"Stap 9",title:"Stille uren en niveaus",copy:"Stel daarna het stille venster en de compressorlimieten voor dag en nacht in.",fields:[{title:"Stille uren",copy:"Hier bepaal je wanneer het systeem rustiger moet werken."}]},{id:"confirm",kicker:"Stap 10",title:"Bevestigen en afronden",copy:"Controleer nog \xE9\xE9n keer je keuzes. Met afronden markeer je Quick Start als voltooid.",fields:[{title:"Afronden",copy:"Je instellingen zijn al opgeslagen. Deze stap markeert alleen dat Quick Start klaar is."}]}],fo=[1,2],bn=Array.from({length:11},(e,t)=>t),Rr=["cooling","heating"];function Mu(e){return e==="cooling"?"cooling":"heating"}function Pu(e){return e==="cooling"?"Cooling":"Heating"}function jt(e,t,o){return`hp${e}OduRuntime${Pu(t)}F${o}`}function ae(e,t){return`hp${e}OduRuntimeFrequency${t}`}function vs(e){return[ae(e,"Enable"),ae(e,"Load"),ae(e,"Apply"),ae(e,"Status"),...Rr.flatMap(t=>bn.map(o=>jt(e,t,o)))]}function Nu(e){const t=String(e||"").match(/^hp([12])OduRuntimeFrequency(?:Load|Apply)$/);return t?Number(t[1]):0}const Or=fo.flatMap(vs),ws=new Set(fo.flatMap(e=>[ae(e,"Load"),ae(e,"Apply")])),O={setupComplete:{domain:"binary_sensor",name:"Setup Complete",optional:!0},status:{domain:"binary_sensor",name:"Status",optional:!0},firmwareUpdate:{domain:"update",name:"Firmware Update",optional:!0},firmwareUpdateChannel:{domain:"select",name:"Firmware Update Channel",optional:!0},firmwareUpdateTarget:{domain:"select",name:"Firmware Update Target",optional:!0},firmwareUpdateProgress:{domain:"sensor",name:"Firmware Update Progress",optional:!0},firmwareUpdateStatus:{domain:"text_sensor",name:"Firmware Update Status",optional:!0},firmwareTestOtaUrl:{domain:"text",name:"Firmware Test OTA URL",optional:!0},firmwareTestOtaMd5Url:{domain:"text",name:"Firmware Test OTA MD5 URL",optional:!0},checkFirmwareUpdates:{domain:"button",name:"Check Firmware Updates",optional:!0},installFirmwareTestOta:{domain:"button",name:"Install Firmware Test OTA",optional:!0},installFirmwareUpdateTarget:{domain:"button",name:"Install Firmware Update Target",optional:!0},restartAction:{domain:"button",name:"Restart",optional:!0},uptime:{domain:"sensor",name:"Uptime",optional:!0},uptimeReadable:{domain:"text_sensor",name:"Uptime readable",optional:!0},timeNowHhmm:{domain:"text_sensor",name:"Time now (HH:MM)",optional:!0},timeValid:{domain:"binary_sensor",name:"Time valid",optional:!0},ipAddress:{domain:"text_sensor",name:"IP Address",optional:!0},wifiSsid:{domain:"text_sensor",name:"WiFi SSID",optional:!0},projectVersionText:{domain:"text_sensor",name:"OpenQuatt Version",optional:!0},releaseChannelText:{domain:"text_sensor",name:"OpenQuatt Release Channel",optional:!0},installationTopology:{domain:"text_sensor",name:"OpenQuatt Installation Topology",optional:!0},hardwareProfileText:{domain:"text_sensor",name:"OpenQuatt Hardware Profile",optional:!0},connectionText:{domain:"text_sensor",name:"OpenQuatt Connection",optional:!0},wifiSignal:{domain:"sensor",name:"WiFi Signal",optional:!0},espInternalTemp:{domain:"sensor",name:"ESP Internal Temperature",optional:!0},hpGeneration:{domain:"select",name:"Quatt Hybrid version"},strategy:{domain:"select",name:"Heating Control Mode"},openquattEnabled:{domain:"switch",name:"OpenQuatt Enabled",optional:!0},boilerCvAssistEnabled:{domain:"switch",name:"Boiler assist enabled",optional:!0},manualCoolingEnable:{domain:"switch",name:"Manual Cooling Enable",optional:!0},cicCompatibilityMode:{domain:"switch",name:"CiC Compatibility Mode",optional:!0},silentModeOverride:{domain:"select",name:"Silent Mode Override",optional:!0},heatingEnableSelected:{domain:"binary_sensor",name:"Heating Enable (Selected)",optional:!0},heatingEnableValid:{domain:"binary_sensor",name:"Heating Enable Valid",optional:!0},heatingBlockedByThermostat:{domain:"binary_sensor",name:"Heating blocked by thermostat",optional:!0},coolingEnableSelected:{domain:"binary_sensor",name:"Cooling Enable (Selected)",optional:!0},coolingRequestActive:{domain:"binary_sensor",name:"Cooling Request Active",optional:!0},coolingPermitted:{domain:"binary_sensor",name:"Cooling Permitted",optional:!0},coolingBlockReason:{domain:"text_sensor",name:"Cooling Block Reason",optional:!0},coolingGuardMode:{domain:"text_sensor",name:"Cooling Guard Mode",optional:!0},coolingDewPointSelected:{domain:"sensor",name:"Cooling Dew Point (Selected)",optional:!0},coolingMinimumSafeSupplyTemp:{domain:"sensor",name:"Cooling Minimum Safe Supply Temp",optional:!0},coolingEffectiveMinSupplyTemp:{domain:"sensor",name:"Cooling Effective Minimum Supply Temp",optional:!0},coolingFallbackNightMinOutdoorTemp:{domain:"sensor",name:"Cooling Fallback Night Minimum Outdoor Temp",optional:!0},coolingFallbackMinSupplyTemp:{domain:"sensor",name:"Cooling Fallback Minimum Supply Temp",optional:!0},coolingSupplyTarget:{domain:"sensor",name:"Cooling Supply Target",optional:!0},coolingSupplyError:{domain:"sensor",name:"Cooling Supply Error",optional:!0},coolingDemandRaw:{domain:"sensor",name:"Cooling Demand (raw)",optional:!0},coolingBaseDemandRaw:{domain:"sensor",name:"Cooling base demand raw",optional:!0},coolingLimitedDemand:{domain:"sensor",name:"Cooling limited demand",optional:!0},coolingLimiterAllowedMax:{domain:"sensor",name:"Cooling limiter allowed max",optional:!0},coolingBufferGapFiltered:{domain:"sensor",name:"Cooling buffer gap filtered",optional:!0},coolingBufferGapRate:{domain:"sensor",name:"Cooling buffer gap rate",optional:!0},coolingProjectedGap:{domain:"sensor",name:"Cooling projected gap",optional:!0},coolingProjectionBrakeActive:{domain:"sensor",name:"Cooling projection brake active",optional:!0},coolingDewGap:{domain:"sensor",name:"Cooling dew gap",optional:!0},coolingStopBufferGap:{domain:"sensor",name:"Cooling stop buffer gap",optional:!0},coolingLimiterReasonCode:{domain:"sensor",name:"Cooling limiter reason code",optional:!0},coolingStopReasonCode:{domain:"sensor",name:"Cooling stop reason code",optional:!0},coolingRequestReasonCode:{domain:"sensor",name:"Cooling request reason code",optional:!0},coolingRequestHp1Level:{domain:"sensor",name:"Cooling request HP1 level",optional:!0},coolingRequestHp2Level:{domain:"sensor",name:"Cooling request HP2 level",optional:!0},coolingRequestOwnerHp:{domain:"sensor",name:"Cooling request owner HP",optional:!0},coolingOwnerHp:{domain:"sensor",name:"Cooling owner HP",optional:!0},coolingWaterCycleActive:{domain:"sensor",name:"Cooling water cycle active",optional:!0},waterSupplySource:{domain:"select",name:"Water Supply Source",optional:!0},flowSource:{domain:"select",name:"Flow Source",optional:!0},qFlowSource:{domain:"select",name:"Q Flow Source",optional:!0},outdoorUnitFlowMode:{domain:"select",name:"Outdoor Unit Flow Mode",optional:!0},outsideTempSource:{domain:"select",name:"Outside Temperature Source",optional:!0},roomTempSource:{domain:"select",name:"Room Temperature Source",optional:!0},roomSetpointSource:{domain:"select",name:"Room Setpoint Source",optional:!0},heatingEnableSource:{domain:"select",name:"Heating Enable Source",optional:!0},coolingEnableSource:{domain:"select",name:"Cooling Enable Source",optional:!0},localWaterSupplyTempSource:{domain:"select",name:"Local Water Supply Temp Source",optional:!0},coolingMinimumSupplyTemp:{domain:"number",name:"Cooling Minimum Supply Temp",optional:!0},coolingDemandMax:{domain:"number",name:"Cooling Demand Max",optional:!0},coolingRestartDelta:{domain:"number",name:"Cooling Restart Delta",optional:!0},coolingPidKp:{domain:"number",name:"Cooling PID Kp",optional:!0},coolingPidKi:{domain:"number",name:"Cooling PID Ki",optional:!0},coolingPidKd:{domain:"number",name:"Cooling PID Kd",optional:!0},coolingSafetyMargin:{domain:"number",name:"Cooling Safety Margin",optional:!0},coolingRequestOnDelta:{domain:"number",name:"Cooling Request On Delta",optional:!0},coolingRequestOffDelta:{domain:"number",name:"Cooling Request Off Delta",optional:!0},coolingWithoutDewPointMode:{domain:"select",name:"Cooling Without Dew Point",optional:!0},flowControlMode:{domain:"select",name:"Flow Control Mode"},flowSetpoint:{domain:"number",name:"Flow Setpoint"},coolingFlowSetpoint:{domain:"number",name:"Cooling Flow Setpoint",optional:!0},manualIpwm:{domain:"number",name:"Manual iPWM"},compressorStarts2hWarningLimit:{domain:"number",name:"Compressor starts 2h warning limit",optional:!0},compressorStarts72hWarningLimit:{domain:"number",name:"Compressor starts 72h warning limit",optional:!0},compressorCyclingWarning2h:{domain:"binary_sensor",name:"Compressor cycling warning 2h",optional:!0},compressorCyclingWarning72h:{domain:"binary_sensor",name:"Compressor cycling warning 72h",optional:!0},alternatingCompressorStartsWarning:{domain:"binary_sensor",name:"Alternating compressor starts warning",optional:!0},compressorCyclingAlertLatched:{domain:"binary_sensor",name:"Compressor cycling alert latched",optional:!0},compressorCyclingAlertAlternating:{domain:"binary_sensor",name:"Compressor cycling alert alternating",optional:!0},compressorCyclingAlertFirstSeen:{domain:"sensor",name:"Compressor cycling alert first seen",optional:!0},compressorCyclingAlertLastSeen:{domain:"sensor",name:"Compressor cycling alert last seen",optional:!0},compressorCyclingAlertHp1Peak2h:{domain:"sensor",name:"Compressor cycling alert HP1 peak 2h",optional:!0},compressorCyclingAlertHp1Peak72h:{domain:"sensor",name:"Compressor cycling alert HP1 peak 72h",optional:!0},compressorCyclingAlertHp2Peak2h:{domain:"sensor",name:"Compressor cycling alert HP2 peak 2h",optional:!0},compressorCyclingAlertHp2Peak72h:{domain:"sensor",name:"Compressor cycling alert HP2 peak 72h",optional:!0},acknowledgeCompressorCyclingAlert:{domain:"button",name:"Acknowledge compressor cycling alert",optional:!0},hp1CompressorStarts2h:{domain:"sensor",name:"HP1 - Compressor starts 2h",optional:!0},hp1CompressorStarts6h:{domain:"sensor",name:"HP1 - Compressor starts 6h",optional:!0},hp1CompressorStarts24h:{domain:"sensor",name:"HP1 - Compressor starts 24h",optional:!0},hp1CompressorStarts72h:{domain:"sensor",name:"HP1 - Compressor starts 72h",optional:!0},hp1CompressorLastStartAge:{domain:"sensor",name:"HP1 - Compressor last start age",optional:!0},hp2CompressorStarts2h:{domain:"sensor",name:"HP2 - Compressor starts 2h",optional:!0},hp2CompressorStarts6h:{domain:"sensor",name:"HP2 - Compressor starts 6h",optional:!0},hp2CompressorStarts24h:{domain:"sensor",name:"HP2 - Compressor starts 24h",optional:!0},hp2CompressorStarts72h:{domain:"sensor",name:"HP2 - Compressor starts 72h",optional:!0},hp2CompressorLastStartAge:{domain:"sensor",name:"HP2 - Compressor last start age",optional:!0},lowflowFaultActive:{domain:"binary_sensor",name:"Lowflow fault active",optional:!0},flowMismatch:{domain:"binary_sensor",name:"Flow mismatch (HP1 vs HP2)",optional:!0},cicPollingEnabled:{domain:"switch",name:"CIC - Enable polling",optional:!0},cicFeedUrl:{domain:"text",name:"CIC - Feed URL",optional:!0},cicWaterSupplyTemp:{domain:"sensor",name:"CIC - Water Supply Temp",optional:!0},cicControlSetpoint:{domain:"sensor",name:"CIC - Control setpoint",optional:!0},cicRoomSetpoint:{domain:"sensor",name:"CIC - Room setpoint",optional:!0},cicRoomTemp:{domain:"sensor",name:"CIC - Room temperature",optional:!0},cicFlowrate:{domain:"sensor",name:"CIC - Flowrate (filtered)",optional:!0},cicLastSuccessAge:{domain:"sensor",name:"CIC - Last success age",optional:!0},cicChEnabled:{domain:"binary_sensor",name:"CIC - CH enabled",optional:!0},cicChEnableValid:{domain:"binary_sensor",name:"CIC - CH enable valid",optional:!0},cicCoolingEnabled:{domain:"binary_sensor",name:"CIC - Cooling enabled",optional:!0},cicJsonFeedOk:{domain:"binary_sensor",name:"CIC - JSON Feed OK",optional:!0},cicDataStale:{domain:"binary_sensor",name:"CIC - Data stale",optional:!0},otEnabled:{domain:"switch",name:"OpenTherm Enabled",optional:!0},otThermostatChEnable:{domain:"binary_sensor",name:"OT - Thermostat CH Enable",optional:!0},otThermostatStatusValid:{domain:"binary_sensor",name:"OT - Thermostat Status Valid",optional:!0},otThermostatCoolingEnable:{domain:"binary_sensor",name:"OT - Thermostat Cooling Enable",optional:!0},otLinkProblem:{domain:"binary_sensor",name:"OT - Link Problem",optional:!0},otControlSetpoint:{domain:"sensor",name:"OT - Control Setpoint",optional:!0},otRoomSetpoint:{domain:"sensor",name:"OT - Room Setpoint",optional:!0},otRoomTemp:{domain:"sensor",name:"OT - Room Temperature",optional:!0},flowKp:{domain:"number",name:"Flow PI Kp",optional:!0},flowKi:{domain:"number",name:"Flow PI Ki",optional:!0},boilerRatedHeatPower:{domain:"number",name:"Boiler rated heat power",optional:!0},commissioningCm100Start:{domain:"button",name:"CM100 Start",optional:!0},commissioningCm100Stop:{domain:"button",name:"CM100 Stop",optional:!0},commissioningStatus:{domain:"text_sensor",name:"Commissioning status",optional:!0},cm100Active:{domain:"binary_sensor",name:"CM100 active",optional:!0},boilerPowerTestStart:{domain:"button",name:"Boiler Power Test Start",optional:!0},boilerPowerTestAbort:{domain:"button",name:"Boiler Power Test Abort",optional:!0},boilerPowerTestApply:{domain:"button",name:"Boiler Power Test Apply",optional:!0},boilerPowerTestResult:{domain:"sensor",name:"Boiler power test result",optional:!0},boilerPowerTestActive:{domain:"binary_sensor",name:"Boiler power test active",optional:!0},boilerPowerTestStatus:{domain:"text_sensor",name:"Boiler power test status",optional:!0},flowAutotuneStart:{domain:"button",name:"Flow Autotune Start",optional:!0},flowAutotuneAbort:{domain:"button",name:"Flow Autotune Abort",optional:!0},flowAutotuneApply:{domain:"button",name:"Apply Flow Autotune Kp-Ki",optional:!0},flowAutotuneStatus:{domain:"text_sensor",name:"Flow Autotune status",optional:!0},flowKpSuggested:{domain:"number",name:"Flow Autotune Kp suggested",optional:!0},flowKiSuggested:{domain:"number",name:"Flow Autotune Ki suggested",optional:!0},airPurgeStart:{domain:"button",name:"Air Purge Start",optional:!0},airPurgeAbort:{domain:"button",name:"Air Purge Abort",optional:!0},airPurgeReturnToAuto:{domain:"switch",name:"Air purge return to Auto",optional:!0},airPurgeActive:{domain:"binary_sensor",name:"Air purge active",optional:!0},airPurgeStatus:{domain:"text_sensor",name:"Air purge status",optional:!0},airPurgeRemaining:{domain:"sensor",name:"Air purge remaining",optional:!0},airPurgePhase:{domain:"sensor",name:"Air purge phase",optional:!0},airPurgeTargetIpwm:{domain:"sensor",name:"Air purge target iPWM",optional:!0},manualFlowStart:{domain:"button",name:"Manual Flow Start",optional:!0},manualFlowAbort:{domain:"button",name:"Manual Flow Abort",optional:!0},manualFlowApplyHeating:{domain:"button",name:"Apply Manual Flow To Heating",optional:!0},manualFlowApplyCooling:{domain:"button",name:"Apply Manual Flow To Cooling",optional:!0},manualFlowActive:{domain:"binary_sensor",name:"Manual flow active",optional:!0},manualFlowStatus:{domain:"text_sensor",name:"Manual flow status",optional:!0},manualFlowSetpoint:{domain:"number",name:"Manual flow service setpoint",optional:!0},manualFlowTargetIpwm:{domain:"sensor",name:"Manual flow target iPWM",optional:!0},quickFlowTest:{domain:"switch",name:"Quick flow test",optional:!0},manualHpStart:{domain:"button",name:"Manual HP Start",optional:!0},manualHpAbort:{domain:"button",name:"Manual HP Abort",optional:!0},manualHpActive:{domain:"binary_sensor",name:"Manual HP active",optional:!0},manualHpStatus:{domain:"text_sensor",name:"Manual HP status",optional:!0},manualHpGuardStatus:{domain:"text_sensor",name:"Manual HP guard status",optional:!0},manualHp1Mode:{domain:"select",name:"Manual HP1 service mode",optional:!0},manualHp2Mode:{domain:"select",name:"Manual HP2 service mode",optional:!0},manualHp1Level:{domain:"number",name:"Manual HP1 compressor level",optional:!0},manualHp2Level:{domain:"number",name:"Manual HP2 compressor level",optional:!0},hpWaterCalibrationStart:{domain:"button",name:"HP Water Calibration Start",optional:!0},hpWaterCalibrationAbort:{domain:"button",name:"HP Water Calibration Abort",optional:!0},hpWaterCalibrationApply:{domain:"button",name:"Apply HP Water Calibration Offsets",optional:!0},hpWaterCalibrationActive:{domain:"binary_sensor",name:"HP water calibration active",optional:!0},hpWaterCalibrationStatus:{domain:"text_sensor",name:"HP water calibration status",optional:!0},hpWaterCalibrationRemaining:{domain:"sensor",name:"HP water calibration remaining",optional:!0},hpWaterCalibrationPhase:{domain:"sensor",name:"HP water calibration phase",optional:!0},hpWaterCalibrationSpread:{domain:"sensor",name:"HP water calibration spread",optional:!0},hpWaterCalibrationSupplyDelta:{domain:"sensor",name:"HP water calibration supply delta",optional:!0},hpWaterCalibrationStableProgress:{domain:"sensor",name:"HP water calibration stable window progress",optional:!0},hpWaterCalibrationStableRequired:{domain:"sensor",name:"HP water calibration stable window required",optional:!0},hpWaterCalibrationResultReference:{domain:"sensor",name:"HP water calibration result reference",optional:!0},hpWaterCalibrationResultSpreadBefore:{domain:"sensor",name:"HP water calibration result spread before",optional:!0},hpWaterCalibrationResultExpectedSpread:{domain:"sensor",name:"HP water calibration result expected spread",optional:!0},hpWaterCalibrationResultHp1InRawAvg:{domain:"sensor",name:"HP water calibration result HP1 water in raw average",optional:!0},hpWaterCalibrationResultHp1OutRawAvg:{domain:"sensor",name:"HP water calibration result HP1 water out raw average",optional:!0},hpWaterCalibrationResultHp2InRawAvg:{domain:"sensor",name:"HP water calibration result HP2 water in raw average",optional:!0},hpWaterCalibrationResultHp2OutRawAvg:{domain:"sensor",name:"HP water calibration result HP2 water out raw average",optional:!0},hp1WaterInOffset:{domain:"number",name:"HP1 water in temperature offset",optional:!0},hp1WaterOutOffset:{domain:"number",name:"HP1 water out temperature offset",optional:!0},hp2WaterInOffset:{domain:"number",name:"HP2 water in temperature offset",optional:!0},hp2WaterOutOffset:{domain:"number",name:"HP2 water out temperature offset",optional:!0},hp1WaterInOffsetSuggested:{domain:"number",name:"HP calibration HP1 water in offset suggested",optional:!0},hp1WaterOutOffsetSuggested:{domain:"number",name:"HP calibration HP1 water out offset suggested",optional:!0},hp2WaterInOffsetSuggested:{domain:"number",name:"HP calibration HP2 water in offset suggested",optional:!0},hp2WaterOutOffsetSuggested:{domain:"number",name:"HP calibration HP2 water out offset suggested",optional:!0},controlModeLabel:{domain:"text_sensor",name:"Control Mode (Label)"},flowMode:{domain:"text_sensor",name:"Flow Mode"},dayMax:{domain:"number",name:"Day max level"},silentMax:{domain:"number",name:"Silent max level"},silentStartTime:{domain:"time",name:"Silent start time"},silentEndTime:{domain:"time",name:"Silent end time"},openquattResumeAt:{domain:"datetime",name:"OpenQuatt resume at",optional:!0},maxWater:{domain:"number",name:"Maximum water temperature"},minRuntime:{domain:"number",name:"Minimum runtime"},totalPower:{domain:"sensor",name:"Total Power Input"},heatingPowerInput:{domain:"sensor",name:"Heating Power Input",optional:!0},coolingPowerInput:{domain:"sensor",name:"Cooling Power Input",optional:!0},totalCop:{domain:"sensor",name:"Total COP"},totalEer:{domain:"sensor",name:"Total EER",optional:!0},totalHeat:{domain:"sensor",name:"Total Heat Power"},totalCoolingPower:{domain:"sensor",name:"Total Cooling Power",optional:!0},boilerActive:{domain:"binary_sensor",name:"Boiler active",optional:!0},boilerHeatPower:{domain:"sensor",name:"Boiler Heat Power",optional:!0},systemHeatPower:{domain:"sensor",name:"System Heat Power",optional:!0},flowSelected:{domain:"sensor",name:"Flow average (Selected)"},flowLocal:{domain:"sensor",name:"Flow average (local)",optional:!0},controllerFlow:{domain:"sensor",name:"Controller Flow",optional:!0},trendHistoryEnabled:{domain:"switch",name:"Trendopslag",optional:!0},trendHistoryFlashEnabled:{domain:"switch",name:"Trendhistorie opslaan in flash",optional:!0},webServerLogHistoryEnabled:{domain:"switch",name:"RAM log history",optional:!0},debugLevel:{domain:"select",name:"Debug Level",optional:!0},trendHistoryFlush:{domain:"button",name:"Trendhistorie nu opslaan",optional:!0},trendHistoryFlashAvailable:{domain:"text_sensor",name:"Trendhistorie beschikbaar",optional:!0},trendHistoryFlashOldest:{domain:"text_sensor",name:"Trendhistorie oudste punt",optional:!0},trendHistoryFlashNewest:{domain:"text_sensor",name:"Trendhistorie nieuwste punt",optional:!0},trendHistoryFlashLastFlush:{domain:"text_sensor",name:"Trendhistorie laatste opslag",optional:!0},trendHistoryFlashSize:{domain:"sensor",name:"Trendhistorie grootte",optional:!0},trendHistoryFlashWrites:{domain:"sensor",name:"Trendhistorie schrijfacties",optional:!0},lifetimeEnergyHistoryEnabled:{domain:"switch",name:"Lifetime energiehistorie opslaan",optional:!0},lifetimeEnergyHistoryCapture:{domain:"button",name:"Lifetime energiehistorie nu opslaan",optional:!0},lifetimeEnergyHistoryClear:{domain:"button",name:"Lifetime energiehistorie wissen",optional:!0},lifetimeEnergyHistoryAvailable:{domain:"text_sensor",name:"Lifetime energiehistorie beschikbaar",optional:!0},lifetimeEnergyHistoryOldest:{domain:"text_sensor",name:"Lifetime energiehistorie oudste dag",optional:!0},lifetimeEnergyHistoryNewest:{domain:"text_sensor",name:"Lifetime energiehistorie nieuwste dag",optional:!0},lifetimeEnergyHistoryLastWrite:{domain:"text_sensor",name:"Lifetime energiehistorie laatste opslag",optional:!0},lifetimeEnergyHistorySize:{domain:"sensor",name:"Lifetime energiehistorie grootte",optional:!0},lifetimeEnergyHistoryWrites:{domain:"sensor",name:"Lifetime energiehistorie schrijfacties",optional:!0},electricalEnergyDaily:{domain:"sensor",name:"Electrical Energy Daily",optional:!0},electricalEnergyCumulative:{domain:"sensor",name:"Electrical Energy Cumulative",optional:!0},heatingElectricalEnergyDaily:{domain:"sensor",name:"Heating Electrical Energy Daily",optional:!0},heatingElectricalEnergyCumulative:{domain:"sensor",name:"Heating Electrical Energy Cumulative",optional:!0},coolingElectricalEnergyDaily:{domain:"sensor",name:"Cooling Electrical Energy Daily",optional:!0},coolingElectricalEnergyCumulative:{domain:"sensor",name:"Cooling Electrical Energy Cumulative",optional:!0},heatpumpThermalEnergyDaily:{domain:"sensor",name:"HeatPump Thermal Energy Daily",optional:!0},heatpumpThermalEnergyCumulative:{domain:"sensor",name:"HeatPump Thermal Energy Cumulative",optional:!0},heatpumpCoolingEnergyDaily:{domain:"sensor",name:"HeatPump Cooling Energy Daily",optional:!0},heatpumpCoolingEnergyCumulative:{domain:"sensor",name:"HeatPump Cooling Energy Cumulative",optional:!0},heatpumpCopDaily:{domain:"sensor",name:"HeatPump COP Daily",optional:!0},heatpumpCopCumulative:{domain:"sensor",name:"HeatPump COP Cumulative",optional:!0},heatpumpEerDaily:{domain:"sensor",name:"HeatPump EER Daily",optional:!0},heatpumpEerCumulative:{domain:"sensor",name:"HeatPump EER Cumulative",optional:!0},boilerThermalEnergyDaily:{domain:"sensor",name:"Boiler Thermal Energy Daily",optional:!0},boilerThermalEnergyCumulative:{domain:"sensor",name:"Boiler Thermal Energy Cumulative",optional:!0},systemThermalEnergyDaily:{domain:"sensor",name:"System Thermal Energy Daily",optional:!0},systemThermalEnergyCumulative:{domain:"sensor",name:"System Thermal Energy Cumulative",optional:!0},roomTemp:{domain:"sensor",name:"Room Temperature (Selected)"},roomSetpoint:{domain:"sensor",name:"Room Setpoint (Selected)"},supplyTemp:{domain:"sensor",name:"Water Supply Temp (Selected)"},outsideTempSelected:{domain:"sensor",name:"Outside Temperature (Selected)",optional:!0},waterSupplyTempEsp:{domain:"sensor",name:"Water Supply Temp",optional:!0},waterSupplyTempDs18b20:{domain:"sensor",name:"Water Supply Temp (DS18B20)",optional:!0},outsideTempLocalAggregated:{domain:"sensor",name:"Outside Temperature (Local aggregated)",optional:!0},outsideTempHa:{domain:"sensor",name:"HA - Outside Temperature",optional:!0},waterSupplyTempHa:{domain:"sensor",name:"HA - Water Supply Temperature",optional:!0},roomSetpointHa:{domain:"sensor",name:"HA - Thermostat Setpoint",optional:!0},roomTempHa:{domain:"sensor",name:"HA - Thermostat Room Temperature",optional:!0},heatingEnableHa:{domain:"binary_sensor",name:"HA - Heating Enable",optional:!0},coolingEnableHa:{domain:"binary_sensor",name:"HA - Cooling Enable",optional:!0},outsideTempHaValid:{domain:"binary_sensor",name:"HA - Outside Temperature Valid",optional:!0},waterSupplyTempHaValid:{domain:"binary_sensor",name:"HA - Water Supply Temperature Valid",optional:!0},roomSetpointHaValid:{domain:"binary_sensor",name:"HA - Room Setpoint Valid",optional:!0},roomTempHaValid:{domain:"binary_sensor",name:"HA - Room Temperature Valid",optional:!0},heatingEnableHaValid:{domain:"binary_sensor",name:"HA - Heating Enable Valid",optional:!0},coolingEnableHaValid:{domain:"binary_sensor",name:"HA - Cooling Enable Valid",optional:!0},roomTempEffectiveSource:{domain:"text_sensor",name:"Room Temperature Effective Source",optional:!0},roomSetpointEffectiveSource:{domain:"text_sensor",name:"Room Setpoint Effective Source",optional:!0},heatingEnableEffectiveSource:{domain:"text_sensor",name:"Heating Enable Effective Source",optional:!0},coolingEnableEffectiveSource:{domain:"text_sensor",name:"Cooling Enable Effective Source",optional:!0},curveSupplyTarget:{domain:"sensor",name:"Heating Curve Supply Target"},requestReason:{domain:"text_sensor",name:"Request Reason",optional:!0},strategyActiveCode:{domain:"sensor",name:"Strategy active code",optional:!0},strategyPhaseCode:{domain:"sensor",name:"Strategy phase code",optional:!0},strategyRequestedPower:{domain:"sensor",name:"Strategy requested power",optional:!0},strategySupplyTarget:{domain:"sensor",name:"Strategy supply target",optional:!0},strategyWaterLimitFactor:{domain:"sensor",name:"Strategy water limit factor",optional:!0},strategyRequestActive:{domain:"binary_sensor",name:"Strategy request active",optional:!0},strategyWaterTripActive:{domain:"binary_sensor",name:"Strategy water trip active",optional:!0},strategyWaterHardTripActive:{domain:"binary_sensor",name:"Strategy water hard trip active",optional:!0},curveDemandEffective:{domain:"sensor",name:"Curve demand (effective)",optional:!0},curveDemandDiscrete:{domain:"sensor",name:"Curve demand (discrete)",optional:!0},curveDispatchTotalLevel:{domain:"sensor",name:"Curve dispatch total level",optional:!0},curveTargetHp1Level:{domain:"sensor",name:"Curve target HP1 level",optional:!0},curveTargetHp2Level:{domain:"sensor",name:"Curve target HP2 level",optional:!0},curveRestartInhibit:{domain:"sensor",name:"Curve restart inhibit",optional:!0},curvePhase:{domain:"text_sensor",name:"Curve Phase",optional:!0},curveOperatingRegime:{domain:"text_sensor",name:"Curve operating regime",optional:!0},curveCapacityMode:{domain:"text_sensor",name:"Curve capacity mode",optional:!0},hpCapacity:{domain:"sensor",name:"HP capacity (W)",optional:!0},hpDeficit:{domain:"sensor",name:"HP deficit (W)",optional:!0},phouseHouse:{domain:"sensor",name:"Power House \u2013 P_house",optional:!0},phouseReq:{domain:"sensor",name:"Power House \u2013 P_req",optional:!0},duoOptimizerReason:{domain:"text_sensor",name:"Duo optimizer reason",optional:!0},selectedInputHoldActive:{domain:"text_sensor",name:"Selected Input Hold Active",optional:!0},silentActive:{domain:"binary_sensor",name:"Silent active"},silentStatus:{domain:"text_sensor",name:"Silent status",optional:!0},silentWindow:{domain:"text_sensor",name:"Silent window (start-end)",optional:!0},stickyActive:{domain:"binary_sensor",name:"Sticky pump active"},housePower:{domain:"number",name:"Rated maximum house power"},houseColdTemp:{domain:"number",name:"House cold temp"},houseOutdoorMax:{domain:"number",name:"Maximum heating outdoor temperature"},phResponseProfile:{domain:"select",name:"Power House response profile"},phKp:{domain:"number",name:"Power House temperature reaction"},phComfortBelow:{domain:"number",name:"Power House comfort below setpoint"},phComfortAbove:{domain:"number",name:"Power House comfort above setpoint"},phDemandRiseTime:{domain:"number",name:"Power House demand rise time"},phDemandFallTime:{domain:"number",name:"Power House demand fall time"},lowLoadDynamicThresholds:{domain:"text_sensor",name:"Low-load dynamic thresholds",optional:!0},lowLoadDynamicOffFactor:{domain:"number",name:"Low-load dynamic OFF factor",optional:!0},lowLoadDynamicOnFactor:{domain:"number",name:"Low-load dynamic ON factor",optional:!0},lowLoadMinimumHysteresis:{domain:"number",name:"Low-load minimum hysteresis",optional:!0},lowLoadCm2ReentryBlock:{domain:"number",name:"Low-load CM2 re-entry block",optional:!0},curveControlProfile:{domain:"select",name:"Heating Curve Control Profile"},heatingCurvePidKp:{domain:"number",name:"Heating Curve PID Kp",optional:!0},heatingCurvePidKi:{domain:"number",name:"Heating Curve PID Ki",optional:!0},heatingCurvePidKd:{domain:"number",name:"Heating Curve PID Kd",optional:!0},curveFallbackSupply:{domain:"number",name:"Curve Fallback Tsupply (No Outside Temp)"},curveM20:{domain:"number",name:"Curve Tsupply @ -20\xB0C"},curveM10:{domain:"number",name:"Curve Tsupply @ -10\xB0C"},curve0:{domain:"number",name:"Curve Tsupply @ 0\xB0C"},curve5:{domain:"number",name:"Curve Tsupply @ 5\xB0C"},curve10:{domain:"number",name:"Curve Tsupply @ 10\xB0C"},curve15:{domain:"number",name:"Curve Tsupply @ 15\xB0C"},hp1ExcludedA:{domain:"select",name:"HP1 - Excluded compressor level A"},hp1ExcludedB:{domain:"select",name:"HP1 - Excluded compressor level B"},hp1Power:{domain:"sensor",name:"HP1 - Power Input"},hp1Heat:{domain:"sensor",name:"HP1 - Heat Power"},hp1Cooling:{domain:"sensor",name:"HP1 - Cooling Power"},hp1Cop:{domain:"sensor",name:"HP1 - COP"},hp1Compressor:{domain:"sensor",name:"HP1 compressor level",optional:!0},hp1Freq:{domain:"sensor",name:"HP1 - Compressor frequency"},hp1FanSpeed:{domain:"sensor",name:"HP1 - Fan speed"},hp1Flow:{domain:"sensor",name:"HP1 - Flow"},hp1EvaporatorCoilTemp:{domain:"sensor",name:"HP1 - Evaporator coil temperature"},hp1InnerCoilTemp:{domain:"sensor",name:"HP1 - Inner coil temperature"},hp1OutsideTemp:{domain:"sensor",name:"HP1 - Outside temperature"},hp1CondenserPressure:{domain:"sensor",name:"HP1 - Condenser pressure"},hp1DischargeTemp:{domain:"sensor",name:"HP1 - Gas discharge temperature"},hp1EvaporatorPressure:{domain:"sensor",name:"HP1 - Evaporator pressure"},hp1ReturnTemp:{domain:"sensor",name:"HP1 - Gas return temperature"},hp1WaterIn:{domain:"sensor",name:"HP1 - Water in temperature"},hp1WaterOut:{domain:"sensor",name:"HP1 - Water out temperature"},hp1WaterInRaw:{domain:"sensor",name:"HP1 - Water in temperature raw",optional:!0},hp1WaterOutRaw:{domain:"sensor",name:"HP1 - Water out temperature raw",optional:!0},hp1Mode:{domain:"text_sensor",name:"HP1 - Working Mode Label"},hp1Failures:{domain:"text_sensor",name:"HP1 - Active Failures List"},hp1Defrost:{domain:"binary_sensor",name:"HP1 - Defrost"},hp1BottomPlate:{domain:"binary_sensor",name:"HP1 - Bottom plate heater"},hp1Crankcase:{domain:"binary_sensor",name:"HP1 - Crankcase heater"},hp1Eev:{domain:"sensor",name:"HP1 - EEV steps"},hp1FourWay:{domain:"binary_sensor",name:"HP1 - 4-Way valve"},hp2ExcludedA:{domain:"select",name:"HP2 - Excluded compressor level A",optional:!0},hp2ExcludedB:{domain:"select",name:"HP2 - Excluded compressor level B",optional:!0},hp2Power:{domain:"sensor",name:"HP2 - Power Input",optional:!0},hp2Heat:{domain:"sensor",name:"HP2 - Heat Power",optional:!0},hp2Cooling:{domain:"sensor",name:"HP2 - Cooling Power",optional:!0},hp2Cop:{domain:"sensor",name:"HP2 - COP",optional:!0},hp2Compressor:{domain:"sensor",name:"HP2 compressor level",optional:!0},hp2Freq:{domain:"sensor",name:"HP2 - Compressor frequency",optional:!0},hp2FanSpeed:{domain:"sensor",name:"HP2 - Fan speed",optional:!0},hp2Flow:{domain:"sensor",name:"HP2 - Flow",optional:!0},hp2EvaporatorCoilTemp:{domain:"sensor",name:"HP2 - Evaporator coil temperature",optional:!0},hp2InnerCoilTemp:{domain:"sensor",name:"HP2 - Inner coil temperature",optional:!0},hp2OutsideTemp:{domain:"sensor",name:"HP2 - Outside temperature",optional:!0},hp2CondenserPressure:{domain:"sensor",name:"HP2 - Condenser pressure",optional:!0},hp2DischargeTemp:{domain:"sensor",name:"HP2 - Gas discharge temperature",optional:!0},hp2EvaporatorPressure:{domain:"sensor",name:"HP2 - Evaporator pressure",optional:!0},hp2ReturnTemp:{domain:"sensor",name:"HP2 - Gas return temperature",optional:!0},hp2WaterIn:{domain:"sensor",name:"HP2 - Water in temperature",optional:!0},hp2WaterOut:{domain:"sensor",name:"HP2 - Water out temperature",optional:!0},hp2WaterInRaw:{domain:"sensor",name:"HP2 - Water in temperature raw",optional:!0},hp2WaterOutRaw:{domain:"sensor",name:"HP2 - Water out temperature raw",optional:!0},hp2Mode:{domain:"text_sensor",name:"HP2 - Working Mode Label",optional:!0},hp2Failures:{domain:"text_sensor",name:"HP2 - Active Failures List",optional:!0},hp2Defrost:{domain:"binary_sensor",name:"HP2 - Defrost",optional:!0},hp2BottomPlate:{domain:"binary_sensor",name:"HP2 - Bottom plate heater",optional:!0},hp2Crankcase:{domain:"binary_sensor",name:"HP2 - Crankcase heater",optional:!0},hp2Eev:{domain:"sensor",name:"HP2 - EEV steps",optional:!0},hp2FourWay:{domain:"binary_sensor",name:"HP2 - 4-Way valve",optional:!0},apply:{domain:"button",name:"Complete setup"},reset:{domain:"button",name:"Reset setup state"}};fo.forEach(e=>{const t=`HP${e} - EXPERIMENTAL`;O[ae(e,"Enable")]={domain:"switch",name:`${t} ODU runtime frequency write enable`,optional:!0},O[ae(e,"Load")]={domain:"button",name:`${t} load ODU runtime frequency table`,optional:!0},O[ae(e,"Apply")]={domain:"button",name:`${t} apply ODU runtime frequency table`,optional:!0},O[ae(e,"Status")]={domain:"text_sensor",name:`${t} ODU runtime frequency status`,optional:!0},Rr.forEach(o=>{bn.forEach(r=>{O[jt(e,o,r)]={domain:"number",name:`${t} ${Mu(o)} F${r} runtime Hz`,optional:!0}})})});const Dr=[{id:"overview",label:"Overzicht"},{id:"energy",label:"Energie"},{id:"diagnosis",label:"Diagnose"},{id:"results",label:"Resultaten"},{id:"settings",label:"Instellingen"}],Lu=new Set(Dr.map(e=>e.id)),ye=[{id:"installation",label:"Installatie"},{id:"heating",label:"Verwarmen"},{id:"cooling",label:"Koelen"},{id:"integrations",label:"Bronnen / integraties"},{id:"service",label:"Service"},{id:"system",label:"Systeem"}],xe=new Set(ye.map(e=>e.id)),Ru=[{title:"HP1",accent:"blue",keys:{power:"hp1Power",heat:"hp1Heat",cooling:"hp1Cooling",cop:"hp1Cop",freq:"hp1Freq",fanSpeed:"hp1FanSpeed",flow:"hp1Flow",evaporatorCoilTemp:"hp1EvaporatorCoilTemp",innerCoilTemp:"hp1InnerCoilTemp",outsideTemp:"hp1OutsideTemp",condenserPressure:"hp1CondenserPressure",dischargeTemp:"hp1DischargeTemp",evaporatorPressure:"hp1EvaporatorPressure",returnTemp:"hp1ReturnTemp",waterIn:"hp1WaterIn",waterOut:"hp1WaterOut",mode:"hp1Mode",failures:"hp1Failures",defrost:"hp1Defrost",bottomPlate:"hp1BottomPlate",crankcase:"hp1Crankcase",eev:"hp1Eev",fourWay:"hp1FourWay"}},{title:"HP2",accent:"orange",keys:{power:"hp2Power",heat:"hp2Heat",cooling:"hp2Cooling",cop:"hp2Cop",freq:"hp2Freq",fanSpeed:"hp2FanSpeed",flow:"hp2Flow",evaporatorCoilTemp:"hp2EvaporatorCoilTemp",innerCoilTemp:"hp2InnerCoilTemp",outsideTemp:"hp2OutsideTemp",condenserPressure:"hp2CondenserPressure",dischargeTemp:"hp2DischargeTemp",evaporatorPressure:"hp2EvaporatorPressure",returnTemp:"hp2ReturnTemp",waterIn:"hp2WaterIn",waterOut:"hp2WaterOut",mode:"hp2Mode",failures:"hp2Failures",defrost:"hp2Defrost",bottomPlate:"hp2BottomPlate",crankcase:"hp2Crankcase",eev:"hp2Eev",fourWay:"hp2FourWay"}}],ce=[{key:"curveM20",outdoor:-20,label:"-20\xB0C"},{key:"curveM10",outdoor:-10,label:"-10\xB0C"},{key:"curve0",outdoor:0,label:"0\xB0C"},{key:"curve5",outdoor:5,label:"5\xB0C"},{key:"curve10",outdoor:10,label:"10\xB0C"},{key:"curve15",outdoor:15,label:"15\xB0C"}],Yt=["housePower","houseColdTemp","houseOutdoorMax","phResponseProfile","phKp","phComfortBelow","phComfortAbove","phDemandRiseTime","phDemandFallTime"],Hn=["dayMax","silentMax","maxWater"],ct=["flowControlMode","flowSetpoint","coolingFlowSetpoint","manualIpwm"],ys=["flowKp","flowKi"],eo=["hp1WaterInOffset","hp1WaterOutOffset","hp2WaterInOffset","hp2WaterOutOffset"],to=["hp1WaterInRaw","hp1WaterIn","hp1WaterOutRaw","hp1WaterOut","hp2WaterInRaw","hp2WaterIn","hp2WaterOutRaw","hp2WaterOut"],Fr=["compressorStarts2hWarningLimit","compressorStarts72hWarningLimit","compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","compressorCyclingAlertLatched","compressorCyclingAlertAlternating","compressorCyclingAlertFirstSeen","compressorCyclingAlertLastSeen","compressorCyclingAlertHp1Peak2h","compressorCyclingAlertHp1Peak72h","compressorCyclingAlertHp2Peak2h","compressorCyclingAlertHp2Peak72h","acknowledgeCompressorCyclingAlert","hp1CompressorStarts2h","hp1CompressorStarts6h","hp1CompressorStarts24h","hp1CompressorStarts72h","hp1CompressorLastStartAge","hp2CompressorStarts2h","hp2CompressorStarts6h","hp2CompressorStarts24h","hp2CompressorStarts72h","hp2CompressorLastStartAge","lowflowFaultActive","flowMismatch","cicPollingEnabled","cicDataStale","otEnabled","otLinkProblem","hp1Failures","hp2Failures"],Ou=["compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","compressorCyclingAlertLatched","lowflowFaultActive","flowMismatch","cicPollingEnabled","cicDataStale","otEnabled","otLinkProblem","hp1Failures","hp2Failures"],xr=["commissioningStatus","cm100Active","commissioningCm100Start","commissioningCm100Stop","boilerPowerTestStart","boilerPowerTestAbort","boilerPowerTestApply","boilerPowerTestResult","boilerPowerTestActive","boilerPowerTestStatus","boilerHeatPower","flowAutotuneStart","flowAutotuneAbort","flowAutotuneApply","flowAutotuneStatus","flowKpSuggested","flowKiSuggested","airPurgeStart","airPurgeAbort","airPurgeReturnToAuto","airPurgeActive","airPurgeStatus","airPurgeRemaining","airPurgePhase","airPurgeTargetIpwm","manualFlowStart","manualFlowAbort","manualFlowApplyHeating","manualFlowApplyCooling","manualFlowActive","manualFlowStatus","manualFlowSetpoint","manualFlowTargetIpwm","manualHpStart","manualHpAbort","manualHpActive","manualHpStatus","manualHpGuardStatus","manualHp1Mode","manualHp2Mode","manualHp1Level","manualHp2Level","hpWaterCalibrationStart","hpWaterCalibrationAbort","hpWaterCalibrationApply","hpWaterCalibrationActive","hpWaterCalibrationStatus","hpWaterCalibrationRemaining","hpWaterCalibrationPhase","hpWaterCalibrationSpread","hpWaterCalibrationSupplyDelta","hpWaterCalibrationStableProgress","hpWaterCalibrationStableRequired","hpWaterCalibrationResultReference","hpWaterCalibrationResultSpreadBefore","hpWaterCalibrationResultExpectedSpread","hpWaterCalibrationResultHp1InRawAvg","hpWaterCalibrationResultHp1OutRawAvg","hpWaterCalibrationResultHp2InRawAvg","hpWaterCalibrationResultHp2OutRawAvg",...to,"hp1WaterInOffsetSuggested","hp1WaterOutOffsetSuggested","hp2WaterInOffsetSuggested","hp2WaterOutOffsetSuggested","flowSelected","hp1Compressor","hp1Freq","hp1Failures","hp2Compressor","hp2Freq","hp2Failures","hp1Mode","hp2Mode"],qs=["cicCompatibilityMode"],Ss=["otEnabled","otLinkProblem"],ks=["cicPollingEnabled","cicFeedUrl","cicDataStale"],Cs=["otThermostatChEnable","otThermostatCoolingEnable","otControlSetpoint","otRoomSetpoint","otRoomTemp"],Ts=["cicJsonFeedOk","cicWaterSupplyTemp","cicControlSetpoint","cicRoomSetpoint","cicRoomTemp","cicFlowrate","cicLastSuccessAge","cicChEnabled","cicCoolingEnabled"],Ir=["waterSupplySource","localWaterSupplyTempSource","flowSource","qFlowSource","outdoorUnitFlowMode","outsideTempSource","roomTempSource","roomSetpointSource","heatingEnableSource","coolingEnableSource"],Es=["supplyTemp","waterSupplyTempEsp","waterSupplyTempDs18b20","waterSupplyTempHa","waterSupplyTempHaValid","flowSelected","flowLocal","controllerFlow","hp1Flow","hp2Flow","outsideTempSelected","outsideTempLocalAggregated","outsideTempHa","outsideTempHaValid","roomTemp","roomTempEffectiveSource","roomTempHa","roomTempHaValid","roomSetpoint","roomSetpointEffectiveSource","roomSetpointHa","roomSetpointHaValid","heatingEnableSelected","heatingEnableValid","heatingBlockedByThermostat","heatingEnableEffectiveSource","otThermostatChEnable","otThermostatStatusValid","cicChEnabled","cicChEnableValid","heatingEnableHa","heatingEnableHaValid","coolingEnableSelected","coolingEnableEffectiveSource","coolingEnableHa","coolingEnableHaValid"],ut=["hardwareProfileText","hpGeneration","flowSource","qFlowSource","cicPollingEnabled","cicFeedUrl","cicJsonFeedOk","cicDataStale","cicFlowrate","controllerFlow","flowSelected","flowLocal","hp1Flow","hp2Flow","commissioningCm100Start","commissioningCm100Stop","commissioningStatus","cm100Active","quickFlowTest"],bo=["hardwareProfileText","roomTempSource","roomSetpointSource","roomTemp","roomSetpoint","roomTempEffectiveSource","roomSetpointEffectiveSource","otEnabled","otLinkProblem","otRoomTemp","otRoomSetpoint","cicPollingEnabled","cicFeedUrl","cicJsonFeedOk","cicDataStale","cicRoomTemp","cicRoomSetpoint","roomTempHa","roomTempHaValid","roomSetpointHa","roomSetpointHaValid"],$s=["coolingMinimumSupplyTemp","coolingDemandMax","coolingRestartDelta","coolingRequestOnDelta","coolingRequestOffDelta","coolingSafetyMargin","coolingWithoutDewPointMode","coolingGuardMode","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingEffectiveMinSupplyTemp"],vo=[...ce.map(e=>e.key),"curveFallbackSupply","curveControlProfile"],As=["minRuntime","hp1ExcludedA","hp1ExcludedB","hp2ExcludedA","hp2ExcludedB"],wo=["silentStartTime","silentEndTime","silentMax","dayMax"],Du=1e4;const ur=[{minutes:15,label:"15 min"},{minutes:30,label:"30 min"},{minutes:60,label:"1 uur"}],Bt=["projectVersionText","releaseChannelText","installationTopology","hardwareProfileText","connectionText","timeValid","controlModeLabel","strategy","openquattEnabled","manualCoolingEnable","silentModeOverride","outsideTempSelected","roomTemp","roomSetpoint","supplyTemp","flowSelected","flowControlMode","flowMode","flowSetpoint","coolingFlowSetpoint","manualIpwm","flowKp","flowKi","totalPower","heatingPowerInput","coolingPowerInput","hp1Mode","hp1Compressor","hp1Freq","hp1Flow","hp1Power","hp1Heat","hp1Cooling","hp1WaterIn","hp1WaterOut","hp1Defrost","hp1Failures","hp2Mode","hp2Compressor","hp2Freq","hp2Flow","hp2Power","hp2Heat","hp2Cooling","hp2WaterIn","hp2WaterOut","hp2Defrost","hp2Failures","coolingEnableSelected","coolingRequestActive","coolingPermitted","coolingBlockReason","coolingGuardMode","coolingMinimumSupplyTemp","coolingSafetyMargin","coolingDemandMax","coolingRestartDelta","coolingPidKp","coolingPidKi","coolingPidKd","coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingEffectiveMinSupplyTemp","coolingSupplyTarget","coolingSupplyError","coolingDemandRaw","coolingBaseDemandRaw","coolingLimitedDemand","coolingLimiterAllowedMax","coolingBufferGapFiltered","coolingBufferGapRate","coolingProjectedGap","coolingProjectionBrakeActive","coolingDewGap","coolingStopBufferGap","coolingLimiterReasonCode","coolingStopReasonCode","coolingRequestReasonCode","coolingRequestHp1Level","coolingRequestHp2Level","coolingRequestOwnerHp","coolingOwnerHp","coolingWaterCycleActive","requestReason","strategyActiveCode","strategyPhaseCode","strategyRequestedPower","strategySupplyTarget","strategyWaterLimitFactor","strategyRequestActive","strategyWaterTripActive","strategyWaterHardTripActive","curveControlProfile","heatingCurvePidKp","heatingCurvePidKi","heatingCurvePidKd","curveSupplyTarget","curveDemandEffective","curveDemandDiscrete","curveDispatchTotalLevel","curveTargetHp1Level","curveTargetHp2Level","curveRestartInhibit","curvePhase","curveOperatingRegime","curveCapacityMode","phouseHouse","phouseReq","hpCapacity","hpDeficit","duoOptimizerReason","selectedInputHoldActive","silentActive","lowLoadDynamicThresholds","lowLoadDynamicOffFactor","lowLoadDynamicOnFactor","lowLoadMinimumHysteresis","lowLoadCm2ReentryBlock","lowflowFaultActive","flowMismatch","compressorCyclingWarning2h","compressorCyclingWarning72h","alternatingCompressorStartsWarning","cicDataStale","otLinkProblem"],Zt=["firmwareUpdate","firmwareUpdateChannel","firmwareUpdateTarget","firmwareUpdateProgress","firmwareUpdateStatus"],Fu=["firmwareTestOtaUrl","firmwareTestOtaMd5Url","installFirmwareTestOta"],Wr=[...Zt,...Fu,"installFirmwareUpdateTarget","projectVersionText","releaseChannelText","installationTopology","hardwareProfileText","connectionText"],Gn=["hp2ExcludedA","hp2ExcludedB","hp2Power","hp2WaterOut"],$e=["status","uptime","uptimeReadable","timeNowHhmm","timeValid","ipAddress","wifiSsid","wifiSignal","installationTopology","hardwareProfileText","connectionText","hpGeneration","projectVersionText","releaseChannelText","espInternalTemp"],Mn=["strategy","openquattEnabled","boilerCvAssistEnabled","openquattResumeAt","manualCoolingEnable","silentModeOverride","coolingEnableSelected","coolingRequestActive","coolingPermitted","coolingBlockReason","coolingGuardMode","coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingEffectiveMinSupplyTemp","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingSupplyTarget","coolingSupplyError","coolingDemandRaw","controlModeLabel","flowMode","totalPower","heatingPowerInput","coolingPowerInput","totalCop","totalEer","totalHeat","totalCoolingPower","strategyRequestedPower","phouseHouse","phouseReq","hpCapacity","boilerActive","boilerHeatPower","systemHeatPower","electricalEnergyDaily","electricalEnergyCumulative","heatingElectricalEnergyDaily","heatingElectricalEnergyCumulative","coolingElectricalEnergyDaily","coolingElectricalEnergyCumulative","heatpumpThermalEnergyDaily","heatpumpThermalEnergyCumulative","heatpumpCoolingEnergyDaily","heatpumpCoolingEnergyCumulative","heatpumpCopDaily","heatpumpCopCumulative","heatpumpEerDaily","heatpumpEerCumulative","boilerThermalEnergyDaily","boilerThermalEnergyCumulative","systemThermalEnergyDaily","systemThermalEnergyCumulative","lifetimeEnergyHistoryEnabled","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites","flowSelected","outsideTempSelected","roomTemp","roomSetpoint","supplyTemp","curveSupplyTarget","silentActive","stickyActive","hp1Power","hp1Heat","hp1Cooling","hp1Cop","hp1Compressor","hp1Freq","hp1FanSpeed","hp1Flow","hp1EvaporatorCoilTemp","hp1InnerCoilTemp","hp1OutsideTemp","hp1CondenserPressure","hp1DischargeTemp","hp1EvaporatorPressure","hp1ReturnTemp","hp1WaterIn","hp1WaterOut","hp1Mode","hp1Failures","hp1Defrost","hp1BottomPlate","hp1Crankcase","hp1Eev","hp1FourWay","hp2Power","hp2Heat","hp2Cooling","hp2Cop","hp2Compressor","hp2Freq","hp2FanSpeed","hp2Flow","hp2EvaporatorCoilTemp","hp2InnerCoilTemp","hp2OutsideTemp","hp2CondenserPressure","hp2DischargeTemp","hp2EvaporatorPressure","hp2ReturnTemp","hp2WaterIn","hp2WaterOut","hp2Mode","hp2Failures","hp2Defrost","hp2BottomPlate","hp2Crankcase","hp2Eev","hp2FourWay"],Qn=["strategy","openquattEnabled","boilerCvAssistEnabled","openquattResumeAt","manualCoolingEnable","trendHistoryEnabled","trendHistoryFlashEnabled","coolingPermitted","coolingRequestActive","coolingBlockReason","controlModeLabel","flowMode","flowSelected","outsideTempSelected","roomTemp","roomSetpoint","supplyTemp","curveSupplyTarget","silentActive","stickyActive","totalPower","heatingPowerInput","coolingPowerInput","totalHeat","totalCoolingPower","totalCop","totalEer","strategyRequestedPower","phouseReq","hpCapacity","boilerActive","boilerHeatPower","systemHeatPower","silentModeOverride","hp1Power","hp1Heat","hp1Cooling","hp1Cop","hp1Compressor","hp1Freq","hp1FanSpeed","hp1Mode","hp1Flow","hp1EvaporatorCoilTemp","hp1InnerCoilTemp","hp1OutsideTemp","hp1CondenserPressure","hp1DischargeTemp","hp1EvaporatorPressure","hp1ReturnTemp","hp1WaterIn","hp1WaterOut","hp1Defrost","hp1BottomPlate","hp1Crankcase","hp1Eev","hp1FourWay","hp2Power","hp2Heat","hp2Cooling","hp2Cop","hp2Compressor","hp2Freq","hp2FanSpeed","hp2Mode","hp2Flow","hp2EvaporatorCoilTemp","hp2InnerCoilTemp","hp2OutsideTemp","hp2CondenserPressure","hp2DischargeTemp","hp2EvaporatorPressure","hp2ReturnTemp","hp2WaterIn","hp2WaterOut","hp2Defrost","hp2BottomPlate","hp2Crankcase","hp2Eev","hp2FourWay",...Ou],xu=["hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower","strategy",...Yt,...vo,...ct,"maxWater",...wo,...ut,...bo,"coolingDewPointSelected","coolingMinimumSafeSupplyTemp","coolingEffectiveMinSupplyTemp","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingSupplyTarget","coolingSupplyError","coolingDemandRaw","totalPower","heatingPowerInput","coolingPowerInput","totalHeat","totalCoolingPower","strategyRequestedPower","phouseHouse","phouseReq","hpCapacity","boilerActive","boilerHeatPower","systemHeatPower","flowSelected","roomTemp","roomSetpoint","supplyTemp","curveSupplyTarget","hp1Power","hp1Heat","hp1Cooling","hp1Freq","hp1FanSpeed","hp1Flow","hp1EvaporatorCoilTemp","hp1InnerCoilTemp","hp1OutsideTemp","hp1CondenserPressure","hp1DischargeTemp","hp1EvaporatorPressure","hp1ReturnTemp","hp1WaterIn","hp1WaterOut","hp2Power","hp2Heat","hp2Cooling","hp2Freq","hp2FanSpeed","hp2Flow","hp2EvaporatorCoilTemp","hp2InnerCoilTemp","hp2OutsideTemp","hp2CondenserPressure","hp2DischargeTemp","hp2EvaporatorPressure","hp2ReturnTemp","hp2WaterIn","hp2WaterOut"],Iu=[{label:"Nu",tone:"blue",categories:[{title:"Verwarmen",tone:"orange",groups:[{title:"Warmtepomp",rows:[["Elektrisch vermogen","heatingPowerInput"],["Warmteafgifte","totalHeat"],["COP","totalCop"]]},{title:"CV-ketel",rows:[["Warmteafgifte","boilerHeatPower"]]},{title:"Systeem",rows:[["Warmteafgifte","systemHeatPower"]]}]},{title:"Koelen",tone:"blue",groups:[{title:"Warmtepomp",rows:[["Elektrisch vermogen","coolingPowerInput"],["Koelafgifte","totalCoolingPower"],["COP (EER)","totalEer"]]}]}]},{label:"Vandaag",tone:"orange",categories:[{title:"Verwarmen",tone:"orange",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","heatingElectricalEnergyDaily"],["Warmte","heatpumpThermalEnergyDaily"],["COP","heatpumpCopDaily"]]},{title:"CV-ketel",rows:[["Warmte","boilerThermalEnergyDaily"]]},{title:"Systeem",rows:[["Warmte","systemThermalEnergyDaily"]]}]},{title:"Koelen",tone:"blue",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","coolingElectricalEnergyDaily"],["Koeling","heatpumpCoolingEnergyDaily"],["COP (EER)","heatpumpEerDaily"]]}]}]},{label:"Cumulatief",tone:"green",categories:[{title:"Verwarmen",tone:"orange",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","heatingElectricalEnergyCumulative"],["Warmte","heatpumpThermalEnergyCumulative"],["COP","heatpumpCopCumulative"]]},{title:"CV-ketel",rows:[["Warmte","boilerThermalEnergyCumulative"]]},{title:"Systeem",rows:[["Warmte","systemThermalEnergyCumulative"]]}]},{title:"Koelen",tone:"blue",groups:[{title:"Warmtepomp",rows:[["Elektriciteit","coolingElectricalEnergyCumulative"],["Koeling","heatpumpCoolingEnergyCumulative"],["COP (EER)","heatpumpEerCumulative"]]}]}]}],Hs=["strategy","installationTopology","hpGeneration","openquattEnabled","boilerCvAssistEnabled","boilerRatedHeatPower",...xr,"manualCoolingEnable","silentModeOverride","trendHistoryEnabled","trendHistoryFlashEnabled","trendHistoryFlush","webServerLogHistoryEnabled","trendHistoryFlashAvailable","trendHistoryFlashOldest","trendHistoryFlashNewest","trendHistoryFlashLastFlush","trendHistoryFlashSize","trendHistoryFlashWrites","lifetimeEnergyHistoryEnabled","lifetimeEnergyHistoryCapture","lifetimeEnergyHistoryClear","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites",...qs,...Ss,...Cs,...ks,...Ts,...Ir,...Es,...ct,...ys,...eo,...to,...Fr,...$s,...Hn,...Yt,...vo,...As,...wo,...Or];const kv=new Set(["installationTopology",...xr,...Or,"trendHistoryFlashAvailable","trendHistoryFlashOldest","trendHistoryFlashNewest","trendHistoryFlashLastFlush","trendHistoryFlashSize","trendHistoryFlashWrites","lifetimeEnergyHistoryAvailable","lifetimeEnergyHistoryOldest","lifetimeEnergyHistoryNewest","lifetimeEnergyHistoryLastWrite","lifetimeEnergyHistorySize","lifetimeEnergyHistoryWrites","cicDataStale","otLinkProblem","coolingGuardMode","coolingFallbackNightMinOutdoorTemp","coolingFallbackMinSupplyTemp","coolingEffectiveMinSupplyTemp"]),_t=[{id:"installation",label:"Installatie",keys:["setupComplete","hpGeneration","boilerCvAssistEnabled","boilerRatedHeatPower"]},{id:"operation",label:"Bediening",keys:["strategy","openquattEnabled","manualCoolingEnable","silentModeOverride","openquattResumeAt"]},{id:"integrations",label:"Integraties",keys:["otEnabled","cicPollingEnabled","cicFeedUrl","cicCompatibilityMode"]},{id:"sensor_sources",label:"Sensorbronnen",keys:["waterSupplySource","localWaterSupplyTempSource","flowSource","qFlowSource","outdoorUnitFlowMode","outsideTempSource","roomTempSource","roomSetpointSource","heatingEnableSource","coolingEnableSource",...eo]},{id:"comfort",label:"Comfort",keys:["silentStartTime","silentEndTime","dayMax","silentMax","maxWater"]},{id:"heatingCurve",label:"Stooklijn",keys:["curveControlProfile","curveFallbackSupply",...ce.map(e=>e.key)]},{id:"powerHouse",label:"Power House",keys:["housePower","houseColdTemp","houseOutdoorMax","phResponseProfile","phKp","phComfortBelow","phComfortAbove","phDemandRiseTime","phDemandFallTime"]},{id:"flow",label:"Flow",keys:["flowControlMode","flowSetpoint","coolingFlowSetpoint","manualIpwm","flowKp","flowKi"]},{id:"cooling",label:"Koeling",keys:["coolingMinimumSupplyTemp","coolingDemandMax","coolingRestartDelta","coolingRequestOnDelta","coolingRequestOffDelta","coolingSafetyMargin","coolingWithoutDewPointMode"]},{id:"compressor",label:"Compressor",keys:["minRuntime","compressorStarts2hWarningLimit","compressorStarts72hWarningLimit","hp1ExcludedA","hp1ExcludedB","hp2ExcludedA","hp2ExcludedB"]},{id:"system",label:"Systeem",keys:["trendHistoryEnabled","trendHistoryFlashEnabled","lifetimeEnergyHistoryEnabled","webServerLogHistoryEnabled","firmwareUpdateChannel"]}],Ms=1,Pn=[...new Set(_t.flatMap(e=>e.keys))],Wu=new Set(Pn),Bu=5e3,Vu=3e4,ju=6e4,_u=1500,Ku=3e4,Uu=3e4,zu=1e3,Br=3e4,mi=250,Gu=750,Qu=22,Yu=Qu/1.7,Zu=360/3.2,vn="2000-01-01 00:00:00",Kt=24,no=[3,12,24,72,168,336,720],n={mounted:!1,root:null,nativeApp:null,nativeFrontendLoaded:!1,nativeFrontendLoading:!1,pollTimer:null,entitySyncInFlight:!1,pendingEntitySyncOptions:null,lastEntitySyncAttemptAt:0,lastFastEntitySyncAt:0,lastBulkEntitySyncAt:0,lastStaticEntitySyncAt:0,lastAuthStatusRefreshAt:0,loginAuthStatusPollTimer:null,lastApiSecurityStatusRefreshAt:0,lastMqttStatusRefreshAt:0,summary:"",stage:"Laden...",interfacePanelOpen:ed(),devPanelOpen:nd(),nativeOpen:td()==="native",currentStep:"generation",quickStartModalMode:"wizard",settingsGroup:od(),appView:"",overviewTheme:Ju(),hpVisualMode:ad(),hpLayoutMode:sd(),trendWindowHours:cd(),trendHistoryRaw:"",trendHistoryError:"",trendHistorySignature:"",trendHistoryNowMs:Number.NaN,trendHistoryLastFetchAt:0,trendHistoryFetchPromise:null,energyHistoryRaw:"",energyHistoryError:"",energyHistorySignature:"",energyHistoryNowMs:Number.NaN,energyHistoryLastFetchAt:0,energyHistoryFetchPromise:null,energyHistoryView:"day",energyHistoryPeriodSelection:{day:"",week:"",month:"",year:""},deviceReconnectMode:"",deviceReconnectStartedAt:0,deviceReconnectRecoveryStartedAt:0,deviceReconnectRecoveryTimer:null,deviceReconnectLastError:"",entitySyncFailureCount:0,lastEntitySyncAt:0,lastEntitySyncSuccessAt:0,lastEntityResponseAt:0,overviewMetadataHydrated:!1,overviewMetadataHydrating:!1,busyAction:"",controlError:"",controlNotice:"",webServerLogSource:null,webServerLogConnected:!1,webServerLogEnabled:null,webServerLogError:"",webServerLogHistoryLoading:!1,webServerLogHistoryError:"",webServerLogHistoryRequestToken:0,webServerLogHistoryLoaded:!1,webServerLogScrollRestoreToken:0,cm100CommissioningScrollRestoreToken:0,serviceTaskModalScrollRestoreToken:0,quickStartScrollRestoreToken:0,quickStartCicFeedUrlDraft:null,quickStartThermostatSourceDraft:null,webServerLogCopyMessage:"",webServerLogCopyError:"",webServerLogRecentTail:[],webServerLogRecentAnchorAt:0,webServerLogEntries:[],debugRecordingActive:!1,debugRecordingStartedAt:0,debugRecordingEndsAt:0,debugRecordingTimer:null,debugRecordingSamples:[],debugRecordingError:"",debugRecordingNotice:"",debugRecordingBusy:!1,debugRecordingLastSampleAt:0,debugRecordingSequence:0,debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingEvents:[],debugRecordingSelectedMinutes:15,debugRecordingDeviceStatus:null,debugRecordingAcknowledgedId:jm(),debugRecordingDeviceBundle:null,debugRecordingDevicePollTimer:null,complete:!1,lastKnownInstallationTopology:"",quickStartModalOpen:!0,loadingEntities:!0,entities:{},optionalMissingEntities:{},settingsInfoOpen:"",installationMonitoringDetailsOpen:!1,integrationDiagnosticsOpen:!1,oduRuntimeFrequencyDetailsOpen:!1,installationMonitoringProblemSignature:"",settingsInteractionLock:!1,settingsRenderSignature:"",settingsBackupDraft:null,settingsBackupError:"",settingsBackupBusy:!1,pendingCommissioningCm100Start:!1,pendingBoilerPowerTestStart:!1,pendingFlowAutotuneStart:!1,pendingAirPurgeStart:!1,pendingManualFlowStart:!1,pendingManualHpStart:!1,pendingHpWaterCalibrationStart:!1,commissioningTaskLock:"",commissioningBoilerHeatPowerDisplay:"",headerRenderSignature:"",drafts:{},inputDrafts:{},focusedField:"",updateModalOpen:!1,systemModal:"",authStatus:null,authDraftUsername:"",authDraftCurrentPassword:"",authDraftNewPassword:"",authDraftConfirmPassword:"",authBusy:!1,authNotice:"",authError:"",apiSecurityStatus:null,apiSecurityBusy:!1,apiSecurityNotice:"",apiSecurityError:"",mqttStatus:null,mqttDraftEnabled:!1,mqttDraftBroker:"",mqttDraftPort:"1883",mqttDraftUsername:"",mqttDraftPassword:"",mqttDraftBaseTopic:"openquatt",mqttDraftPublishProfile:"standard",mqttDraftEssentialIntervalS:"10",mqttDraftStandardIntervalS:"30",mqttDraftDiagnosticIntervalS:"60",mqttDraftRetainSnapshots:!0,mqttBusy:!1,mqttNotice:"",mqttError:"",updateCheckBusy:!1,updateInstallBusy:!1,updateInstallTargetVersion:"",updateInstallPhaseHint:"",updateInstallProgressHint:Number.NaN,updateInstallMode:"",updateInstallTargetConnection:"",firmwareAdvancedOpen:!1,firmwareConnectionSwitchOpen:!1,firmwareConnectionSwitchConfirmed:!1,updateInstallCompleted:!1,updateInstallCompletedVersion:"",updateManualUploadOpen:!1,updateManualUploadFile:null,updateManualUploadFileName:"",updateManualUploadError:"",updateTestFirmwareOpen:!1,updateTestFirmwarePr:"",updateTestFirmwareConfirmed:!1,updateTestFirmwareError:"",updateTestFirmwareBuild:null,pauseResumeDraft:"",draggingCurveKey:"",motionFrame:0,motionStartedAt:0,reducedMotion:dd(),motionPreferenceMedia:null,motionPreferenceListener:null,motionTargets:{pipeFlows:[],fanBlades:[]}};function Ju(){try{return window.localStorage.getItem("oq-overview-theme")==="dark"?"dark":"light"}catch{return"light"}}function Xu(e){n.overviewTheme=e==="dark"?"dark":"light";try{window.localStorage.setItem("oq-overview-theme",n.overviewTheme)}catch{}}function ed(){return!1}function Zo(e){n.interfacePanelOpen=e===!0}function td(){try{return window.localStorage.getItem("oq-active-surface")==="native"?"native":"app"}catch{return"app"}}function Ps(e){try{window.localStorage.setItem("oq-active-surface",e==="native"?"native":"app")}catch{}}function nd(){try{return window.localStorage.getItem("oq-dev-panel-open")==="true"}catch{return!1}}function od(){try{const e=window.localStorage.getItem("oq-settings-group");return xe.has(e)?e:ye[0].id}catch{return ye[0].id}}function Yn(e,t={}){n.settingsGroup=xe.has(e)?e:ye[0].id;try{window.localStorage.setItem("oq-settings-group",n.settingsGroup)}catch{}t.syncUrl!==!1&&n.appView==="settings"&&xs(t.syncMode||"replace")}function rd(e){n.devPanelOpen=e===!0;try{window.localStorage.setItem("oq-dev-panel-open",n.devPanelOpen?"true":"false")}catch{}}function ad(){try{return window.localStorage.getItem("oq-hp-visual-mode")==="compact"?"compact":"schematic"}catch{return"schematic"}}function id(e){n.hpVisualMode=e==="compact"?"compact":"schematic";try{window.localStorage.setItem("oq-hp-visual-mode",n.hpVisualMode)}catch{}}function sd(){try{const e=window.localStorage.getItem("oq-hp-layout-mode");return e==="focus-hp1"||e==="focus-hp2"?e:"equal"}catch{return"equal"}}function ld(e){n.hpLayoutMode=e==="focus-hp1"||e==="focus-hp2"?e:"equal";try{window.localStorage.setItem("oq-hp-layout-mode",n.hpLayoutMode)}catch{}}function cd(){try{const e=Number(window.localStorage.getItem("oq-trend-window-hours"));return no.includes(e)?e:Kt}catch{return Kt}}function Ns(){const e=n.entities?.trendHistoryFlashEnabled;if(!e)return!1;if(typeof e.value=="boolean")return e.value;const t=String(e.state??e.value??"").toLowerCase();return t==="on"||t==="true"||t==="1"}function ud(){return Ns()?no:no.filter(e=>e<=168)}function Vr(e){const t=ud(),o=Number(e);return t.includes(o)?o:Number.isFinite(o)&&o>t[t.length-1]?t[t.length-1]:t.includes(Kt)?Kt:t[0]}function jr(e){n.trendWindowHours=Vr(e);try{window.localStorage.setItem("oq-trend-window-hours",String(n.trendWindowHours))}catch{}}function Ut(){return"overview"}function Ls(){if(typeof window>"u"||typeof window.matchMedia!="function")return null;try{return window.matchMedia("(prefers-reduced-motion: reduce)")}catch{return null}}function dd(){return!!Ls()?.matches}function pd(e){if(n.reducedMotion=!!e?.matches,n.reducedMotion){_r();return}Qr()}function gd(){const e=Ls();!e||n.motionPreferenceMedia===e||(n.motionPreferenceMedia=e,n.motionPreferenceListener=pd,typeof e.addEventListener=="function"?e.addEventListener("change",n.motionPreferenceListener):typeof e.addListener=="function"&&e.addListener(n.motionPreferenceListener),n.reducedMotion=!!e.matches)}function md(){return Object.keys(n.entities).length>0}function _r(){n.motionFrame&&(window.cancelAnimationFrame(n.motionFrame),n.motionFrame=0),n.motionStartedAt=0,zr()}function hd(){return mi+Math.floor(Math.random()*(Gu-mi+1))}function fd(){return(document.hidden?Br:Bu)+hd()}function Rs(e=fd()){n.pollTimer||n.nativeOpen||(n.pollTimer=window.setTimeout(async()=>{n.pollTimer=null,await re(),Rs()},e))}function Os(){Rs()}function Ds(){n.pollTimer&&(window.clearTimeout(n.pollTimer),n.pollTimer=null)}function bd(){n.nativeOpen||(Ds(),Os(),document.hidden||re({forceProbe:!0}))}function Kr(e={}){if(ro(),n.nativeOpen){Ds(),_r(),n.nativeFrontendLoaded||dr();return}if(Qr(),Os(),e.refresh!==!1){if(!md()){mg();return}re(n.appView==="settings"?{forceBulk:!0}:{forceFast:!0})}}function wn(e){return e==="trends"&&(e="diagnosis"),!Lu.has(e)||e==="diagnosis"&&!rn()?"":e}function oo(e){return String(e||"").trim().toLowerCase()}function Ur(){try{const e=new URL(window.location.href),t=oo(e.searchParams.get("view")||""),o=wn(t);if(o)return o;const r=oo(e.hash.replace(/^#/,""));return wn(r)||""}catch{return""}}function Fs(){try{const e=new URL(window.location.href),t=oo(e.searchParams.get("section")||"");if(xe.has(t))return t;const o=oo(e.searchParams.get("group")||"");return xe.has(o)?o:""}catch{return""}}function xs(e="replace"){try{const t=new URL(window.location.href),o=wn(n.appView)||Ut();if(t.searchParams.set("view",o),o==="settings"){const a=xe.has(n.settingsGroup)?n.settingsGroup:ye[0].id;t.searchParams.set("section",a),t.searchParams.delete("group")}else t.searchParams.delete("section"),t.searchParams.delete("group");t.hash&&wn(t.hash.replace(/^#/,""))&&(t.hash="");const r=e==="push"?"pushState":"replaceState";window.history[r]({oqView:o,oqSettingsSection:o==="settings"?n.settingsGroup:""},"",t.toString())}catch{}}function qt(e,t={}){const o=wn(e)||Ut(),r=t.syncMode||"replace",a=n.appView!==o;n.appView=o,(a||t.forceSync)&&xs(r)}function vd(){const e=Ur()||Ut(),t=e==="settings"?Fs()||n.settingsGroup:"";if(!(e===n.appView&&(e!=="settings"||t===n.settingsGroup))){if(n.appView=e,e==="settings"&&t){n.settingsGroup=t;try{window.localStorage.setItem("oq-settings-group",n.settingsGroup)}catch{}}g(),re(e==="settings"?{forceBulk:!0}:{forceFast:!0})}}function ro(){n.nativeApp&&(n.nativeApp.classList.add("oq-native-app"),n.nativeApp.classList.toggle("oq-native-app--collapsed",!n.nativeOpen),n.nativeApp.setAttribute("aria-hidden",n.nativeOpen?"false":"true"))}function wd(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",hi,{once:!0}):hi(),window.addEventListener("pointermove",Cg),window.addEventListener("pointerup",Tg),window.addEventListener("popstate",vd),window.addEventListener("oq-mock-updated",yd),window.addEventListener("oq-dev-controls-changed",qd),document.addEventListener("visibilitychange",bd)}function yd(){n.mounted&&re()}function qd(){n.mounted&&g()}function hi(){Sd();let e=document.querySelector("esp-app");e||(e=document.createElement("esp-app"),document.body.appendChild(e)),n.nativeApp=e,n.nativeFrontendLoaded=Array.from(document.scripts).some(t=>t.src===ms),n.mounted||(kd(e),n.mounted=!0,Kr()),ro(),n.nativeOpen||(re(),Ma({silent:!0}))}function Sd(){if(!document.head)return;let e=document.head.querySelector('meta[name="viewport"]');e||(e=document.createElement("meta"),e.name="viewport",document.head.appendChild(e)),e.setAttribute("content","width=device-width, initial-scale=1")}function kd(e){const t=document.createElement("section");t.id="oq-helper-root",t.lang="nl-NL",document.documentElement&&!document.documentElement.lang&&(document.documentElement.lang="nl-NL"),e.parentNode.insertBefore(t,e),t.addEventListener("click",Sg),t.addEventListener("change",qg),t.addEventListener("input",bg),t.addEventListener("keydown",vg),t.addEventListener("wheel",yg,{passive:!1}),t.addEventListener("focusin",Pi),t.addEventListener("focusout",Pi),t.addEventListener("mouseover",hg),t.addEventListener("mouseout",fg),t.addEventListener("pointerdown",kg),n.root=t,gd();const o=Ur()||Ut(),r=o==="settings"?Fs():"";r&&Yn(r,{syncUrl:!1}),qt(o,{syncMode:"replace",forceSync:!0}),zr(),g()}function Cd(e){return new Promise((t,o)=>{if(!e){t();return}const r=Array.from(document.scripts).find(i=>i.src===e);if(r){if(r.dataset.loaded==="true"){t();return}r.addEventListener("load",()=>t(),{once:!0}),r.addEventListener("error",i=>o(i),{once:!0});return}const a=document.createElement("script");a.src=e,a.async=!1,a.addEventListener("load",()=>{a.dataset.loaded="true",t()},{once:!0}),a.addEventListener("error",i=>o(i),{once:!0}),document.head.appendChild(a)})}async function dr(){if(!(n.nativeFrontendLoaded||n.nativeFrontendLoading)){n.nativeFrontendLoading=!0,n.nativeOpen&&g();try{await Cd(ms),n.nativeFrontendLoaded=!0}catch(e){n.controlError=`ESPHome fallback kon niet worden geladen. ${e.message||e}`,n.nativeOpen=!1,Ps("app"),g(),Kr()}finally{n.nativeFrontendLoading=!1,n.nativeOpen&&g()}}}function fi(){if(!n.root)return;const e=typeof window<"u"?window.__OQ_DEV_CONTROLS__:null;!e||typeof e.bind!="function"||e.bind(n.root)}function zr(){n.root&&(n.root.style.removeProperty("--oq-flow-offset"),n.root.style.removeProperty("--oq-flow-offset-reverse"),n.root.style.removeProperty("--oq-fan-rotation"),n.root.getAttribute("style")||n.root.removeAttribute("style"))}function Gr(){return n.motionTargets={pipeFlows:[],fanBlades:[]},n.root?(n.root.querySelectorAll(".oq-hp-schematic-board.is-running").forEach(r=>{r.querySelectorAll(".oq-hp-tech-pipe-flow").forEach(a=>{n.motionTargets.pipeFlows.push(a)})}),n.root.querySelectorAll(".oq-hp-schematic-board.is-water-flowing:not(.is-running)").forEach(r=>{r.querySelectorAll('.oq-hp-tech-pipe-flow[data-oq-flow-variant="water"]').forEach(a=>{n.motionTargets.pipeFlows.push(a)})}),n.root.querySelectorAll(".oq-hp-schematic-board.is-fan-running").forEach(r=>{r.querySelectorAll(".oq-hp-tech-fan-blades").forEach(a=>{n.motionTargets.fanBlades.push(a)})}),n.motionTargets.pipeFlows.length+n.motionTargets.fanBlades.length):0}function Td(){return n.motionTargets.pipeFlows.length>0||n.motionTargets.fanBlades.length>0}function Is(e=performance.now()){if(!n.root||n.reducedMotion||!Td()&&Gr()===0)return!1;n.motionStartedAt||(n.motionStartedAt=e);const t=(e-n.motionStartedAt)/1e3,o=t*Zu%360;return n.motionTargets.pipeFlows.forEach(r=>{const a=r.dataset.oqFlowVariant==="water"?.42:1,i=-(t*Yu*a);r.style.strokeDashoffset=`${i.toFixed(3)}px`}),n.motionTargets.fanBlades.forEach(r=>{r.style.transform=`rotate(${o.toFixed(3)}deg)`}),!0}function Ws(e){if(!Is(e)){n.motionFrame=0,n.motionStartedAt=0;return}n.motionFrame=window.requestAnimationFrame(Ws)}function Qr(){if(n.motionFrame||n.reducedMotion||Gr()===0)return;const e=performance.now();if(n.motionStartedAt=e,!Is(e)){n.motionStartedAt=0;return}n.motionFrame=window.requestAnimationFrame(Ws)}function Jt(){const e=window.location.pathname.replace(/\/$/,"");return e===""?"":e}function G(e,t,o=""){const r=o?`/${o}`:"";return`${Jt()}/${e}/${encodeURIComponent(t)}${r}`}function ie(e=T("strategy")){return String(e||"").includes("Water Temperature Control")}function Ed(e=T("flowControlMode")){return String(e||"").toLowerCase().includes("manual")}function dt(){return typeof window<"u"&&window.__OQ_DEV_META&&typeof window.__OQ_DEV_META=="object"?window.__OQ_DEV_META:{}}function $d(){const e=String(T("hpGeneration")||"").trim();return e||""}function pr(e){const t=String(e||"").trim().toLowerCase();return t==="single"||t.includes("quatt single")||t.includes("openquatt single")?"single":t==="duo"||t.includes("quatt duo")||t.includes("openquatt duo")?"duo":""}function Ad(){if(!Array.isArray(Gn))return"";if(Gn.some(t=>b(t)))return"duo";const e=n.optionalMissingEntities||{};return Gn.every(t=>e[t])?"single":""}function Jo(e){const t=pr(e);return(t==="single"||t==="duo")&&typeof n<"u"&&n&&typeof n=="object"&&(n.lastKnownInstallationTopology=t),t}function Hd(){if(typeof n<"u"&&n&&typeof n=="object"){const e=String(n.lastKnownInstallationTopology||"").trim().toLowerCase();if(e==="single"||e==="duo")return e}return""}function de(){const e=pr(T("installationTopology"));if(e==="single"||e==="duo")return Jo(e);const t=pr(dt().installation);if(t==="single"||t==="duo")return Jo(t);const o=Ad();return o?Jo(o):Hd()}function Nn(){const e=de(),t=$d();return e==="single"?t?`Quatt Single ${t}`:"Quatt Single":e==="duo"?t?`Quatt Duo ${t}`:"Quatt Duo":t?`Quatt Hybrid ${t}`:"Quatt Hybrid"}function Re(){return"OpenQuatt"}function Bs(e){const t=String(e||"").trim().toLowerCase();return t==="wifi"||t==="wi-fi"||t.includes("wifi")||t.includes("wi-fi")?"wifi":t==="eth"||t==="ethernet"||t.includes("ethernet")?"eth":""}function it(e=Xt()){return e==="wifi"?"Wi-Fi":e==="eth"?"Ethernet":"Onbekend"}function Yr(){const e=String(T("hardwareProfileText")||"").trim().toLowerCase();return e&&e!=="unknown"&&e!=="onbekend"?e:String(dt().hardwareProfile||e).trim().toLowerCase()}function Xt(){return Bs(T("connectionText")||dt().connection)}function Md(){const e=Xt();return e==="wifi"?"eth":e==="eth"?"wifi":""}function bi(e=Xt()){const t=de(),o=t==="duo"?"Duo":t==="single"?"Single":"Onbekende opstelling";return Yr()==="heatpump_controller_q"?`Heatpump Controller Q ${o} ${it(e)}`:`${Re()} ${o} ${it(e)}`}function Zr(){const e=Yr(),t=de(),o=Xt(),r=Md();return e!=="heatpump_controller_q"||t!=="single"&&t!=="duo"||o!=="wifi"&&o!=="eth"||!r?null:{canSwitch:b("firmwareUpdateTarget")&&b("installFirmwareUpdateTarget"),currentConnection:o,targetConnection:r,currentLabel:it(o),targetLabel:it(r),currentBuildLabel:bi(o),targetBuildLabel:bi(r)}}function yn(e=n.updateTestFirmwarePr){const t=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(t)?t:""}function yo(){const e=Yr(),t=de(),o=Xt(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||t!=="single"&&t!=="duo"||!a.connections.includes(o))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};const i=`openquatt-${a.slug}-${t}-${o}`,l=t==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,md5FileName:`${i}.firmware.ota.bin.md5`,label:`${a.label} ${l} ${it(o)}`}}function Jr(e=yn(),t=yo()){if(!e||!t.available)return null;const r=`${`https://github.com/jeroen85/OpenQuatt/releases/download/pr-${e}`}/${t.otaFileName}`;return{otaUrl:r,md5Url:`${r}.md5`,releaseApiUrl:`https://api.github.com/repos/jeroen85/OpenQuatt/releases/tags/pr-${e}`}}function Vs(){const e=A("timeValid"),t=String(T("timeNowHhmm")||"").trim();if(t&&t!=="invalid")return t;if(b("timeValid")&&!e)return"Geen tijdsync";try{return new Intl.DateTimeFormat("nl-NL",{hour:"2-digit",minute:"2-digit"}).format(new Date)}catch{return new Date().toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"})}}function js(){return b("timeValid")&&!A("timeValid")?"Geen tijdsync":`${new Intl.DateTimeFormat("nl-NL",{day:"numeric",month:"short",year:"numeric"}).format(new Date)} \xB7 ${Vs()}`}function Kn(e){if(!Number.isFinite(e)||e<0)return"\u2014";const t=Math.floor(e),o=Math.floor(t/1440),r=Math.floor(t%1440/60),a=t%60;return o>0?`${o}d ${r}u`:r>0?`${r}u ${a}m`:`${a}m`}function Pd(e){return String(e?.uom??e?.unit_of_measurement??"").trim().toLowerCase()}function Nd(e){const t=e?.state;if(t!==""&&t!==null&&t!==void 0){const a=Number(t);if(Number.isFinite(a))return a}const o=e?.value,r=Number(o);return Number.isFinite(r)?r:NaN}function Xr(){const e=Nd(n.entities.uptime);if(Number.isFinite(e)&&e>=0){const r=Pd(n.entities.uptime);if(r==="d")return Kn(e*1440);if(r==="h")return Kn(e*60);if(r==="s")return Kn(e/60)}const t=String(n.entities.uptimeReadable?.state??n.entities.uptimeReadable?.value??"").trim();if(t&&t.toLowerCase()!=="unknown")return t;const o=Number(dt().bootedAt);return!Number.isFinite(o)||o<=0?"\u2014":Kn((Date.now()-o)/6e4)}function ea(){const e=String(n.entities.ipAddress?.state??n.entities.ipAddress?.value??"").trim();if(e)return e;const t=String(dt().ipAddress||"").trim();return t||(typeof window<"u"?String(window.location.hostname||"").trim():"")||"\u2014"}function Ln(){if(Me())return"Controleren";const e=pt();if(e)return e.phaseLabel;if(oa())return"Bijgewerkt";if(qn())return"Bezig";if(en())return"Beschikbaar";const t=Ks();if(t!==null&&t<=0)return"Actueel";const o=dt();return typeof o.updateLabel=="string"&&o.updateLabel.trim()?o.updateLabel.trim():o.updateAvailable===!0?"Beschikbaar":o.updateAvailable===!1||aa()?"Actueel":pe()?"Nog niet gecontroleerd":"\u2014"}function pe(){return n.entities.firmwareUpdate||null}function qo(){const e=pe();return e?String(e.state??e.value??"").trim().toLowerCase():""}function Ld(){const e=n.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function So(){return Ld().toLowerCase()}function _s(){const e=n.entities.firmwareUpdateProgress;if(!e)return Number.NaN;const t=Number(e.value??e.state);return Number.isNaN(t)?Number.NaN:Math.max(0,Math.min(100,t))}function ta(){const e=String(n.updateInstallTargetVersion||"").trim(),t=ue();return!e||!t?!1:Rn(t,e)>=0}function Rd(e=pe()||{}){const t=zt(e),o=ue(e);return!t||!o?!1:Rn(o,t)>=0}function na(){return(ta()||Rd())&&!Me()&&!ao()&&!en()}function oa(){return(n.updateInstallCompleted||na())&&!Me()&&!pt()&&!en()}function ko(){n.updateInstallBusy=!1,n.updateInstallTargetVersion="",n.updateInstallPhaseHint="",n.updateInstallProgressHint=Number.NaN,n.updateInstallMode="",n.updateInstallTargetConnection=""}function Ce(){n.updateManualUploadFile=null,n.updateManualUploadFileName="",n.updateManualUploadError=""}function Ke(e={}){e.clearPr&&(n.updateTestFirmwarePr=""),n.updateTestFirmwareConfirmed=!1,n.updateTestFirmwareError="",n.updateTestFirmwareBuild=null}function Od(){const e=So(),t=_s();if(e==="starting"||e==="uploading"||e==="rebooting"){n.updateInstallPhaseHint=e,Number.isNaN(t)||(n.updateInstallProgressHint=e==="rebooting"?Math.max(t,100):t);return}if(n.updateInstallBusy){if(ta()){n.updateInstallPhaseHint="rebooting",n.updateInstallProgressHint=100;return}n.controlNotice.includes("opnieuw is opgestart")&&(n.updateInstallPhaseHint="rebooting",n.updateInstallProgressHint=100)}}function ao(){const e=So();return e==="starting"||e==="uploading"||e==="rebooting"}function pt(){Od();const e=So(),t=e==="starting"||e==="uploading"||e==="rebooting",o=t?e:n.updateInstallPhaseHint,r=_s(),a=Number.isNaN(n.updateInstallProgressHint)?0:Math.round(n.updateInstallProgressHint),i=t&&!Number.isNaN(r)?Math.round(r):a;return!ao()&&!n.updateInstallBusy?null:o==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:n.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":n.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:o==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:n.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${Re()} gedownload en ge\xEFnstalleerd.`:n.updateInstallMode==="connection-switch"?`De ${it(n.updateInstallTargetConnection)}-build wordt nu naar ${Re()} verzonden.`:`Firmware wordt nu naar ${Re()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:n.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${Re()}.`:n.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${it(n.updateInstallTargetConnection)} is gestart.`:`OTA-update is gestart voor ${Re()}.`}}function zt(e=pe()||{}){const t=String(e.latest_version||"").trim();if(t)return t;const o=String(e.value||"").trim(),r=String(e.current_version||"").trim();return o&&o!==r&&/^v/i.test(o)?o:""}function ue(e=pe()||{}){const t=String(n.entities.projectVersionText?.state||n.entities.projectVersionText?.value||"").trim();return t||String(e.current_version||"").trim()}function Dd(e=pe()||{}){const t=ue(e),o=String(e.current_version||"").trim();return!t||!o||t===o?!1:Rn(t,o)>0}function ra(e=pe()||{},t=Tt()){const o=String(t||"").trim().toLowerCase(),r=String(e.release_url||"").trim().toLowerCase(),a=zt(e).toLowerCase();if(!o||o==="\u2014")return!0;if(o==="dev"){if(r){if(r.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(o==="main"){if(r){if(r.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function vi(e){const o=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return o?{major:Number(o[1]),minor:Number(o[2]),patch:Number(o[3]),prereleaseTag:o[4]||"",prereleaseNumber:o[5]?Number(o[5]):null}:null}function Rn(e,t){const o=vi(e),r=vi(t);if(!o||!r)return 0;if(o.major!==r.major)return o.major>r.major?1:-1;if(o.minor!==r.minor)return o.minor>r.minor?1:-1;if(o.patch!==r.patch)return o.patch>r.patch?1:-1;const a=!o.prereleaseTag,i=!r.prereleaseTag;return a!==i?a?1:-1:o.prereleaseTag!==r.prereleaseTag?o.prereleaseTag>r.prereleaseTag?1:-1:o.prereleaseNumber!==r.prereleaseNumber?(o.prereleaseNumber||0)>(r.prereleaseNumber||0)?1:-1:0}function qn(){if(na())return!1;const e=qo();return n.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function Me(){const e=qo();return n.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function en(){const e=qo();if(!ra())return!1;const t=Ks();return t!==null?t>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:dt().updateAvailable===!0}function aa(){const e=qo();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||Dd()}function ia(){const e=pe()||{},t=ue(e)||"\u2014";let o=ra(e)?zt(e):"";const r=o?Rn(o,t):null;return!Me()&&r!==null&&r<=0&&(o=""),{current:t,latest:o||"\u2014"}}function Ks(){const{current:e,latest:t}=ia();return e==="\u2014"||t==="\u2014"?null:Rn(t,e)}function Us(e=Tt()){const t=String(e||"").trim().toLowerCase();return gi[t]||gi.main}function Fd(){const e=String((pe()||{}).release_url||"").trim(),t=Us();return!e||t.includes("/dev-latest")&&!e.includes("/dev-latest")||!t.includes("/dev-latest")&&e.includes("/dev-latest")?t:e}function xd(){return Re()}function Tt(){return String(T("firmwareUpdateChannel")||n.entities.releaseChannelText?.state||n.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function zs(){return ia().latest!=="\u2014"}function Gs(e){return new Promise(t=>window.setTimeout(t,e))}const Id=1500;function sa(){n.deviceReconnectRecoveryTimer&&(window.clearTimeout(n.deviceReconnectRecoveryTimer),n.deviceReconnectRecoveryTimer=null)}function Et(){return Number(n.deviceReconnectRecoveryStartedAt||0)>0}function Wd(){return Et()?Number(n.deviceReconnectRecoveryStartedAt||0):Number(n.deviceReconnectStartedAt||0)}function Bd(){return Et()?"Gegevens verversen":"Wachten op gegevens"}function Vd(){const e=Wd(),t=e>0?Math.max(0,Math.round((Date.now()-e)/1e3)):0;return Et()?t>0?`${t}s aan het verversen`:"Net weer online":t>0?`${t}s bezig`:"Net gestart"}function wi(){if(!n.deviceReconnectMode||Et())return!1;sa(),n.deviceReconnectRecoveryStartedAt=Date.now(),n.deviceReconnectLastError="",n.entitySyncFailureCount=0;const e=n.deviceReconnectRecoveryStartedAt;return n.deviceReconnectRecoveryTimer=window.setTimeout(()=>{n.deviceReconnectMode&&Number(n.deviceReconnectRecoveryStartedAt||0)===e&&(Qs(),g())},Id),g(),!0}function la(e="reconnect",t=""){n.deviceReconnectMode||(n.deviceReconnectStartedAt=Date.now()),sa(),n.deviceReconnectMode=e,n.deviceReconnectRecoveryStartedAt=0,n.deviceReconnectLastError=t?String(t):n.deviceReconnectLastError,n.systemModal="",n.updateModalOpen=!1,n.controlError=""}function Qs(){sa(),!(!n.deviceReconnectMode&&!n.entitySyncFailureCount)&&(n.deviceReconnectMode="",n.deviceReconnectStartedAt=0,n.deviceReconnectRecoveryStartedAt=0,n.deviceReconnectLastError="",n.entitySyncFailureCount=0)}function jd(){return Et()?"OpenQuatt is weer online":n.deviceReconnectMode==="ota"?"OpenQuatt wordt bijgewerkt":n.deviceReconnectMode==="restart"?"OpenQuatt herstart":"Verbinding herstellen"}function _d(){return Et()?n.deviceReconnectMode==="ota"?"De update is bijna klaar. We verversen nu de gegevens en het logboek.":"De controller reageert weer. We verversen nu de gegevens en het logboek.":n.deviceReconnectMode==="ota"?"De controller installeert de update en start daarna opnieuw op. Deze melding verdwijnt zodra de web-app weer gegevens ontvangt.":n.deviceReconnectMode==="restart"?"De controller start opnieuw op. De web-app probeert automatisch opnieuw verbinding te maken.":"De web-app krijgt tijdelijk geen gegevens van de controller. We proberen automatisch opnieuw te verbinden."}function Kd(){return n.deviceReconnectMode?`
    ...
    `}function zd(e,t){if(!Ys())return"";const r=!!(pt()||n.updateInstallBusy||Me());return`
      <div class="oq-helper-modal-callout oq-helper-modal-callout--subtle oq-firmware-advanced-panel">
        ...
        <div class="oq-firmware-advanced-options">
          ${e?Xo("toggle-firmware-connection-switch","Verbinding wisselen",`Naar ${t.targetLabel}`,n.firmwareConnectionSwitchOpen,r):""}
          ${Xo("toggle-firmware-upload","Handmatige upload","Lokaal OTA-bestand",n.updateManualUploadOpen,r)}
          ${Xo("toggle-firmware-test","Testfirmware","PR-release installeren",n.updateTestFirmwareOpen,r)}
        </div>
        ${Gd()}
        ${Yd()}
        ${Qd()}
      </div>
    `}function Gd(){const e=Zr();if(!e||!n.firmwareConnectionSwitchOpen)return"";const o=!!(pt()||n.updateInstallBusy||Me()),r=!!n.firmwareConnectionSwitchConfirmed,a=e.targetConnection==="eth",i=!e.canSwitch,l=a?"Sluit eerst de netwerkkabel aan. Na de herstart verdwijnt Wi-Fi uit deze firmware.":"Na de herstart verdwijnt Ethernet uit deze firmware. Als er geen Wi-Fi-gegevens bekend zijn, start het OpenQuatt fallback access point.",d=i?'<p class="oq-helper-modal-note oq-helper-modal-note--muted">Verbindingswissel wordt geladen. Open deze modal opnieuw of wacht een moment als de knop disabled blijft.</p>':"";return`
    ...
    `}function Qd(){if(!n.updateTestFirmwareOpen)return"";const t=!!(pt()||n.updateInstallBusy||Me()),o=yn(),r=yo(),a=Jr(o,r),i=!!(r.available&&b("firmwareTestOtaUrl")&&b("firmwareTestOtaMd5Url")&&b("installFirmwareTestOta")),l=!!(o&&i),d=n.updateTestFirmwareBuild||null,u=r.available?r.label:r.error,c=a?r.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen.";return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
    ...
    `:`
      ...
      `}function cp(){if(!n.root)return;if(n.interfacePanelOpen){n.root.querySelector(".oq-debug-recording-header-status")?.remove(),mr();return}const e=n.root.querySelector(".oq-helper-hub--collapsed .oq-helper-hub-head-actions");if(!e)return;const t=e.querySelector(".oq-debug-recording-header-status"),o=Gl();if(!o){t?.remove();return}if(t){t.outerHTML=o;return}e.insertAdjacentHTML("afterbegin",o)}function up(){const e=n.nativeOpen?"native":"app",t=n.nativeFrontendLoading?"ESPHome fallback wordt geladen. Daarna blijft alleen de native webinterface actief.":"De OpenQuatt-app is tijdelijk uitgeschakeld, zodat de ESPHome fallback zelfstandig en zonder extra interfacebelasting kan draaien.",o=n.controlError?`<p class="oq-native-surface-note oq-native-surface-note--error">${s(n.controlError)}</p>`:"";return`
    ...
    `}function pp(){if(!n.updateModalOpen)return"";const e=pe(),t=n.entities.firmwareUpdateChannel||null,{current:o,latest:r}=ia(),a=Me(),i=qn(),l=en(),d=Ud(),u=pt(),c=oa(),p=Fd(),f=c?"Firmware-update afgerond":u||i?"Firmware-update bezig":a?"Controleren op firmware-update":xd(),m=t?Array.isArray(t.option)?t.option:Array.isArray(t.options)?t.options:[]:[],v=Zr(),q=!!(v&&!c);return`
    ...
    `}function gp(){if(n.systemModal==="login")return dp();if(n.systemModal==="api-security")return rp();if(n.systemModal==="mqtt")return ap();if(n.systemModal==="connectivity"){const e=ip();return`
      ...
      `}if(n.systemModal==="settings-backup-restore")return Xh();if(n.systemModal==="settings-backup-import")return Jh();if(n.systemModal==="history-storage")return _h();if(String(n.systemModal||"").startsWith("service-task-"))return Ih();if(n.systemModal==="settings-backup-success"){const e=n.controlNotice||"Backup hersteld.";return`
        <div class="oq-helper-modal-backdrop${n.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
      ...
      `;if(n.systemModal==="webserver-logs")return xm();if(n.systemModal==="debug-recording")return sh();if(n.systemModal==="openquatt-pause"){const e=A("openquattEnabled"),t=n.busyAction==="openquatt-regulation",o=b("openquattResumeAt"),r=n.loadingEntities||n.entitySyncInFlight,a=o||!r,i=ma(),l=ha(T("openquattResumeAt")),d=al();return`
        <div class="oq-helper-modal-backdrop${n.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
...
`)}async function Dm(e){if(!e)return!1;if(window.navigator?.clipboard?.writeText&&window.isSecureContext)return await window.navigator.clipboard.writeText(e),!0;const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.top="-1000px",t.style.opacity="0",document.body.appendChild(t),t.focus(),t.select();let o=!1;try{o=document.execCommand("copy")}finally{document.body.removeChild(t)}return o}async function Fm(){const e=Om();if(n.webServerLogCopyMessage="",n.webServerLogCopyError="",!e){n.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",g();return}try{if(!await Dm(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");n.webServerLogCopyMessage=`${n.webServerLogEntries.length} logregel${n.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){n.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}n.systemModal==="webserver-logs"&&g()}function xm(){const e=an();return`
          ...
          ${e?`
            <div class="oq-debug-recording-progress">
              <div class="oq-debug-recording-progress-head">
                <span>${s(t?`Laatste ${kt(c)} bewaard`:`Nog ${kt(u)}`)}</span>
        ...
        `:`
          <section class="oq-debug-recording-duration" aria-label="Duur">
            ...
            <div class="oq-debug-recording-segments" role="group" aria-label="Kies opnameduur">
              ${ur.map(h=>{const y=Number(h.minutes)===d;return`
                  <button
  ...
  `}function cn(e,t,o){return o?`
    ...
    `}function or(e,t,o,r={}){if(!b(e))return"";const a=n.loadingEntities||n.busyAction===e,i=r.disabled===!0,l=r.buttonClass||"oq-helper-button oq-helper-button--ghost";return`
      <button
        class="${s(l)}"
        type="button"
        data-oq-action="${s(o)}"
    ...
    `}function uh(e,t,o="",r=""){const a=t?o:r;return a?`<p data-oq-switch-copy="${s(e)}" data-on-copy="${s(o)}" data-off-copy="${s(r)}">${s(a)}</p>`:""}function dh(e,t,o,r,a=""){if(!b(e))return"";const i=!!T(e),l=n.loadingEntities||n.busyAction===`switch-${e}`;return qe(e,t,o,`
        <div class="oq-settings-compact-switch-field">
          ${Dn(e,t,i,l)}
          ${r?`<p>${s(r)}</p>`:""}
        </div>
      `,a)}function rr(e,t,o){if(!b(e))return"";const r=!!T(e),a=n.loadingEntities||n.busyAction===`switch-${e}`;return`
    ...
    `}function Wt({active:e,startKey:t,stopKey:o,startLabel:r,stopLabel:a,startClass:i="oq-helper-button oq-helper-button--primary",stopClass:l="oq-helper-button oq-helper-button--ghost",startDisabled:d=!1,stopDisabled:u=!1}){return Ae(e?o:t,e?a:r,e?l:i,e?u:d)}function ph(e,t,o,r,a=""){if(!b(e))return"";const i=n.entities[e]||{},l=String(T(e)||""),d=un(i),u=n.loadingEntities||n.busyAction===`save-${e}`,c=`
      <div class="oq-settings-choice-grid">
        ${d.map(p=>{const f=r[p]||"",m=typeof f=="string"?f:f.copy||"",v=typeof f=="string"?"":f.image||"",q=typeof f=="string"?"":f.alt||"";return Ro({key:e,option:p,currentValue:l,busy:u,copy:m,image:v,imageAlt:q})}).join("")}
      </div>
    `;return qe(e,t,o,c,a)}function X(e,t,o,r="",a={}){if(!b(e))return"";const i=Ge(e),l=He(e),d=a.unitOverride||i.uom||"",u=a.showUnit!==!1&&!!d,c=u&&a.unitMode!=="outside",p=On({key:e,value:l,meta:i,controlClass:`oq-helper-control${u&&!c?" oq-helper-control--split":""}${c?" oq-helper-control--suffix":""}`,unitMarkup:u?c?`<span class="oq-helper-unit-chip">${s(d)}</span>`:`<span class="oq-helper-unit">${s(d)}</span>`:""});return qe(e,t,o,p,r,a.footerMarkup||"")}function rt(e,t,o,r="",a={}){if(!b(e))return"";const i=Ge(e),l=we(e,T(e)),d=a.minLabel||`${i.min}${i.uom||""}`,u=a.maxLabel||`${i.max}${i.uom||""}`,c=a.valueLabel||_(e,l);return qe(e,t,o,`<label class="oq-helper-slider-field"><div class="oq-helper-slider-meta"><span>${s(d)}</span><strong>${s(c)}</strong><span>${s(u)}</span></div><input class="oq-helper-range" type="range" data-oq-field="${s(e)}" min="${i.min}" max="${i.max}" step="${i.step}" value="${l}" ${n.loadingEntities?"disabled":""}></label>`,r)}function Ki(e,t,o,r={}){if(!b(e))return"";const a=Ge(e),i=He(e),l=r.compact===!0,d=r.embedded===!0,u=r.infoId||e,c=r.showCopy!==!1;return`
    ...
    `}function Ui(e,t,o,r=""){if(!b(e))return"";const a=hr(T(e));return qe(e,t,o,`<label class="oq-settings-control oq-settings-control--time"><input class="oq-helper-input oq-helper-input--time" type="time" step="60" lang="nl-NL" inputmode="numeric" data-oq-field="${s(e)}" value="${s(a)}" ${n.loadingEntities?"disabled":""}><span class="oq-settings-time-icon" aria-hidden="true"><svg viewBox="0 0 20 20" focusable="false"><circle cx="10" cy="10" r="6.5" fill="none" stroke="currentColor" stroke-width="1.6" /><path d="M10 6.2 V10 L12.9 11.8" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" /></svg></span></label>`,r||"oq-settings-field--time")}function ne(e,t,o,r,a=""){return`<section class="oq-settings-section"><div class="oq-settings-section-head"><div class="oq-settings-section-head-meta"><p class="oq-helper-label">${s(e)}</p>${a?`<div class="oq-settings-section-head-meta-badge">${a}</div>`:""}</div><h3>${s(t)}</h3><p>${s(o)}</p></div>${r}</section>`}function gh(){const e=xe.has(n.settingsGroup)?n.settingsGroup:ye[0].id;return`
    ...
    `:""}function Xl(){return`
      <div class="oq-settings-curve-grid">
        ...
        ${X("curveFallbackSupply","Fallback-aanvoertemperatuur zonder buitentemperatuur","Aanvoertemperatuur die gebruikt wordt als de buitentemperatuursensor niet beschikbaar is.","oq-settings-field--curve-fallback-card",{footerMarkup:fh()})}
      </div>
    ...
    `}function Ch(e){if(e.key!=="Tab"||e.altKey||e.ctrlKey||e.metaKey)return;const t=e.target&&e.target.closest?e.target.closest("input[data-oq-odu-runtime-tab-index]"):null,o=t?t.closest(".oq-settings-odu-runtime-table"):null;if(!t||!o)return;const r=Array.from(o.querySelectorAll("input[data-oq-odu-runtime-tab-index]:not(:disabled)")).sort((l,d)=>Number(l.dataset.oqOduRuntimeTabIndex||0)-Number(d.dataset.oqOduRuntimeTabIndex||0)),a=r.indexOf(t),i=r[a+(e.shiftKey?-1:1)];a<0||!i||(e.preventDefault(),i.focus(),typeof i.select=="function"&&i.select())}function Th(e){const t=ae(e,"Enable"),o=ae(e,"Load"),r=ae(e,"Apply"),a=ae(e,"Status"),i=String(T(a)||"").trim()||"Nog niet geladen",l=yh(e),d=qh(e),u=!!T(t),c=n.loadingEntities||n.busyAction===o||n.busyAction===r,p=c||!u||!l.valid||!d.safe||!b(r),f=l.valid?"Waarden zijn 0-120 Hz en per tabel oplopend.":`Controleer ${l.invalid.slice(0,5).join(", ")}${l.invalid.length>5?"...":""}.`;return`
    ...
    `}function Eh(){const e=vh();return e.length?`
    ...
    `}function oc(e="oq-settings-grid"){const t=$h();return`
      <div class="${s(e)}">
    ...
    `}function Ah(){if(!b("phResponseProfile"))return"";const e=String(T("phResponseProfile")||""),t=n.loadingEntities||n.busyAction==="save-phResponseProfile",r=`
    ...
    `;return qe("curveControlProfile","Regelprofiel","Kies of de stooklijn vooral comfortabel, gebalanceerd of rustig moet reageren.",r,"oq-settings-field--span-2")}function Hh(){const e=(L,V=0)=>{const P=M(L);return Number.isNaN(P)?V:Math.max(0,P)},o=e("phComfortBelow",.1),r=e("phComfortAbove",.3),a=e("phKp",3e3),i=20-o,l=20+r,d=620,u=184,c=46,p=24,f=18,m=40,v=96,q=d-c-p,h=Math.min(20-1.2,i-.35),y=Math.max(20+1.2,l+.35),w=L=>c+(L-h)/Math.max(.01,y-h)*q,S=w(h),$=w(y),k=w(i),H=w(20),R=w(l),F=Math.abs(i-20)>.001,U=Math.abs(l-20)>.001,C=f+24,E=u-m,N=v-44,I=(L,V,P,D="")=>{const ge=Math.max(S+4,Math.min($-110-4,L-55)),se=L-14,Y=N,Je=28,Se=v-N+16;return`
      ...
      <div class="oq-ph-concept-card">
        <div class="oq-ph-concept-visual">
          ...
          <svg class="oq-ph-concept-svg" viewBox="0 0 ${d} ${u}" role="img" aria-label="Grafiek voor Power House tuning">
            ...
            <rect x="${k.toFixed(1)}" y="${f}" width="${Math.max(20,R-k).toFixed(1)}" height="${(u-f-m).toFixed(1)}" rx="18" class="oq-ph-concept-band oq-ph-concept-band--calm"></rect>
            <rect x="${R.toFixed(1)}" y="${f}" width="${Math.max(20,$-R).toFixed(1)}" height="${(u-f-m).toFixed(1)}" rx="18" class="oq-ph-concept-band oq-ph-concept-band--above"></rect>
            ...
            ${U?I(R,"Comfort boven setpoint",x(l,1,"\xB0C"),"above"):""}
            ...
            ${U?`<text x="${R+5}" y="${u-14}" text-anchor="start" class="oq-ph-concept-tick-value">${s(x(l,1,"\xB0C"))}</text>`:""}
          </svg>
        </div>
    ...
    `:""}function Mh(){const e=bh();return ne("Installatie","Flowregeling","Kies hoe de pomp wordt geregeld en stel de flow-instellingen direct als installatieparameter in. De autotune vind je later bij Service & commissioning.",`
        ${tc()}
        ${e?`
          <div class="oq-settings-subpanel oq-settings-subpanel--nested">
            <div class="oq-settings-subpanel-head">
        ...
        `:""}
      `)}function z(e){return b(e)&&A(e)}function lt(e){return!b(e)||A(e)}function Qi(e){return b(e)?En(W(e,"None")):""}const Ph=new Set(["compressor oil return"]);function Nh(e){const t=En(e);return t==="Geen actieve storingen"?[]:t.split(",").map(o=>o.trim()).filter(o=>o&&!Ph.has(o.toLowerCase()))}function sc(e){const t=Nh(e);return t.length>0?t.join(", "):"Geen actieve storingen"}function kr(e){return b(e)?sc(W(e,"None")):""}function uo(e){const t=kr(e).trim().toLowerCase();return!!t&&t!=="geen actieve storingen"}function Oo(){const e=[],t=z("compressorCyclingWarning2h")||z("compressorCyclingWarning72h")||z("alternatingCompressorStartsWarning"),o=z("compressorCyclingAlertLatched"),r=lt("cicPollingEnabled"),a=lt("otEnabled"),i=(d,u)=>{z(d)&&e.push({key:d,label:u})};i("compressorCyclingWarning2h","Te veel compressorstarts in 2 uur"),i("compressorCyclingWarning72h","Te veel compressorstarts in 72 uur"),i("alternatingCompressorStartsWarning","Warmtepompen starten opvallend vaak om en om"),i("lowflowFaultActive","Te lage flow"),i("flowMismatch","Flowverschil tussen warmtepomp 1 en 2"),r&&i("cicDataStale","CIC-data is verouderd"),a&&i("otLinkProblem","OpenTherm-verbinding meldt een probleem"),uo("hp1Failures")&&e.push({key:"hp1Failures",label:`Warmtepomp 1: ${kr("hp1Failures")}`}),uo("hp2Failures")&&e.push({key:"hp2Failures",label:`Warmtepomp 2: ${kr("hp2Failures")}`});const l=e.length;return o&&!t&&e.unshift({key:"compressorCyclingAlertLatched",label:"Pendelen eerder gedetecteerd; melding nog niet bevestigd"}),{problems:e,active:e.length>0,cyclingAlertLatched:o,cyclingAlertActive:t,cyclingAlertRecovered:o&&!t,title:l>0?"Aandacht nodig":o?"Eerdere waarschuwing nog niet bevestigd":"Geen bijzonderheden",copy:l>0?`${e.length} aandachtspunt${e.length===1?"":"en"} zichtbaar. Bekijk hieronder de details.`:o?"Het pendelen is hersteld. De melding blijft zichtbaar totdat je haar bevestigt.":"OpenQuatt ziet op dit moment geen actieve aandachtspunten in de bewaakte signalen."}}function po(e,t="Aandacht",o="OK"){return`<span class="oq-settings-monitoring-badge${e?" is-warning":" is-clear"}">${s(e?t:o)}</span>`}function Dt({label:e,value:t,note:o="",active:r=!1}){return`
    ...
    `}function Zi(e,t){return b(`${t}CompressorStarts2h`)?`
      <div class="oq-settings-monitoring-compressor-unit">
        <div>
          <p>${s(e)}</p>
          <span>Laatste start: ${s(Lh(`${t}CompressorLastStartAge`))}</span>
        </div>
        <dl>
    ...
    `:""}function lc(e){const t=e.active?e.problems.map(o=>o.key).sort().join("|"):"";if(!t){n.installationMonitoringProblemSignature="";return}t!==n.installationMonitoringProblemSignature&&(n.installationMonitoringProblemSignature=t,n.installationMonitoringDetailsOpen=!0)}function Oh(){const e=Oo();lc(e);const t=lt("cicPollingEnabled"),o=lt("otEnabled"),r=[b("lowflowFaultActive")?Dt({label:"Flow",value:z("lowflowFaultActive")?"Te lage flow gemeld":"Geen lage-flowmelding",active:z("lowflowFaultActive")}):"",b("flowMismatch")?Dt({label:"Flowvergelijking duo",value:z("flowMismatch")?"Afwijking tussen warmtepompen":"Geen afwijking gemeld",active:z("flowMismatch")}):""].filter(Boolean).join(""),a=[b("cicDataStale")?Dt({label:"CIC-data",value:t?z("cicDataStale")?"Verouderd":"Geen probleem gemeld":"Polling uitgeschakeld",active:t&&z("cicDataStale")}):"",b("otLinkProblem")?Dt({label:"OpenTherm",value:o?z("otLinkProblem")?"Verbindingsprobleem":"Geen probleem gemeld":"Uitgeschakeld",active:o&&z("otLinkProblem")}):""].filter(Boolean).join(""),i=[b("hp1Failures")?Dt({label:"Warmtepomp 1",value:Qi("hp1Failures"),active:uo("hp1Failures")}):"",b("hp2Failures")?Dt({label:"Warmtepomp 2",value:Qi("hp2Failures"),active:uo("hp2Failures")}):""].filter(Boolean).join(""),l=M("compressorStarts2hWarningLimit"),d=M("compressorStarts72hWarningLimit"),u=z("compressorCyclingWarning2h")||z("compressorCyclingWarning72h")||z("alternatingCompressorStartsWarning")||e.cyclingAlertLatched,c=r?`
    ...
    `:"";return ne("Bewaking","Installatiebewaking","Lokale diagnose voor compressorstarts, hydrauliek en verbindingen. Hiervoor is geen Home Assistant nodig.",`
        ...
        <div class="oq-settings-monitoring-grid">
          ...
          <article class="oq-settings-monitoring-card">
            ...
            ${rt("compressorStarts72hWarningLimit","Alarmwaarde voor aantal starts per 72 uur","Aantal starts per warmtepomp binnen 72 uur.","oq-settings-field--compact",{minLabel:"1",maxLabel:"120",valueLabel:Number.isNaN(d)?"\u2014":`${Math.round(d)} starts / 72 uur`})}
          </article>
          ${p}
          </div>
          <div class="oq-settings-monitoring-column">
        ...
        `},{key:"manual-hp",title:"Handmatige warmtepompbediening",label:"Handmatige warmtepomp",summary:"Selecteer een werkmodus en vraag per warmtepomp een compressorstand aan binnen de bestaande bewaking.",status:ci,available:!!(Bn||n.entities.manualHpStatus),openDisabled:!i,cardMarkup:Ot({taskKey:"manual-hp",title:"Handmatige warmtepompbediening",copy:"Start eerst de service-taak zodat de waterpomp draait. Zodra voldoende flow is gemeten kun je per warmtepomp vanuit Standby naar verwarmen of koelen schakelen en daarna een compressorstand aanvragen.",subcopy:"Low-flow, maximale watertemperatuur, minimum draaitijd, minimum uit-tijd en veilige modusovergangen blijven actief. De koelvloer, silent-modus, dag/nacht-cap en normaal uitgesloten compressorstanden worden voor deze handmatige test bewust genegeerd.",status:ci,statusCopy:Le?ni?"De compressorvraag staat op 0. De waterpomp blijft draaien totdat de minimale draaitijd veilig is afgerond.":ti?"De bewaking heeft de aangevraagde standen teruggezet naar 0. Controleer de oorzaak voordat je opnieuw opschaalt.":"De service-taak is actief. Een veiligheidsstop zet de aangevraagde standen terug naar 0; opnieuw opschalen vereist een bewuste handeling.":i?"CM100 staat klaar. Start de taak om handmatige warmtepompbediening vrij te geven.":"Start CM100 eerst.",progressTask:"",actions:`
          ...
          `,metrics:`
            ...
            <div class="oq-settings-manual-hp-statuses">
              ...
              ${b("hp2Failures")?J("hp2Failures","Warmtepomp 2 statusmelding","Actuele melding die de warmtepomp zelf rapporteert.",En(W("hp2Failures","None")),"oq-settings-field--compact"):""}
            </div>
          `})},{key:"autotune",title:"Flow autotune",label:"Autotune",summary:"Berekent een voorstel voor de flowregeling en kan Kp/Ki daarna toepassen.",status:Qo,available:!0,openDisabled:vt(Qo),cardMarkup:Ot({taskKey:"autotune",title:"Flow autotune",copy:"Bereken een voorstel voor de flowregeling en pas dat daarna toe in de installatie-instellingen. Autotune duurt meestal ongeveer 5 tot 10 minuten.",subcopy:"Na toepassen worden de flow-instellingen bijgewerkt.",status:Qo,statusCopy:V?"Wacht totdat CM100 actief is voordat je autotune start.":D?"Autotune draait op dit moment.":i?"CM100 staat klaar. Start de autotune wanneer je wilt.":"Start CM100 eerst en voer daarna autotune uit.",progressTask:"autotune",actions:`
          ...
          `,metrics:`
            ${J("airPurgeRemaining","Resterende tijd","Ontluchten loopt maximaal 5 minuten.",zo,"oq-settings-field--compact")}
            ...
            ${dh("airPurgeReturnToAuto","Na afloop","","Service mode (CM100) afsluiten","oq-settings-field--span-2 oq-settings-field--compact")}
          `})}].filter(Au=>Au.available);return{cm100Status:Tu,cm100StartDisabled:c,cm100StopDisabled:p,serviceStatusCopy:Eu,tasks:$u}}function Fh(e){return`
    ...
    `}function xh(){const e=cc();return ne("Service","Service & commissioning","Gebruik de service-stand (controlmode CM100) voor testen, afstelling en onderhoudstaken.",`
        <div class="oq-settings-service-shell">
          ...
          <div class="oq-settings-system-summary oq-settings-service-task-list">
            ${e.tasks.map(t=>Fh(t)).join("")}
          </div>
        </div>
      `)}function Ih(){const e=String(n.systemModal||"").replace(/^service-task-/,""),o=cc().tasks.find(r=>r.key===e);return o?`
      <div class="oq-helper-modal-backdrop${n.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=n.entities.hpGeneration||{},o=String(T("hpGeneration")||""),r=un(t),a=n.loadingEntities||n.busyAction==="save-hpGeneration";return`
    ...
    `}function Wh(){const e=Nn(),t=n.entities.hpGeneration||{},o=b("hpGeneration")&&un(t).length>0;return!e&&!o?"":ne("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function uc(e="oq-settings-grid oq-settings-boiler-simple-grid"){if(!b("boilerCvAssistEnabled"))return"";const t=A("boilerCvAssistEnabled"),o=b("boilerRatedHeatPower"),r=Ge("boilerRatedHeatPower"),a=He("boilerRatedHeatPower"),i=n.loadingEntities||n.busyAction==="switch-boilerCvAssistEnabled",d=o?On({key:"boilerRatedHeatPower",value:a,meta:r,controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-boiler-power-control",unitMarkup:'<span class="oq-helper-unit-chip">W</span>'}):`
      ...
      `)}function jh(){if(!b("trendHistoryEnabled")&&!b("lifetimeEnergyHistoryEnabled"))return"";const e=A("trendHistoryEnabled"),t=e&&A("trendHistoryFlashEnabled"),o=e&&b("trendHistoryFlashAvailable"),r=b("lifetimeEnergyHistoryEnabled"),a=r&&A("lifetimeEnergyHistoryEnabled"),i=b("lifetimeEnergyHistoryAvailable"),l=o?te("trendHistoryFlashAvailable"):"Alleen live",d=i?Zl(te("lifetimeEnergyHistoryAvailable")):"Geen data";return ne("Diagnose","Opslagbeheer","Bekijk en beheer welke diagnose- en energiegegevens OpenQuatt bewaart.",`
        <article class="oq-settings-storage-summary">
          ...
          <div class="oq-settings-storage-summary-metrics" aria-label="Opslagstatus">
            ${b("trendHistoryEnabled")?tr("Live diagnose",e?"Aan":"Uit","Live",e):""}
            ${b("trendHistoryFlashEnabled")?tr("Diagnosehistorie",l,t?"Flash-geheugen":"Uit",t):""}
            ${r?tr("Energiehistorie",d,a?"Flash-geheugen":"Uit",a):""}
          </div>
      ...
      `)}function _h(){const e=b("trendHistoryEnabled")&&A("trendHistoryEnabled"),t=e&&b("trendHistoryFlashEnabled")&&A("trendHistoryFlashEnabled"),r=b("lifetimeEnergyHistoryEnabled")&&A("lifetimeEnergyHistoryEnabled"),a=b("lifetimeEnergyHistoryAvailable")?te("lifetimeEnergyHistoryAvailable"):"Geen data",i=b("lifetimeEnergyHistoryClear")&&a!=="Geen data"&&a!=="\u2014",l=b("trendHistoryFlashAvailable")?te("trendHistoryFlashAvailable"):"Geen geschiedenis",d=Zl(a),u=e&&b("trendHistoryFlush"),p=b("lifetimeEnergyHistoryCapture")||b("lifetimeEnergyHistoryClear"),f=[{key:"trendHistoryFlashAvailable",label:"Periode",note:"bewaard"},{key:"trendHistoryFlashSize",label:"Opslagruimte"},{key:"trendHistoryFlashWrites",label:"Schrijvingen"},{key:"trendHistoryFlashOldest",label:"Eerste meting"},{key:"trendHistoryFlashNewest",label:"Laatste meting"},{key:"trendHistoryFlashLastFlush",label:"Laatst vastgelegd"}],m=[{key:"lifetimeEnergyHistoryAvailable",label:"Dagen bewaard",value:d},{key:"lifetimeEnergyHistorySize",label:"Opslagruimte"},{key:"lifetimeEnergyHistoryWrites",label:"Schrijvingen"},{key:"lifetimeEnergyHistoryOldest",label:"Eerste dag"},{key:"lifetimeEnergyHistoryNewest",label:"Laatste dag"},{key:"lifetimeEnergyHistoryLastWrite",label:"Laatst vastgelegd"}];return`
      <div class="oq-helper-modal-backdrop${n.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
          ...
          <div class="oq-settings-storage-domain-grid">
            <section class="oq-settings-storage-domain oq-settings-storage-domain--trend">
              ...
              <div class="oq-settings-storage-domain-rows">
                ${nr("trendHistoryEnabled","Live diagnosegegevens","Bewaar recente meetpunten voor de Diagnose-grafieken.","Beschikbaar zolang de controller online is.","Nieuwe diagnosepunten worden niet bijgehouden.","Tijdelijk")}
                ${nr("trendHistoryFlashEnabled","Diagnosegeschiedenis bewaren","Bewaar diagnosegegevens ook na een update of herstart.","Wordt ongeveer elk uur vastgelegd.","Alleen live gegevens; bestaande geschiedenis blijft staan.",l)}
                ${u?`
                  <div class="oq-settings-storage-inline-action">
                    ...
                    ${or("trendHistoryFlush","Vastleggen","flush-trend-history",{disabled:!t,busyLabel:"Vastleggen..."})}
                  </div>
                `:""}
              </div>
              ${_i(f)}
            ...
            <section class="oq-settings-storage-domain oq-settings-storage-domain--energy">
              ...
              <div class="oq-settings-storage-domain-rows">
                ${nr("lifetimeEnergyHistoryEnabled","Dagtotalen bewaren","Bewaar dagtotalen zodat Resultaten over langere periodes beschikbaar blijven.","Wordt opgeslagen bij dagwissel en normale afsluiting.","Nieuwe dagtotalen worden niet bewaard; bestaande historie blijft staan.",d)}
                ${p?`
                  <div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--split">
                    ...
                    <div class="oq-settings-storage-action-stack">
                      ${or("lifetimeEnergyHistoryCapture","Vastleggen","save-lifetime-energy-history",{disabled:!r,busyLabel:"Vastleggen..."})}
                    </div>
                  </div>
                  <div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--danger">
                    ...
                    <div class="oq-settings-storage-action-stack">
                      ${or("lifetimeEnergyHistoryClear","Alles wissen","clear-lifetime-energy-history",{disabled:!i,buttonClass:"oq-helper-button oq-helper-button--warning",busyLabel:"Wissen..."})}
                    </div>
                  </div>
                `:""}
              </div>
    ...
    `}function Kh(){const e=ie()?`
      ...
      `;return ne("Regeling","Verwarmingsstrategie","Kies hier hoe OpenQuatt je verwarming regelt. De instellingen hieronder passen zich automatisch aan.",`
        ...
        ${rc()}
        ${e}
      `)}function Uh(){return ne("Beveiliging","Watertemperatuur","Beschermt het systeem tegen te hoge aanvoertemperaturen. OpenQuatt regelt richting deze grens terug en grijpt 5\xB0C erboven hard in.",oc())}function zh(){const e=b("otEnabled"),t=b("cicPollingEnabled")||b("cicFeedUrl"),o=b("cicCompatibilityMode"),r=b("otLinkProblem")||b("cicDataStale")||b("cicJsonFeedOk");if(!e&&!t&&!o&&!r)return"";const a=lt("cicPollingEnabled"),i=lt("otEnabled"),l=({label:q,value:h,active:y=!1})=>`
    ...
    `:"";return ne("Integratie","OpenTherm & CIC-polling","Configureer de directe thermostaatbus, externe CIC-feed en Quatt app-compatibiliteit.",`
      ...
      `:""},S=({label:C="HA input",valueKey:E="",validKey:N="",value:I=""})=>i(E,N)?[w({label:C,key:E,value:I}),w({label:"HA status",value:"Geldig"})]:[],$=(C,E={})=>{if(!b(C))return{markup:"",warning:""};const N=n.entities[C]||{},I=String(T(C)||""),L=un(N).filter(Q=>d(Q,E)),V=I&&!d(I,E),P=I==="HA input"&&E.keepUnavailableCurrent!==!0,j=(V&&!P&&!L.includes(I)?[I,...L]:L).map(Q=>{const ge=!d(Q,E),se=p(Q,E),Y=ge?`${se} (${u(Q,E)||"niet beschikbaar"})`:se;return`<option value="${s(Q)}" ${Q===I?"selected":""}>${s(Y)}</option>`}).join("");return{markup:`
        ...
        `,warning:V?`Huidige bron niet beschikbaar: ${u(I,E)}`:""}},k=({key:C,title:E,select:N,secondarySelect:I=null,secondarySelects:K=null,rows:L=[]})=>{const V=N&&N.when!==!1?$(N.key,N):{markup:"",warning:""},D=(Array.isArray(K)?K:I?[I]:[]).filter(Y=>Y&&Y.when!==!1).map(Y=>$(Y.key,Y)).filter(Y=>Y.markup),j=D.map(Y=>Y.markup).join(""),Q=D.map(Y=>Y.warning).find(Boolean)||"",ge=L.filter(Boolean).join(""),se=`${V.markup}${j}`;return!se&&!ge?"":`
      ...
      `)}function Yh(){return ne("Integratie","MQTT","Stel hier de broker in voor de experimentele, compacte publish-only telemetry-export van OpenQuatt.",`
      ...
      `)}function Jh(){const e=n.settingsBackupBusy;return`
      <div class="oq-helper-modal-backdrop${n.overviewTheme==="dark"?" oq-helper-modal-backdrop--dark":""}" data-oq-modal="system">
    ...
    `}function ef(){const e=Ln(),t=js(),o=n.busyAction==="restartAction";return ne("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
      ...
      `)}function tf(){const e=[Gi("Warmtepomp 1","hp1ExcludedA","hp1ExcludedB"),Gi("Warmtepomp 2","hp2ExcludedA","hp2ExcludedB")].filter(Boolean).join("");return ne("Installatie","Compressorinstellingen","Stel hier de minimale draaitijd in en bepaal per warmtepomp welke compressorstanden je wilt overslaan.",`
        <div class="oq-settings-subpanel">
          <div class="oq-settings-subpanel-head">
      ...
      `)}function nf(){return ne("Comfort","Stille uren","Kies wanneer het systeem stiller moet werken, en hoe ver het dan nog mag opschalen.",Na())}function of(){return Na("oq-settings-grid oq-settings-grid--modal")}function rf(){const e=[X("coolingMinimumSupplyTemp","Minimale koel-aanvoer","Ondergrens voor het koeldoel. OpenQuatt gebruikt de hoogste waarde van deze instelling en de dauwpuntveilige grens."),rt("coolingDemandMax","Maximale koelsterkte","Bepaalt hoe krachtig OpenQuatt mag koelen. Lager geeft langere, rustigere runs; hoger geeft meer koelvermogen bij warm weer.","",{minLabel:"Rustig",maxLabel:"Krachtig",valueLabel:`${_("coolingDemandMax")} max`}),X("coolingRestartDelta","Herstartmarge watertemperatuur","Na het bereiken van het koel-aanvoerdoel start de watercyclus pas opnieuw zodra de aanvoer deze marge boven het doel ligt."),X("coolingRequestOnDelta","Koelvraag start boven setpoint","Koelvraag wordt actief zodra de kamer warmer is dan setpoint plus deze marge."),X("coolingRequestOffDelta","Koelvraag stopt boven setpoint","Koelvraag valt weer af zodra de kamer koeler is dan setpoint plus deze marge."),X("coolingSafetyMargin","Dauwpunt veiligheidsmarge","Extra marge boven het geselecteerde dauwpunt voor de minimale veilige watertemperatuur.")].filter(Boolean),t=b("coolingWithoutDewPointMode"),o=[b("coolingGuardMode")?J("coolingGuardMode","Actieve beveiligingsroute","Laat zien of koeling nu via dauwpuntmeting, dauwpuntsbenadering of expliciet toestaan wordt begrensd.",W("coolingGuardMode","Onbekend")):"",b("coolingFallbackNightMinOutdoorTemp")?J("coolingFallbackNightMinOutdoorTemp","Nachtminimum buitentemperatuur","Minimum buitentemperatuur van de afgelopen nacht. Warme nachten maken de dauwpuntsbenadering conservatiever.",W("coolingFallbackNightMinOutdoorTemp","\u2014")):"",b("coolingFallbackMinSupplyTemp")?J("coolingFallbackMinSupplyTemp","Berekende minimum watertemperatuur","De conservatieve ondergrens die OpenQuatt gebruikt bij de dauwpuntsbenadering. Als die grens door warm weer hoger wordt dan zinvol is, houdt OpenQuatt rekening met de kamertemperatuur.",W("coolingFallbackMinSupplyTemp","\u2014")):"",b("coolingEffectiveMinSupplyTemp")?J("coolingEffectiveMinSupplyTemp","Actieve minimum ondergrens","De ondergrens die de koeling nu daadwerkelijk gebruikt: dauwpunt plus marge, dauwpuntsbenadering, of de ingestelde minimumgrens bij expliciet toestaan.",W("coolingEffectiveMinSupplyTemp","\u2014")):""].filter(Boolean);if(!e.length&&!t&&!o.length)return"";const r={"Dew point required":"Koel alleen als er een betrouwbare dauwpuntmeting beschikbaar is. Zonder dauwpuntmeting blijft koeling geblokkeerd.","Allow without dew point":"Gebruik een echte dauwpuntmeting als die beschikbaar is. Ontbreekt die, koel dan alleen via een conservatieve dauwpuntsbenadering.","Allow without dew point, use fallback":"Gebruik een echte dauwpuntmeting als die beschikbaar is. Ontbreekt die, koel dan alleen via een conservatieve dauwpuntsbenadering.","Allow without dew point, use dew point approximation":"Gebruik een echte dauwpuntmeting als die beschikbaar is. Ontbreekt die, koel dan alleen via een conservatieve dauwpuntsbenadering.","Allow without dew point, user responsibility":"Sta koeling expliciet toe zonder dauwpuntgrens. Ook een beschikbare dauwpuntmeting wordt dan genegeerd; alleen de ingestelde minimale koel-aanvoer geldt."};return ne("Koeling","Koelingsinstellingen","Stel hier in wanneer koelvraag ontstaat, hoe koud het water mag worden en hoeveel het water mag opwarmen voor herstart.",`
        ...
        ${t||o.length?`
          <div class="oq-settings-grid">
            ${t?ph("coolingWithoutDewPointMode","Keuze koelbeveiliging","Kies welke veiligheidsgrens OpenQuatt gebruikt: dauwpuntmeting, dauwpuntsbenadering bij ontbrekende meting, of expliciet toestaan zonder dauwpuntgrens.",r,"oq-settings-field--span-2"):""}
            ${t?`
        ...
        `:""}
      `)}function dc(){const o={top:22,right:18,bottom:38,left:34},r=560-o.left-o.right,a=240-o.top-o.bottom,i=ce[0].outdoor,l=ce[ce.length-1].outdoor,d=v=>o.left+(v-i)/(l-i)*r,u=v=>o.top+(70-v)/50*a,c=[20,30,40,50,60,70].map(v=>{const q=u(v);return`
    ...
    `}function lf(){const e=Oa(),t=n.busyAction==="quickstart-thermostat-source",o=e.status==="Geldig"?" is-active":"",r=e.isRemoteProfile?`
    ...
    `}function cf(){return!n.quickStartModalOpen||n.loadingEntities||n.complete===null||n.complete&&n.quickStartModalMode!=="generation"?"":n.quickStartModalMode==="generation"?`
      ...
      `:`
      <div class="oq-helper-modal-backdrop oq-helper-modal-backdrop--quickstart" data-oq-modal="quickstart-forced">
        <section class="oq-helper-modal oq-helper-modal--wide oq-helper-modal--quickstart" data-oq-quickstart-scroller data-oq-quickstart-step="${s(qf().id)}" role="dialog" aria-modal="true" aria-labelledby="oq-quickstart-modal-title">
          <div class="oq-helper-modal-head">
            <div>
    ...
    `}function fc(){return n.root?n.root.querySelector("[data-oq-quickstart-scroller]"):null}function uf(){const e=fc();return e?{stepId:String(e.dataset.oqQuickstartStep||""),scrollHeight:e.scrollHeight,scrollTop:e.scrollTop,stickToBottom:Ea(e)}:null}function df(e){if(!e)return;const t=fc();if(!t||String(t.dataset.oqQuickstartStep||"")!==e.stepId)return;if(e.stickToBottom){t.scrollTop=t.scrollHeight;return}const o=e.scrollTop+(t.scrollHeight-e.scrollHeight);t.scrollTop=Math.max(0,o)}function es(e,t=!0){if(!e)return;const o=Number(n.quickStartScrollRestoreToken||0)+1;n.quickStartScrollRestoreToken=o;const r=()=>{n.quickStartScrollRestoreToken!==o||!n.quickStartModalOpen||df(e)};if(t){window.requestAnimationFrame(r);return}r()}function ts(){return`
      <section class="oq-helper-panel">
    ...
    `}function vf(){return n.currentStep==="generation"?pc():n.currentStep==="boiler"?b("boilerCvAssistEnabled")?pf():ts():n.currentStep==="flow-source"?sf():n.currentStep==="thermostat-source"?lf():n.currentStep==="flow"?gf():n.currentStep==="heating"?mf():n.currentStep==="water"?hf():n.currentStep==="silent"?ff():n.currentStep==="confirm"?bf():ts()}function At(){return ho.filter(e=>!e.optionalEntity||b(e.optionalEntity))}function Be(e){const t=At().findIndex(o=>o.id===e);return`Stap ${Math.max(0,t)+1}`}function wf(e){const t=Do(),o=e===t,r=n.complete===!0||e<t;return{tone:o?"current":r?"done":"upcoming",label:o?"Actief":r?"Gereed":"Volgend",current:o}}function yf(e=!1){return At().map((t,o)=>{const r=wf(o);return`
        <button
      ...
      `}).join("")}function qf(){const e=At();return e.find(t=>t.id===n.currentStep)||e[0]||ho[0]}function Do(){return Math.max(0,At().findIndex(e=>e.id===n.currentStep))}function ns(e){const t=At(),o=Math.min(t.length-1,Math.max(0,Do()+e));n.currentStep=t[o]?.id||ho[0].id}function Ye(e={}){const t=Do(),o=At(),r=t>0?o[t-1]:null,a=t<o.length-1?o[t+1]:null;return`
    ...
    `}function Sf(){const e=Do(),t=At();return`
    ...
    `}function Cf({label:e,value:t,tone:o,note:r,status:a=!1}){return`
      <article class="oq-overview-stat oq-overview-stat--${s(o)}${a?" oq-overview-stat--status":""}">
        <p>${s(e)}</p>
        <strong>${s(t)}</strong>
        <span>${s(r)}</span>
      </article>
    `}function Fo(e,t=!1){return e.map(o=>Cf({...o,value:Object.prototype.hasOwnProperty.call(o,"key")?Oe(o.key):o.value,status:t})).join("")}function Da(e){return`
      <div class="oq-overview-sectionhead">
        <h3>${s(e)}</h3>
      </div>
    `}function bc(){const e=Oo();return`
    ...
    `}function wc(e,t){return t?"Actief":e==="Stand-by"?"Stand-by":e==="Onbekend"?"Onbekend":"Niet actief"}function Tf(e,t){const o=t?"active":"neutral",r=wc(e,t);return`<span class="oq-overview-chip oq-overview-chip--${s(o)}" data-oq-bind="panel-status">${s(r)}</span>`}function Ef(e){return`
      <span
    ...
    `}function Hf(e){return Number.isNaN(e)?"\u2014":`${e>0?"+":""}${e.toFixed(1)} \xB0C`}function x(e,t,o=""){const r=Number(e);return Number.isNaN(r)?"\u2014":`${r.toFixed(t)}${o?` ${o}`:""}`}function Mf(e){if(!Number.isFinite(e)||e<0)return"\u2014";const t=Math.floor(e),o=Math.floor(t/1440),r=Math.floor(t%1440/60),a=t%60;return o>0?`${o}d ${r}u`:r>0?`${r}u ${a}m`:`${a}m`}function Pf(e){const o=String(e||"").trim().match(/^(\d{1,2}):(\d{2})$/);if(!o)return Number.NaN;const r=Number(o[1]),a=Number(o[2]);return Number.isNaN(r)||Number.isNaN(a)||r<0||r>23||a<0||a>59?Number.NaN:r*60+a}function Nf(e){const t=Pf(W("timeNowHhmm",""));if(!Number.isFinite(t))return"";const o=Math.round(e),r=((t-o)%1440+1440)%1440,a=Math.floor(r/60),i=r%60;return`${String(a).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function Lf(e,t){const o=Math.max(0,(Number(t)-Number(e))/6e4),r=Mf(o),a=b("timeValid")&&A("timeValid")?Nf(o):"";return a?{value:a,note:`${r} geleden`}:{value:`${r} geleden`,note:"Geen tijdsync"}}function Rf(e){const t=Number(e);return Number.isNaN(t)?"\u2014":`${t>0?"+":t<0?"-":""}${Math.abs(t).toFixed(0)} W`}function qc(){return["outsideTempSelected","hp1OutsideTemp","hp2OutsideTemp"].find(e=>b(e))||""}function Of(){return["hp1WaterIn","hp2WaterIn"].find(e=>b(e))||""}function Sc(e=W("controlModeLabel","")){const t=String(e||"").toLowerCase();return t.includes("cm5")||t.includes("cooling")||t.includes("koeling")}function ht(){return Sc()}function kc(e,t){const o=String(e||"").trim().toLowerCase();return o==="waiting for room request"||o==="wacht op kamervraag"?!0:t?!1:o==="flow too low"||o==="flow te laag"||o==="flow unavailable"}function Cc(){return ht()?"Koeling":ie()?"Stooklijn":"Power House"}function Df(){const e=["phouseReq","strategyRequestedPower"];for(const t of e){const o=M(t);if(!Number.isNaN(o))return o}return Number.NaN}function Tc(){const e=Df(),t=M("phouseHouse"),o=M("totalHeat"),r=M("hpCapacity"),a=Number.isNaN(e)||Number.isNaN(t)?Number.NaN:e-t;let i="Nog aan het opbouwen",l="Zodra alle vermogens beschikbaar zijn, zie je hier hoe de warmtevraag is opgebouwd.";return!Number.isNaN(e)&&!Number.isNaN(r)&&e>r+150?(i="Capaciteit begrenst",l="De gevraagde warmtevraag ligt boven wat de warmtepomp nu ongeveer kan leveren."):!Number.isNaN(e)&&!Number.isNaN(o)&&o<e-250?(i="Levert minder dan gevraagd",l="De actuele warmteafgifte blijft nog onder de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(o)&&o>e+250?(i="Levert meer dan gevraagd",l="De actuele warmteafgifte ligt nu boven de gevraagde warmtevraag."):!Number.isNaN(e)&&!Number.isNaN(o)&&(i="In balans",l="Gevraagde warmtevraag en actuele levering liggen nu dicht bij elkaar."),{requestedText:x(e,0,"W"),houseText:x(t,0,"W"),correctionText:Rf(a),capacityText:Oe("hpCapacity"),statusTitle:i,statusCopy:l}}function Ec(){const e=M("curveSupplyTarget"),t=M("supplyTemp"),o=qc(),r=o?M(o):Number.NaN,a=Number.isNaN(e)||Number.isNaN(t)?Number.NaN:t-e,i=!!o&&Number.isNaN(r);let l="Stuurt op buitentemperatuur",d="De doelaanvoer volgt de huidige buitentemperatuur en vergelijkt die met de actuele aanvoer.";return i?(l="Fallback actief",d="De buitentemperatuur ontbreekt, dus de regeling valt terug op de ingestelde fallback-aanvoer."):!Number.isNaN(a)&&a<-1?(l="Nog onder doel",d="De actuele aanvoertemperatuur ligt nog onder de doelaanvoer."):!Number.isNaN(a)&&a>1?(l="Boven doel",d="De actuele aanvoertemperatuur ligt nu boven de doelaanvoer."):Number.isNaN(a)||(l="Dicht bij doel",d="De actuele aanvoertemperatuur sluit nu goed aan op de doelaanvoer."),{targetText:Oe("curveSupplyTarget"),supplyText:Oe("supplyTemp"),deltaText:Hf(a),capacityText:Oe("hpCapacity"),statusTitle:l,statusCopy:d}}function $c(){const e=M("supplyTemp"),t=W("coolingGuardMode",""),o=W("coolingFallbackNightMinOutdoorTemp","\u2014"),r=M("coolingSupplyError"),a=M("coolingDemandRaw"),i=A("coolingPermitted"),l=A("coolingRequestActive"),d=W("coolingBlockReason","Onbekend"),u=Jl(d),c=kc(d,l);let p="Wacht op koelvraag",f="Zodra er koelvraag is, zie je hier hoe de regeling de aanvoer richting het koeldoel stuurt.";return c?(p="Wacht op koelvraag",f="Koeling staat aan en wacht nog op actieve koelvraag vanuit de kamerregeling."):i?l?!Number.isNaN(a)&&a<=0?(p="Houdt doel vast",f="De koelvraag loopt nog, maar de compressor hoeft nu niet harder te werken."):!Number.isNaN(r)&&r>1?(p="Trekt aanvoer omlaag",f="De actuele aanvoertemperatuur ligt nog ruim boven het koeldoel."):!Number.isNaN(r)&&r>.2?(p="Benadert koeldoel",f="De regeling koelt nog door, maar zit al dicht bij de gewenste aanvoertemperatuur."):Number.isNaN(r)||(p="Koelt rustig door",f="De aanvoertemperatuur zit dicht bij het koeldoel en de regeling werkt nu op laag pitje."):(p="Koeling gereed",f="Koeling is toegestaan, maar wacht nog op actieve koelvraag vanuit de kamerregeling."):(p="Koeling geblokkeerd",f=`Blokkade: ${u}.`),{targetText:Oe("coolingSupplyTarget"),supplyText:Oe("supplyTemp"),safeFloorText:Oe("coolingEffectiveMinSupplyTemp"),guardMode:t,fallbackNightMin:o,demandText:Oe("coolingDemandRaw"),statusTitle:p,statusCopy:f,permitted:i,requestActive:l,blockReason:u,waitingForRoomRequest:c}}function Tr(){if(ht()){const t=$c(),o=t.guardMode.toLowerCase(),r=o.includes("user responsibility"),a=o.includes("fallback");return{title:"Koelregeling",copy:r?"Koeling draait expliciet zonder dauwpuntmeting of dauwpuntsbenadering. De ingestelde minimale koel-aanvoer blijft gelden.":"Koeling laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die bij de veilige grens zit.",focusLabel:"Koeldoel",focusValue:t.targetText,focusCopy:t.statusCopy,metrics:[{label:"Actuele aanvoertemperatuur",value:t.supplyText,tone:"orange",note:"Wat nu door het systeem loopt."},{label:r?"Ingestelde grens":a?"Berekende grens":"Veilige aanvoergrens",value:t.safeFloorText,tone:"blue",note:r?"Geen dauwpuntmeting of benadering; dit is de ingestelde minimale koel-aanvoer.":a?`Conservatieve dauwpuntsbenadering. Nachtminimum: ${t.fallbackNightMin}.`:"Dauwpunt plus veiligheidsmarge."},{label:"Koelvraag",value:t.demandText,tone:"sky",note:"De huidige koelvraag van de regelaar."}]}}if(ie()){const t=Ec();return{title:"Stooklijnregeling",copy:"De stooklijn laat zien op welke aanvoertemperatuur de regeling nu mikt en hoe dicht die al benaderd wordt.",focusLabel:"Doelaanvoer",focusValue:t.targetText,focusCopy:"De aanvoertemperatuur waar de regeling nu naartoe werkt.",metrics:[{label:"Actuele aanvoertemperatuur",value:t.supplyText,tone:"orange",note:"Wat nu wordt geleverd."},{label:"Afwijking doelaanvoer",value:t.deltaText,tone:"blue",note:"Verschil met het doel."},{label:"Beschikbare warmtecapaciteit",value:t.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}const e=Tc();return{title:"Vermogensbalans",copy:"Power House laat zien waar de warmtevraag nu vandaan komt en of de warmtepomp dat kan volgen.",focusLabel:"Gevraagd vermogen",focusValue:e.requestedText,focusCopy:"De warmtevraag waar Power House nu naartoe stuurt.",metrics:[{label:"Berekende huisvraag",value:e.houseText,tone:"blue",note:"Op basis van woning en buitentemperatuur."},{label:"Kamercorrectie",value:e.correctionText,tone:"orange",note:"Extra bijsturing rond setpoint."},{label:"Beschikbare warmtecapaciteit",value:e.capacityText,tone:"sky",note:"Bij huidige buitentemperatuur."}]}}function Ac(e){return vc({className:"oq-overview-system",title:e.title,copy:e.copy,signature:be(e),body:`
        ...
        <div class="oq-overview-metrics oq-overview-metrics--three-column">
          ${e.metrics.map(t=>Af(t.label,t.value,t.tone,t.note)).join("")}
        </div>
      `})}function Ff(){if(!A("openquattEnabled"))return{label:"Regeling nu",value:"Regeling tijdelijk uit",tone:"orange"};if(ht()){const r=$c(),a=r.waitingForRoomRequest?"neutral":r.permitted?r.statusTitle==="Koelt rustig door"||r.statusTitle==="Houdt temperatuur vast"?"green":r.statusTitle==="Koeling gereed"?"neutral":"sky":"orange";return{label:"Regeling nu",value:r.statusTitle,tone:a}}if(jb())return{label:"Regeling nu",value:"Stand-by",tone:"neutral"};const t=(ie()?Ec():Tc()).statusTitle;return{label:"Regeling nu",value:t,tone:t==="In balans"||t==="Dicht bij doel"?"green":t==="Nog aan het opbouwen"||t==="Stuurt op buitentemperatuur"?"neutral":"orange"}}function xf(){return A("openquattEnabled")?ht()?A("coolingPermitted")?A("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:W("coolingBlockReason","Koeling geblokkeerd"),tone:"orange"}:A("silentActive")?{label:"Systeem",value:"Stille uren actief",tone:"neutral"}:A("stickyActive")?{label:"Systeem",value:"Pompbescherming actief",tone:"neutral"}:{label:"Systeem",value:"Normaal",tone:"neutral"}:{label:"Systeem",value:"Vorstbeveiliging blijft actief",tone:"neutral"}}function Hc(e,t){const o=Ff(),r=xf();return[{label:"Strategie",value:e,tone:"orange",note:"regelstrategie"},{label:"Controlmode",value:t,tone:"orange",note:"actieve modus"},{label:"Regeling",value:o.value,tone:"orange",note:"wat OpenQuatt nu doet"},{label:"Systeem",value:r.value,tone:"orange",note:"actieve randvoorwaarde"}]}function Mc(e,t){const o=Hc(e,t);return`
    ...
    `:""}function Ft({className:e,action:t,label:o,busy:r=!1,loading:a=!1,attrs:i=""}){return`
      ...
      `:s(r?"Bezig...":o)}</button>
    `}function Bf(e){if(e.kind==="openquatt-control"){const t=n.busyAction==="openquatt-regulation",o=(n.loadingEntities||n.entitySyncInFlight)&&!b("openquattResumeAt");return A("openquattEnabled")?`<div class="oq-overview-controlpanel-actions">${Ft({className:"oq-overview-controlpanel-toggle",action:"open-openquatt-pause-modal",label:"Tijdelijk uitschakelen",busy:t})}</div>`:`
    ...
    `}function Nc(){const e=If();return e.length?`
    ...
    `:""}function Vf(e){const t=W("controlModeLabel");return`
    ...
    `}function Fa(){const e=qc(),t=Of();return ht()?{title:"Koeltemperaturen",copy:"De belangrijkste temperaturen voor kamercomfort, koeldoel en dauwpuntveiligheid.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},{label:"Koeldoel",key:"coolingSupplyTarget"},{label:"Veilige aanvoergrens",key:"coolingMinimumSafeSupplyTemp"},{label:"Dauwpunt",key:"coolingDewPointSelected"}]}:{title:"Temperaturen",copy:"De belangrijkste temperaturen voor comfort en regeling.",rows:[{label:"Kamertemperatuur",key:"roomTemp"},{label:"Kamer setpoint",key:"roomSetpoint"},{label:"Aanvoertemperatuur",key:"supplyTemp"},...t?[{label:"Retourtemperatuur",key:t}]:[],e?{label:"Buitentemperatuur",key:e}:{label:"Buitentemperatuur",key:"",value:"\u2014"}]}}function Lc(e=Fa()){return be({...e,values:e.rows.map(t=>t.value||W(t.key))})}function Rc(){const e=Fa();return vc({className:"oq-overview-temps",title:e.title,copy:e.copy,signature:Lc(e),body:`
        <div class="oq-overview-temps-list">
          ${e.rows.map(t=>Cr(t.label,t.key,t.value||"")).join("")}
        </div>
      `})}const os=360;function Ze(){const e=Vr(n.trendWindowHours||Kt);return e!==n.trendWindowHours&&jr(e),e}function Oc(e=Ze()){return Math.max(1,Number(e)||24)*60*60*1e3}function jf(e=Ze()){const t=Number(e)||24;return t>=72&&t%24===0?`${t/24}d`:`${t}u`}function xa(e=Ze()){const t=Number(e)||24;if(t>=72&&t%24===0){const o=t/24;return`${o} ${o===1?"dag":"dagen"}`}return`${t} uur`}function ar(e){if(!Number.isFinite(e))return"\u2014";const t=new Date(e);if(Number.isNaN(t.getTime()))return"\u2014";const o={day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"};try{return new Intl.DateTimeFormat("nl-NL",o).format(t)}catch{return t.toLocaleString("nl-NL",o)}}function _f(e){const t=String(e||"").trim().split("|");if(t.length<5)return null;const o=Number(t[0]);if(!Number.isFinite(o))return null;const r=a=>{const i=Number(a);return Number.isFinite(i)?i:null};return{t:o,outside:r(t[1]),supply:r(t[2]),room:t.length>=8?r(t[3]):null,roomSetpoint:t.length>=8?r(t[4]):null,flow:t.length>=8?r(t[5]):null,input:t.length>=8?r(t[6]):r(t[3]),output:t.length>=8?r(t[7]):r(t[4])}}function Er(){return!!(typeof window<"u"&&window.__OQ_DEV_CONTROLS__||typeof window<"u"&&window.__OQ_DEV_META)}function ir(e=Ze()){return typeof window>"u"||!window.__OQ_DEV_TREND_MOCKS__||typeof window.__OQ_DEV_TREND_MOCKS__.buildTrendPreviewSamples!="function"?[]:window.__OQ_DEV_TREND_MOCKS__.buildTrendPreviewSamples(e)}function Dc(){const e=Oc(),t=String(n.trendHistoryRaw||"").trim();if(!t)return Er()?ir():[];const o=t.split(/\r?\n/).map(_f).filter(Boolean),r=o.length?o[o.length-1].t:Number.NaN,a=Number.isFinite(n.trendHistoryNowMs)?n.trendHistoryNowMs:Number.isFinite(r)?r:Number.NaN;if(!Number.isFinite(a))return o.length?o.slice(-os):ir();const i=Math.max(0,a-e),l=o.filter(d=>d.t>=i).slice(-os);return l.length?l:Er()?ir(windowHours):[]}function Ia(){const e=Ze(),t=xa(e),o=Dc(),r=Er()&&o.length===0,a=ht();return[{id:"temperatures",title:"Temperaturen",copy:`Buiten- en aanvoertemperatuur van de laatste ${t}.`,tone:"orange",samples:o,mock:r,windowHours:e,series:[{id:"outside",sampleKey:"outside",currentKey:"outsideTempSelected",label:"Buiten",tone:"orange",decimals:1,unit:" \xB0C"},{id:"supply",sampleKey:"supply",currentKey:"supplyTemp",label:"Aanvoer",tone:"blue",decimals:1,unit:" \xB0C"}]},{id:"power",title:"Vermogen",copy:`Elektrisch vermogen en verwarmingsvermogen van de laatste ${t}.`,tone:"green",samples:o,mock:r,windowHours:e,series:[{id:"input",sampleKey:"input",currentKey:"totalPower",label:"Elektrisch vermogen",tone:"green",decimals:0,unit:" W"},{id:"output",sampleKey:"output",currentKey:a?"totalCoolingPower":"totalHeat",label:a?"Koelvermogen":"Verwarmingsvermogen",tone:"sky",decimals:0,unit:" W"}]},{id:"rendement",title:"Rendement",copy:`COP van de laatste ${t}.`,tone:"slate",samples:o,mock:r,windowHours:e,series:[{id:"cop",label:"COP",tone:"slate",decimals:1,unit:"",currentKey:a?"totalEer":"totalCop",derive:i=>{const l=Number(i?.input),d=Number(i?.output);return!Number.isFinite(l)||!Number.isFinite(d)||l<=0?Number.NaN:d/l}}]},{id:"comfort",title:"Comfort",copy:`Kamertemperatuur en setpoint van de laatste ${t}.`,tone:"blue",samples:o,mock:r,windowHours:e,series:[{id:"roomTemp",sampleKey:"room",currentKey:"roomTemp",label:"Kamertemperatuur",tone:"blue",decimals:1,unit:" \xB0C"},{id:"roomSetpoint",sampleKey:"roomSetpoint",currentKey:"roomSetpoint",label:"Kamer setpoint",tone:"orange",decimals:1,unit:" \xB0C"}]},{id:"flow",title:"Flow",copy:`Flow van de laatste ${t}.`,tone:"sky",samples:o,mock:r,windowHours:e,series:[{id:"flow",sampleKey:"flow",currentKey:"flowSelected",label:"Flow",tone:"sky",decimals:0,unit:" L/h",axisMin:0,axisTickStep:250}]}]}function Kf(e){const t=e.samples[e.samples.length-1]||null;return be({id:e.id,windowHours:e.windowHours,sampleCount:e.samples.length,firstTimestamp:e.samples[0]?.t||0,lastTimestamp:t?.t||0,trendSignature:n.trendHistorySignature||"",latestValues:t?[t.outside,t.supply,t.room,t.roomSetpoint,t.flow,t.input,t.output]:[]})}function kn(e,t){if(!e||!t)return Number.NaN;const o=typeof e.derive=="function"?e.derive(t):t?.[e.sampleKey],r=Number(o);return Number.isFinite(r)?r:Number.NaN}function Uf(e,t){const o=[];return e.forEach(r=>{t.forEach(a=>{const i=kn(a,r);Number.isFinite(i)&&o.push(i)})}),o.length?{min:Math.min(...o),max:Math.max(...o)}:{min:0,max:1}}function zf(e){if(!Number.isFinite(e)||e<=0)return 1;const t=Math.floor(Math.log10(e)),o=e/10**t;let r;return o<=1?r=1:o<=2?r=2:o<=5?r=5:r=10,r*10**t}function Gf(e,t){const o=Number.isFinite(e?.min)?e.min:0,r=Number.isFinite(e?.max)?e.max:1,a=Math.max(r-o,1),i=Array.isArray(t)?t.map(m=>Number(m?.axisMin)).find(m=>Number.isFinite(m)):Number.NaN,l=Array.isArray(t)?t.map(m=>Number(m?.axisMax)).find(m=>Number.isFinite(m)):Number.NaN,d=Array.isArray(t)?t.map(m=>Number(m?.axisTickStep)).find(m=>Number.isFinite(m)&&m>0):Number.NaN,u=Math.max(1,Number.isFinite(d)?d:zf(a/4)),c=[];if(Number.isFinite(i)||Number.isFinite(l)){const m=Number.isFinite(i)?i:0,v=Number.isFinite(l)?l:Math.ceil(r/u)*u,q=Math.floor(m/u)*u,h=Math.ceil(v/u)*u;for(let y=q;y<=h+u*.5;y+=u)c.push(y)}else{const m=a/u,v=m<=1.8?3:m<=4.25?5:7,q=Math.floor(v/2),h=(o+r)/2,y=Math.round(h/u)*u;for(let w=-q;w<=q;w+=1)c.push(y+w*u)}const p=c[0],f=c[c.length-1];return{ticks:c,axisMin:p,axisMax:f,axisDecimals:0}}function Fc(e,t,o={}){const r=Number(o.windowHours),a=Number.isFinite(r)?r:Ze(),i=Oc(a),l=640,d=220,u=46,c=18,p=18,f=34,m=l-u-c,v=d-p-f,q=e[e.length-1],h=!!o.mockData,y=h?i:Number.isFinite(n.trendHistoryNowMs)?n.trendHistoryNowMs:q?q.t:0,w=h?0:y-i,S=Math.max(y-w,1),$=S,k=Uf(e,t),H=k.min===k.max?{min:k.min-1,max:k.max+1}:{min:k.min-Math.max((k.max-k.min)*.12,1),max:k.max+Math.max((k.max-k.min)*.12,1)},R=Gf(k,t),F=L=>u+(L-w)/S*m,U=L=>{if(!Number.isFinite(L))return Number.NaN;const V=(L-H.min)/Math.max(H.max-H.min,1);return p+(1-Math.min(1,Math.max(0,V)))*v},C=[0,.5,1].map(L=>u+m*L),E=R.ticks.map(L=>U(L)),N=R.ticks.map((L,V)=>({x:u-10,y:E[V],text:x(L,R.axisDecimals)})),I=e.map(L=>{const V=F(L.t),P=t.map(D=>{const j=kn(D,L);return Number.isFinite(j)?{seriesId:D.id||D.sampleKey||D.label,tone:D.tone,label:D.label,decimals:D.decimals,unit:D.unit,value:j,x:V,y:U(j)}:null});return{sample:L,x:V,values:P}}),K=t.flatMap(L=>{const V=[];let P=[];return e.forEach(D=>{const j=kn(L,D);if(!Number.isFinite(j)){P.length&&(V.push(P),P=[]);return}P.push({x:F(D.t),y:U(j)})}),P.length&&V.push(P),V.map(D=>D.length<2?{tone:L.tone,points:D,path:""}:{tone:L.tone,points:D,path:D.map((j,Q)=>`${Q===0?"M":"L"} ${j.x.toFixed(1)} ${j.y.toFixed(1)}`).join(" ")})});return{width:l,height:d,left:u,right:c,top:p,bottom:f,plotWidth:m,plotHeight:v,latest:q,uptimeMs:$,endTime:y,startTime:w,span:S,windowHours:a,range:k,displayRange:H,gridXs:C,gridYs:E,yAxisLabels:N,points:I,tracks:K,series:t}}function Wa(){return be({windowHours:Ze(),trendSignature:n.trendHistorySignature||"",trendNowMs:Number.isFinite(n.trendHistoryNowMs)?n.trendHistoryNowMs:0,coolingActive:ht()})}function Qf(e){return Ia().find(t=>t.id===e)||null}function Yf(e,t){if(!e||!Array.isArray(e.points)||e.points.length===0)return-1;let o=0,r=Math.abs(e.points[0].x-t);return e.points.forEach((a,i)=>{const l=Math.abs(a.x-t);l<r&&(o=i,r=l)}),o}function Zf(e,t){const o=xc(e,t);return`
    ...
    `}function Xf(e){const t=e.samples[e.samples.length-1]||null,o=xa(e.windowHours);return`
      <article class="oq-overview-trendcard oq-overview-trendcard--${s(e.tone)}" data-oq-trend-card="${s(e.id)}" data-render-signature="${s(Kf(e))}">
        ...
        ${Jf(e.samples,e.series,e.mock,e.windowHours)}
    ...
    `}function tb(){const e=Ze(),t=Ns();return`
    ...
    `}function nb(){const e="overview-trends-history",t=n.settingsInfoOpen===e;return`
    ...
    `}function ob(){const e=rn(),o=Dc().length>0;return`
    ...
    `}function rb(){if(!n.root||n.appView!=="diagnosis")return!1;const e=n.root.querySelector(".oq-overview-board");if(!e)return!1;const t=e.querySelector(".oq-overview-trends");return t?(nt(t,Wa(),Ba()),Ic(e),ja(e),!0):!1}function Va(e){if(!e)return null;const t=e.__oqTrendHoverNodes;if(t&&t.chart&&t.hoverLayer&&t.hoverPanel)return t;const o=e.querySelector("[data-oq-trend-hover-layer]"),r={chart:e.querySelector(".oq-overview-trend-chart"),hoverLayer:o,hoverPanel:e.querySelector("[data-oq-trend-hover]"),hoverTime:e.querySelector("[data-oq-trend-hover-time]"),hoverNote:e.querySelector("[data-oq-trend-hover-note]"),hoverValues:e.querySelector("[data-oq-trend-hover-values]"),hoverLine:o?o.querySelector(".oq-overview-trend-hover-line"):null,hoverDots:{}};return o&&o.querySelectorAll("[data-oq-trend-hover-dot]").forEach(a=>{r.hoverDots[a.getAttribute("data-oq-trend-hover-dot")]=a}),e.__oqTrendHoverNodes=r,r}function rs(e,t,o,r=Va(e)){if(!e||!t||!Array.isArray(t.points)||t.points.length===0)return;const a=Math.max(0,Math.min(t.points.length-1,o)),i=t.points[a];if(!i||!r||!r.chart||!r.hoverLayer||!r.hoverPanel||!r.hoverTime||!r.hoverNote||!r.hoverValues)return;const l=String(a);if(!r.hoverPanel.hidden&&e.dataset.oqTrendHoverIndex===l)return;const d=Lf(i.sample.t,t.endTime);r.hoverPanel.hidden=!1,r.hoverLayer.removeAttribute("hidden"),r.hoverTime.textContent=d.value,r.hoverNote.textContent=d.note,r.hoverLine&&(r.hoverLine.setAttribute("x1",i.x.toFixed(1)),r.hoverLine.setAttribute("x2",i.x.toFixed(1)));const u=[];t.series.forEach(c=>{const p=kn(c,i.sample),f=c.id||c.sampleKey||c.label,m=r.hoverDots[f];if(!Number.isFinite(p)){m&&m.setAttribute("display","none");return}const v=i.values.find(q=>q.seriesId===f);m&&v&&(m.removeAttribute("display"),m.setAttribute("cx",v.x.toFixed(1)),m.setAttribute("cy",v.y.toFixed(1))),u.push(`
        <div class="oq-overview-trend-hover-row oq-overview-trend-hover-row--${s(c.tone)}">
          <span>${s(c.label)}</span>
          <strong>${s(x(p,c.decimals,c.unit))}</strong>
        </div>
      `)}),r.hoverValues.innerHTML=u.join(""),e.dataset.oqTrendHoverIndex=l}function ab(e){if(!e)return;const t=Va(e);t?.hoverPanel&&(t.hoverPanel.hidden=!0),t?.hoverLayer&&t.hoverLayer.setAttribute("hidden",""),delete e.dataset.oqTrendHoverIndex}function ja(e=n.root){if(!e)return;e.querySelectorAll("[data-oq-trend-card]").forEach(o=>{const r=o.dataset.renderSignature||"";if(o.__oqTrendBoundSignature===r)return;typeof o.__oqTrendCleanup=="function"&&o.__oqTrendCleanup(),o.__oqTrendHoverNodes=null,o.__oqTrendBoundSignature=r;const a=o.querySelector(".oq-overview-trend-chart");if(!a)return;const i=Qf(o.dataset.oqTrendCard);if(!i)return;const l=Fc(i.samples,i.series,{mockData:i.mock});o.__oqTrendModel=l;const d=Va(o);let u=0,c=null;const p=()=>{const v=c;c=null,u=0;const q=a.getBoundingClientRect();if(!q.width||!q.height)return;const h=Number(v?.clientX);if(!Number.isFinite(h)){rs(o,l,l.points.length-1,d);return}const w=Math.min(q.width,Math.max(0,h-q.left))/q.width*l.width,S=Yf(l,w);rs(o,l,S,d)},f=v=>{c=v,u||(u=window.requestAnimationFrame(p))},m=()=>{u&&(window.cancelAnimationFrame(u),u=0),c=null,ab(o)};a.addEventListener("pointermove",f),a.addEventListener("pointerenter",f),a.addEventListener("pointerleave",m),a.addEventListener("focus",f),a.addEventListener("blur",m),a.addEventListener("touchstart",f,{passive:!0}),o.__oqTrendCleanup=()=>{u&&(window.cancelAnimationFrame(u),u=0),c=null,a.removeEventListener("pointermove",f),a.removeEventListener("pointerenter",f),a.removeEventListener("pointerleave",m),a.removeEventListener("focus",f),a.removeEventListener("blur",m),a.removeEventListener("touchstart",f)}})}function ib([e,t]){const o=Nl(t);if(!b(t)&&Number.isNaN(o))return"";const r=Pl(t)?Oe(t):W(t);return`
      <div class="oq-overview-energy-row">
        <span>${s(e)}</span>
        <strong>${s(r)}</strong>
      </div>
    `}function sb(e){const t=e.rows.map(ib).filter(Boolean).join("");return t?`
    ...
    `:""}function lb(e){const t=e.groups.map(sb).filter(Boolean).join("");return t?`
    ...
    `:""}function cb(e){const t=e.categories.map(lb).filter(Boolean).join("");return t?`
    ...
    `:""}function _a(){const e=Iu.map(cb).filter(Boolean),t=["oq-overview-energy-grid",e.length===1?"oq-overview-energy-grid--single":"",e.length===2?"oq-overview-energy-grid--two":""].filter(Boolean).join(" ");return{renderedColumns:e,gridClassName:t}}function Wc(e=_a()){return be(e)}function Bc(e=_a()){return`
    ...
    `}const xo=["electricalInputWh","heatingInputWh","coolingInputWh","heatpumpHeatOutputWh","heatpumpCoolingOutputWh","boilerHeatOutputWh","systemHeatOutputWh"],Vc=[{id:"day",label:"Dag"},{id:"week",label:"Week"},{id:"month",label:"Maand"},{id:"year",label:"Jaar"},{id:"all",label:"Alles"}],ub=new Set(["day","week","month","year"]),db=["Zo","Ma","Di","Wo","Do","Vr","Za"];function Ee(e){const t=String(e||"").trim();return Vc.some(o=>o.id===t)?t:"day"}function as(e){const t=Ee(e);n.energyHistoryView!==t&&(n.energyHistoryView=t,g())}function xn(e){return ub.has(Ee(e))}function Io(){const e=new Date;return e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate()}function Ka(){const e=String(n.energyHistoryRaw||"");let t=null;return e.split(/\r?\n/).forEach(o=>{const r=Qc(o);r&&(t=r.dateKey)}),t}function pb(e=[],t=!0){const o=Ka(),r=(Array.isArray(e)?e:[]).map(a=>Number(a?.dateKey)).filter(Number.isFinite);return Number.isFinite(Number(o))&&r.push(Number(o)),t&&Vo().forEach(a=>{const i=Number(a?.dateKey);Number.isFinite(i)&&r.push(i)}),r.length?Math.max(...r):Io()}function Ie(e){return e.getFullYear()*1e4+(e.getMonth()+1)*100+e.getDate()}function jc(e,t,o){return new Date(e,t-1,o,12,0,0)}function gb(e,t){return new Date(e,t,0).getDate()}function is(e){return String(e).padStart(2,"0")}function sr(e){const t=Z(e);return t?`${t.year}-${is(t.month)}-${is(t.day)}`:""}function _c(e){const t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(String(e||"").trim());if(!t)return null;const o=Number(t[1]),r=Number(t[2]),a=Number(t[3]),i=jc(o,r,a);return i.getFullYear()!==o||i.getMonth()+1!==r||i.getDate()!==a?null:Z(Ie(i))}function Kc(e,t){return Number(e)*100+Number(t)}function $r(e){return Kc(e.getFullYear(),e.getMonth()+1)}function Cn(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return null;const o=Math.floor(t/100),r=t%100;return o<2020||r<1||r>12?null:{key:t,year:o,month:r,date:new Date(o,r-1,1,12,0,0)}}function mb(e){const t=String(e||"").trim(),o=/^(\d{4})-(\d{2})$/.exec(t);return Cn(o?Kc(Number(o[1]),Number(o[2])):t)}function Uc(e,t){const o=Cn(e);if(!o)return"";const r=new Date(o.year,o.month-1+Number(t||0),1,12,0,0);return String($r(r))}function Wo(e){const t=new Date(e.getTime()),o=t.getDay(),r=o===0?-6:1-o;return t.setDate(t.getDate()+r),t.setHours(12,0,0,0),t}function Tn(e,t){const o=new Date(e.getTime());return o.setDate(o.getDate()+t),o.setHours(12,0,0,0),o}function ss(e){return e.toLocaleDateString("nl-NL",{day:"numeric",month:"short"}).replace(/\./g,"")}function zc(e){const t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),o=(t.getUTCDay()+6)%7;t.setUTCDate(t.getUTCDate()-o+3);const r=t.getUTCFullYear(),a=new Date(Date.UTC(r,0,4)),i=(a.getUTCDay()+6)%7;return a.setUTCDate(a.getUTCDate()-i+3),{week:1+Math.round((t-a)/(10080*60*1e3)),year:r}}function ls(e){return Ie(Wo(e))}function hb(e){const o=_c(e)||Z(e);if(!o)return null;const r=Wo(o.date);return Z(Ie(r))}function Gc(e){const t=Z(e);if(!t)return"Week";const o=Wo(t.date),r=Tn(o,6);return`Week ${zc(o).week} (${ss(o)} - ${ss(r)})`}function Z(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return null;const o=Math.floor(t/1e4),r=Math.floor(t/100)%100,a=t%100;return o<2020||r<1||r>12||a<1||a>31?null:{key:t,year:o,month:r,day:a,date:new Date(o,r-1,a,12,0,0)}}function Ue(e,t="day"){const o=Z(e);return o?t==="weekday"?db[o.date.getDay()]||"":t==="month"?o.date.toLocaleDateString("nl-NL",{month:"short"}):t==="year"?String(o.year):o.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"short"}):"\u2014"}function bt(e){const t=M(e);return!Number.isFinite(t)||t<0?null:Math.round(t*1e3)}function fb(e){const t=Number(e);return Number.isFinite(t)&&t>=0?t:null}function Ua(e,t=0){const o={};return xo.forEach((r,a)=>{o[r]=fb(e[t+a])}),o}function bb(e){const t=String(e||"").trim();if(!t||t.startsWith("@"))return null;const o=t.split("|");if(o.length<10)return null;const r=Number(o[0]),a=Number(o[1]),i=Number(o[2]),l=Z(a);return!Number.isFinite(r)||!l?null:{sequence:r,dateKey:a,year:l.year,month:l.month,day:l.day,partial:!!(i&1),source:"flash",...Ua(o,3)}}function Qc(e){const t=String(e||"").trim();if(!t.startsWith("@current|"))return null;const o=t.split("|");if(o.length<9)return null;const r=Number(o[1]),a=Z(r);return a?{sequence:Number.MAX_SAFE_INTEGER,dateKey:r,year:a.year,month:a.month,day:a.day,partial:!0,source:"current",...Ua(o,2)}:null}function vb(e){const t=String(e||"").trim();if(!t.startsWith("@hour|"))return null;const o=t.split("|");if(o.length<11)return null;const r=Number(o[1]),a=Number(o[2]),i=Number(o[3]),l=Z(a);return!Number.isFinite(r)||!l||!Number.isInteger(i)||i<0||i>23?null:{sequence:r,dateKey:a,year:l.year,month:l.month,day:l.day,hour:i,partial:!0,source:"hour",label:String(i),tooltipLabel:`${String(i).padStart(2,"0")}:00 - ${String((i+1)%24).padStart(2,"0")}:00`,sortKey:a*100+i,...Ua(o,4)}}function wb(){const e=Ka()||Io(),t=Z(e);if(!t)return null;const o={sequence:Number.MAX_SAFE_INTEGER-1,dateKey:e,year:t.year,month:t.month,day:t.day,partial:!0,source:"sensors",electricalInputWh:bt("electricalEnergyDaily"),heatingInputWh:bt("heatingElectricalEnergyDaily"),coolingInputWh:bt("coolingElectricalEnergyDaily"),heatpumpHeatOutputWh:bt("heatpumpThermalEnergyDaily"),heatpumpCoolingOutputWh:bt("heatpumpCoolingEnergyDaily"),boilerHeatOutputWh:bt("boilerThermalEnergyDaily"),systemHeatOutputWh:bt("systemThermalEnergyDaily")};return xo.some(r=>Number.isFinite(o[r]))?o:null}function In(e,t){const o=Number(e?.[t]);return Number.isFinite(o)&&o>=0?o:0}function Bo(){const e=new Map;String(n.energyHistoryRaw||"").split(/\r?\n/).forEach(i=>{const l=bb(i)||Qc(i);if(!l)return;const d=e.get(l.dateKey);(!d||l.sequence>=d.sequence)&&e.set(l.dateKey,l)});const o=wb();o&&e.set(o.dateKey,o);const r=new Set(e.keys()),a=new Map;return Vo().forEach(i=>{if(r.has(i.dateKey))return;let l=a.get(i.dateKey);if(!l){const d=Z(i.dateKey);if(!d)return;l=wt({dateKey:d.key,year:d.year,month:d.month,day:d.day,label:Ue(d.key),sortKey:d.key,source:"hour-summary"}),l.tooltipLabel=`${Ue(i.dateKey)} \xB7 uurdata sinds herstart`,a.set(i.dateKey,l)}yt(l,i)}),a.forEach((i,l)=>{e.set(l,i)}),[...e.values()].sort((i,l)=>i.dateKey-l.dateKey)}function Vo(){const e=new Map;return String(n.energyHistoryRaw||"").split(/\r?\n/).forEach(o=>{const r=vb(o);if(!r)return;const a=`${r.dateKey}:${r.hour}`,i=e.get(a);(!i||r.sequence>=i.sequence)&&e.set(a,r)}),[...e.values()].sort((o,r)=>o.sortKey-r.sortKey)}function yb(e){return Vo().filter(t=>t.dateKey===Number(e))}function xt(e,t){return e.reduce((o,r)=>o+In(r,t),0)}function Yc(e){return["heatpumpHeatOutputWh","heatpumpCoolingOutputWh","boilerHeatOutputWh"].reduce((t,o)=>t+In(e,o),0)}function qb(e){return In(e,"electricalInputWh")+Yc(e)}function Xn(e,t){const o=Number(e),r=Number(t);return!Number.isFinite(o)||!Number.isFinite(r)||r<=0?"\u2014":(o/r).toFixed(2)}function Te(e,t=1){const o=Number(e);return Number.isFinite(o)?Math.abs(o)>=999500?`${(o/1e6).toFixed(2)} MWh`:Math.abs(o)<1e3?`${Math.round(o)} Wh`:`${(o/1e3).toFixed(t)} kWh`:"\u2014"}function wt({dateKey:e,year:t,month:o,day:r,hour:a=null,label:i,tooltipLabel:l="",sortKey:d,source:u="bucket"}){return{sequence:0,dateKey:e,year:t,month:o,day:r,hour:a,label:i,tooltipLabel:l,sortKey:d??e,partial:!1,source:u,electricalInputWh:0,heatingInputWh:0,coolingInputWh:0,heatpumpHeatOutputWh:0,heatpumpCoolingOutputWh:0,boilerHeatOutputWh:0,systemHeatOutputWh:0}}function yt(e,t){return xo.forEach(o=>{e[o]+=In(t,o)}),e.partial=e.partial||!!t?.partial,e.sequence=Math.max(Number(e.sequence||0),Number(t?.sequence||0)),e}function Sb(e){const t=new Map;return e.forEach(o=>{t.set(o.dateKey,o)}),t}function Zc(e,t){const o=Ee(e);if(o==="day"){const r=_c(t)||Z(t);return r?String(r.key):""}if(o==="week"){const r=hb(t);return r?String(r.key):""}if(o==="month"){const r=mb(t);return r?String(r.key):""}if(o==="year"){const r=Number(t);return Number.isInteger(r)&&r>=2020&&r<=2200?String(r):""}return""}function jo(e,t){const o=Ee(t),r=Z(pb(e,!0)),a=Vo(),i=[...e.map(m=>m.dateKey),...a.map(m=>m.dateKey)].filter(m=>Number.isFinite(Number(m))),l=i.length?Math.min(...i.map(Number)):r?.key,u=(l?Z(l):r)?.date||r?.date||new Date,c=r?.date||new Date;let p=r?.key||Io(),f=p;return o==="week"?(p=ls(u),f=ls(c)):o==="month"?(p=$r(u),f=$r(c)):o==="year"?(p=u.getFullYear(),f=c.getFullYear()):(p=Ie(u),f=Ie(c)),Number(p)>Number(f)&&(p=f),{min:String(p),max:String(f)}}function Jc(e,t){const o=Number(e);return Number.isFinite(o)?o<Number(t.min)?String(t.min):o>Number(t.max)?String(t.max):String(e):String(t.max)}function kb(e,t,o=jo(e,t)){const r=Ee(t),a=n.energyHistoryPeriodSelection?.[r],i=Zc(r,a);return Jc(i||o.max,o)}function Cb(e,t){const o=Ee(e),r=[];let a=0;if(o==="week"){let i=String(t.max);for(;Number(i)>=Number(t.min)&&a<6e3;){const l=Z(i);r.push({value:i,label:Gc(i),group:l?String(zc(l.date).year):""}),i=l?String(Ie(Tn(l.date,-7))):"",a+=1}return r}if(o==="month"){let i=String(t.max);for(;Number(i)>=Number(t.min)&&a<1200;){const l=Cn(i);if(!l)break;r.push({value:i,label:l.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"}),group:String(l.year)}),i=Uc(i,-1),a+=1}return r}if(o==="year")for(let i=Number(t.max);i>=Number(t.min);i-=1)r.push({value:String(i),label:String(i)});return r}function za(e,t){const o=Ee(t);if(!xn(o))return{view:o,selectedValue:"",minValue:"",maxValue:"",canPrevious:!1,canNext:!1,isNow:!0,options:[]};const r=jo(e,o),a=kb(e,o,r);return{view:o,selectedValue:a,minValue:r.min,maxValue:r.max,canPrevious:Number(a)>Number(r.min),canNext:Number(a)<Number(r.max),isNow:Number(a)===Number(r.max),options:Cb(o,r)}}function go(e,t){const o=Ee(e);if(!xn(o))return;const r=Bo(),a=jo(r,o),i=Zc(o,t),l=Jc(i||a.max,a);n.energyHistoryPeriodSelection={...n.energyHistoryPeriodSelection,[o]:l},g()}function cs(e,t){const o=Ee(e);if(!xn(o))return;const r=Bo(),a=za(r,o),i=Number(t)<0?-1:1;let l=a.selectedValue;if(o==="day"){const d=Z(a.selectedValue);l=d?String(Ie(Tn(d.date,i))):l}else if(o==="week"){const d=Z(a.selectedValue);l=d?String(Ie(Tn(d.date,i*7))):l}else o==="month"?l=Uc(a.selectedValue,i):o==="year"&&(l=String(Number(a.selectedValue)+i));go(o,l)}function us(e){const t=Ee(e);if(!xn(t))return;const o=Bo(),r=jo(o,t);go(t,r.max)}function Tb(e,t,o=za(e,t)){const r=Ee(t),a=Sb(e);if(!e.length&&r==="all")return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};if(r==="day"){const d=Z(o.selectedValue);if(!d)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const u=yb(d.key);if(u.length){const v=new Map(u.map(h=>[h.hour,h])),q=[];for(let h=0;h<24;h+=1){const y=String(h),w=`${d.date.toLocaleDateString("nl-NL",{day:"numeric",month:"long"})} \xB7 ${String(h).padStart(2,"0")}:00 - ${String((h+1)%24).padStart(2,"0")}:00`,S=wt({dateKey:d.key,year:d.year,month:d.month,day:d.day,hour:h,label:y,tooltipLabel:w,sortKey:h,source:"hour"}),$=v.get(h);$&&yt(S,$),q.push(S)}return{buckets:q,title:"Dag",detail:`${d.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 uurdata sinds herstart`}}const c=a.get(d.key),p=Ka()||Io(),f=d.key===p?"Vandaag":Ue(d.key),m=wt({dateKey:d.key,year:d.year,month:d.month,day:d.day,label:f,sortKey:d.key,source:"day"});return c&&yt(m,c),{buckets:[m],title:"Dag",detail:`${d.date.toLocaleDateString("nl-NL",{weekday:"long",day:"numeric",month:"long",year:"numeric"})} \xB7 dagtotaal`}}if(r==="week"){const d=Z(o.selectedValue);if(!d)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const u=Wo(d.date),c=[];for(let p=0;p<7;p+=1){const f=Tn(u,p),m=Ie(f),v=Z(m),q=wt({dateKey:m,year:v.year,month:v.month,day:v.day,label:Ue(m,"weekday"),sortKey:m}),h=a.get(m);h&&yt(q,h),c.push(q)}return{buckets:c,title:"Week",detail:Gc(o.selectedValue)}}if(r==="month"){const d=Cn(o.selectedValue);if(!d)return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const u=gb(d.year,d.month),c=[];for(let p=1;p<=u;p+=1){const f=jc(d.year,d.month,p),m=Ie(f),v=wt({dateKey:m,year:d.year,month:d.month,day:p,label:String(p),sortKey:m}),q=a.get(m);q&&yt(v,q),c.push(v)}return{buckets:c,title:"Maand",detail:d.date.toLocaleDateString("nl-NL",{month:"long",year:"numeric"})}}if(r==="year"){const d=Number(o.selectedValue);if(!Number.isInteger(d))return{buckets:[],title:"Geen data",detail:"Lifetime energiehistorie"};const u=[];for(let c=1;c<=12;c+=1){const p=d*1e4+c*100+1,f=wt({dateKey:p,year:d,month:c,day:1,label:Ue(p,"month"),sortKey:c,source:"month"});e.filter(m=>m.year===d&&m.month===c).forEach(m=>yt(f,m)),u.push(f)}return{buckets:u,title:"Jaar",detail:String(d)}}const i=new Map;e.forEach(d=>{i.has(d.year)||i.set(d.year,wt({dateKey:d.year*1e4+101,year:d.year,month:1,day:1,label:String(d.year),sortKey:d.year,source:"year"})),yt(i.get(d.year),d)});const l=[...i.values()].sort((d,u)=>d.sortKey-u.sortKey);return{buckets:l,title:"Alles",detail:l.length?`${l[0].label} - ${l[l.length-1].label}`:"Geen data"}}function Eb(e){const t=xt(e,"heatpumpHeatOutputWh"),o=xt(e,"heatpumpCoolingOutputWh"),r=xt(e,"boilerHeatOutputWh");return{electricalInputWh:xt(e,"electricalInputWh"),heatingInputWh:xt(e,"heatingInputWh"),coolingInputWh:xt(e,"coolingInputWh"),heatOutputWh:t,coolingOutputWh:o,boilerOutputWh:r,outputWh:t+o+r}}function $b(e){const t=Number(e.heatOutputWh||0)+Number(e.coolingOutputWh||0),o=Number(e.boilerOutputWh||0),r=t+o;return!Number.isFinite(r)||r<=0?Number.NaN:t/r*100}function zn(e,t,o=""){return`
      <div class="oq-energy-history-stat">
        <span>${s(e)}</span>
        <strong>${s(t)}</strong>
        ${o?`<p>${s(o)}</p>`:""}
      </div>
    `}function lr(e,t,o){const r=[];o.forEach(i=>{const l=String(i.group||"");let d=r[r.length-1];(!d||d.label!==l)&&(d={label:l,options:[]},r.push(d)),d.options.push(i)});const a=r.some(i=>i.label)?r.map(i=>i.label?`
    ...
    `}function ds(e){return e.view==="day"?`
        <label class="oq-energy-history-period-field">
          ...
          <input
            class="oq-energy-history-period-input"
            type="date"
            value="${s(sr(e.selectedValue))}"
            min="${s(sr(e.minValue))}"
            max="${s(sr(e.maxValue))}"
            data-oq-energy-history-period-input="day"
          >
        </label>
      `:e.view==="week"?lr(e,"Week",e.options):e.view==="month"?lr(e,"Maand",e.options):e.view==="year"?lr(e,"Jaar",e.options):`
      <div class="oq-energy-history-period-field oq-energy-history-period-field--static">
        <span>Periode</span>
        <strong>Volledig bereik</strong>
      </div>
    `}function Ab(e){return xn(e.view)?`
    ...
    `:`
      ...
      `}function Hb(){const e=document.activeElement;return!!(e&&e.closest&&e.closest(".oq-energy-history-period"))}function Mb(e){return`
    ...
    `}function Pb(e){const t=Number(e.electricalInputWh||0),o=Number(e.heatOutputWh||0),r=Number(e.coolingOutputWh||0),a=Number(e.boilerOutputWh||0),i=a>0?"boiler":"boiler-zero",l=Math.max(1,t+o+r+a),d=c=>`${Math.max(0,Number(c||0)/l*100).toFixed(2)}%`,u=$b(e);return`
    ...
    `}function Nb(e){const t=Math.max(1,Number(e||0)/1e3),o=Math.pow(10,Math.floor(Math.log10(t))),r=t/o;return(r<=1.5?1.5:r<=3?3:r<=6?6:10)*o*1e3}function Lb(e){const t=Number(e);return Number.isFinite(t)?t>=999500?`${Number((t/1e6).toFixed(1))}`:`${Number((t/1e3).toFixed(1))}`:""}function Rb(e){return e>=999500?"MWh":"kWh"}function Ob(e){const c=Math.max(1e3,...e.map(qb)),p=Nb(c),f=e.length?1218/e.length:1218,m=Math.max(6,Math.min(38,f*.68));return{width:1280,height:260,left:44,right:18,top:26,bottom:38,plotWidth:1218,plotHeight:196,axisMax:p,barSlot:f,barWidth:m,yOf:q=>26+(1-Math.min(1,Math.max(0,Number(q||0)/p)))*196}}function Db(e){const t=Xn(e.heatpumpHeatOutputWh,e.heatingInputWh),o=Xn(e.heatpumpCoolingOutputWh,e.coolingInputWh),r=Xn(Yc(e),e.electricalInputWh);return[e.tooltipLabel||e.label||Ue(e.dateKey),`Elektrisch: ${Te(e.electricalInputWh,1)}`,`Warmtepomp warmte: ${Te(e.heatpumpHeatOutputWh,1)}`,`Warmtepomp koeling: ${Te(e.heatpumpCoolingOutputWh,1)}`,`Cv-ketel: ${Te(e.boilerHeatOutputWh,1)}`,`COP verwarmen: ${t}`,`EER koelen: ${o}`,`Output / elektrisch: ${r}`].join(`
`)}function Fb(e){if(!e.length)return`
      ...
      `;const t=Ob(e),o=Rb(t.axisMax),r=[0,.25,.5,.75,1].map(i=>t.axisMax*i),a=e.map((i,l)=>{const d=t.left+t.barSlot*l+t.barSlot/2,u=[{key:"electricalInputWh",className:"input",label:"Verbruikte elektriciteit"},{key:"heatpumpHeatOutputWh",className:"heat",label:"Warmte door warmtepomp"},{key:"heatpumpCoolingOutputWh",className:"cooling",label:"Koeling warmtepomp"},{key:"boilerHeatOutputWh",className:"boiler",label:"Cv-ketel"}];let c=t.height-t.bottom;const p=u.map(q=>{const h=In(i,q.key);if(h<=0)return"";const y=h/t.axisMax*t.plotHeight;return c-=y,`
        ...
        `}).join(""),m=e.length<=12||l===0||l===e.length-1||l%3===0?`<text x="${d.toFixed(1)}" y="${t.height-18}" text-anchor="middle" class="oq-energy-history-axis-label">${s(i.label||Ue(i.dateKey))}</text>`:"",v=Db(i);return`
      ...
      <svg class="oq-energy-history-chart" viewBox="0 0 ${t.width} ${t.height}" role="img" aria-label="Energiehistorie">
        ...
        ${r.map(i=>{const l=t.yOf(i);return`
            ...
            <text x="${t.left-10}" y="${l.toFixed(1)}" text-anchor="end" dominant-baseline="middle" class="oq-energy-history-axis-label">${s(Lb(i))}</text>
          `}).join("")}
        ${a}
      </svg>
    `}function xb(e=null){const t=Number(e?.boilerOutputWh||0)>0?"boiler":"boiler-zero";return`
    ...
    `}function Ga(){const e=Bo(),t=Ee(n.energyHistoryView),o=za(e,t),r=Tb(e,t,o),a=Eb(r.buckets);return{records:e,buckets:r.buckets,viewModel:r,periodControl:o,summary:a,activeView:t}}function Xc(e=Ga()){return be({energyHistorySignature:n.energyHistorySignature||"",energyHistoryError:n.energyHistoryError||"",activeView:e.activeView,periodView:e.periodControl.view,periodValue:e.periodControl.selectedValue,periodMin:e.periodControl.minValue,periodMax:e.periodControl.maxValue,recordCount:e.records.length,bucketCount:e.buckets.length,latestDate:e.records[e.records.length-1]?.dateKey||0,currentValues:xo.map(t=>e.buckets[e.buckets.length-1]?.[t]??null)})}function eu(e=Ga()){const t=e.summary,o=e.buckets[0]?.dateKey?Ue(e.buckets[0].dateKey):"\u2014",r=e.buckets[e.buckets.length-1]?.dateKey?Ue(e.buckets[e.buckets.length-1].dateKey):"\u2014";return`
    ...
    `;const i=o.getBoundingClientRect();r.classList.add("is-visible");const l=r.getBoundingClientRect(),d=Math.min(Math.max(8,e.clientX-i.left+14),Math.max(8,i.width-l.width-8)),u=Math.min(Math.max(8,e.clientY-i.top-l.height-12),Math.max(8,i.height-l.height-8));r.style.transform=`translate(${d.toFixed(0)}px, ${u.toFixed(0)}px)`}function Ib(){return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(n.overviewTheme)}">
          <div class="oq-overview-head">
          <div>
    ...
    `}function Bb(){if(!n.root||n.appView!=="energy")return!1;const e=n.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-overview-energy"):null;if(!e||!t)return!1;const o=`oq-overview-board oq-overview-board--${n.overviewTheme}`;e.className!==o&&(e.className=o);const r=_a();return nt(t,Wc(r),Bc(r))}function Vb(){if(!n.root||n.appView!=="results")return!1;const e=n.root.querySelector(".oq-overview-board"),t=e?e.querySelector(".oq-energy-history"):null;if(!e||!t)return!1;const o=`oq-overview-board oq-overview-board--${n.overviewTheme}`;e.className!==o&&(e.className=o);const r=Ga(),a=Hb();return(a?!1:nt(t,Xc(r),eu(r)))||a}function Qa(e,t,o){const r=ou(W(t.mode,"Unknown")),a=A(t.defrost),i=En(W(t.failures,"None")),l=sc(i),d=r==="Verwarmen"||r==="Koelen"||a;return{mode:r,defrostActive:a,failures:i,warningFailures:l,running:d,thermalKey:r==="Koelen"?t.cooling:t.heat,schematic:Zb(e,t,o,r,a,l,d)}}function tu(e,t=null){return`<h3>${s(e)}</h3>${t?`<button class="oq-overview-hp-card-action" type="button" data-oq-action="select-hp-layout" data-hp-layout="${s(t.layout)}">${ov(t.layout==="equal"?"minus":"plus")}<span>${s(t.label)}</span></button>`:""}`}function Ar(e,t,o,r){return`<div class="oq-overview-hp-status">${yc(e,t,o,r)}</div>`}function jb(){return W("controlModeLabel","").toLowerCase().includes("standby")}function _b(e,t){return t?"ontdooit":e==="Verwarmen"?"verwarmt":e==="Koelen"?"koelt":e==="Stand-by"?"stand-by":"onbekend"}function nu(e){return!Array.isArray(e)||e.length===0?"":`<p class="oq-overview-hp-summary">${s(e.map(t=>`${t.title} ${_b(ou(W(t.keys.mode,"Unknown")),A(t.keys.defrost))}`).join(", "))}</p>`}function Kb(e){const t=n.entities[e];if(!t)return"Positie: \xE2\u20AC\u201D";const o=M(e);return Number.isNaN(o)?`Positie: ${W(e)}`:`Positie: ${x(o,0,t.uom||"")}`}function Ub(e){return b(e)?`Positie: ${A(e)?"Koelen/Defrost":"Verwarmen"}`:"Positie: \xE2\u20AC\u201D"}function ou(e){const t=String(e||"").trim();return!t||t==="Unknown"?"Onbekend":t==="Standby"?"Stand-by":t==="Heating"?"Verwarmen":t==="Cooling"?"Koelen":t}function En(e){const t=String(e||"").trim();return!t||t==="None"?"Geen actieve storingen":t}function Hr(e,t,o,r=!0,a="default"){return`
    ...
    `}function zb(e,t,o){return e==="temperature"?`
        <svg
    ...
    `}function Mr({bind:e,x:t,y:o,width:r,value:a,label:i,ariaLabel:l="",align:d="start"}){const u=l||`${i} temperatuur ${a}`,c=d==="end",p=d==="center",f=p?"middle":c?"end":"start",m=p?t+r/2:c?t+r-2:t+2;return`
      <g
    ...
    `}function Gb({tooltip:e,...t}){return`${Mr(t)}${$n({bind:t.bind,...e})}`}function Qb({bind:e,ariaLabel:t,x:o,y:r,width:a,height:i,rx:l,tooltip:d}){return`
      ...
      <div class="${s(e.boardClass)}" data-oq-hp-board="${s(e.title)}">
        <div class="oq-hp-tech-shell">
          <div class="oq-hp-tech-visual">
            ...
            ${Object.entries(e.pipes).map(([c,p])=>Hr(c.replace(/[A-Z]/g,f=>`-${f.toLowerCase()}`),p.tone,p.d,p.animated,p.flowVariant)).join("")}
    ...
    `}function ru(e,t,o,r="normal",a=null){if(!b(t.power))return"";const i=Qa(e,t,o),{mode:l,defrostActive:d,running:u,thermalKey:c}=i,p=i.schematic;return n.hpVisualMode==="schematic"?`
        <section class="oq-overview-hp oq-overview-hp--${s(o)} oq-overview-hp--${s(r)}" data-oq-hp-panel="${s(e)}">
          <div class="oq-overview-hp-head">
            ...
            <div class="oq-overview-hp-head-side">
              ${Ar(l,u,p.warningActive,p.failureText)}
            </div>
          </div>
          ${Jb(p)}
        </section>
    ...
    `}function Pr(){if(!Ya())return"";const e=_o();return n.hpVisualMode!=="schematic"?nv(e):`
          ...
          <div class="oq-boiler-card-main">
            ...
            <div class="oq-boiler-mini-schematic">
              <svg class="oq-boiler-mini-svg" viewBox="0 0 420 132" role="img" aria-label="Schematische weergave CV-ketel of boiler">
                ...
                ${Hr("boiler-return","return","M24 88 H166 C180 88 190 80 196 68",!0,"water")}
                ${Hr("boiler-supply","supply","M224 52 C232 40 244 36 258 36 H396",!0,"water")}
                ...
                ${Mr({bind:"boiler-return",x:22,y:70,width:78,value:e.returnTempText,label:"Retour",ariaLabel:`Retour ${e.returnTempText}`,align:"start"})}
                ...
                ${Mr({bind:"boiler-supply",x:320,y:16,width:76,value:e.supplyTempText,label:"Aanvoer",ariaLabel:`Aanvoer ${e.supplyTempText}`,align:"end"})}
    ...
    `}function au(){const e=typeof de=="function"?de():"";return Ru.filter(t=>e==="single"&&t.title==="HP2"?!1:b(t.keys.power))}function Ja(e){return!Array.isArray(e)||e.length<2||n.hpVisualMode!=="schematic"?"equal":n.hpLayoutMode==="focus-hp1"||n.hpLayoutMode==="focus-hp2"?n.hpLayoutMode:"equal"}function mo(e,t,o){return!Array.isArray(t)||t.length<2?"normal":o==="focus-hp1"?e===0?"focus":"muted":o==="focus-hp2"?e===1?"focus":"muted":"normal"}function Nr(e,t,o){return!Array.isArray(t)||t.length<2||n.hpVisualMode!=="schematic"?null:mo(e,t,o)==="focus"?{layout:"equal",label:"Toon beide"}:{layout:e===0?"focus-hp1":"focus-hp2",label:"Vergroot"}}function iu(e){return!Array.isArray(e)||e.length!==1?Ja(e):Ya()?"equal":"single"}function ov(e="plus"){return`
    ...
    `}function rv(e,t){if(!e)return!1;const o=e.querySelector(".oq-overview-hp-tools-copy"),r=e.querySelector('[data-hp-visual="schematic"]'),a=e.querySelector('[data-hp-visual="compact"]');return!o||!r||!a?(at(e,su(t)),!0):(at(o,`
      <h3>Warmtepompen</h3>
      ${nu(t)}
    `),r.classList.toggle("is-active",n.hpVisualMode==="schematic"),a.classList.toggle("is-active",n.hpVisualMode==="compact"),!0)}function av(){const e=Cc(),t=au(),o=Ja(t),r=iu(t),a=su(t);return`
      <section class="oq-helper-panel oq-helper-panel--flush">
        <div class="oq-overview-board oq-overview-board--${s(n.overviewTheme)}">
          ${bc()}
          ${Vf(e)}
          ...
          <div class="oq-overview-hp-grid oq-overview-hp-grid--${s(r)}">
            ${t.map((i,l)=>ru(i.title,i.keys,i.accent,mo(l,t,o),Nr(l,t,o))).join("")}
            ${Pr()}
          </div>
        </div>
      </section>
    `}function iv(e,t,o){if(!e)return;const r=e.querySelector(t);r&&r.textContent!==o&&(r.textContent=o)}function at(e,t){e&&e.innerHTML!==t&&(e.innerHTML=t)}function nt(e,t,o){return!e||e.dataset.renderSignature===t?!1:(e.outerHTML=o,!0)}function Vt(e,t,o){e&&e.getAttribute(t)!==o&&e.setAttribute(t,o)}function sv(e,t){t.forEach(([o,r])=>{iv(e,`[data-oq-bind="${o}"]`,r)})}function lv(e,t){t.forEach(([o,r])=>{Vt(e.querySelector(`[data-oq-bind="${o}"]`),"aria-label",r)})}function cv(e,t,o,r=""){const a=e.querySelector(`[data-oq-bind="${t}"]`);a&&(a.classList.toggle("is-active",o),Vt(a,"tabindex",o?"0":"-1"),!o&&r&&Ko(e.querySelector(`[data-oq-bind="${r}"]`)))}function uv(e,t,o){Vt(e.querySelector(`[data-oq-bind="${t}"]`),"fill",o)}function An(e,t,o,r){if(!e)return;const a=`${t}${o}`;r.map(l=>`${t}${l}`).find(l=>e.classList.contains(l))!==a&&(r.forEach(l=>e.classList.remove(`${t}${l}`)),e.classList.add(a))}function dv(e,t,o,r){const a=e.querySelector(`[data-oq-pipe="${t}"]`);a&&(An(a,"oq-hp-tech-pipe--",o,["supply","return","hotgas","liquid","expansion","suction"]),a.querySelectorAll("path").forEach(i=>{i.getAttribute("d")!==r&&i.setAttribute("d",r)}))}function Ko(e){e&&(e.classList.remove("is-active"),e.setAttribute("aria-hidden","true"))}function gs(e,t,o){!e||!t||!o||(e.querySelectorAll(".oq-hp-tech-tooltip.is-active").forEach(r=>{r!==o&&Ko(r)}),t.appendChild(o),o.classList.add("is-active"),o.setAttribute("aria-hidden","false"))}function pv(e,t,o,r){if(!e||!t||!o||!r||o.dataset.oqTooltipWired==="true")return;o.dataset.oqTooltipWired="true";const a=()=>{o.matches(":hover")||document.activeElement===o||Ko(r)};o.addEventListener("mouseenter",()=>gs(e,t,r)),o.addEventListener("mouseleave",a),o.addEventListener("focus",()=>gs(e,t,r)),o.addEventListener("blur",a)}function lu(e){if(!e)return;const t=e.querySelector(".oq-hp-tech-svg");if(!t)return;let o=t.querySelector(".oq-hp-tech-tooltip-layer");o||(o=document.createElementNS("http://www.w3.org/2000/svg","g"),o.setAttribute("class","oq-hp-tech-tooltip-layer"),t.appendChild(o)),Array.from(t.querySelectorAll(".oq-hp-tech-tooltip")).forEach(r=>{o.appendChild(r)}),e.querySelectorAll("[data-oq-tooltip-target]").forEach(r=>{const a=r.getAttribute("data-oq-tooltip-target");if(!a)return;const i=e.querySelector(`[data-oq-bind="${a}-tooltip"]`);pv(e,o,r,i)})}function gv(e=n.root){e&&e.querySelectorAll("[data-oq-hp-board]").forEach(t=>{lu(t)})}function mv(e,t,o,r,a=null,i=null){if(!e)return;const l=i||Qa(t,o,r),{mode:d,running:u}=l,c=l.schematic,p=e.querySelector(".oq-overview-hp-head-title");p&&at(p,tu(t,a));const f=e.querySelector(".oq-overview-hp-head-side");if(f){let y=f.querySelector(".oq-overview-hp-status");y||(at(f,Ar(d,u,c.warningActive,c.failureText)),y=f.querySelector(".oq-overview-hp-status")),$f(y,d,u,c.warningActive,c.failureText)}const m=e.querySelector("[data-oq-hp-board]");if(!m)return;m.className!==c.boardClass&&(m.className=c.boardClass),sv(m,[["status",c.statusText],["left-exchanger-title",c.leftExchangerTitle],["right-exchanger-title",c.rightExchangerTitle],["compressor-freq",c.compressorFreqText],["flow-value",c.flowText],["inner-coil-temp-value",c.innerCoilTempText],["evaporator-temp-value",c.evaporatorCoilTempText],["outside-temp-value",c.outsideTempText],["discharge-pressure-value",c.dischargePressureText],["discharge-temp-value",c.dischargeTempText],["suction-pressure-value",c.suctionPressureText],["suction-temp-value",c.suctionTempText],["supply-value",c.waterOutText],["return-value",c.waterInText],["footer-mode",c.mode],["footer-power",c.powerText],["footer-heat",c.heatText],["footer-efficiency-label",c.efficiencyLabel],["footer-efficiency",c.efficiencyText],["fan-speed-value",c.fanRpmText],["fourway-detail",c.fourWayPositionText],["eev-detail",c.eevPositionText]]);const v=m.querySelector('[data-oq-bind="footer-heat-label"]');if(v){Vt(v,"aria-label",c.heatLabel);const y=c.heatLabel==="Koelafgifte"?"Koel<br>afgifte":"Warmte<br>afgifte";v.innerHTML!==y&&(v.innerHTML=y)}[["bottom-heater",c.bottomPlateActive],["crankcase-heater",c.crankcaseActive]].forEach(([y,w])=>{cv(m,y,w,`${y}-tooltip`)});const q=m.querySelector('[data-oq-bind="defrost-badge"]');q&&(Vt(q,"tabindex",c.defrostActive?"0":"-1"),Vt(q,"aria-label",c.defrostActive?"Defrost actief":"Defrost uit"),c.defrostActive||Ko(m.querySelector('[data-oq-bind="defrost-badge-tooltip"]'))),[["supply-tooltip",c.supplyLineTone],["return-tooltip",c.returnLineTone]].forEach(([y,w])=>{An(m.querySelector(`[data-oq-bind="${y}"]`),"oq-hp-tech-tooltip--",w,["warm","supply","return"])}),lv(m,[["supply-reading",`Aanvoer temperatuur ${c.waterOutText}`],["flow-reading",`Flow ${c.flowText}`],["inner-coil-temp-reading",`Inner coil temperatuur ${c.innerCoilTempText}`],["evaporator-temp-reading",`Verdampertemperatuur ${c.evaporatorCoilTempText}`],["outside-temp-reading",`Buitentemperatuur ${c.outsideTempText}`],["compressor-freq-trigger",`Compressorfrequentie ${c.compressorFreqText}`],["fan-speed-reading",`Ventilatorsnelheid ${c.fanRpmText}`],["discharge-pressure-reading",`Persdruk ${c.dischargePressureText}`],["discharge-temp-reading",`Perstemperatuur ${c.dischargeTempText}`],["return-reading",`Retour temperatuur ${c.waterInText}`],["suction-pressure-reading",`Zuigdruk ${c.suctionPressureText}`],["suction-temp-reading",`Zuigtemperatuur ${c.suctionTempText}`],["fourway-trigger",`4-wegklep, ${c.fourWayPositionText}`],["eev-trigger",`Expansieventiel, ${c.eevPositionText}`]]),An(m.querySelector(".oq-hp-tech-pump"),"oq-hp-tech-pump--",c.returnLineTone,["supply","return"]);const h=String(c.title||"hp").toLowerCase().replace(/[^a-z0-9]+/g,"-");uv(m,"cond-water",`url(#${c.reverseCycle?`${h}-cond-water-cool`:`${h}-cond-water-heat`})`),Object.entries(c.pipes).forEach(([y,w])=>{dv(m,y.replace(/[A-Z]/g,S=>`-${S.toLowerCase()}`),w.tone,w.d)}),lu(m),Gr()}function hv(){if(!n.root||n.appView!=="overview")return!1;const e=n.root.querySelector(".oq-overview-board");if(!e)return!1;const t=`oq-overview-board oq-overview-board--${n.overviewTheme}`;e.className!==t&&(e.className=t);const o=Cc(),r=e.querySelector("[data-oq-monitoring-notice]"),a=e.querySelector(".oq-overview-summary-shell"),i=e.querySelector(".oq-overview-system"),l=e.querySelector(".oq-overview-temps"),d=e.querySelector(".oq-overview-trends"),u=e.querySelector(".oq-overview-hp-tools"),c=e.querySelector(".oq-overview-hp-grid"),p=e.querySelector("[data-oq-boiler-panel]"),f=au();if(r){const S=Oo();nt(r,be(S),bc())}if(a){const S=a.querySelector(".oq-overview-top");S&&at(S,Fo(Pc()));const $=a.querySelector(".oq-overview-statuspanel");if($){const H=W("controlModeLabel");nt($,be(Hc(o,H)),Mc(o,H))}const k=a.querySelector(".oq-overview-summary-side");if(k){const H=El();k.dataset.renderSignature!==H&&(at(k,Nc()),k.dataset.renderSignature=H)}}if(i&&nt(i,be(Tr()),Ac(Tr())),l){const S=Fa();nt(l,Lc(S),Rc())}if(d&&n.appView==="overview"&&(nt(d,Wa(),Ba()),Ic(e)),ja(e),!u||!c)return!1;const m=Ja(f),v=iu(f);if(rv(u,f),An(c,"oq-overview-hp-grid--",v,["single","equal","focus-hp1","focus-hp2"]),n.hpVisualMode!=="schematic"){const S=[...f.map((k,H)=>ru(k.title,k.keys,k.accent,mo(H,f,m),Nr(H,f,m))),Pr()].join(""),$=be({visualMode:n.hpVisualMode,layout:v,markup:S});return c.dataset.renderSignature!==$&&(at(c,S),c.dataset.renderSignature=$),!0}const q=Ya()?_o():null,h=q?Pr():"",y=q?Za(q):"";return!!p!=!!h||(p&&p.dataset.renderSignature!==y?p.outerHTML=h:p&&q&&tv(p,q),c.querySelectorAll("[data-oq-hp-panel]").length!==f.length)?!1:(f.forEach((S,$)=>{const k=e.querySelector(`[data-oq-hp-panel="${S.title}"]`);if(k){const H=Qa(S.title,S.keys,S.accent);An(k,"oq-overview-hp--",mo($,f,m),["normal","focus","muted"]),mv(k,S.title,S.keys,S.accent,Nr($,f,m),H)}}),!0)}function fv(){return`
      <section class="oq-helper-panel">
    ...
    `}function vv(){return n.appView==="overview"?av():n.appView==="energy"?Ib():n.appView==="diagnosis"?ob():n.appView==="results"?Wb():fv()}function wv(){const e=Zs();return`
    ...
    `}function yv(){const e=typeof document<"u"?document.activeElement:null;return!e||typeof e.matches!="function"?null:e.matches("select[data-oq-dev-control]")?e:null}function qv(e){if(!e||n.deferDevControlSelectRender)return;n.deferDevControlSelectRender=!0;const t=()=>{e.removeEventListener("blur",t),e.removeEventListener("change",t),n.deferDevControlSelectRender=!1,window.setTimeout(()=>g(),0)};e.addEventListener("blur",t,{once:!0}),e.addEventListener("change",t,{once:!0})}function g(){if(!n.root)return;const e=yv();if(e){qv(e);return}const t=n.systemModal==="webserver-logs"?gt():null,o=n.systemModal==="cm100-commissioning"?dm():null,r=String(n.systemModal||"").startsWith("service-task-")?gm():null,a=n.quickStartModalOpen?uf():null;if(n.nativeOpen){n.root.innerHTML=`
        ${yi()}
        ${up()}
      `,n.settingsRenderSignature="",n.headerRenderSignature=gr(),_r(),ro(),Bi(),fi(),Di(),Oi(),st(t),xi(o),Ii(r),es(a);return}const i=vv(),l=n.loadingEntities?`${i}${bv()}`:i,d=n.appView==="overview"||n.appView==="energy"||n.appView==="diagnosis"||n.appView==="results";n.root.innerHTML=`
      ${yi()}
      ...
      ${gp()}
      ${Kd()}
    `,n.settingsRenderSignature=n.appView==="settings"?yr():"",n.headerRenderSignature=gr(),zr(),gv(),Bi(),Qr(),ja(),ro(),fi(),Di(),Oi(),st(t),xi(o),Ii(r),es(a)}function s(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}wd();})();
