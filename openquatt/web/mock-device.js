(function () {
  ...
  function seedEntities() {
    ...
    [
      ...
      ["Power House Kp (W-K)", 2800, 0, 4000, 10, "W/K"],
      ["Power House deadband", 0.1, 0, 1, 0.01, "°C"],
      ["Power House comfort below setpoint", 0.0, 0, 2, 0.05, "°C"],
      ["Power House comfort above setpoint", 0.1, 0, 2, 0.05, "°C"],
      ["Power House comfort bias base", 0.0, 0, 0.5, 0.05, "°C"],
      ["Power House comfort bias max", 0.3, 0, 0.5, 0.05, "°C"],
