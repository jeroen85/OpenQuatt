...
STRICT_TOP_LEVEL_ORDER_RULES = {
    ...
    "openquatt/oq_packages.yaml": (
        ...
        "oq_thermal_limits",
        "oq_heating_strategy",
        "oq_dispatch_contract",
        "oq_cooling_dispatch",
        "oq_heating_curve_control",
        "oq_power_house_control",
        "oq_heat_control",
        "oq_thermal_actuator",
        "oq_flow_control",
        "oq_flow_autotune",
...
NESTED_KEY_ORDER_RULES = {
    ...
    ("openquatt/profiles/oq_substitutions_heatpump_listener.yaml", "substitutions"): (
        "esp_board",
        "esp_flash_size",
        "esp_variant",
        "uart_tx_pin",
        "uart_rx_pin",
        "uart_rts_pin",
        "oq_ot_thermostat_in_pin",
        "oq_ot_thermostat_out_pin",
        "ds18b20_pin",
        "oq_boiler_relay_pin",
    ),
    ("openquatt/profiles/oq_substitutions_waveshare.yaml", "substitutions"): (
        "esp_board",
        "esp_flash_size",
        "esp_variant",
        "uart_tx_pin",
